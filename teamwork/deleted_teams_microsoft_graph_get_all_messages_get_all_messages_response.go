...
func NewDeletedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesResponse()(*DeletedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesResponse) {
    m := &DeletedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesResponse{
...
func CreateDeletedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewDeletedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesResponse(), nil
}
// GetFieldDeserializers the deserialization information for the current model
func (m *DeletedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *DeletedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesResponse) GetValue()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ChatMessageable) {
...
func (m *DeletedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *DeletedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesResponse) SetValue(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ChatMessageable)() {
    err := m.GetBackingStore().Set("value", value)
    if err != nil {
        panic(err)
    }
}
// DeletedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesResponseable 
type DeletedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesResponseable interface {
