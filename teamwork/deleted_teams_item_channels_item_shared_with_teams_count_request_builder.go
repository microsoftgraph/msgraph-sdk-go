...
func (m *DeletedTeamsItemChannelsItemSharedWithTeamsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsItemSharedWithTeamsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
