...
// ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceMemberOfUserCountRequestBuilder provides operations to count the resources in the collection.
type ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceMemberOfUserCountRequestBuilder struct {
...
// NewItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceMemberOfUserCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
func NewItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceMemberOfUserCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceMemberOfUserCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceMemberOfUserCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceMemberOfUserCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceMemberOfUserCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceMemberOfUserCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceMemberOfUserCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
