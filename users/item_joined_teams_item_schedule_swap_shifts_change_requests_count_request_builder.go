...
func (m *ItemJoinedTeamsItemScheduleSwapShiftsChangeRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemScheduleSwapShiftsChangeRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
