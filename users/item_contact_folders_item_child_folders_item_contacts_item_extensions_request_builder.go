...
func (m *ItemContactFoldersItemChildFoldersItemContactsItemExtensionsRequestBuilder) ByExtensionIdString(extensionId string)(*ItemContactFoldersItemChildFoldersItemContactsItemExtensionsExtensionItemRequestBuilder) {
