...
func (m *ItemCalendargroupsItemCalendarsItemEventsItemInstancesItemAttachmentsRequestBuilder) CreateUploadSession()(*ItemCalendargroupsItemCalendarsItemEventsItemInstancesItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilder) {
    return NewItemCalendargroupsItemCalendarsItemEventsItemInstancesItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
