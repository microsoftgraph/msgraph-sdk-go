...
func (m *ItemContactFoldersRequestBuilder) MicrosoftGraphDelta()(*ItemContactFoldersMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemContactFoldersMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
