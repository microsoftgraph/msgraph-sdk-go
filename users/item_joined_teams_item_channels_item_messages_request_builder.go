...
func (m *ItemJoinedTeamsItemChannelsItemMessagesRequestBuilder) MicrosoftGraphDelta()(*ItemJoinedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemJoinedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
