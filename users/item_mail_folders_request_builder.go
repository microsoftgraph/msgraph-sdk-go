...
func (m *ItemMailFoldersRequestBuilder) MicrosoftGraphDelta()(*ItemMailFoldersMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemMailFoldersMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
