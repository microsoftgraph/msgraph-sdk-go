...
func (m *ItemTodoListsItemTasksMicrosoftGraphDeltaDeltaResponse) GetValue()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.TodoTaskable) {
...
func (m *ItemTodoListsItemTasksMicrosoftGraphDeltaDeltaResponse) SetValue(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.TodoTaskable)() {
    err := m.GetBackingStore().Set("value", value)
    if err != nil {
        panic(err)
    }
}
// ItemTodoListsItemTasksMicrosoftGraphDeltaDeltaResponseable 
type ItemTodoListsItemTasksMicrosoftGraphDeltaDeltaResponseable interface {
