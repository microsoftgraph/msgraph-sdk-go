...
// ItemJoinedTeamsItemClonePostRequestBody provides operations to call the clone method.
...
func (m *ItemJoinedTeamsItemClonePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemJoinedTeamsItemClonePostRequestBody) SetAdditionalData(value map[string]interface{})() {
