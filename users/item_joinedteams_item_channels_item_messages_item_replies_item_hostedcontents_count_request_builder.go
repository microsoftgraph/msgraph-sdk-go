...
// NewItemJoinedteamsItemChannelsItemMessagesItemRepliesItemHostedcontentsCountRequestBuilderInternal instantiates a new ItemJoinedteamsItemChannelsItemMessagesItemRepliesItemHostedcontentsCountRequestBuilder and sets the default values.
func NewItemJoinedteamsItemChannelsItemMessagesItemRepliesItemHostedcontentsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemJoinedteamsItemChannelsItemMessagesItemRepliesItemHostedcontentsCountRequestBuilder) {
    m := &ItemJoinedteamsItemChannelsItemMessagesItemRepliesItemHostedcontentsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/hostedContents/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemJoinedteamsItemChannelsItemMessagesItemRepliesItemHostedcontentsCountRequestBuilder instantiates a new ItemJoinedteamsItemChannelsItemMessagesItemRepliesItemHostedcontentsCountRequestBuilder and sets the default values.
...
func (m *ItemJoinedteamsItemChannelsItemMessagesItemRepliesItemHostedcontentsCountRequestBuilder) WithUrl(rawUrl string)(*ItemJoinedteamsItemChannelsItemMessagesItemRepliesItemHostedcontentsCountRequestBuilder) {
    return NewItemJoinedteamsItemChannelsItemMessagesItemRepliesItemHostedcontentsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
