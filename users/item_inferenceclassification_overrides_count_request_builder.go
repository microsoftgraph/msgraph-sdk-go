...
func (m *ItemInferenceclassificationOverridesCountRequestBuilder) WithUrl(rawUrl string)(*ItemInferenceclassificationOverridesCountRequestBuilder) {
    return NewItemInferenceclassificationOverridesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
