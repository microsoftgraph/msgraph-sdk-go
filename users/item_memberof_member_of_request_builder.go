...
func (m *ItemMemberofMemberOfRequestBuilder) GraphDirectoryRole()(*ItemMemberofGraphdirectoryroleGraphDirectoryRoleRequestBuilder) {
    return NewItemMemberofGraphdirectoryroleGraphDirectoryRoleRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
