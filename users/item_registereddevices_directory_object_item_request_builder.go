...
func (m *ItemRegistereddevicesDirectoryObjectItemRequestBuilder) GraphAppRoleAssignment()(*ItemRegistereddevicesItemGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) {
    return NewItemRegistereddevicesItemGraphapproleassignmentGraphAppRoleAssignmentRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// GraphDevice casts the previous resource to device.
// returns a *ItemRegistereddevicesItemGraphdeviceGraphDeviceRequestBuilder when successful
func (m *ItemRegistereddevicesDirectoryObjectItemRequestBuilder) GraphDevice()(*ItemRegistereddevicesItemGraphdeviceGraphDeviceRequestBuilder) {
    return NewItemRegistereddevicesItemGraphdeviceGraphDeviceRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// GraphEndpoint casts the previous resource to endpoint.
// returns a *ItemRegistereddevicesItemGraphendpointGraphEndpointRequestBuilder when successful
func (m *ItemRegistereddevicesDirectoryObjectItemRequestBuilder) GraphEndpoint()(*ItemRegistereddevicesItemGraphendpointGraphEndpointRequestBuilder) {
    return NewItemRegistereddevicesItemGraphendpointGraphEndpointRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
