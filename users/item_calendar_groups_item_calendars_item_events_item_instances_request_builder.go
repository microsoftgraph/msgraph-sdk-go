...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarGroupsItemCalendarsItemEventsItemInstancesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemCalendarGroupsItemCalendarsItemEventsItemInstancesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
