...
func (m *ItemMessagesItemReplyRequestBuilder) WithUrl(rawUrl string)(*ItemMessagesItemReplyRequestBuilder) {
    return NewItemMessagesItemReplyRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
