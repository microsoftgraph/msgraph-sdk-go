...
// ItemJoinedTeamsItemMembersAddPostRequestBody provides operations to call the add method.
...
func (m *ItemJoinedTeamsItemMembersAddPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemJoinedTeamsItemMembersAddPostRequestBody) SetAdditionalData(value map[string]interface{})() {
