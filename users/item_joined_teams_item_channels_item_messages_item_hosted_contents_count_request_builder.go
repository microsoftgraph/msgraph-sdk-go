...
func (m *ItemJoinedTeamsItemChannelsItemMessagesItemHostedContentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemChannelsItemMessagesItemHostedContentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
