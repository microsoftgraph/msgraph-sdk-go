...
func (m *ItemMailFoldersItemChildFoldersItemMessageRulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMailFoldersItemChildFoldersItemMessageRulesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
