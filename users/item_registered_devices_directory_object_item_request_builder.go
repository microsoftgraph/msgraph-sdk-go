...
func (m *ItemRegisteredDevicesDirectoryObjectItemRequestBuilder) MicrosoftGraphAppRoleAssignment()(*ItemRegisteredDevicesItemMicrosoftGraphAppRoleAssignmentAppRoleAssignmentRequestBuilder) {
    return NewItemRegisteredDevicesItemMicrosoftGraphAppRoleAssignmentAppRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
