...
// ItemCalendarsItemCalendarViewItemAcceptPostRequestBody provides operations to call the accept method.
...
func (m *ItemCalendarsItemCalendarViewItemAcceptPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarsItemCalendarViewItemAcceptPostRequestBody) SetAdditionalData(value map[string]interface{})() {
