...
// ItemCalendarsItemEventsItemForwardPostRequestBody provides operations to call the forward method.
...
func (m *ItemCalendarsItemEventsItemForwardPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarsItemEventsItemForwardPostRequestBody) SetAdditionalData(value map[string]interface{})() {
