...
// ByTeamsTabIdString provides operations to manage the tabs property of the microsoft.graph.chat entity.
func (m *ItemChatsItemTabsRequestBuilder) ByTeamsTabIdString(teamsTabId string)(*ItemChatsItemTabsTeamsTabItemRequestBuilder) {
