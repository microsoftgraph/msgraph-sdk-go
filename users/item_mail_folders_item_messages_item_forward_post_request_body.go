...
// ItemMailFoldersItemMessagesItemForwardPostRequestBody provides operations to call the forward method.
...
func (m *ItemMailFoldersItemMessagesItemForwardPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMailFoldersItemMessagesItemForwardPostRequestBody) SetAdditionalData(value map[string]interface{})() {
