...
// NewItemJoinedteamsItemChannelsItemTabsTeamsTabItemRequestBuilderInternal instantiates a new ItemJoinedteamsItemChannelsItemTabsTeamsTabItemRequestBuilder and sets the default values.
func NewItemJoinedteamsItemChannelsItemTabsTeamsTabItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemJoinedteamsItemChannelsItemTabsTeamsTabItemRequestBuilder) {
    m := &ItemJoinedteamsItemChannelsItemTabsTeamsTabItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/tabs/{teamsTab%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemJoinedteamsItemChannelsItemTabsTeamsTabItemRequestBuilder instantiates a new ItemJoinedteamsItemChannelsItemTabsTeamsTabItemRequestBuilder and sets the default values.
...
// returns a *ItemJoinedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilder when successful
func (m *ItemJoinedteamsItemChannelsItemTabsTeamsTabItemRequestBuilder) TeamsApp()(*ItemJoinedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilder) {
    return NewItemJoinedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemJoinedteamsItemChannelsItemTabsTeamsTabItemRequestBuilder) WithUrl(rawUrl string)(*ItemJoinedteamsItemChannelsItemTabsTeamsTabItemRequestBuilder) {
    return NewItemJoinedteamsItemChannelsItemTabsTeamsTabItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
