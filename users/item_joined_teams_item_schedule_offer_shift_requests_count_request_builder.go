...
func (m *ItemJoinedTeamsItemScheduleOfferShiftRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemScheduleOfferShiftRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
