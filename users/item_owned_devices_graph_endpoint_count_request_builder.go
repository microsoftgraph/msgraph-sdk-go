...
func (m *ItemOwnedDevicesGraphEndpointCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedDevicesGraphEndpointCountRequestBuilderGetRequestConfiguration)(*int64, error) {
