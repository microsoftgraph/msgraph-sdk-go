...
// ItemCalendarGroupsItemCalendarsItemEventsItemForwardPostRequestBody provides operations to call the forward method.
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemForwardPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemForwardPostRequestBody) SetAdditionalData(value map[string]interface{})() {
