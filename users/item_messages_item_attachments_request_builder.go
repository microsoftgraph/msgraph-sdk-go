...
func (m *ItemMessagesItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*ItemMessagesItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilder) {
    return NewItemMessagesItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
