...
// ItemMailFoldersItemChildFoldersItemMessagesItemReplyPostRequestBody provides operations to call the reply method.
...
func (m *ItemMailFoldersItemChildFoldersItemMessagesItemReplyPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMailFoldersItemChildFoldersItemMessagesItemReplyPostRequestBody) SetAdditionalData(value map[string]interface{})() {
