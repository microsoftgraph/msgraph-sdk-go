...
func (m *ItemOwneddevicesDirectoryObjectItemRequestBuilder) GraphAppRoleAssignment()(*ItemOwneddevicesItemGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) {
    return NewItemOwneddevicesItemGraphapproleassignmentGraphAppRoleAssignmentRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
