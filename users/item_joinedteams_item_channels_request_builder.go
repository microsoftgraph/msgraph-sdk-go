...
func (m *ItemJoinedteamsItemChannelsRequestBuilder) GetAllMessages()(*ItemJoinedteamsItemChannelsGetallmessagesGetAllMessagesRequestBuilder) {
    return NewItemJoinedteamsItemChannelsGetallmessagesGetAllMessagesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
