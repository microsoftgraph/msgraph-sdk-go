...
// ItemMessagesItemForwardPostRequestBody provides operations to call the forward method.
...
func (m *ItemMessagesItemForwardPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMessagesItemForwardPostRequestBody) SetAdditionalData(value map[string]interface{})() {
