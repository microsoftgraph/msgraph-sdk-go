...
func (m *ItemJoinedTeamsItemChannelsItemMembersRequestBuilder) Remove()(*ItemJoinedTeamsItemChannelsItemMembersRemoveRequestBuilder) {
    return NewItemJoinedTeamsItemChannelsItemMembersRemoveRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
