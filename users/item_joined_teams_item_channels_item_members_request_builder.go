...
func (m *ItemJoinedTeamsItemChannelsItemMembersRequestBuilder) MicrosoftGraphAdd()(*ItemJoinedTeamsItemChannelsItemMembersMicrosoftGraphAddRequestBuilder) {
    return NewItemJoinedTeamsItemChannelsItemMembersMicrosoftGraphAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
