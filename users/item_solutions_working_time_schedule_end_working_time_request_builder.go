...
// Post triggers the policies associated with the end of working hours for user.
...
// ToPostRequestInformation triggers the policies associated with the end of working hours for user.
