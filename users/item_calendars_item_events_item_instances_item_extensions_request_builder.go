...
func (m *ItemCalendarsItemEventsItemInstancesItemExtensionsRequestBuilder) ByExtensionIdString(extensionId string)(*ItemCalendarsItemEventsItemInstancesItemExtensionsExtensionItemRequestBuilder) {
