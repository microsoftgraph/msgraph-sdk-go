...
func (m *ItemCreatedObjectsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCreatedObjectsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
