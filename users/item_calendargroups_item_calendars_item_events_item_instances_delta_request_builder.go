...
// NewItemCalendargroupsItemCalendarsItemEventsItemInstancesDeltaRequestBuilderInternal instantiates a new ItemCalendargroupsItemCalendarsItemEventsItemInstancesDeltaRequestBuilder and sets the default values.
...
// NewItemCalendargroupsItemCalendarsItemEventsItemInstancesDeltaRequestBuilder instantiates a new ItemCalendargroupsItemCalendarsItemEventsItemInstancesDeltaRequestBuilder and sets the default values.
...
func (m *ItemCalendargroupsItemCalendarsItemEventsItemInstancesDeltaRequestBuilder) GetAsDeltaGetResponse(ctx context.Context, requestConfiguration *ItemCalendargroupsItemCalendarsItemEventsItemInstancesDeltaRequestBuilderGetRequestConfiguration)(ItemCalendargroupsItemCalendarsItemEventsItemInstancesDeltaGetResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateItemCalendargroupsItemCalendarsItemEventsItemInstancesDeltaGetResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
