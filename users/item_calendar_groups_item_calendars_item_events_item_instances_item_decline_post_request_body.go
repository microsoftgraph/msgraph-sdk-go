...
// ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody provides operations to call the decline method.
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemDeclinePostRequestBody) SetAdditionalData(value map[string]interface{})() {
