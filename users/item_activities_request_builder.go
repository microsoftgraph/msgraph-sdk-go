...
func (m *ItemActivitiesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemActivitiesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UserActivityCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateUserActivityCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemActivitiesRequestBuilder) MicrosoftGraphRecent()(*ItemActivitiesMicrosoftGraphRecentRecentRequestBuilder) {
    return NewItemActivitiesMicrosoftGraphRecentRecentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
