...
func (m *ItemDrivesItemRootDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDrivesItemRootDeltaRequestBuilderGetRequestConfiguration)(ItemDrivesItemRootDeltaResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateItemDrivesItemRootDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemDrivesItemRootDeltaRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemDrivesItemRootDeltaRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
