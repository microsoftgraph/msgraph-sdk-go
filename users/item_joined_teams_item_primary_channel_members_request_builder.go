...
func (m *ItemJoinedTeamsItemPrimaryChannelMembersRequestBuilder) MicrosoftGraphAdd()(*ItemJoinedTeamsItemPrimaryChannelMembersMicrosoftGraphAddAddRequestBuilder) {
    return NewItemJoinedTeamsItemPrimaryChannelMembersMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
