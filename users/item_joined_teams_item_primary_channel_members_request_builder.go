...
func (m *ItemJoinedTeamsItemPrimaryChannelMembersRequestBuilder) Remove()(*ItemJoinedTeamsItemPrimaryChannelMembersRemoveRequestBuilder) {
    return NewItemJoinedTeamsItemPrimaryChannelMembersRemoveRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
