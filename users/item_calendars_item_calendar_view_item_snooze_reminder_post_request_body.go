...
// ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody provides operations to call the snoozeReminder method.
...
func (m *ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarsItemCalendarViewItemSnoozeReminderPostRequestBody) SetAdditionalData(value map[string]interface{})() {
