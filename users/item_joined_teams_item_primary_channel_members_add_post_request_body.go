...
// ItemJoinedTeamsItemPrimaryChannelMembersAddPostRequestBody provides operations to call the add method.
...
func (m *ItemJoinedTeamsItemPrimaryChannelMembersAddPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemJoinedTeamsItemPrimaryChannelMembersAddPostRequestBody) SetAdditionalData(value map[string]interface{})() {
