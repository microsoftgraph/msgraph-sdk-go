...
// ItemPresenceSetPresencePostRequestBody provides operations to call the setPresence method.
...
func (m *ItemPresenceSetPresencePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemPresenceSetPresencePostRequestBody) SetAdditionalData(value map[string]interface{})() {
