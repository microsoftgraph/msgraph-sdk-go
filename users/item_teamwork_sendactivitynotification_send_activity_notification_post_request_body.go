...
type ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody instantiates a new ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody and sets the default values.
func NewItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody()(*ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) {
    m := &ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody(), nil
}
// GetActivityType gets the activityType property value. The activityType property
// returns a *string when successful
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) GetActivityType()(*string) {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetChainId gets the chainId property value. The chainId property
// returns a *int64 when successful
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) GetChainId()(*int64) {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) GetPreviewText()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ItemBodyable) {
...
// returns a *string when successful
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) GetTeamsAppId()(*string) {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) GetTemplateParameters()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.KeyValuePairable) {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) GetTopic()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.TeamworkActivityTopicable) {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) SetActivityType(value *string)() {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetChainId sets the chainId property value. The chainId property
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) SetChainId(value *int64)() {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) SetPreviewText(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ItemBodyable)() {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) SetTeamsAppId(value *string)() {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) SetTemplateParameters(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.KeyValuePairable)() {
...
func (m *ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBody) SetTopic(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.TeamworkActivityTopicable)() {
    err := m.GetBackingStore().Set("topic", value)
    if err != nil {
        panic(err)
    }
}
type ItemTeamworkSendactivitynotificationSendActivityNotificationPostRequestBodyable interface {
