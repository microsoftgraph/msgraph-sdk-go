...
// NewItemTodoListsItemExtensionsCountRequestBuilderInternal instantiates a new ItemTodoListsItemExtensionsCountRequestBuilder and sets the default values.
...
// NewItemTodoListsItemExtensionsCountRequestBuilder instantiates a new ItemTodoListsItemExtensionsCountRequestBuilder and sets the default values.
...
func (m *ItemTodoListsItemExtensionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTodoListsItemExtensionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
