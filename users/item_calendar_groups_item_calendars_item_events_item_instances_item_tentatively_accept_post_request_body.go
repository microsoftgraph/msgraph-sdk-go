...
// ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody provides operations to call the tentativelyAccept method.
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody) SetAdditionalData(value map[string]interface{})() {
