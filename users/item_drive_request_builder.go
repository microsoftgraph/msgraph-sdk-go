...
// ItemDriveRequestBuilderGetQueryParameters the user's OneDrive. Read-only.
...
func NewItemDriveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDriveRequestBuilder) {
    m := &ItemDriveRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/drive{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
// ToGetRequestInformation the user's OneDrive. Read-only.
