...
func (m *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredOwnersRequestBuilder) AppRoleAssignment()(*ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredOwnersAppRoleAssignmentRequestBuilder) {
    return NewItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredOwnersAppRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredOwnersRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredOwnersRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DirectoryObjectCollectionResponseable, error) {
