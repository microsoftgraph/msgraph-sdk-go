...
// ItemMailFoldersItemMessagesItemCreateForwardPostRequestBody provides operations to call the createForward method.
...
func (m *ItemMailFoldersItemMessagesItemCreateForwardPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMailFoldersItemMessagesItemCreateForwardPostRequestBody) SetAdditionalData(value map[string]interface{})() {
