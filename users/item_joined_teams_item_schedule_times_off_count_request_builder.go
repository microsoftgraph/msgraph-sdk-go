...
func (m *ItemJoinedTeamsItemScheduleTimesOffCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemScheduleTimesOffCountRequestBuilderGetRequestConfiguration)(*int64, error) {
