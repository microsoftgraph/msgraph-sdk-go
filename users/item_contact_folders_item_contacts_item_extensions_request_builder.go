...
func (m *ItemContactFoldersItemContactsItemExtensionsRequestBuilder) ByExtensionIdString(extensionId string)(*ItemContactFoldersItemContactsItemExtensionsExtensionItemRequestBuilder) {
