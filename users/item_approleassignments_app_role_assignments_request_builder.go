...
// ItemApproleassignmentsAppRoleAssignmentsRequestBuilder provides operations to manage the appRoleAssignments property of the microsoft.graph.user entity.
type ItemApproleassignmentsAppRoleAssignmentsRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemApproleassignmentsAppRoleAssignmentsRequestBuilderGetQueryParameters retrieve the list of appRoleAssignments that are currently granted to a user. This operation also returns app role assignments granted to groups that the user is a direct member of.
...
// Get retrieve the list of appRoleAssignments that are currently granted to a user. This operation also returns app role assignments granted to groups that the user is a direct member of.
...
// ToGetRequestInformation retrieve the list of appRoleAssignments that are currently granted to a user. This operation also returns app role assignments granted to groups that the user is a direct member of.
