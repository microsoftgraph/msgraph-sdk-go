...
func (m *UsersItemRegisteredDevicesDirectoryObjectItemRequestBuilder) AppRoleAssignment()(*UsersItemRegisteredDevicesItemAppRoleAssignmentRequestBuilder) {
    return NewUsersItemRegisteredDevicesItemAppRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *UsersItemRegisteredDevicesDirectoryObjectItemRequestBuilder) Get(ctx context.Context, requestConfiguration *UsersItemRegisteredDevicesDirectoryObjectItemRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DirectoryObjectable, error) {
