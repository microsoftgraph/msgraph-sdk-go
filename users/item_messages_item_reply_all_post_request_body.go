...
// ItemMessagesItemReplyAllPostRequestBody provides operations to call the replyAll method.
...
func (m *ItemMessagesItemReplyAllPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMessagesItemReplyAllPostRequestBody) SetAdditionalData(value map[string]interface{})() {
