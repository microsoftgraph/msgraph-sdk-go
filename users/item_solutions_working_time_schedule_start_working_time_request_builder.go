...
// Post triggers the policies associated with the start of working hours for user.
...
// ToPostRequestInformation triggers the policies associated with the start of working hours for user.
