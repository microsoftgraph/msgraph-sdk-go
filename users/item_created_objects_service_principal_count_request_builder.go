...
// ItemCreatedObjectsServicePrincipalCountRequestBuilderGetQueryParameters get the number of the resource
type ItemCreatedObjectsServicePrincipalCountRequestBuilderGetQueryParameters struct {
...
type ItemCreatedObjectsServicePrincipalCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemCreatedObjectsServicePrincipalCountRequestBuilderGetQueryParameters
}
...
func NewItemCreatedObjectsServicePrincipalCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCreatedObjectsServicePrincipalCountRequestBuilder) {
    m := &ItemCreatedObjectsServicePrincipalCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/createdObjects/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
...
func NewItemCreatedObjectsServicePrincipalCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCreatedObjectsServicePrincipalCountRequestBuilder) {
    ...
    return NewItemCreatedObjectsServicePrincipalCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemCreatedObjectsServicePrincipalCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCreatedObjectsServicePrincipalCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemCreatedObjectsServicePrincipalCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemCreatedObjectsServicePrincipalCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
