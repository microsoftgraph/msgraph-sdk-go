...
// ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody provides operations to call the decline method.
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesItemDeclinePostRequestBody) SetAdditionalData(value map[string]interface{})() {
