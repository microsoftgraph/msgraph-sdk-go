...
func (m *ItemJoinedTeamsItemPrimaryChannelMessagesItemRepliesRequestBuilder) MicrosoftGraphDelta()(*ItemJoinedTeamsItemPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemJoinedTeamsItemPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
