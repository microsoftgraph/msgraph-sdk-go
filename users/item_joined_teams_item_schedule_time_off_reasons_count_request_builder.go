...
func (m *ItemJoinedTeamsItemScheduleTimeOffReasonsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemScheduleTimeOffReasonsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
