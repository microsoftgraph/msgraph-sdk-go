...
// ItemCalendarEventsItemAcceptPostRequestBody provides operations to call the accept method.
...
func (m *ItemCalendarEventsItemAcceptPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarEventsItemAcceptPostRequestBody) SetAdditionalData(value map[string]interface{})() {
