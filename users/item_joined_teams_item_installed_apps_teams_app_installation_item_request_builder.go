...
func NewItemJoinedTeamsItemInstalledAppsTeamsAppInstallationItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, teamsAppInstallationId *string)(*ItemJoinedTeamsItemInstalledAppsTeamsAppInstallationItemRequestBuilder) {
...
func NewItemJoinedTeamsItemInstalledAppsTeamsAppInstallationItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemJoinedTeamsItemInstalledAppsTeamsAppInstallationItemRequestBuilder) {
    ...
    return NewItemJoinedTeamsItemInstalledAppsTeamsAppInstallationItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemJoinedTeamsItemInstalledAppsTeamsAppInstallationItemRequestBuilder) MicrosoftGraphUpgrade()(*ItemJoinedTeamsItemInstalledAppsItemMicrosoftGraphUpgradeUpgradeRequestBuilder) {
    return NewItemJoinedTeamsItemInstalledAppsItemMicrosoftGraphUpgradeUpgradeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
