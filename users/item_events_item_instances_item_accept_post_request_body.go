...
// ItemEventsItemInstancesItemAcceptPostRequestBody provides operations to call the accept method.
...
func (m *ItemEventsItemInstancesItemAcceptPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemEventsItemInstancesItemAcceptPostRequestBody) SetAdditionalData(value map[string]interface{})() {
