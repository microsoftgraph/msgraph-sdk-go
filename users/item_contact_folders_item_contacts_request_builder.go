...
func (m *ItemContactFoldersItemContactsRequestBuilder) MicrosoftGraphDelta()(*ItemContactFoldersItemContactsMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemContactFoldersItemContactsMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
