...
func (m *ItemRegisteredDevicesGraphAppRoleAssignmentCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredDevicesGraphAppRoleAssignmentCountRequestBuilderGetRequestConfiguration)(*int64, error) {
