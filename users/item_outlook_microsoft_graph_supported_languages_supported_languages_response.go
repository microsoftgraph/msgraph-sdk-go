...
func NewItemOutlookMicrosoftGraphSupportedLanguagesSupportedLanguagesResponse()(*ItemOutlookMicrosoftGraphSupportedLanguagesSupportedLanguagesResponse) {
    m := &ItemOutlookMicrosoftGraphSupportedLanguagesSupportedLanguagesResponse{
        BaseCollectionPaginationCountResponse: *iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.NewBaseCollectionPaginationCountResponse(),
    }
    return m
}
// CreateItemOutlookMicrosoftGraphSupportedLanguagesSupportedLanguagesResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateItemOutlookMicrosoftGraphSupportedLanguagesSupportedLanguagesResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemOutlookMicrosoftGraphSupportedLanguagesSupportedLanguagesResponse(), nil
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemOutlookMicrosoftGraphSupportedLanguagesSupportedLanguagesResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
