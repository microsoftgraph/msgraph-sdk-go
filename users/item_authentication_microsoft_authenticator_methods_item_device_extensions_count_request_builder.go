...
// ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceExtensionsCountRequestBuilderGetQueryParameters get the number of the resource
type ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceExtensionsCountRequestBuilderGetQueryParameters struct {
...
type ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceExtensionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceExtensionsCountRequestBuilderGetQueryParameters
}
...
func NewItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceExtensionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceExtensionsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/extensions/$count{?%24search,%24filter}";
...
func (m *ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceExtensionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemAuthenticationMicrosoftAuthenticatorMethodsItemDeviceExtensionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
