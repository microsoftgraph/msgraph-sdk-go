...
// ItemEventsItemInstancesItemExceptionOccurrencesRequestBuilderGetQueryParameters get exceptionOccurrences from users
...
func (m *ItemEventsItemInstancesItemExceptionOccurrencesRequestBuilder) ByEventId2(eventId2 string)(*ItemEventsItemInstancesItemExceptionOccurrencesEventItemRequestBuilder) {
    ...
    return NewItemEventsItemInstancesItemExceptionOccurrencesEventItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
// NewItemEventsItemInstancesItemExceptionOccurrencesRequestBuilderInternal instantiates a new ItemEventsItemInstancesItemExceptionOccurrencesRequestBuilder and sets the default values.
func NewItemEventsItemInstancesItemExceptionOccurrencesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemEventsItemInstancesItemExceptionOccurrencesRequestBuilder) {
    m := &ItemEventsItemInstancesItemExceptionOccurrencesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemEventsItemInstancesItemExceptionOccurrencesRequestBuilder instantiates a new ItemEventsItemInstancesItemExceptionOccurrencesRequestBuilder and sets the default values.
...
func (m *ItemEventsItemInstancesItemExceptionOccurrencesRequestBuilder) Count()(*ItemEventsItemInstancesItemExceptionOccurrencesCountRequestBuilder) {
    return NewItemEventsItemInstancesItemExceptionOccurrencesCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemEventsItemInstancesItemExceptionOccurrencesRequestBuilder) Delta()(*ItemEventsItemInstancesItemExceptionOccurrencesDeltaRequestBuilder) {
    return NewItemEventsItemInstancesItemExceptionOccurrencesDeltaRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// Get get exceptionOccurrences from users
// returns a EventCollectionResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemEventsItemInstancesItemExceptionOccurrencesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemEventsItemInstancesItemExceptionOccurrencesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.EventCollectionResponseable, error) {
