...
func (m *ItemJoinedTeamsItemScheduleSchedulingGroupsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemScheduleSchedulingGroupsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
