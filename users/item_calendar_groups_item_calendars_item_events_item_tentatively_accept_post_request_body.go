...
// ItemCalendarGroupsItemCalendarsItemEventsItemTentativelyAcceptPostRequestBody provides operations to call the tentativelyAccept method.
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemTentativelyAcceptPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemTentativelyAcceptPostRequestBody) SetAdditionalData(value map[string]interface{})() {
