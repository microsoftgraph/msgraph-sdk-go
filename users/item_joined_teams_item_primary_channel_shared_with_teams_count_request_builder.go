...
func (m *ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
