...
// ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceCheckMemberGroupsPostRequestBody 
...
func (m *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceCheckMemberGroupsPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceCheckMemberGroupsPostRequestBody) SetAdditionalData(value map[string]any)() {
