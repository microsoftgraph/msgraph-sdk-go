...
// ItemJoinedTeamsItemMembersAddResponse provides operations to call the add method.
...
func (m *ItemJoinedTeamsItemMembersAddResponse) GetValue()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ActionResultPartable) {
    return m.value
}
...
func (m *ItemJoinedTeamsItemMembersAddResponse) SetValue(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ActionResultPartable)() {
    m.value = value
}
