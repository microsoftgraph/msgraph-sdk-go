...
func (m *ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemCalendarGroupsItemCalendarsItemCalendarViewItemInstancesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
