...
func (m *ItemManagedDevicesItemLogCollectionRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemManagedDevicesItemLogCollectionRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
