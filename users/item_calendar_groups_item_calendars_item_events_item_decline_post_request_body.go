...
// ItemCalendarGroupsItemCalendarsItemEventsItemDeclinePostRequestBody provides operations to call the decline method.
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemDeclinePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarGroupsItemCalendarsItemEventsItemDeclinePostRequestBody) SetAdditionalData(value map[string]interface{})() {
