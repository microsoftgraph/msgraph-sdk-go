...
// ItemCalendarEventsItemCancelPostRequestBody provides operations to call the cancel method.
...
func (m *ItemCalendarEventsItemCancelPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarEventsItemCancelPostRequestBody) SetAdditionalData(value map[string]interface{})() {
