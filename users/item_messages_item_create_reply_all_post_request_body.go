...
// ItemMessagesItemCreateReplyAllPostRequestBody provides operations to call the createReplyAll method.
...
func (m *ItemMessagesItemCreateReplyAllPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMessagesItemCreateReplyAllPostRequestBody) SetAdditionalData(value map[string]interface{})() {
