...
func (m *ItemCalendarCalendarViewItemExtensionsRequestBuilder) ByExtensionIdString(extensionId string)(*ItemCalendarCalendarViewItemExtensionsExtensionItemRequestBuilder) {
...
func NewItemCalendarCalendarViewItemExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarCalendarViewItemExtensionsRequestBuilder) {
    m := &ItemCalendarCalendarViewItemExtensionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
