...
// Builds and executes requests for operations under \users\{user-id}\todo\lists\{todoTaskList-id}\tasks
...
func NewTasksRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TasksRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/todo/lists/{todoTaskList_id}/tasks{?top,skip,search,filter,count,orderby,select,expand}";
