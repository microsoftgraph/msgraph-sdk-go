...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property scopedRoleMemberOf for users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property scopedRoleMemberOf in users
