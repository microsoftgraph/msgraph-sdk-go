...
// refRequestBuilder builds and executes requests for operations under \users\{user-id}\managedAppRegistrations\$ref
...
// refRequestBuilderGetQueryParameters zero or more managed app registrations that belong to the user.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/managedAppRegistrations/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation zero or more managed app registrations that belong to the user.
...
// Post zero or more managed app registrations that belong to the user.
