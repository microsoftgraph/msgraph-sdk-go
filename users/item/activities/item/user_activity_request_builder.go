...
import (
    ...
    i388feb2971b7d8cb0d5e9193d5ef00529bc7f6e3bf29d3dca3646bcb7809356a "github.com/microsoftgraph/msgraph-sdk-go/users/item/activities/item/historyitems"
    ia9480708f9227e4169fa25ed641175212a4508510e8240d822c8261975b393f6 "github.com/microsoftgraph/msgraph-sdk-go/users/item/activities/item/historyitems/item"
)
...
func NewUserActivityRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UserActivityRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/activities/{userActivity_id}{?select,expand}";
...
func (m *UserActivityRequestBuilder) HistoryItems()(*i388feb2971b7d8cb0d5e9193d5ef00529bc7f6e3bf29d3dca3646bcb7809356a.HistoryItemsRequestBuilder) {
    return i388feb2971b7d8cb0d5e9193d5ef00529bc7f6e3bf29d3dca3646bcb7809356a.NewHistoryItemsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Gets an item from the github.com/microsoftgraph/msgraph-sdk-go.users.item.activities.item.historyItems.item collection
// Parameters:
//  - id : Unique identifier of the item
func (m *UserActivityRequestBuilder) HistoryItemsById(id string)(*ia9480708f9227e4169fa25ed641175212a4508510e8240d822c8261975b393f6.ActivityHistoryItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return ia9480708f9227e4169fa25ed641175212a4508510e8240d822c8261975b393f6.NewActivityHistoryItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
// The user's activities across devices. Read-only. Nullable.
// Parameters:
//  - options : Options for the request
