...
import (
    ...
    i528d5e366de16e1193cd04e0ab94213c69e42eb13c03adabf02b9a57d9493a96 "github.com/microsoftgraph/msgraph-sdk-go/users/item/transitivememberof/orgcontact/count"
)
...
func NewOrgContactRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrgContactRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/transitiveMemberOf/microsoft.graph.orgContact{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
...
func (m *OrgContactRequestBuilder) Count()(*i528d5e366de16e1193cd04e0ab94213c69e42eb13c03adabf02b9a57d9493a96.CountRequestBuilder) {
    return i528d5e366de16e1193cd04e0ab94213c69e42eb13c03adabf02b9a57d9493a96.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *OrgContactRequestBuilder) Get(ctx context.Context, requestConfiguration *OrgContactRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.OrgContactCollectionResponseable, error) {
