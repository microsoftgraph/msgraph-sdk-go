...
import (
    ...
    iad2c44f6ce66b253d6f31312b1bda9388883b45fb10b6cfc24ad379ce8c3347a "github.com/microsoftgraph/msgraph-sdk-go/users/item/memberof/ref"
)
...
func NewMemberOfRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MemberOfRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/memberOf{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MemberOfRequestBuilder) Ref()(*iad2c44f6ce66b253d6f31312b1bda9388883b45fb10b6cfc24ad379ce8c3347a.RefRequestBuilder) {
    return iad2c44f6ce66b253d6f31312b1bda9388883b45fb10b6cfc24ad379ce8c3347a.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
