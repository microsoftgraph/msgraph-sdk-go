...
// RefRequestBuilder builds and executes requests for operations under \users\{user-id}\agreementAcceptances\$ref
...
// RefRequestBuilderGetQueryParameters the user's terms of use acceptance statuses. Read-only. Nullable.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/agreementAcceptances/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the user's terms of use acceptance statuses. Read-only. Nullable.
...
// Post the user's terms of use acceptance statuses. Read-only. Nullable.
