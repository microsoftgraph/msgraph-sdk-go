...
// allowedCalendarSharingRolesWithUserRequestBuilder builds and executes requests for operations under \users\{user-id}\events\{event-id}\calendar\microsoft.graph.allowedCalendarSharingRoles(User='{User}')
...
func NewAllowedCalendarSharingRolesWithUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter, user *string)(*AllowedCalendarSharingRolesWithUserRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/events/{event_id}/calendar/microsoft.graph.allowedCalendarSharingRoles(User='{User}')";
