...
import (
    ...
    i6bdd5f13e76e7c9a5313c568c5f42ea8a24f21f6135f654e9a2b7a40c1634d13 "github.com/microsoftgraph/msgraph-sdk-go/users/item/events/item/calendar/calendarview/delta"
)
...
func NewCalendarViewRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CalendarViewRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/events/{event_id}/calendar/calendarView{?top,skip,filter,count,orderby,select}";
...
func (m *CalendarViewRequestBuilder) Delta()(*i6bdd5f13e76e7c9a5313c568c5f42ea8a24f21f6135f654e9a2b7a40c1634d13.DeltaRequestBuilder) {
    return i6bdd5f13e76e7c9a5313c568c5f42ea8a24f21f6135f654e9a2b7a40c1634d13.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The calendar view for the calendar. Navigation property. Read-only.
// Parameters:
//  - h : Request headers
