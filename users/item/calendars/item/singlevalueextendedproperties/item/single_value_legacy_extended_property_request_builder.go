...
// SingleValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\singleValueExtendedProperties\{singleValueLegacyExtendedProperty-id}
