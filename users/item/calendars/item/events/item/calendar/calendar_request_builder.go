...
import (
    ...
    i1d24178de6ae6ccfad0995e5c1a7ab893feb4de12a4a4ed60c53af0b3784dacd "github.com/microsoftgraph/msgraph-sdk-go/users/item/calendars/item/events/item/calendar/allowedcalendarsharingroleswithuser"
    i852608350141d9685e3dfffc99911266fecf6339f03aac9e3262ecec458ccaa6 "github.com/microsoftgraph/msgraph-sdk-go/users/item/calendars/item/events/item/calendar/getschedule"
)
...
func (m *CalendarRequestBuilder) AllowedCalendarSharingRolesWithUser(user *string)(*i1d24178de6ae6ccfad0995e5c1a7ab893feb4de12a4a4ed60c53af0b3784dacd.AllowedCalendarSharingRolesWithUserRequestBuilder) {
    return i1d24178de6ae6ccfad0995e5c1a7ab893feb4de12a4a4ed60c53af0b3784dacd.NewAllowedCalendarSharingRolesWithUserRequestBuilderInternal(m.pathParameters, m.requestAdapter, user);
}
...
func NewCalendarRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CalendarRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/calendars/{calendar_id}/events/{event_id}/calendar{?select}";
...
func (m *CalendarRequestBuilder) GetSchedule()(*i852608350141d9685e3dfffc99911266fecf6339f03aac9e3262ecec458ccaa6.GetScheduleRequestBuilder) {
    return i852608350141d9685e3dfffc99911266fecf6339f03aac9e3262ecec458ccaa6.NewGetScheduleRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The calendar that contains the event. Navigation property. Read-only.
// Parameters:
//  - options : Options for the request
