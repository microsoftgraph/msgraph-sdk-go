...
// CreateUploadSessionRequestBuilder builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\events\{event-id}\attachments\microsoft.graph.createUploadSession
