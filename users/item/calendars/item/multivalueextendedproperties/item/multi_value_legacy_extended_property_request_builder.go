...
// MultiValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
