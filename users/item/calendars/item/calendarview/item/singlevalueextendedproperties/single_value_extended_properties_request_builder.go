...
import (
    ...
    i6084cfb9a2b28a65a7772eabbc2cca114c0582c1931b11fab0e243d2c194ad53 "github.com/microsoftgraph/msgraph-sdk-go/users/item/calendars/item/calendarview/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/calendarView/{event_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i6084cfb9a2b28a65a7772eabbc2cca114c0582c1931b11fab0e243d2c194ad53.CountRequestBuilder) {
    return i6084cfb9a2b28a65a7772eabbc2cca114c0582c1931b11fab0e243d2c194ad53.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
