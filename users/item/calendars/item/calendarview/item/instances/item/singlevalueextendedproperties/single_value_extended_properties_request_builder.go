...
import (
    ...
    i1899073490c0a2e5e9edc5f8687e4b1c23fb4fb76f8d29ad89cc4dc3ed446a99 "github.com/microsoftgraph/msgraph-sdk-go/users/item/calendars/item/calendarview/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/calendarView/{event_id}/instances/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i1899073490c0a2e5e9edc5f8687e4b1c23fb4fb76f8d29ad89cc4dc3ed446a99.CountRequestBuilder) {
    return i1899073490c0a2e5e9edc5f8687e4b1c23fb4fb76f8d29ad89cc4dc3ed446a99.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
