...
import (
    ...
    i1d454c44e43065b2ef7f3078665912ab2dc87eabfdf8370c0288da963204fe38 "github.com/microsoftgraph/msgraph-sdk-go/users/item/calendars/item/calendarview/item/attachments/createuploadsession"
    i95a8639d30de15ff48a890279323013382f8e1435634b362d1d4b88e023ae01a "github.com/microsoftgraph/msgraph-sdk-go/users/item/calendars/item/calendarview/item/attachments/count"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/calendarView/{event_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*i95a8639d30de15ff48a890279323013382f8e1435634b362d1d4b88e023ae01a.CountRequestBuilder) {
    return i95a8639d30de15ff48a890279323013382f8e1435634b362d1d4b88e023ae01a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*i1d454c44e43065b2ef7f3078665912ab2dc87eabfdf8370c0288da963204fe38.CreateUploadSessionRequestBuilder) {
    return i1d454c44e43065b2ef7f3078665912ab2dc87eabfdf8370c0288da963204fe38.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
