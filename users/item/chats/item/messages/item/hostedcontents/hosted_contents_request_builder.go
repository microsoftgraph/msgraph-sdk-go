...
import (
    ...
    ie436578c6e31c95562088caa39284eb5194619f8fae72b905cfd72d4a449599e "github.com/microsoftgraph/msgraph-sdk-go/users/item/chats/item/messages/item/hostedcontents/count"
)
...
func NewHostedContentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HostedContentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/chats/{chat_id}/messages/{chatMessage_id}/hostedContents{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *HostedContentsRequestBuilder) Count()(*ie436578c6e31c95562088caa39284eb5194619f8fae72b905cfd72d4a449599e.CountRequestBuilder) {
    return ie436578c6e31c95562088caa39284eb5194619f8fae72b905cfd72d4a449599e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
