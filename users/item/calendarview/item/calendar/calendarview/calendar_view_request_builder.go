...
import (
    ...
    i712f54db5037fa039a0427ccd37d12b2aaf8b6b9eecee57296e5052ec8d5fc9b "github.com/microsoftgraph/msgraph-sdk-go/users/item/calendarview/item/calendar/calendarview/delta"
)

// calendarViewRequestBuilder builds and executes requests for operations under \users\{user-id}\calendarView\{event-id}\calendar\calendarView
...
func NewCalendarViewRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CalendarViewRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendarView/{event_id}/calendar/calendarView{?top,skip,filter,count,orderby,select}";
...
// Delta builds and executes requests for operations under \users\{user-id}\calendarView\{event-id}\calendar\calendarView\microsoft.graph.delta()
func (m *CalendarViewRequestBuilder) Delta()(*i712f54db5037fa039a0427ccd37d12b2aaf8b6b9eecee57296e5052ec8d5fc9b.DeltaRequestBuilder) {
    return i712f54db5037fa039a0427ccd37d12b2aaf8b6b9eecee57296e5052ec8d5fc9b.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
