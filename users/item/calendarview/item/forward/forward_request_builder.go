...
// ForwardRequestBuilder builds and executes requests for operations under \users\{user-id}\calendarView\{event-id}\microsoft.graph.forward
...
func NewForwardRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ForwardRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendarView/{event_id}/microsoft.graph.forward";
