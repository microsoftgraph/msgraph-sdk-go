...
import (
    ...
    i14c5e94e9256a398b8059431b672fbbeffa4b38ee68dc074c165d12e8c1eba04 "github.com/microsoftgraph/msgraph-sdk-go/users/item/calendarview/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendarView/{event_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i14c5e94e9256a398b8059431b672fbbeffa4b38ee68dc074c165d12e8c1eba04.CountRequestBuilder) {
    return i14c5e94e9256a398b8059431b672fbbeffa4b38ee68dc074c165d12e8c1eba04.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
