...
// RefRequestBuilder builds and executes requests for operations under \users\{user-id}\followedSites\$ref
...
// RefRequestBuilderGetQueryParameters get ref of followedSites from users
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/followedSites/$ref{?top,skip,search,filter,count,orderby}";
...
// CreateGetRequestInformation get ref of followedSites from users
...
// CreatePostRequestInformation create new navigation property ref to followedSites for users
...
// Get get ref of followedSites from users
...
// Post create new navigation property ref to followedSites for users
