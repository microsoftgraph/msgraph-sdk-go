...
import (
    ...
    ia2dd4932b465404d795118b396b3113d76c78978ca04c11543bbaf93ed42a88f "github.com/microsoftgraph/msgraph-sdk-go/users/item/joinedteams/item/channels/item/tabs/count"
)
...
func NewTabsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TabsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/channels/{channel_id}/tabs{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *TabsRequestBuilder) Count()(*ia2dd4932b465404d795118b396b3113d76c78978ca04c11543bbaf93ed42a88f.CountRequestBuilder) {
    return ia2dd4932b465404d795118b396b3113d76c78978ca04c11543bbaf93ed42a88f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
