...
import (
    ...
    i52bef3a0f8064cddc38d8e5e591837e8e2de599cfca70d922a69037d02812f7f "github.com/microsoftgraph/msgraph-sdk-go/users/item/joinedteams/item/channels/item/members/count"
    i576bd30062cfdfba392a57e46b487d2173b1bf8b8fae9ba7c24db7aebf7ee930 "github.com/microsoftgraph/msgraph-sdk-go/users/item/joinedteams/item/channels/item/members/add"
)
...
type MembersRequestBuilderPostOptions struct {
    // 
    Body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationMemberable;
    // Request headers
    Headers map[string]string;
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption;
...
func (m *MembersRequestBuilder) Add()(*i576bd30062cfdfba392a57e46b487d2173b1bf8b8fae9ba7c24db7aebf7ee930.AddRequestBuilder) {
    return i576bd30062cfdfba392a57e46b487d2173b1bf8b8fae9ba7c24db7aebf7ee930.NewAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/channels/{channel_id}/members{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MembersRequestBuilder) Count()(*i52bef3a0f8064cddc38d8e5e591837e8e2de599cfca70d922a69037d02812f7f.CountRequestBuilder) {
    return i52bef3a0f8064cddc38d8e5e591837e8e2de599cfca70d922a69037d02812f7f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *MembersRequestBuilder) Get(options *MembersRequestBuilderGetOptions)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationMemberCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateConversationMemberCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
...
func (m *MembersRequestBuilder) Post(options *MembersRequestBuilderPostOptions)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationMemberable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateConversationMemberFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
