...
import (
    ...
    i13f2c12972ef68e9dd505ae92c5952ff6b06be80d8979bde567a4bdce24008ea "github.com/microsoftgraph/msgraph-sdk-go/users/item/joinedteams/item/channels/item/messages/item/replies/item/hostedcontents"
    i1cda83d247cf07cc215bd97e014c3ef438e187e10500103e214f2e79fc80e79b "github.com/microsoftgraph/msgraph-sdk-go/users/item/joinedteams/item/channels/item/messages/item/replies/item/hostedcontents/item"
)
...
func NewChatMessageItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChatMessageItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/channels/{channel_id}/messages/{chatMessage_id}/replies/{chatMessage_id1}{?select,expand}";
...
func (m *ChatMessageItemRequestBuilder) HostedContents()(*i13f2c12972ef68e9dd505ae92c5952ff6b06be80d8979bde567a4bdce24008ea.HostedContentsRequestBuilder) {
    return i13f2c12972ef68e9dd505ae92c5952ff6b06be80d8979bde567a4bdce24008ea.NewHostedContentsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// HostedContentsById gets an item from the github.com/microsoftgraph/msgraph-sdk-go/.users.item.joinedTeams.item.channels.item.messages.item.replies.item.hostedContents.item collection
func (m *ChatMessageItemRequestBuilder) HostedContentsById(id string)(*i1cda83d247cf07cc215bd97e014c3ef438e187e10500103e214f2e79fc80e79b.ChatMessageHostedContentItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i1cda83d247cf07cc215bd97e014c3ef438e187e10500103e214f2e79fc80e79b.NewChatMessageHostedContentItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
