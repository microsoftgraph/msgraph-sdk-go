...
import (
    ...
    i98b1c93b29411ca324f1fe1859e0c93a8f7d8beea1ed2d95a1f64c2471be896d "github.com/microsoftgraph/msgraph-sdk-go/users/item/joinedteams/item/channels/item/messages/count"
    ie1631a631fcd77f92a98280f9aa93b0b9fadc445d3787dcaaae5933e51ff7730 "github.com/microsoftgraph/msgraph-sdk-go/users/item/joinedteams/item/channels/item/messages/delta"
)
...
func NewMessagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MessagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/channels/{channel_id}/messages{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MessagesRequestBuilder) Count()(*i98b1c93b29411ca324f1fe1859e0c93a8f7d8beea1ed2d95a1f64c2471be896d.CountRequestBuilder) {
    return i98b1c93b29411ca324f1fe1859e0c93a8f7d8beea1ed2d95a1f64c2471be896d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *MessagesRequestBuilder) Delta()(*ie1631a631fcd77f92a98280f9aa93b0b9fadc445d3787dcaaae5933e51ff7730.DeltaRequestBuilder) {
    return ie1631a631fcd77f92a98280f9aa93b0b9fadc445d3787dcaaae5933e51ff7730.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
