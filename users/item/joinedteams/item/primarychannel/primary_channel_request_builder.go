...
// DeleteWithResponseHandler delete navigation property primaryChannel for users
...
// PatchWithResponseHandler update the navigation property primaryChannel in users
