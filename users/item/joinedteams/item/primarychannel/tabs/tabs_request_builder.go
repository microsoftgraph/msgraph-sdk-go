...
import (
    ...
    ic345df6f5da1fe46744aa6f54a4aa4d3526278421293c1568764e1535dd42204 "github.com/microsoftgraph/msgraph-sdk-go/users/item/joinedteams/item/primarychannel/tabs/count"
)
...
func NewTabsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TabsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/primaryChannel/tabs{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *TabsRequestBuilder) Count()(*ic345df6f5da1fe46744aa6f54a4aa4d3526278421293c1568764e1535dd42204.CountRequestBuilder) {
    return ic345df6f5da1fe46744aa6f54a4aa4d3526278421293c1568764e1535dd42204.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
