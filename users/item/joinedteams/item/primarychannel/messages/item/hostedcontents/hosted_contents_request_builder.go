...
import (
    ...
    ic1dd74b51947296f267b36190ef9050fe8d7f93f428217468730c00e16f219a0 "github.com/microsoftgraph/msgraph-sdk-go/users/item/joinedteams/item/primarychannel/messages/item/hostedcontents/count"
)
...
func NewHostedContentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*HostedContentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/primaryChannel/messages/{chatMessage_id}/hostedContents{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *HostedContentsRequestBuilder) Count()(*ic1dd74b51947296f267b36190ef9050fe8d7f93f428217468730c00e16f219a0.CountRequestBuilder) {
    return ic1dd74b51947296f267b36190ef9050fe8d7f93f428217468730c00e16f219a0.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
