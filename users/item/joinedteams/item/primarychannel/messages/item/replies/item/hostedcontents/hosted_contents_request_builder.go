...
import (
    ...
    if38794932ecdad04cff90f85e6b59c2344d596081e556f7181c54e767a10111e "github.com/microsoftgraph/msgraph-sdk-go/users/item/joinedteams/item/primarychannel/messages/item/replies/item/hostedcontents/count"
)
...
type HostedContentsRequestBuilderPostOptions struct {
    // 
    Body i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ChatMessageHostedContentable;
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
...
func NewHostedContentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HostedContentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/primaryChannel/messages/{chatMessage_id}/replies/{chatMessage_id1}/hostedContents{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *HostedContentsRequestBuilder) Count()(*if38794932ecdad04cff90f85e6b59c2344d596081e556f7181c54e767a10111e.CountRequestBuilder) {
    return if38794932ecdad04cff90f85e6b59c2344d596081e556f7181c54e767a10111e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *HostedContentsRequestBuilder) Get(options *HostedContentsRequestBuilderGetOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ChatMessageHostedContentCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CreateChatMessageHostedContentCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ChatMessageHostedContentCollectionResponseable), nil
}
// Post create new navigation property to hostedContents for users
func (m *HostedContentsRequestBuilder) Post(options *HostedContentsRequestBuilderPostOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ChatMessageHostedContentable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CreateChatMessageHostedContentFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ChatMessageHostedContentable), nil
}
