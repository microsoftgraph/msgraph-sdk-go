...
// GroupRequestBuilderGetQueryParameters get group from users
...
// CreateGetRequestInformationWithRequestConfiguration get group from users
...
// GetWithRequestConfigurationAndResponseHandler get group from users
