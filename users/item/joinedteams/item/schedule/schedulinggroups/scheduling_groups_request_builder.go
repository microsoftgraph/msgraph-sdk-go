...
import (
    ...
    id9180d65282fdc04f5bd904760eb3140fee5181a56ed82e39f9ffbfc740cda89 "github.com/microsoftgraph/msgraph-sdk-go/users/item/joinedteams/item/schedule/schedulinggroups/count"
)
...
func NewSchedulingGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SchedulingGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/schedule/schedulingGroups{?top,skip,search,filter,count,orderby,select}";
...
func (m *SchedulingGroupsRequestBuilder) Count()(*id9180d65282fdc04f5bd904760eb3140fee5181a56ed82e39f9ffbfc740cda89.CountRequestBuilder) {
    return id9180d65282fdc04f5bd904760eb3140fee5181a56ed82e39f9ffbfc740cda89.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
