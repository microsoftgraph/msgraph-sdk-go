...
func (m *OwnedDevicesResponse) GetValue()([]if299d9ef56e2af8df97202321de61e2aee15552ebb21beaaf1dc86170d772b19.DirectoryObject) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *OwnedDevicesResponse) SetValue(value []if299d9ef56e2af8df97202321de61e2aee15552ebb21beaaf1dc86170d772b19.DirectoryObject)() {
    if m != nil {
        m.value = value
    }
}
