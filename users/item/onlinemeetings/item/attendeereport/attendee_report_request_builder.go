...
// attendeeReportRequestBuilder builds and executes requests for operations under \users\{user-id}\onlineMeetings\{onlineMeeting-id}\attendeeReport
...
func NewAttendeeReportRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AttendeeReportRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onlineMeetings/{onlineMeeting_id}/attendeeReport";
...
// CreateGetRequestInformation get media content for the navigation property onlineMeetings from users
...
// CreatePutRequestInformation update media content for the navigation property onlineMeetings in users
...
// Get get media content for the navigation property onlineMeetings from users
...
// Put update media content for the navigation property onlineMeetings in users
