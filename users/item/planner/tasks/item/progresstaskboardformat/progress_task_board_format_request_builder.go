...
// ProgressTaskBoardFormatRequestBuilder builds and executes requests for operations under \users\{user-id}\planner\tasks\{plannerTask-id}\progressTaskBoardFormat
