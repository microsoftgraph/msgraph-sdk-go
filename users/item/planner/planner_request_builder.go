...
// CreateGetRequestInformationWithRequestConfiguration entry-point to the Planner resource that might exist for a user. Read-only.
...
func (m *PlannerRequestBuilder) Patch(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.PlannerUserable, requestConfiguration *PlannerRequestBuilderPatchRequestConfiguration)(error) {
