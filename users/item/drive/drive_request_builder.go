...
import (
    ...
    i9af96beedb5142930ac51b4ab8b36f47f818cfa35b40454eff9a0be40e482eb8 "github.com/microsoftgraph/msgraph-sdk-go/users/item/drive/ref"
)

// DriveRequestBuilder builds and executes requests for operations under \users\{user-id}\drive
...
// DriveRequestBuilderGetQueryParameters the user's OneDrive. Read-only.
...
func NewDriveRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drive{?select,expand}";
...
// CreateGetRequestInformation the user's OneDrive. Read-only.
...
// Get the user's OneDrive. Read-only.
func (m *DriveRequestBuilder) Get(options *DriveRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Drive, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewDrive() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Drive), nil
}
func (m *DriveRequestBuilder) Ref()(*i9af96beedb5142930ac51b4ab8b36f47f818cfa35b40454eff9a0be40e482eb8.RefRequestBuilder) {
    return i9af96beedb5142930ac51b4ab8b36f47f818cfa35b40454eff9a0be40e482eb8.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
