...
// CreateDeleteRequestInformation the user's OneDrive. Read-only.
...
// CreatePatchRequestInformation the user's OneDrive. Read-only.
...
// Delete the user's OneDrive. Read-only.
...
// Patch the user's OneDrive. Read-only.
