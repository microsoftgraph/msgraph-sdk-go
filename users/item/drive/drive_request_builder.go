...
// CreateGetRequestInformationWithRequestConfiguration the user's OneDrive. Read-only.
...
// GetWithRequestConfigurationAndResponseHandler the user's OneDrive. Read-only.
