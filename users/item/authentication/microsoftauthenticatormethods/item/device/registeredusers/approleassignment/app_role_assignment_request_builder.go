...
import (
    ...
    i50d38fc44e12f185afbc848a90858c6aae67024f97735b344d191246a7420d64 "github.com/microsoftgraph/msgraph-sdk-go/users/item/authentication/microsoftauthenticatormethods/item/device/registeredusers/approleassignment/count"
)
...
func NewAppRoleAssignmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AppRoleAssignmentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/registeredUsers/microsoft.graph.appRoleAssignment{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AppRoleAssignmentRequestBuilder) Count()(*i50d38fc44e12f185afbc848a90858c6aae67024f97735b344d191246a7420d64.CountRequestBuilder) {
    return i50d38fc44e12f185afbc848a90858c6aae67024f97735b344d191246a7420d64.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
