...
// Fido2MethodsRequestBuilder builds and executes requests for operations under \users\{user-id}\authentication\fido2Methods
...
func (m *Fido2MethodsRequestBuilder) Get(options *Fido2MethodsRequestBuilderGetOptions)(*Fido2MethodsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewFido2MethodsResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
...
func (m *Fido2MethodsRequestBuilder) Post(options *Fido2MethodsRequestBuilderPostOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Fido2AuthenticationMethod, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewFido2AuthenticationMethod() }, nil, nil)
    if err != nil {
        return nil, err
    }
