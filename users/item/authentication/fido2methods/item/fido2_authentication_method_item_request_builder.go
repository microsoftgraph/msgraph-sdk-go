...
// Fido2AuthenticationMethodItemRequestBuilder builds and executes requests for operations under \users\{user-id}\authentication\fido2Methods\{fido2AuthenticationMethod-id}
