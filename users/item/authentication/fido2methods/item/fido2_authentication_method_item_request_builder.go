...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property fido2Methods for users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property fido2Methods in users
