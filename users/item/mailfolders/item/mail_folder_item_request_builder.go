...
// DeleteWithResponseHandler delete navigation property mailFolders for users
...
// PatchWithResponseHandler update the navigation property mailFolders in users
