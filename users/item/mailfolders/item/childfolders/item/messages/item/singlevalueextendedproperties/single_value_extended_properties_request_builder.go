...
import (
    ...
    ic07c4b95d2703661d81c657cfb9510415c0734f2fdba61fd65578f536f510a5f "github.com/microsoftgraph/msgraph-sdk-go/users/item/mailfolders/item/childfolders/item/messages/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/childFolders/{mailFolder_id1}/messages/{message_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*ic07c4b95d2703661d81c657cfb9510415c0734f2fdba61fd65578f536f510a5f.CountRequestBuilder) {
    return ic07c4b95d2703661d81c657cfb9510415c0734f2fdba61fd65578f536f510a5f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
