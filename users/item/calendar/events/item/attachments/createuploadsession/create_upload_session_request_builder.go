...
// CreateUploadSessionRequestBuilder builds and executes requests for operations under \users\{user-id}\calendar\events\{event-id}\attachments\microsoft.graph.createUploadSession
