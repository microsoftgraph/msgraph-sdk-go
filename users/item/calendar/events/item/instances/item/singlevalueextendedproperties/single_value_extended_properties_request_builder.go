...
import (
    ...
    i1fbec19099cbbb16c66b8e4b31fb5f7b5cfb635e42a03c80aa995e355dfad56b "github.com/microsoftgraph/msgraph-sdk-go/users/item/calendar/events/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendar/events/{event_id}/instances/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i1fbec19099cbbb16c66b8e4b31fb5f7b5cfb635e42a03c80aa995e355dfad56b.CountRequestBuilder) {
    return i1fbec19099cbbb16c66b8e4b31fb5f7b5cfb635e42a03c80aa995e355dfad56b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
