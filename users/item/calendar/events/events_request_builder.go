...
// eventsRequestBuilder builds and executes requests for operations under \users\{user-id}\calendar\events
...
// Delta builds and executes requests for operations under \users\{user-id}\calendar\events\microsoft.graph.delta()
