...
// singleValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \users\{user-id}\calendar\singleValueExtendedProperties\{singleValueLegacyExtendedProperty-id}
