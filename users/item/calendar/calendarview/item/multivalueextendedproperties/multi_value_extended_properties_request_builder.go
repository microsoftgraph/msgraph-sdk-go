...
import (
    ...
    i6f6b55f97463779c1ac19afdd8c108d33f1a1c23a46d769398e73f1468dad025 "github.com/microsoftgraph/msgraph-sdk-go/users/item/calendar/calendarview/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendar/calendarView/{event_id}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*i6f6b55f97463779c1ac19afdd8c108d33f1a1c23a46d769398e73f1468dad025.CountRequestBuilder) {
    return i6f6b55f97463779c1ac19afdd8c108d33f1a1c23a46d769398e73f1468dad025.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
