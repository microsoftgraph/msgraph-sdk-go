...
// AcceptRequestBuilder builds and executes requests for operations under \users\{user-id}\calendar\calendarView\{event-id}\microsoft.graph.accept
...
func NewAcceptRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AcceptRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendar/calendarView/{event_id}/microsoft.graph.accept";
