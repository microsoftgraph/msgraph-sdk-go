...
// GetWithResponseHandler get content for the navigation property versions from users
...
// PutWithResponseHandler update content for the navigation property versions in users
