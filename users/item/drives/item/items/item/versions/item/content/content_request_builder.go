...
// CreateGetRequestInformation get content for the navigation property versions from users
...
// CreateGetRequestInformationWithRequestConfiguration get content for the navigation property versions from users
...
// CreatePutRequestInformation update content for the navigation property versions in users
...
// CreatePutRequestInformationWithRequestConfiguration update content for the navigation property versions in users
...
// Get get content for the navigation property versions from users
func (m *ContentRequestBuilder) Get()([]byte, error) {
    return m.GetWithRequestConfigurationAndResponseHandler(nil, nil);
}
// GetWithRequestConfigurationAndResponseHandler get content for the navigation property versions from users
...
// Put update content for the navigation property versions in users
func (m *ContentRequestBuilder) Put(body []byte)(error) {
    return m.PutWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PutWithRequestConfigurationAndResponseHandler update content for the navigation property versions in users
