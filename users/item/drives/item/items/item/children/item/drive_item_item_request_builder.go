...
import (
    ...
    i9330e66ee3ba1876f6e292030cd27c7ba0a9f493400dc8e95f08ae305ec50d97 "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/items/item/children/item/content"
)
...
func NewDriveItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/children/{driveItem%2Did1}{?%24select,%24expand}";
...
func (m *DriveItemItemRequestBuilder) Content()(*i9330e66ee3ba1876f6e292030cd27c7ba0a9f493400dc8e95f08ae305ec50d97.ContentRequestBuilder) {
    return i9330e66ee3ba1876f6e292030cd27c7ba0a9f493400dc8e95f08ae305ec50d97.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
