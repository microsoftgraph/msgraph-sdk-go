...
import (
    ...
    i738aaa76ebed4c218c594a3746e8361f38b582fb43bc3fde41960eaba1c915e3 "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/items/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/items/{driveItem_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i738aaa76ebed4c218c594a3746e8361f38b582fb43bc3fde41960eaba1c915e3.CountRequestBuilder) {
    return i738aaa76ebed4c218c594a3746e8361f38b582fb43bc3fde41960eaba1c915e3.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
