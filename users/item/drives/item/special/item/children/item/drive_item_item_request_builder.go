...
import (
    ...
    i2acec3e0f1777912a65a56541896d8e6e244ee3bf1d7293968a87c165a4b18c8 "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/special/item/children/item/content"
)
...
func NewDriveItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/special/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
...
func (m *DriveItemItemRequestBuilder) Content()(*i2acec3e0f1777912a65a56541896d8e6e244ee3bf1d7293968a87c165a4b18c8.ContentRequestBuilder) {
    return i2acec3e0f1777912a65a56541896d8e6e244ee3bf1d7293968a87c165a4b18c8.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
