...
import (
    ...
    ica28ac9c610e50b2654448991c93ce189f3ad452920704bbe9216a7e6c89bd90 "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/bundles/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*ica28ac9c610e50b2654448991c93ce189f3ad452920704bbe9216a7e6c89bd90.CountRequestBuilder) {
    return ica28ac9c610e50b2654448991c93ce189f3ad452920704bbe9216a7e6c89bd90.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
