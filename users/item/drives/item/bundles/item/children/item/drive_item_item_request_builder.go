...
import (
    ...
    i241e4927df7481cf53f935ccda984ccd3e4d6ea6c59ba7cfb6167f8a5af39ea2 "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/bundles/item/children/item/content"
)
...
func NewDriveItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
...
func (m *DriveItemItemRequestBuilder) Content()(*i241e4927df7481cf53f935ccda984ccd3e4d6ea6c59ba7cfb6167f8a5af39ea2.ContentRequestBuilder) {
    return i241e4927df7481cf53f935ccda984ccd3e4d6ea6c59ba7cfb6167f8a5af39ea2.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
