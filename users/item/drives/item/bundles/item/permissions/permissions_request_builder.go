...
import (
    ...
    i4edc9f014d9fc442302e4fa524900b2b60e71bff47ef7d0ea486fba5f22cc232 "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/bundles/item/permissions/count"
)
...
func NewPermissionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/permissions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PermissionsRequestBuilder) Count()(*i4edc9f014d9fc442302e4fa524900b2b60e71bff47ef7d0ea486fba5f22cc232.CountRequestBuilder) {
    return i4edc9f014d9fc442302e4fa524900b2b60e71bff47ef7d0ea486fba5f22cc232.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
