...
import (
    ...
    i8b05096488563e3a548b5b562f56e4b5b56dd717d5092d05b911f3519f03e06b "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/bundles/item/permissions/item/grant"
)
...
func NewPermissionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/permissions/{permission_id}{?select,expand}";
...
func (m *PermissionItemRequestBuilder) Grant()(*i8b05096488563e3a548b5b562f56e4b5b56dd717d5092d05b911f3519f03e06b.GrantRequestBuilder) {
    return i8b05096488563e3a548b5b562f56e4b5b56dd717d5092d05b911f3519f03e06b.NewGrantRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
