...
import (
    ...
    i6678169138ff47cc921fb929054793f7478e09e7d2f62b82280264adc3b2c89c "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/bundles/item/listitem/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/listItem/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i6678169138ff47cc921fb929054793f7478e09e7d2f62b82280264adc3b2c89c.ContentRequestBuilder) {
    return i6678169138ff47cc921fb929054793f7478e09e7d2f62b82280264adc3b2c89c.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
