...
import (
    ...
    ib184379102b19b763fe64fe4bfe161a62572342dfe1060b60fe91d689333066a "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/list/items/count"
)
...
func NewItemsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ItemsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/list/items{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ItemsRequestBuilder) Count()(*ib184379102b19b763fe64fe4bfe161a62572342dfe1060b60fe91d689333066a.CountRequestBuilder) {
    return ib184379102b19b763fe64fe4bfe161a62572342dfe1060b60fe91d689333066a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
