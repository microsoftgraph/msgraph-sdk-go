...
import (
    ...
    i357484134714eb217408b0e4b1a82829d64fe381371d84d3a6048d9671e9d5df "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/list/contenttypes/item/basetypes/count"
)
...
func NewBaseTypesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BaseTypesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/list/contentTypes/{contentType_id}/baseTypes{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *BaseTypesRequestBuilder) Count()(*i357484134714eb217408b0e4b1a82829d64fe381371d84d3a6048d9671e9d5df.CountRequestBuilder) {
    return i357484134714eb217408b0e4b1a82829d64fe381371d84d3a6048d9671e9d5df.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
