...
import (
    ...
    i787a7adcd9ba6ab5d14dd01bea679d25100254ed2d20a76a4f22e4cf78f588cc "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/following/item/permissions/item/grant"
)
...
func NewPermissionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/following/{driveItem_id}/permissions/{permission_id}{?select,expand}";
...
func (m *PermissionItemRequestBuilder) Grant()(*i787a7adcd9ba6ab5d14dd01bea679d25100254ed2d20a76a4f22e4cf78f588cc.GrantRequestBuilder) {
    return i787a7adcd9ba6ab5d14dd01bea679d25100254ed2d20a76a4f22e4cf78f588cc.NewGrantRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
