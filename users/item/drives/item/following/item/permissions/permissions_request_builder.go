...
import (
    ...
    ibf35713c3add57a3e7f15b4d1bb6973eee6f0941396ba37bc31c8ad3ebf334a9 "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/following/item/permissions/count"
)
...
func NewPermissionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/following/{driveItem_id}/permissions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PermissionsRequestBuilder) Count()(*ibf35713c3add57a3e7f15b4d1bb6973eee6f0941396ba37bc31c8ad3ebf334a9.CountRequestBuilder) {
    return ibf35713c3add57a3e7f15b4d1bb6973eee6f0941396ba37bc31c8ad3ebf334a9.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
