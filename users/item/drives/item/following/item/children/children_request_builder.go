...
import (
    ...
    iebb323c7da301bf7f24ab375f33afc6cbf63382274a48309be417703aca805ad "github.com/microsoftgraph/msgraph-sdk-go/users/item/drives/item/following/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/following/{driveItem_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*iebb323c7da301bf7f24ab375f33afc6cbf63382274a48309be417703aca805ad.CountRequestBuilder) {
    return iebb323c7da301bf7f24ab375f33afc6cbf63382274a48309be417703aca805ad.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ChildrenRequestBuilder) Get(options *ChildrenRequestBuilderGetOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.DriveItemCollectionResponseable, error) {
