...
import (
    ...
    i3174f8fe7cb379fa407b13c4fe01b8ae1f72e79d67e03df68addc860d1a9beda "github.com/microsoftgraph/msgraph-sdk-go/users/item/calendargroups/item/calendars/item/events/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/events/{event_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i3174f8fe7cb379fa407b13c4fe01b8ae1f72e79d67e03df68addc860d1a9beda.CountRequestBuilder) {
    return i3174f8fe7cb379fa407b13c4fe01b8ae1f72e79d67e03df68addc860d1a9beda.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
