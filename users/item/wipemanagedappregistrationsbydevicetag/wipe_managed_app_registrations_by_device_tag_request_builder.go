...
// WipeManagedAppRegistrationsByDeviceTagRequestBuilder builds and executes requests for operations under \users\{user-id}\microsoft.graph.wipeManagedAppRegistrationsByDeviceTag
