...
// CreatePostRequestInformationWithRequestConfiguration clear the preferred availability and activity status for a user.
...
func (m *ClearUserPreferredPresenceRequestBuilder) Post(ctx context.Context, requestConfiguration *ClearUserPreferredPresenceRequestBuilderPostRequestConfiguration)(error) {
