...
func (m *SendMailRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body SendMailRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action sendMail
func (m *SendMailRequestBuilder) PostWithResponseHandler(body SendMailRequestBodyable, requestConfiguration *SendMailRequestBuilderPostRequestConfiguration)(error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action sendMail
func (m *SendMailRequestBuilder) PostWithResponseHandler(body SendMailRequestBodyable, requestConfiguration *SendMailRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
