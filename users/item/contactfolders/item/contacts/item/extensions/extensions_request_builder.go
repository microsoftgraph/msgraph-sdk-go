...
import (
    ...
    icf46ae67cd77086d96d0e57127bf509da9c36fd15032a23df166f319f1146ef2 "github.com/microsoftgraph/msgraph-sdk-go/users/item/contactfolders/item/contacts/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/contactFolders/{contactFolder_id}/contacts/{contact_id}/extensions{?top,skip,filter,count,orderby,select,expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*icf46ae67cd77086d96d0e57127bf509da9c36fd15032a23df166f319f1146ef2.CountRequestBuilder) {
    return icf46ae67cd77086d96d0e57127bf509da9c36fd15032a23df166f319f1146ef2.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
