...
// MultiValueLegacyExtendedPropertyItemRequestBuilder builds and executes requests for operations under \users\{user-id}\contactFolders\{contactFolder-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
