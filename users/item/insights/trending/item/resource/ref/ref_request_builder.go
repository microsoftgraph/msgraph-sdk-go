...
// RefRequestBuilder builds and executes requests for operations under \users\{user-id}\insights\trending\{trending-id}\resource\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/insights/trending/{trending_id}/resource/$ref";
...
// CreateDeleteRequestInformation used for navigating to the trending document.
...
// CreatePutRequestInformation used for navigating to the trending document.
...
// Delete used for navigating to the trending document.
...
// Put used for navigating to the trending document.
