...
// EntireColumnRequestBuilder builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.entireColumn()
...
// EntireColumnRequestBuilderGetOptions options for Get
type EntireColumnRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// EntireColumnResponse union type wrapper for classes workbookRange
...
// NewEntireColumnResponse instantiates a new entireColumnResponse and sets the default values.
...
// NewEntireColumnRequestBuilderInternal instantiates a new EntireColumnRequestBuilder and sets the default values.
func NewEntireColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*EntireColumnRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/resource/microsoft.graph.workbookRange/microsoft.graph.entireColumn()";
...
// NewEntireColumnRequestBuilder instantiates a new EntireColumnRequestBuilder and sets the default values.
...
// CreateGetRequestInformation invoke function entireColumn
func (m *EntireColumnRequestBuilder) CreateGetRequestInformation(options *EntireColumnRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *EntireColumnRequestBuilder) Get(options *EntireColumnRequestBuilderGetOptions)(*EntireColumnResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewEntireColumnResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
