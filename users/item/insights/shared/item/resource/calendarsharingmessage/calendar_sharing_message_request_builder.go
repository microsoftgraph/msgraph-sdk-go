...
import (
    ...
    i53d0c5eaceae631780b6143749dbbdb243764868eec92af7463fcce33e5bfd0c "github.com/microsoftgraph/msgraph-sdk-go/users/item/insights/shared/item/resource/calendarsharingmessage/accept"
)

// calendarSharingMessageRequestBuilder builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\resource\microsoft.graph.calendarSharingMessage
...
func (m *CalendarSharingMessageRequestBuilder) Accept()(*i53d0c5eaceae631780b6143749dbbdb243764868eec92af7463fcce33e5bfd0c.AcceptRequestBuilder) {
    return i53d0c5eaceae631780b6143749dbbdb243764868eec92af7463fcce33e5bfd0c.NewAcceptRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewCalendarSharingMessageRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CalendarSharingMessageRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/resource/microsoft.graph.calendarSharingMessage";
