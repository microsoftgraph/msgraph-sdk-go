...
// RefRequestBuilder builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\lastSharedMethod\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property lastSharedMethod for users
...
// CreateGetRequestInformation get ref of lastSharedMethod from users
...
// CreatePutRequestInformation update the ref of navigation property lastSharedMethod in users
...
// Delete delete ref of navigation property lastSharedMethod for users
...
// Get get ref of lastSharedMethod from users
...
// Put update the ref of navigation property lastSharedMethod in users
