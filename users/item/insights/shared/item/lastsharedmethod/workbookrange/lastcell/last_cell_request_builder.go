...
// LastCellRequestBuilder builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\lastSharedMethod\microsoft.graph.workbookRange\microsoft.graph.lastCell()
...
// LastCellRequestBuilderGetOptions options for Get
type LastCellRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// LastCellResponse union type wrapper for classes workbookRange
...
// NewLastCellResponse instantiates a new lastCellResponse and sets the default values.
...
// NewLastCellRequestBuilderInternal instantiates a new LastCellRequestBuilder and sets the default values.
func NewLastCellRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LastCellRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRange/microsoft.graph.lastCell()";
...
// NewLastCellRequestBuilder instantiates a new LastCellRequestBuilder and sets the default values.
...
// CreateGetRequestInformation invoke function lastCell
func (m *LastCellRequestBuilder) CreateGetRequestInformation(options *LastCellRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *LastCellRequestBuilder) Get(options *LastCellRequestBuilderGetOptions)(*LastCellResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewLastCellResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
