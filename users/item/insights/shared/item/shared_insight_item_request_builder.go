...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property shared for users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property shared in users
