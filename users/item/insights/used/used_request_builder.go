...
// UsedRequestBuilder builds and executes requests for operations under \users\{user-id}\insights\used
...
func NewUsedRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UsedRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/insights/used{?top,skip,search,filter,count,orderby,select,expand}";
