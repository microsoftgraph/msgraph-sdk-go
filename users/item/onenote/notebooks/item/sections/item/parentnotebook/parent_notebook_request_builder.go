...
import (
    ...
    i520696bbe8fee8e5ec1dd95e24cbecc3beec594c06b5854b5c6321b0cef31fb4 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/notebooks/item/sections/item/parentnotebook/copynotebook"
    if6733b056473901f096ae95cffac78cd9f34cdf3a9cbdbf8d457b0844efab8ac "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/notebooks/item/sections/item/parentnotebook/ref"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i520696bbe8fee8e5ec1dd95e24cbecc3beec594c06b5854b5c6321b0cef31fb4.CopyNotebookRequestBuilder) {
    return i520696bbe8fee8e5ec1dd95e24cbecc3beec594c06b5854b5c6321b0cef31fb4.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ParentNotebookRequestBuilder) Ref()(*if6733b056473901f096ae95cffac78cd9f34cdf3a9cbdbf8d457b0844efab8ac.RefRequestBuilder) {
    return if6733b056473901f096ae95cffac78cd9f34cdf3a9cbdbf8d457b0844efab8ac.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
