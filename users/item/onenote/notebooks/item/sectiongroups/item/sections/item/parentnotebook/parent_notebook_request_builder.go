...
import (
    ...
    i7061a32d01bb0fdebe204a7c333c1adeb7bc22a2e83cf78422dcfadceff5c519 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/notebooks/item/sectiongroups/item/sections/item/parentnotebook/copynotebook"
    i8dd2a8fede6ba4b983cb708ed0fc5742e02eb9c6d6260ed9b4033421ef82f037 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/notebooks/item/sectiongroups/item/sections/item/parentnotebook/ref"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i7061a32d01bb0fdebe204a7c333c1adeb7bc22a2e83cf78422dcfadceff5c519.CopyNotebookRequestBuilder) {
    return i7061a32d01bb0fdebe204a7c333c1adeb7bc22a2e83cf78422dcfadceff5c519.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ParentNotebookRequestBuilder) Ref()(*i8dd2a8fede6ba4b983cb708ed0fc5742e02eb9c6d6260ed9b4033421ef82f037.RefRequestBuilder) {
    return i8dd2a8fede6ba4b983cb708ed0fc5742e02eb9c6d6260ed9b4033421ef82f037.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
