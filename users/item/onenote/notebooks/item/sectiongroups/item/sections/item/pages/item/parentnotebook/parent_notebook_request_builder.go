...
import (
    ...
    i1e9b90ff5e82af9d0d0bd11be7f353db44d99ef320ce3a612a2c65503927c30a "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/notebooks/item/sectiongroups/item/sections/item/pages/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i1e9b90ff5e82af9d0d0bd11be7f353db44d99ef320ce3a612a2c65503927c30a.CopyNotebookRequestBuilder) {
    return i1e9b90ff5e82af9d0d0bd11be7f353db44d99ef320ce3a612a2c65503927c30a.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
