...
import (
    ...
    idd22974eb360831fcfbfa2643c0064dafcc4c19eb46108d7c0fc732de884a4b8 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sectiongroups/item/parentnotebook/sections/item/pages/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/sectionGroups/{sectionGroup_id}/parentNotebook/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*idd22974eb360831fcfbfa2643c0064dafcc4c19eb46108d7c0fc732de884a4b8.CopyNotebookRequestBuilder) {
    return idd22974eb360831fcfbfa2643c0064dafcc4c19eb46108d7c0fc732de884a4b8.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the page.  Read-only.
// Parameters:
//  - h : Request headers
