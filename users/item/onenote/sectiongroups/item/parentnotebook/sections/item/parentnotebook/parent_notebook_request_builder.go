...
import (
    ...
    i644db318c3dea781d12ee0170ee3a7757e9b381e7c8e34b45fee3ef902e3abed "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sectiongroups/item/parentnotebook/sections/item/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\sectionGroups\{sectionGroup-id}\parentNotebook\sections\{onenoteSection-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/sectionGroups/{sectionGroup_id}/parentNotebook/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i644db318c3dea781d12ee0170ee3a7757e9b381e7c8e34b45fee3ef902e3abed.CopyNotebookRequestBuilder) {
    return i644db318c3dea781d12ee0170ee3a7757e9b381e7c8e34b45fee3ef902e3abed.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
