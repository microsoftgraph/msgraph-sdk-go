...
import (
    ...
    i47098390d5c63b2a7e35536dea56771377e34007574d9000e12cef632e315066 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sectiongroups/item/sections/count"
)
...
func NewSectionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SectionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/sectionGroups/{sectionGroup_id}/sections{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SectionsRequestBuilder) Count()(*i47098390d5c63b2a7e35536dea56771377e34007574d9000e12cef632e315066.CountRequestBuilder) {
    return i47098390d5c63b2a7e35536dea56771377e34007574d9000e12cef632e315066.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
