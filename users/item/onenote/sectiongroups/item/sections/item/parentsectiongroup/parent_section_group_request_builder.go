...
import (
    ...
    ifaa90981e6ae249626458a83f47789b04bb54ce56e8ae7727c12ee38eb011b46 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sectiongroups/item/sections/item/parentsectiongroup/ref"
)

// ParentSectionGroupRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\parentSectionGroup
...
func NewParentSectionGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentSectionGroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/parentSectionGroup{?select,expand}";
...
func (m *ParentSectionGroupRequestBuilder) Ref()(*ifaa90981e6ae249626458a83f47789b04bb54ce56e8ae7727c12ee38eb011b46.RefRequestBuilder) {
    return ifaa90981e6ae249626458a83f47789b04bb54ce56e8ae7727c12ee38eb011b46.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
