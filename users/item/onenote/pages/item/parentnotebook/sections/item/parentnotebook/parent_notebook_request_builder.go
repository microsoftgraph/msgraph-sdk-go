...
import (
    ...
    i3924c12f6946a2de974588f07836d5e28e6b37fb493c7f4e1c8c1b70d8927803 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/pages/item/parentnotebook/sections/item/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\pages\{onenotePage-id}\parentNotebook\sections\{onenoteSection-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/pages/{onenotePage_id}/parentNotebook/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i3924c12f6946a2de974588f07836d5e28e6b37fb493c7f4e1c8c1b70d8927803.CopyNotebookRequestBuilder) {
    return i3924c12f6946a2de974588f07836d5e28e6b37fb493c7f4e1c8c1b70d8927803.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
