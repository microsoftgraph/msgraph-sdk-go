...
import (
    ...
    ie84bb0363243fb1a5eeb69eed600a54c70b6a40825c0a17748da409c3b127397 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/pages/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\pages\{onenotePage-id}\parentNotebook\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*ie84bb0363243fb1a5eeb69eed600a54c70b6a40825c0a17748da409c3b127397.CopyNotebookRequestBuilder) {
    return ie84bb0363243fb1a5eeb69eed600a54c70b6a40825c0a17748da409c3b127397.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
