...
import (
    ...
    i36dc29c206561c39b8db073df7b5f713a0feca154499e587c438b66bb355232c "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/pages/item/parentnotebook/sectiongroups/item/sections/item/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\pages\{onenotePage-id}\parentNotebook\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i36dc29c206561c39b8db073df7b5f713a0feca154499e587c438b66bb355232c.CopyNotebookRequestBuilder) {
    return i36dc29c206561c39b8db073df7b5f713a0feca154499e587c438b66bb355232c.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
