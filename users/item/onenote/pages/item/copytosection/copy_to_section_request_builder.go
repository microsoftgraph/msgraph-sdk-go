...
func NewCopyToSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CopyToSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/onenote/pages/{onenotePage%2Did}/microsoft.graph.copyToSection";
...
func (m *CopyToSectionRequestBuilder) PostWithResponseHandler(body CopyToSectionRequestBodyable, requestConfiguration *CopyToSectionRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.OnenoteOperationable, error) {
