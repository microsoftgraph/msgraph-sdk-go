...
// OnenotePatchContentRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\pages\{onenotePage-id}\microsoft.graph.onenotePatchContent
