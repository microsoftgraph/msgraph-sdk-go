...
import (
    ...
    i9bac1a18f017d245075f1d65377f67e8180c67f37f9c9e3b190f862be3e443e1 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/pages/item/parentsection/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)

// parentNotebookRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\pages\{onenotePage-id}\parentSection\parentNotebook\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/pages/{onenotePage_id}/parentSection/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i9bac1a18f017d245075f1d65377f67e8180c67f37f9c9e3b190f862be3e443e1.CopyNotebookRequestBuilder) {
    return i9bac1a18f017d245075f1d65377f67e8180c67f37f9c9e3b190f862be3e443e1.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
