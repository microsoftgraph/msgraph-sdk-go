...
import (
    ...
    ie5d7b80a3d50be31ad63cacc6fd60ceefa6cd5bc63a0d5c6a194f1d35b470135 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/pages/item/parentsection/parentsectiongroup/sections/item/copytosectiongroup"
    iefef6952f0fd82b9ac712b8e03dfb7f7502ed39655a09d7fec1011095ef9b8d2 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/pages/item/parentsection/parentsectiongroup/sections/item/copytonotebook"
)
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/users/{user_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/sections/{onenoteSection_id}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*iefef6952f0fd82b9ac712b8e03dfb7f7502ed39655a09d7fec1011095ef9b8d2.CopyToNotebookRequestBuilder) {
    return iefef6952f0fd82b9ac712b8e03dfb7f7502ed39655a09d7fec1011095ef9b8d2.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*ie5d7b80a3d50be31ad63cacc6fd60ceefa6cd5bc63a0d5c6a194f1d35b470135.CopyToSectionGroupRequestBuilder) {
    return ie5d7b80a3d50be31ad63cacc6fd60ceefa6cd5bc63a0d5c6a194f1d35b470135.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The sections in the section group. Read-only. Nullable.
// Parameters:
