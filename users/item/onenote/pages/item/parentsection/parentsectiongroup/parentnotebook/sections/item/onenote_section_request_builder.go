...
import (
    ...
    i3977536de0c467480526a3aaccae1c44c4a173b4d25185974decbe2843c5acb9 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/pages/item/parentsection/parentsectiongroup/parentnotebook/sections/item/copytosectiongroup"
    i9ec4558c0747c0bb3c4c094312dc968e147bd4efade4d60252f79d6fe3835d73 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/pages/item/parentsection/parentsectiongroup/parentnotebook/sections/item/copytonotebook"
)

// OnenoteSectionRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\pages\{onenotePage-id}\parentSection\parentSectionGroup\parentNotebook\sections\{onenoteSection-id}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/parentNotebook/sections/{onenoteSection_id}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*i9ec4558c0747c0bb3c4c094312dc968e147bd4efade4d60252f79d6fe3835d73.CopyToNotebookRequestBuilder) {
    return i9ec4558c0747c0bb3c4c094312dc968e147bd4efade4d60252f79d6fe3835d73.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*i3977536de0c467480526a3aaccae1c44c4a173b4d25185974decbe2843c5acb9.CopyToSectionGroupRequestBuilder) {
    return i3977536de0c467480526a3aaccae1c44c4a173b4d25185974decbe2843c5acb9.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
