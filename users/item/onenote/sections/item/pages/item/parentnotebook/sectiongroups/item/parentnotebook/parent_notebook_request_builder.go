...
import (
    ...
    i12c465c9d6dd6dfc29d34bc7215eb06b8c979886cf9eff22a3ac6b69a0b6ae91 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sections/item/pages/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\sections\{onenoteSection-id}\pages\{onenotePage-id}\parentNotebook\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i12c465c9d6dd6dfc29d34bc7215eb06b8c979886cf9eff22a3ac6b69a0b6ae91.CopyNotebookRequestBuilder) {
    return i12c465c9d6dd6dfc29d34bc7215eb06b8c979886cf9eff22a3ac6b69a0b6ae91.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
