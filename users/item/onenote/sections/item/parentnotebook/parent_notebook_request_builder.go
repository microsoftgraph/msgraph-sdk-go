...
import (
    ...
    i73ed8502a1d996152217a1d17815bc0c03b5d19b4d9434bd9c223e26fdb3ad52 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sections/item/parentnotebook/sections"
    ic5b651f6ab3799487531d0620099a058c007be037472a0a70bdb838b2c9fdf14 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sections/item/parentnotebook/sectiongroups"
    id6026202aaf8a3eb2ca3d682b17377bbb1677d44c4add7e1acfb63b0068fc5bf "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sections/item/parentnotebook/copynotebook"
    i1f77f091adaf660de8a7b3e2a87eddb03f016859fbce4bf4480b1fd4f3adec4d "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sections/item/parentnotebook/sectiongroups/item"
    i6533ff249031797ffaf921fe9c38470d34c098f0a1fe2570392c1fb37bc2512a "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sections/item/parentnotebook/sections/item"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\sections\{onenoteSection-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*id6026202aaf8a3eb2ca3d682b17377bbb1677d44c4add7e1acfb63b0068fc5bf.CopyNotebookRequestBuilder) {
    return id6026202aaf8a3eb2ca3d682b17377bbb1677d44c4add7e1acfb63b0068fc5bf.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ParentNotebookRequestBuilder) SectionGroups()(*ic5b651f6ab3799487531d0620099a058c007be037472a0a70bdb838b2c9fdf14.SectionGroupsRequestBuilder) {
    return ic5b651f6ab3799487531d0620099a058c007be037472a0a70bdb838b2c9fdf14.NewSectionGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionGroupsById gets an item from the github.com/microsoftgraph/msgraph-sdk-go/.users.item.onenote.sections.item.parentNotebook.sectionGroups.item collection
func (m *ParentNotebookRequestBuilder) SectionGroupsById(id string)(*i1f77f091adaf660de8a7b3e2a87eddb03f016859fbce4bf4480b1fd4f3adec4d.SectionGroupRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i1f77f091adaf660de8a7b3e2a87eddb03f016859fbce4bf4480b1fd4f3adec4d.NewSectionGroupRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
func (m *ParentNotebookRequestBuilder) Sections()(*i73ed8502a1d996152217a1d17815bc0c03b5d19b4d9434bd9c223e26fdb3ad52.SectionsRequestBuilder) {
    return i73ed8502a1d996152217a1d17815bc0c03b5d19b4d9434bd9c223e26fdb3ad52.NewSectionsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionsById gets an item from the github.com/microsoftgraph/msgraph-sdk-go/.users.item.onenote.sections.item.parentNotebook.sections.item collection
func (m *ParentNotebookRequestBuilder) SectionsById(id string)(*i6533ff249031797ffaf921fe9c38470d34c098f0a1fe2570392c1fb37bc2512a.OnenoteSectionRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i6533ff249031797ffaf921fe9c38470d34c098f0a1fe2570392c1fb37bc2512a.NewOnenoteSectionRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
