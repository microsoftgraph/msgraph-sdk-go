...
import (
    ...
    ic9c909f6560aa3979bb3e76fb1cc5941b759a1af34cbe91de651c46d2afa3bf3 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sections/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\sections\{onenoteSection-id}\parentNotebook\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/sections/{onenoteSection_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*ic9c909f6560aa3979bb3e76fb1cc5941b759a1af34cbe91de651c46d2afa3bf3.CopyNotebookRequestBuilder) {
    return ic9c909f6560aa3979bb3e76fb1cc5941b759a1af34cbe91de651c46d2afa3bf3.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
