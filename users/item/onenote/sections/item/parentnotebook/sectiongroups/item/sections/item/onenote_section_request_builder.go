...
import (
    ...
    i85f305b12860a7aced3e377fe0832dcfa434d07e28dbc4665077887634b6722c "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sections/item/parentnotebook/sectiongroups/item/sections/item/copytosectiongroup"
    ie57f82c082722772afdcccc3bf5463e3f5b87c54bd0ee24be9663a9e7cdc6ec8 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sections/item/parentnotebook/sectiongroups/item/sections/item/copytonotebook"
)

// OnenoteSectionRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\sections\{onenoteSection-id}\parentNotebook\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id1}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/sections/{onenoteSection_id}/parentNotebook/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id1}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*ie57f82c082722772afdcccc3bf5463e3f5b87c54bd0ee24be9663a9e7cdc6ec8.CopyToNotebookRequestBuilder) {
    return ie57f82c082722772afdcccc3bf5463e3f5b87c54bd0ee24be9663a9e7cdc6ec8.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*i85f305b12860a7aced3e377fe0832dcfa434d07e28dbc4665077887634b6722c.CopyToSectionGroupRequestBuilder) {
    return i85f305b12860a7aced3e377fe0832dcfa434d07e28dbc4665077887634b6722c.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
