...
// CopyToNotebookRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\sections\{onenoteSection-id}\microsoft.graph.copyToNotebook
