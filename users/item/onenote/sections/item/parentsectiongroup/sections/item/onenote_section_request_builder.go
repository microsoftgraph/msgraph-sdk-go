...
import (
    ...
    i1cac8fe36a018b0153e754d9fd5d6798f27f39b4e0de7da9fbb0000fefff039f "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sections/item/parentsectiongroup/sections/item/copytosectiongroup"
    i6461aa5b79e675365f0f10f75c824e3b19bb7c30980a1fff1ed6fba722bc2c16 "github.com/microsoftgraph/msgraph-sdk-go/users/item/onenote/sections/item/parentsectiongroup/sections/item/copytonotebook"
)

// onenoteSectionRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\sections\{onenoteSection-id}\parentSectionGroup\sections\{onenoteSection-id1}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/sections/{onenoteSection_id}/parentSectionGroup/sections/{onenoteSection_id1}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*i6461aa5b79e675365f0f10f75c824e3b19bb7c30980a1fff1ed6fba722bc2c16.CopyToNotebookRequestBuilder) {
    return i6461aa5b79e675365f0f10f75c824e3b19bb7c30980a1fff1ed6fba722bc2c16.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*i1cac8fe36a018b0153e754d9fd5d6798f27f39b4e0de7da9fbb0000fefff039f.CopyToSectionGroupRequestBuilder) {
    return i1cac8fe36a018b0153e754d9fd5d6798f27f39b4e0de7da9fbb0000fefff039f.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
