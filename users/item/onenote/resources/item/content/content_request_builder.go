...
// ContentRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\resources\{onenoteResource-id}\content
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/resources/{onenoteResource_id}/content";
...
// CreateGetRequestInformation get media content for the navigation property resources from users
...
// CreatePutRequestInformation update media content for the navigation property resources in users
...
// Get get media content for the navigation property resources from users
...
// Put update media content for the navigation property resources in users
