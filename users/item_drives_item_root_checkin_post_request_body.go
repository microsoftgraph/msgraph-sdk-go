...
func (m *ItemDrivesItemRootCheckinPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemDrivesItemRootCheckinPostRequestBody) SetAdditionalData(value map[string]any)() {
