...
func (m *ItemJoinedTeamsItemChannelsRequestBuilder) MicrosoftGraphGetAllMessages()(*ItemJoinedTeamsItemChannelsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilder) {
    return NewItemJoinedTeamsItemChannelsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
