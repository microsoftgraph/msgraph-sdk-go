...
// ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceCheckMemberObjectsPostRequestBody provides operations to call the checkMemberObjects method.
...
func (m *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceCheckMemberObjectsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceCheckMemberObjectsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
