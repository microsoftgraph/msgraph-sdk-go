...
// FileStorageContainersItemDriveItemsItemWorkbookWorksheetsItemUsedRangeWithValuesOnlyRequestBuilder provides operations to call the usedRange method.
type FileStorageContainersItemDriveItemsItemWorkbookWorksheetsItemUsedRangeWithValuesOnlyRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// FileStorageContainersItemDriveItemsItemWorkbookWorksheetsItemUsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type FileStorageContainersItemDriveItemsItemWorkbookWorksheetsItemUsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewFileStorageContainersItemDriveItemsItemWorkbookWorksheetsItemUsedRangeWithValuesOnlyRequestBuilderInternal instantiates a new FileStorageContainersItemDriveItemsItemWorkbookWorksheetsItemUsedRangeWithValuesOnlyRequestBuilder and sets the default values.
...
// NewFileStorageContainersItemDriveItemsItemWorkbookWorksheetsItemUsedRangeWithValuesOnlyRequestBuilder instantiates a new FileStorageContainersItemDriveItemsItemWorkbookWorksheetsItemUsedRangeWithValuesOnlyRequestBuilder and sets the default values.
...
func (m *FileStorageContainersItemDriveItemsItemWorkbookWorksheetsItemUsedRangeWithValuesOnlyRequestBuilder) WithUrl(rawUrl string)(*FileStorageContainersItemDriveItemsItemWorkbookWorksheetsItemUsedRangeWithValuesOnlyRequestBuilder) {
    return NewFileStorageContainersItemDriveItemsItemWorkbookWorksheetsItemUsedRangeWithValuesOnlyRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
