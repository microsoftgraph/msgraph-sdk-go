...
func NewFileStorageContainersItemPermissionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageContainersItemPermissionsCountRequestBuilder) {
    m := &FileStorageContainersItemPermissionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/permissions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewFileStorageContainersItemPermissionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageContainersItemPermissionsCountRequestBuilder) {
    ...
    return NewFileStorageContainersItemPermissionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int64 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *FileStorageContainersItemPermissionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *FileStorageContainersItemPermissionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
...
func (m *FileStorageContainersItemPermissionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *FileStorageContainersItemPermissionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *FileStorageContainersItemPermissionsCountRequestBuilder) WithUrl(rawUrl string)(*FileStorageContainersItemPermissionsCountRequestBuilder) {
    return NewFileStorageContainersItemPermissionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
