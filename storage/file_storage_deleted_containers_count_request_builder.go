...
func (m *FileStorageDeletedContainersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *FileStorageDeletedContainersCountRequestBuilderGetRequestConfiguration)(*int64, error) {
