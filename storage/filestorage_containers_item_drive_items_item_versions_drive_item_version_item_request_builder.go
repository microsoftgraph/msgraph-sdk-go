...
func (m *FilestorageContainersItemDriveItemsItemVersionsDriveItemVersionItemRequestBuilder) RestoreVersion()(*FilestorageContainersItemDriveItemsItemVersionsItemRestoreversionRestoreVersionRequestBuilder) {
    return NewFilestorageContainersItemDriveItemsItemVersionsItemRestoreversionRestoreVersionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
