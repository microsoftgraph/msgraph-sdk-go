...
func NewSettingsQuotaServicesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SettingsQuotaServicesCountRequestBuilder) {
    m := &SettingsQuotaServicesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/storage/settings/quota/services/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewSettingsQuotaServicesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SettingsQuotaServicesCountRequestBuilder) {
    ...
    return NewSettingsQuotaServicesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int64 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *SettingsQuotaServicesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SettingsQuotaServicesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
...
func (m *SettingsQuotaServicesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *SettingsQuotaServicesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SettingsQuotaServicesCountRequestBuilder) WithUrl(rawUrl string)(*SettingsQuotaServicesCountRequestBuilder) {
    return NewSettingsQuotaServicesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
