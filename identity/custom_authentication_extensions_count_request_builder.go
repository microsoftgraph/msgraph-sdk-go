...
func (m *CustomAuthenticationExtensionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CustomAuthenticationExtensionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
