...
func (m *ConditionalAccessAuthenticationContextClassReferencesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConditionalAccessAuthenticationContextClassReferencesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
