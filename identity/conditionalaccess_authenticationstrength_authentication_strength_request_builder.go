...
// ConditionalaccessAuthenticationstrengthAuthenticationStrengthRequestBuilderGetQueryParameters get authenticationStrength from identity
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ConditionalaccessAuthenticationstrengthAuthenticationStrengthRequestBuilder) Get(ctx context.Context, requestConfiguration *ConditionalaccessAuthenticationstrengthAuthenticationStrengthRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AuthenticationStrengthRootable, error) {
