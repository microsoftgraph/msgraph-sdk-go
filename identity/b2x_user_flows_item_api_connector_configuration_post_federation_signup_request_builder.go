...
// NewB2xUserFlowsItemApiConnectorConfigurationPostFederationSignupRequestBuilder instantiates a new PostFederationSignupRequestBuilder and sets the default values.
