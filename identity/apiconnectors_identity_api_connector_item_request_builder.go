...
func (m *ApiconnectorsIdentityApiConnectorItemRequestBuilder) UploadClientCertificate()(*ApiconnectorsItemUploadclientcertificateUploadClientCertificateRequestBuilder) {
    return NewApiconnectorsItemUploadclientcertificateUploadClientCertificateRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
