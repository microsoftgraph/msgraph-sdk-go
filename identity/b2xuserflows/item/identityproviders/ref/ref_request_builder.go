...
// RefRequestBuilder builds and executes requests for operations under \identity\b2xUserFlows\{b2xIdentityUserFlow-id}\identityProviders\$ref
...
// RefRequestBuilderGetQueryParameters the identity providers included in the user flow.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow_id}/identityProviders/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the identity providers included in the user flow.
...
// Post the identity providers included in the user flow.
