...
// DeleteWithResponseHandler delete navigation property overridesPages for identity
...
// PatchWithResponseHandler update the navigation property overridesPages in identity
