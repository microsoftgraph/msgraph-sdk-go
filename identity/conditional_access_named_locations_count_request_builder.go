...
func (m *ConditionalAccessNamedLocationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConditionalAccessNamedLocationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
