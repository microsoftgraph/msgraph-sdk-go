...
// AuthenticationEventListenersAuthenticationEventListenerItemRequestBuilderGetQueryParameters represents listeners for custom authentication extension events in Azure AD for workforce and customers.
