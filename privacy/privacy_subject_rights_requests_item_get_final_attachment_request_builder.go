...
func NewPrivacySubjectRightsRequestsItemGetFinalAttachmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivacySubjectRightsRequestsItemGetFinalAttachmentRequestBuilder) {
    m := &PrivacySubjectRightsRequestsItemGetFinalAttachmentRequestBuilder{
    }
...
func NewPrivacySubjectRightsRequestsItemGetFinalAttachmentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivacySubjectRightsRequestsItemGetFinalAttachmentRequestBuilder) {
    ...
    return NewPrivacySubjectRightsRequestsItemGetFinalAttachmentRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation invoke function getFinalAttachment
func (m *PrivacySubjectRightsRequestsItemGetFinalAttachmentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *PrivacySubjectRightsRequestsItemGetFinalAttachmentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PrivacySubjectRightsRequestsItemGetFinalAttachmentRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivacySubjectRightsRequestsItemGetFinalAttachmentRequestBuilderGetRequestConfiguration)([]byte, error) {
