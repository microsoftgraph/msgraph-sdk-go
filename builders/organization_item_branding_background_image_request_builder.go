...
func NewOrganizationItemBrandingBackgroundImageRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationItemBrandingBackgroundImageRequestBuilder) {
    m := &OrganizationItemBrandingBackgroundImageRequestBuilder{
    }
...
func NewOrganizationItemBrandingBackgroundImageRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationItemBrandingBackgroundImageRequestBuilder) {
    ...
    return NewOrganizationItemBrandingBackgroundImageRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *OrganizationItemBrandingBackgroundImageRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *OrganizationItemBrandingBackgroundImageRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OrganizationItemBrandingBackgroundImageRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *OrganizationItemBrandingBackgroundImageRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *OrganizationItemBrandingBackgroundImageRequestBuilder) Get(ctx context.Context, requestConfiguration *OrganizationItemBrandingBackgroundImageRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *OrganizationItemBrandingBackgroundImageRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *OrganizationItemBrandingBackgroundImageRequestBuilderPutRequestConfiguration)(error) {
