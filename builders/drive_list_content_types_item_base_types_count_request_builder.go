...
func NewDriveListContentTypesItemBaseTypesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListContentTypesItemBaseTypesCountRequestBuilder) {
    m := &DriveListContentTypesItemBaseTypesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/baseTypes/$count";
...
func NewDriveListContentTypesItemBaseTypesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListContentTypesItemBaseTypesCountRequestBuilder) {
    ...
    return NewDriveListContentTypesItemBaseTypesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveListContentTypesItemBaseTypesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveListContentTypesItemBaseTypesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveListContentTypesItemBaseTypesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveListContentTypesItemBaseTypesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
