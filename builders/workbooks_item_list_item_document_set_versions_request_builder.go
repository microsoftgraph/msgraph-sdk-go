...
func NewWorkbooksItemListItemDocumentSetVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemListItemDocumentSetVersionsRequestBuilder) {
    m := &WorkbooksItemListItemDocumentSetVersionsRequestBuilder{
    }
...
func NewWorkbooksItemListItemDocumentSetVersionsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemListItemDocumentSetVersionsRequestBuilder) {
    ...
    return NewWorkbooksItemListItemDocumentSetVersionsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *WorkbooksItemListItemDocumentSetVersionsRequestBuilder) Count()(*WorkbooksItemListItemDocumentSetVersionsCountRequestBuilder) {
    return NewWorkbooksItemListItemDocumentSetVersionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of the versions of a document set item in a list.
func (m *WorkbooksItemListItemDocumentSetVersionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *WorkbooksItemListItemDocumentSetVersionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *WorkbooksItemListItemDocumentSetVersionsRequestBuilder) CreatePostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DocumentSetVersionable, requestConfiguration *WorkbooksItemListItemDocumentSetVersionsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *WorkbooksItemListItemDocumentSetVersionsRequestBuilder) Get(ctx context.Context, requestConfiguration *WorkbooksItemListItemDocumentSetVersionsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DocumentSetVersionCollectionResponseable, error) {
