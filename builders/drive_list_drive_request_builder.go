...
func NewDriveListDriveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListDriveRequestBuilder) {
    m := &DriveListDriveRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/list/drive{?%24select,%24expand}";
...
func NewDriveListDriveRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListDriveRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveListDriveRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DriveListDriveRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveListDriveRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveListDriveRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveListDriveRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Driveable, error) {
