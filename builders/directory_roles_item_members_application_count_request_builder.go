...
func NewDirectoryRolesItemMembersApplicationCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersApplicationCountRequestBuilder) {
    m := &DirectoryRolesItemMembersApplicationCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/microsoft.graph.application/$count";
...
func NewDirectoryRolesItemMembersApplicationCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersApplicationCountRequestBuilder) {
    ...
    return NewDirectoryRolesItemMembersApplicationCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DirectoryRolesItemMembersApplicationCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersApplicationCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRolesItemMembersApplicationCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersApplicationCountRequestBuilderGetRequestConfiguration)(*int32, error) {
