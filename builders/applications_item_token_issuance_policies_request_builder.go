...
func NewApplicationsItemTokenIssuancePoliciesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenIssuancePoliciesRequestBuilder) {
    m := &ApplicationsItemTokenIssuancePoliciesRequestBuilder{
    }
...
func NewApplicationsItemTokenIssuancePoliciesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenIssuancePoliciesRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewApplicationsItemTokenIssuancePoliciesRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ApplicationsItemTokenIssuancePoliciesRequestBuilder) Count()(*ApplicationsItemTokenIssuancePoliciesCountRequestBuilder) {
    return NewApplicationsItemTokenIssuancePoliciesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list the tokenIssuancePolicy objects that are assigned to an application.
func (m *ApplicationsItemTokenIssuancePoliciesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemTokenIssuancePoliciesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemTokenIssuancePoliciesRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsItemTokenIssuancePoliciesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.TokenIssuancePolicyCollectionResponseable, error) {
...
func (m *ApplicationsItemTokenIssuancePoliciesRequestBuilder) Ref()(*ApplicationsItemTokenIssuancePoliciesRefRequestBuilder) {
    return NewApplicationsItemTokenIssuancePoliciesRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
