...
func NewWorkbooksItemCheckoutRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemCheckoutRequestBuilder) {
    m := &WorkbooksItemCheckoutRequestBuilder{
    }
...
func NewWorkbooksItemCheckoutRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemCheckoutRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewWorkbooksItemCheckoutRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *WorkbooksItemCheckoutRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *WorkbooksItemCheckoutRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *WorkbooksItemCheckoutRequestBuilder) Post(ctx context.Context, requestConfiguration *WorkbooksItemCheckoutRequestBuilderPostRequestConfiguration)(error) {
