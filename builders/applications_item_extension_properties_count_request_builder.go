...
func NewApplicationsItemExtensionPropertiesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemExtensionPropertiesCountRequestBuilder) {
    m := &ApplicationsItemExtensionPropertiesCountRequestBuilder{
    }
...
func NewApplicationsItemExtensionPropertiesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemExtensionPropertiesCountRequestBuilder) {
    ...
    return NewApplicationsItemExtensionPropertiesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *ApplicationsItemExtensionPropertiesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemExtensionPropertiesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemExtensionPropertiesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsItemExtensionPropertiesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
