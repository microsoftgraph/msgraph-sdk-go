...
func NewWorkbooksItemListItemVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemListItemVersionsRequestBuilder) {
    m := &WorkbooksItemListItemVersionsRequestBuilder{
    }
...
func NewWorkbooksItemListItemVersionsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemListItemVersionsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewWorkbooksItemListItemVersionsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *WorkbooksItemListItemVersionsRequestBuilder) Count()(*WorkbooksItemListItemVersionsCountRequestBuilder) {
    return NewWorkbooksItemListItemVersionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *WorkbooksItemListItemVersionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *WorkbooksItemListItemVersionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *WorkbooksItemListItemVersionsRequestBuilder) Get(ctx context.Context, requestConfiguration *WorkbooksItemListItemVersionsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ListItemVersionCollectionResponseable, error) {
