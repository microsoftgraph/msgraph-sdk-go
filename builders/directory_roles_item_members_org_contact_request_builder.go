...
func NewDirectoryRolesItemMembersOrgContactRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersOrgContactRequestBuilder) {
    m := &DirectoryRolesItemMembersOrgContactRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/microsoft.graph.orgContact{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func NewDirectoryRolesItemMembersOrgContactRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersOrgContactRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDirectoryRolesItemMembersOrgContactRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *DirectoryRolesItemMembersOrgContactRequestBuilder) Count()(*DirectoryRolesItemMembersOrgContactCountRequestBuilder) {
    return NewDirectoryRolesItemMembersOrgContactCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DirectoryRolesItemMembersOrgContactRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersOrgContactRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRolesItemMembersOrgContactRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersOrgContactRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.OrgContactCollectionResponseable, error) {
