...
func NewDriveRootChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootChildrenRequestBuilder) {
    m := &DriveRootChildrenRequestBuilder{
    }
...
func NewDriveRootChildrenRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootChildrenRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveRootChildrenRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *DriveRootChildrenRequestBuilder) Count()(*DriveRootChildrenCountRequestBuilder) {
    return NewDriveRootChildrenCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DriveRootChildrenRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveRootChildrenRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveRootChildrenRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveRootChildrenRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveItemCollectionResponseable, error) {
