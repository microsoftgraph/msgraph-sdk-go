...
func NewApplicationsItemOwnersServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemOwnersServicePrincipalRequestBuilder) {
    m := &ApplicationsItemOwnersServicePrincipalRequestBuilder{
    }
...
func NewApplicationsItemOwnersServicePrincipalRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemOwnersServicePrincipalRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewApplicationsItemOwnersServicePrincipalRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ApplicationsItemOwnersServicePrincipalRequestBuilder) Count()(*ApplicationsItemOwnersServicePrincipalCountRequestBuilder) {
    return NewApplicationsItemOwnersServicePrincipalCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ApplicationsItemOwnersServicePrincipalRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemOwnersServicePrincipalRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemOwnersServicePrincipalRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsItemOwnersServicePrincipalRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ServicePrincipalCollectionResponseable, error) {
