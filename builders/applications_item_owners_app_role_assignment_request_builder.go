...
func NewApplicationsItemOwnersAppRoleAssignmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemOwnersAppRoleAssignmentRequestBuilder) {
    m := &ApplicationsItemOwnersAppRoleAssignmentRequestBuilder{
    }
...
func NewApplicationsItemOwnersAppRoleAssignmentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemOwnersAppRoleAssignmentRequestBuilder) {
    ...
    return NewApplicationsItemOwnersAppRoleAssignmentRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ApplicationsItemOwnersAppRoleAssignmentRequestBuilder) Count()(*ApplicationsItemOwnersAppRoleAssignmentCountRequestBuilder) {
    return NewApplicationsItemOwnersAppRoleAssignmentCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ApplicationsItemOwnersAppRoleAssignmentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemOwnersAppRoleAssignmentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemOwnersAppRoleAssignmentRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsItemOwnersAppRoleAssignmentRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AppRoleAssignmentCollectionResponseable, error) {
