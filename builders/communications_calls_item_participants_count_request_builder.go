...
func NewCommunicationsCallsItemParticipantsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemParticipantsCountRequestBuilder) {
    m := &CommunicationsCallsItemParticipantsCountRequestBuilder{
    }
...
func NewCommunicationsCallsItemParticipantsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemParticipantsCountRequestBuilder) {
    ...
    return NewCommunicationsCallsItemParticipantsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *CommunicationsCallsItemParticipantsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CommunicationsCallsItemParticipantsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsCallsItemParticipantsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CommunicationsCallsItemParticipantsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
