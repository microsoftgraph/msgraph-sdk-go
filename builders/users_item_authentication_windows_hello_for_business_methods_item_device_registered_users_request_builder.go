...
func (m *UsersItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredUsersRequestBuilder) AppRoleAssignment()(*UsersItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredUsersAppRoleAssignmentRequestBuilder) {
    return NewUsersItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredUsersAppRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *UsersItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredUsersRequestBuilder) Get(ctx context.Context, requestConfiguration *UsersItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredUsersRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DirectoryObjectCollectionResponseable, error) {
