...
func NewApplicationsItemCreatedOnBehalfOfRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemCreatedOnBehalfOfRequestBuilder) {
    m := &ApplicationsItemCreatedOnBehalfOfRequestBuilder{
    }
...
func NewApplicationsItemCreatedOnBehalfOfRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemCreatedOnBehalfOfRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewApplicationsItemCreatedOnBehalfOfRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation supports $filter (/$count eq 0, /$count ne 0). Read-only.
func (m *ApplicationsItemCreatedOnBehalfOfRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemCreatedOnBehalfOfRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemCreatedOnBehalfOfRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsItemCreatedOnBehalfOfRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DirectoryObjectable, error) {
