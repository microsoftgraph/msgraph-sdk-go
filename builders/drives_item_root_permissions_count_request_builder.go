...
func NewDrivesItemRootPermissionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootPermissionsCountRequestBuilder) {
    m := &DrivesItemRootPermissionsCountRequestBuilder{
    }
...
func NewDrivesItemRootPermissionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootPermissionsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemRootPermissionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DrivesItemRootPermissionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemRootPermissionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemRootPermissionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemRootPermissionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
