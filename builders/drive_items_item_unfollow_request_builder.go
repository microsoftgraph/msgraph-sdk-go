...
func NewDriveItemsItemUnfollowRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemUnfollowRequestBuilder) {
    m := &DriveItemsItemUnfollowRequestBuilder{
    }
...
func NewDriveItemsItemUnfollowRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemUnfollowRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveItemsItemUnfollowRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation unfollow a driveItem.
func (m *DriveItemsItemUnfollowRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *DriveItemsItemUnfollowRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveItemsItemUnfollowRequestBuilder) Post(ctx context.Context, requestConfiguration *DriveItemsItemUnfollowRequestBuilderPostRequestConfiguration)(error) {
