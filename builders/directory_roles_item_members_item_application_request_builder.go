...
func NewDirectoryRolesItemMembersItemApplicationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersItemApplicationRequestBuilder) {
    m := &DirectoryRolesItemMembersItemApplicationRequestBuilder{
    }
...
func NewDirectoryRolesItemMembersItemApplicationRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersItemApplicationRequestBuilder) {
    ...
    return NewDirectoryRolesItemMembersItemApplicationRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the item of type microsoft.graph.directoryObject as microsoft.graph.application
func (m *DirectoryRolesItemMembersItemApplicationRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersItemApplicationRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRolesItemMembersItemApplicationRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersItemApplicationRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Applicationable, error) {
