...
func NewWorkbooksItemVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemVersionsCountRequestBuilder) {
    m := &WorkbooksItemVersionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/versions/$count";
...
func NewWorkbooksItemVersionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemVersionsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewWorkbooksItemVersionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *WorkbooksItemVersionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *WorkbooksItemVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *WorkbooksItemVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WorkbooksItemVersionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
