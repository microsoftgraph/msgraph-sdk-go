...
func NewCommunicationsOnlineMeetingsItemAttendanceReportsItemAttendanceRecordsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsOnlineMeetingsItemAttendanceReportsItemAttendanceRecordsCountRequestBuilder) {
    m := &CommunicationsOnlineMeetingsItemAttendanceReportsItemAttendanceRecordsCountRequestBuilder{
    }
...
func NewCommunicationsOnlineMeetingsItemAttendanceReportsItemAttendanceRecordsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsOnlineMeetingsItemAttendanceReportsItemAttendanceRecordsCountRequestBuilder) {
    ...
    return NewCommunicationsOnlineMeetingsItemAttendanceReportsItemAttendanceRecordsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *CommunicationsOnlineMeetingsItemAttendanceReportsItemAttendanceRecordsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CommunicationsOnlineMeetingsItemAttendanceReportsItemAttendanceRecordsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsOnlineMeetingsItemAttendanceReportsItemAttendanceRecordsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CommunicationsOnlineMeetingsItemAttendanceReportsItemAttendanceRecordsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
