...
func NewPrivacySubjectRightsRequestsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivacySubjectRightsRequestsCountRequestBuilder) {
    m := &PrivacySubjectRightsRequestsCountRequestBuilder{
    }
...
func NewPrivacySubjectRightsRequestsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivacySubjectRightsRequestsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewPrivacySubjectRightsRequestsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *PrivacySubjectRightsRequestsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *PrivacySubjectRightsRequestsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PrivacySubjectRightsRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivacySubjectRightsRequestsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
