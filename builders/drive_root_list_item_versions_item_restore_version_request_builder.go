...
func NewDriveRootListItemVersionsItemRestoreVersionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootListItemVersionsItemRestoreVersionRequestBuilder) {
    m := &DriveRootListItemVersionsItemRestoreVersionRequestBuilder{
    }
...
func NewDriveRootListItemVersionsItemRestoreVersionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootListItemVersionsItemRestoreVersionRequestBuilder) {
    ...
    return NewDriveRootListItemVersionsItemRestoreVersionRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DriveRootListItemVersionsItemRestoreVersionRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *DriveRootListItemVersionsItemRestoreVersionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveRootListItemVersionsItemRestoreVersionRequestBuilder) Post(ctx context.Context, requestConfiguration *DriveRootListItemVersionsItemRestoreVersionRequestBuilderPostRequestConfiguration)(error) {
