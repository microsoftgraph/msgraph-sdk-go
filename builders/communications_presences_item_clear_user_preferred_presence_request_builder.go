...
func NewCommunicationsPresencesItemClearUserPreferredPresenceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsPresencesItemClearUserPreferredPresenceRequestBuilder) {
    m := &CommunicationsPresencesItemClearUserPreferredPresenceRequestBuilder{
    }
...
func NewCommunicationsPresencesItemClearUserPreferredPresenceRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsPresencesItemClearUserPreferredPresenceRequestBuilder) {
    ...
    return NewCommunicationsPresencesItemClearUserPreferredPresenceRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation clear the preferred availability and activity status for a user.
func (m *CommunicationsPresencesItemClearUserPreferredPresenceRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *CommunicationsPresencesItemClearUserPreferredPresenceRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsPresencesItemClearUserPreferredPresenceRequestBuilder) Post(ctx context.Context, requestConfiguration *CommunicationsPresencesItemClearUserPreferredPresenceRequestBuilderPostRequestConfiguration)(error) {
