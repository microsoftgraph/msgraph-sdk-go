...
func NewWorkbooksItemVersionsItemRestoreVersionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemVersionsItemRestoreVersionRequestBuilder) {
    m := &WorkbooksItemVersionsItemRestoreVersionRequestBuilder{
    }
...
func NewWorkbooksItemVersionsItemRestoreVersionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemVersionsItemRestoreVersionRequestBuilder) {
    ...
    return NewWorkbooksItemVersionsItemRestoreVersionRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *WorkbooksItemVersionsItemRestoreVersionRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *WorkbooksItemVersionsItemRestoreVersionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *WorkbooksItemVersionsItemRestoreVersionRequestBuilder) Post(ctx context.Context, requestConfiguration *WorkbooksItemVersionsItemRestoreVersionRequestBuilderPostRequestConfiguration)(error) {
