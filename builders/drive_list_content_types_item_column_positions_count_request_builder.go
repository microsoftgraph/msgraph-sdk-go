...
func NewDriveListContentTypesItemColumnPositionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListContentTypesItemColumnPositionsCountRequestBuilder) {
    m := &DriveListContentTypesItemColumnPositionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/columnPositions/$count";
...
func NewDriveListContentTypesItemColumnPositionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListContentTypesItemColumnPositionsCountRequestBuilder) {
    ...
    return NewDriveListContentTypesItemColumnPositionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveListContentTypesItemColumnPositionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveListContentTypesItemColumnPositionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveListContentTypesItemColumnPositionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveListContentTypesItemColumnPositionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
