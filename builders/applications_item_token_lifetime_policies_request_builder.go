...
func NewApplicationsItemTokenLifetimePoliciesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenLifetimePoliciesRequestBuilder) {
    m := &ApplicationsItemTokenLifetimePoliciesRequestBuilder{
    }
...
func NewApplicationsItemTokenLifetimePoliciesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenLifetimePoliciesRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewApplicationsItemTokenLifetimePoliciesRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ApplicationsItemTokenLifetimePoliciesRequestBuilder) Count()(*ApplicationsItemTokenLifetimePoliciesCountRequestBuilder) {
    return NewApplicationsItemTokenLifetimePoliciesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list the tokenLifetimePolicy objects that are assigned to an application.
func (m *ApplicationsItemTokenLifetimePoliciesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemTokenLifetimePoliciesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemTokenLifetimePoliciesRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsItemTokenLifetimePoliciesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.TokenLifetimePolicyCollectionResponseable, error) {
...
func (m *ApplicationsItemTokenLifetimePoliciesRequestBuilder) Ref()(*ApplicationsItemTokenLifetimePoliciesRefRequestBuilder) {
    return NewApplicationsItemTokenLifetimePoliciesRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
