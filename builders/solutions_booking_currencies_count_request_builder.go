...
func NewSolutionsBookingCurrenciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SolutionsBookingCurrenciesCountRequestBuilder) {
    m := &SolutionsBookingCurrenciesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/solutions/bookingCurrencies/$count";
...
func NewSolutionsBookingCurrenciesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SolutionsBookingCurrenciesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSolutionsBookingCurrenciesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *SolutionsBookingCurrenciesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SolutionsBookingCurrenciesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SolutionsBookingCurrenciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SolutionsBookingCurrenciesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
