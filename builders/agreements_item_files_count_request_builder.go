...
func NewAgreementsItemFilesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AgreementsItemFilesCountRequestBuilder) {
    m := &AgreementsItemFilesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/agreements/{agreement%2Did}/files/$count";
...
func NewAgreementsItemFilesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AgreementsItemFilesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewAgreementsItemFilesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *AgreementsItemFilesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *AgreementsItemFilesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AgreementsItemFilesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AgreementsItemFilesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
