...
func NewWorkbooksItemListItemVersionsItemRestoreVersionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemListItemVersionsItemRestoreVersionRequestBuilder) {
    m := &WorkbooksItemListItemVersionsItemRestoreVersionRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/listItem/versions/{listItemVersion%2Did}/microsoft.graph.restoreVersion";
...
func NewWorkbooksItemListItemVersionsItemRestoreVersionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemListItemVersionsItemRestoreVersionRequestBuilder) {
    ...
    return NewWorkbooksItemListItemVersionsItemRestoreVersionRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *WorkbooksItemListItemVersionsItemRestoreVersionRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *WorkbooksItemListItemVersionsItemRestoreVersionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *WorkbooksItemListItemVersionsItemRestoreVersionRequestBuilder) Post(ctx context.Context, requestConfiguration *WorkbooksItemListItemVersionsItemRestoreVersionRequestBuilderPostRequestConfiguration)(error) {
