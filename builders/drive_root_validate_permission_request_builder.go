...
func NewDriveRootValidatePermissionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootValidatePermissionRequestBuilder) {
    m := &DriveRootValidatePermissionRequestBuilder{
    }
...
func NewDriveRootValidatePermissionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootValidatePermissionRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveRootValidatePermissionRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action validatePermission
func (m *DriveRootValidatePermissionRequestBuilder) CreatePostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveRootValidatePermissionPostRequestBodyable, requestConfiguration *DriveRootValidatePermissionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveRootValidatePermissionRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveRootValidatePermissionPostRequestBodyable, requestConfiguration *DriveRootValidatePermissionRequestBuilderPostRequestConfiguration)(error) {
