...
func (m *ReportsGetOffice365GroupsActivityDetailWithDateRequestBuilder) Get(ctx context.Context, requestConfiguration *ReportsGetOffice365GroupsActivityDetailWithDateRequestBuilderGetRequestConfiguration)([]byte, error) {
