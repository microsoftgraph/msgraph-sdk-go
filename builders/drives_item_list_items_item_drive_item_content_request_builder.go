...
func NewDrivesItemListItemsItemDriveItemContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListItemsItemDriveItemContentRequestBuilder) {
    m := &DrivesItemListItemsItemDriveItemContentRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/driveItem/content";
...
func NewDrivesItemListItemsItemDriveItemContentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListItemsItemDriveItemContentRequestBuilder) {
    ...
    return NewDrivesItemListItemsItemDriveItemContentRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation the content stream, if the item represents a file.
func (m *DrivesItemListItemsItemDriveItemContentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemListItemsItemDriveItemContentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemListItemsItemDriveItemContentRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *DrivesItemListItemsItemDriveItemContentRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *DrivesItemListItemsItemDriveItemContentRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemListItemsItemDriveItemContentRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *DrivesItemListItemsItemDriveItemContentRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *DrivesItemListItemsItemDriveItemContentRequestBuilderPutRequestConfiguration)(error) {
