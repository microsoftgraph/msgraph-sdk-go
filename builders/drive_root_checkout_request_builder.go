...
func NewDriveRootCheckoutRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootCheckoutRequestBuilder) {
    m := &DriveRootCheckoutRequestBuilder{
    }
...
func NewDriveRootCheckoutRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootCheckoutRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveRootCheckoutRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DriveRootCheckoutRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *DriveRootCheckoutRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveRootCheckoutRequestBuilder) Post(ctx context.Context, requestConfiguration *DriveRootCheckoutRequestBuilderPostRequestConfiguration)(error) {
