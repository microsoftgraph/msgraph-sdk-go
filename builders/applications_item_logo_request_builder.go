...
func NewApplicationsItemLogoRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemLogoRequestBuilder) {
    m := &ApplicationsItemLogoRequestBuilder{
    }
...
func NewApplicationsItemLogoRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemLogoRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewApplicationsItemLogoRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation the main logo for the application. Not nullable.
func (m *ApplicationsItemLogoRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemLogoRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemLogoRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *ApplicationsItemLogoRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ApplicationsItemLogoRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsItemLogoRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *ApplicationsItemLogoRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *ApplicationsItemLogoRequestBuilderPutRequestConfiguration)(error) {
