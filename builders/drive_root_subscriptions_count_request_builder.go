...
func NewDriveRootSubscriptionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootSubscriptionsCountRequestBuilder) {
    m := &DriveRootSubscriptionsCountRequestBuilder{
    }
...
func NewDriveRootSubscriptionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootSubscriptionsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveRootSubscriptionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveRootSubscriptionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveRootSubscriptionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveRootSubscriptionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveRootSubscriptionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
