...
func NewDriveItemsItemPermissionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemPermissionsCountRequestBuilder) {
    m := &DriveItemsItemPermissionsCountRequestBuilder{
    }
...
func NewDriveItemsItemPermissionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemPermissionsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveItemsItemPermissionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveItemsItemPermissionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveItemsItemPermissionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveItemsItemPermissionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveItemsItemPermissionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
