...
// GetAvailableExtensionPropertiesRequestBuilder builds and executes requests for operations under \directoryRoleTemplates\microsoft.graph.getAvailableExtensionProperties
