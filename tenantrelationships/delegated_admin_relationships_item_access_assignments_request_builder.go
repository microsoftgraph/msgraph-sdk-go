...
// DelegatedAdminRelationshipsItemAccessAssignmentsRequestBuilderGetQueryParameters the access assignments associated with the delegated admin relationship.
