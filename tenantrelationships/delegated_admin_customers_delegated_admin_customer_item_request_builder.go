...
// DelegatedAdminCustomersDelegatedAdminCustomerItemRequestBuilderGetQueryParameters get delegatedAdminCustomers from tenantRelationships
...
func (m *DelegatedAdminCustomersDelegatedAdminCustomerItemRequestBuilder) ServiceManagementDetailsById(id string)(*DelegatedAdminCustomersItemServiceManagementDetailsDelegatedAdminServiceManagementDetailItemRequestBuilder) {
    ...
    return NewDelegatedAdminCustomersItemServiceManagementDetailsDelegatedAdminServiceManagementDetailItemRequestBuilderInternal(urlTplParams, m.requestAdapter, id);
}
...
// ToGetRequestInformation get delegatedAdminCustomers from tenantRelationships
