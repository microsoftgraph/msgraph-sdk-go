...
// DelegatedAdminRelationshipsRequestBuilderGetQueryParameters get delegatedAdminRelationships from tenantRelationships
...
// ToPostRequestInformation create new navigation property to delegatedAdminRelationships for tenantRelationships
