...
func (m *ForceDeleteRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body ForceDeleteRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action forceDelete
func (m *ForceDeleteRequestBuilder) PostWithResponseHandler(body ForceDeleteRequestBodyable, requestConfiguration *ForceDeleteRequestBuilderPostRequestConfiguration)(error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action forceDelete
func (m *ForceDeleteRequestBuilder) PostWithResponseHandler(body ForceDeleteRequestBodyable, requestConfiguration *ForceDeleteRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
