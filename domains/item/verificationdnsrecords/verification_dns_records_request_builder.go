...
func NewVerificationDnsRecordsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VerificationDnsRecordsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/domains/{domain_id}/verificationDnsRecords{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VerificationDnsRecordsRequestBuilder) CreateGetRequestInformation(options *VerificationDnsRecordsRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *VerificationDnsRecordsRequestBuilder) CreatePostRequestInformation(options *VerificationDnsRecordsRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *VerificationDnsRecordsRequestBuilder) Get(options *VerificationDnsRecordsRequestBuilderGetOptions)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DomainDnsRecordCollectionResponseable, error) {
...
func (m *VerificationDnsRecordsRequestBuilder) Post(options *VerificationDnsRecordsRequestBuilderPostOptions)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DomainDnsRecordable, error) {
