...
// ItemFederationConfigurationRequestBuilderGetQueryParameters domain settings configured by a customer when federated with Microsoft Entra ID. Supports $expand.
...
// Get domain settings configured by a customer when federated with Microsoft Entra ID. Supports $expand.
...
// Post create new navigation property to federationConfiguration for domains
...
// ToGetRequestInformation domain settings configured by a customer when federated with Microsoft Entra ID. Supports $expand.
...
// ToPostRequestInformation create new navigation property to federationConfiguration for domains
// returns a *RequestInformation when successful
