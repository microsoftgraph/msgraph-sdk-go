...
func (m *ItemValidatePermissionPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemValidatePermissionPostRequestBody) SetAdditionalData(value map[string]any)() {
