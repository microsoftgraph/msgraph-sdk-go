...
func NewItemDeltaWithTokenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, token *string)(*ItemDeltaWithTokenRequestBuilder) {
    m := &ItemDeltaWithTokenRequestBuilder{
    }
...
func NewItemDeltaWithTokenRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDeltaWithTokenRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemDeltaWithTokenRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// CreateGetRequestInformation invoke function delta
func (m *ItemDeltaWithTokenRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemDeltaWithTokenRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemDeltaWithTokenRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDeltaWithTokenRequestBuilderGetRequestConfiguration)(ItemDeltaWithTokenResponseable, error) {
    ...
    return res.(ItemDeltaWithTokenResponseable), nil
}
