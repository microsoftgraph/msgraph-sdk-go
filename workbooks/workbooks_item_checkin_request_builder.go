...
func NewWorkbooksItemCheckinRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemCheckinRequestBuilder) {
    m := &WorkbooksItemCheckinRequestBuilder{
    }
...
func NewWorkbooksItemCheckinRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemCheckinRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewWorkbooksItemCheckinRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *WorkbooksItemCheckinRequestBuilder) CreatePostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.WorkbooksItemCheckinPostRequestBodyable, requestConfiguration *WorkbooksItemCheckinRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *WorkbooksItemCheckinRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.WorkbooksItemCheckinPostRequestBodyable, requestConfiguration *WorkbooksItemCheckinRequestBuilderPostRequestConfiguration)(error) {
