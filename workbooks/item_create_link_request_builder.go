...
func NewItemCreateLinkRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCreateLinkRequestBuilder) {
    m := &ItemCreateLinkRequestBuilder{
    }
...
func NewItemCreateLinkRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCreateLinkRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemCreateLinkRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemCreateLinkRequestBuilder) Post(ctx context.Context, body ItemCreateLinkPostRequestBodyable, requestConfiguration *ItemCreateLinkRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Permissionable, error) {
...
func (m *ItemCreateLinkRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemCreateLinkPostRequestBodyable, requestConfiguration *ItemCreateLinkRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
