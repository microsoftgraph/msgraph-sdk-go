...
func NewItemValidatePermissionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemValidatePermissionRequestBuilder) {
    m := &ItemValidatePermissionRequestBuilder{
    }
...
func NewItemValidatePermissionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemValidatePermissionRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemValidatePermissionRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action validatePermission
func (m *ItemValidatePermissionRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ItemValidatePermissionPostRequestBodyable, requestConfiguration *ItemValidatePermissionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemValidatePermissionRequestBuilder) Post(ctx context.Context, body ItemValidatePermissionPostRequestBodyable, requestConfiguration *ItemValidatePermissionRequestBuilderPostRequestConfiguration)(error) {
