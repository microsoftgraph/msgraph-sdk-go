...
func NewItemCopyRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCopyRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemCopyRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemCopyRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ItemCopyPostRequestBodyable, requestConfiguration *ItemCopyRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemCopyRequestBuilder) Post(ctx context.Context, body ItemCopyPostRequestBodyable, requestConfiguration *ItemCopyRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveItemable, error) {
