...
func (m *PreviewRequestBuilder) Post(options *PreviewRequestBuilderPostOptions)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ItemPreviewInfoable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateItemPreviewInfoFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
