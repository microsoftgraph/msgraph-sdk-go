...
func (m *InviteResponse) GetValue()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Permissionable) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *InviteResponse) SetValue(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Permissionable)() {
    if m != nil {
        m.value = value
    }
}
