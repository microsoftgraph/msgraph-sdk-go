...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property subscriptions for workbooks
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property subscriptions in workbooks
