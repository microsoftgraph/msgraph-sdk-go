...
import (
    ...
    i1695c9fb33779ab1edf680753a69ef0a408d72ae7be185fc6161bccb1f3e890a "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/children/item/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i1695c9fb33779ab1edf680753a69ef0a408d72ae7be185fc6161bccb1f3e890a.ContentRequestBuilder) {
    return i1695c9fb33779ab1edf680753a69ef0a408d72ae7be185fc6161bccb1f3e890a.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateDeleteRequestInformation collection containing Item objects for the immediate children of Item. Only items representing folders have children. Read-only. Nullable.
...
// CreatePatchRequestInformation collection containing Item objects for the immediate children of Item. Only items representing folders have children. Read-only. Nullable.
...
// Delete collection containing Item objects for the immediate children of Item. Only items representing folders have children. Read-only. Nullable.
...
// Patch collection containing Item objects for the immediate children of Item. Only items representing folders have children. Read-only. Nullable.
