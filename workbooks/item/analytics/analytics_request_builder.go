...
import (
    ...
    i7b8e1ff74ccc726e8354455556623547ced444e65fdf0a023bcebf7752ccc34d "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/analytics/ref"
)

// AnalyticsRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\analytics
...
func NewAnalyticsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AnalyticsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/analytics{?select,expand}";
...
func (m *AnalyticsRequestBuilder) Ref()(*i7b8e1ff74ccc726e8354455556623547ced444e65fdf0a023bcebf7752ccc34d.RefRequestBuilder) {
    return i7b8e1ff74ccc726e8354455556623547ced444e65fdf0a023bcebf7752ccc34d.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
