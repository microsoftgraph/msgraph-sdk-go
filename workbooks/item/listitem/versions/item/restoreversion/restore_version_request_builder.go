...
// RestoreVersionRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\listItem\versions\{listItemVersion-id}\microsoft.graph.restoreVersion
...
func NewRestoreVersionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RestoreVersionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/listItem/versions/{listItemVersion_id}/microsoft.graph.restoreVersion";
