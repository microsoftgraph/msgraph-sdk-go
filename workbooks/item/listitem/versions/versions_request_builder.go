...
import (
    ...
    i89a3254da5ce9cd54048e3deb85e582c27c1a62cac84b69858c4c5c96565673a "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/listitem/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/listItem/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *VersionsRequestBuilder) Count()(*i89a3254da5ce9cd54048e3deb85e582c27c1a62cac84b69858c4c5c96565673a.CountRequestBuilder) {
    return i89a3254da5ce9cd54048e3deb85e582c27c1a62cac84b69858c4c5c96565673a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
