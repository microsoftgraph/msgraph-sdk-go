...
// DeleteWithResponseHandler delete navigation property listItem for workbooks
...
// PatchWithResponseHandler update the navigation property listItem in workbooks
