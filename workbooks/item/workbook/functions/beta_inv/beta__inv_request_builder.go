...
func (m *Beta_InvRequestBuilder) CreatePostRequestInformation(options *Beta_InvRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
// Parameters:
//  - options : Options for the request
func (m *Beta_InvRequestBuilder) Post(options *Beta_InvRequestBuilderPostOptions)(*Beta_InvResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewBeta_InvResponse() }, nil)
    if err != nil {
        return nil, err
    }
