...
// Dec2HexRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.dec2Hex
...
// Dec2HexRequestBuilderPostOptions options for Post
type Dec2HexRequestBuilderPostOptions struct {
    // 
    Body *Dec2HexRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// Dec2HexResponse union type wrapper for classes workbookFunctionResult
...
// NewDec2HexResponse instantiates a new dec2HexResponse and sets the default values.
...
// NewDec2HexRequestBuilderInternal instantiates a new Dec2HexRequestBuilder and sets the default values.
func NewDec2HexRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Dec2HexRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.dec2Hex";
...
// NewDec2HexRequestBuilder instantiates a new Dec2HexRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action dec2Hex
func (m *Dec2HexRequestBuilder) CreatePostRequestInformation(options *Dec2HexRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *Dec2HexRequestBuilder) Post(options *Dec2HexRequestBuilderPostOptions)(*Dec2HexResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewDec2HexResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
