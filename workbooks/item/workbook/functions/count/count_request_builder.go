...
// CountRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.count
...
// CountRequestBuilderPostOptions options for Post
type CountRequestBuilderPostOptions struct {
    // 
...
// CountResponse union type wrapper for classes workbookFunctionResult
...
// NewCountResponse instantiates a new countResponse and sets the default values.
...
func NewCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.count";
...
// CreatePostRequestInformation invoke action count
...
func (m *CountRequestBuilder) Post(options *CountRequestBuilderPostOptions)(*CountResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewCountResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
