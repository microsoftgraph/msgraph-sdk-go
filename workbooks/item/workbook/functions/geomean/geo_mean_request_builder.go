...
// GeoMeanRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.geoMean
...
// GeoMeanRequestBuilderPostOptions options for Post
...
// GeoMeanResponse union type wrapper for classes workbookFunctionResult
...
// NewGeoMeanResponse instantiates a new geoMeanResponse and sets the default values.
...
// NewGeoMeanRequestBuilderInternal instantiates a new GeoMeanRequestBuilder and sets the default values.
func NewGeoMeanRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GeoMeanRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.geoMean";
...
// NewGeoMeanRequestBuilder instantiates a new GeoMeanRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action geoMean
...
func (m *GeoMeanRequestBuilder) Post(options *GeoMeanRequestBuilderPostOptions)(*GeoMeanResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGeoMeanResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
