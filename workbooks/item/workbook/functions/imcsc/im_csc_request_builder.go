...
// ImCscRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.imCsc
...
// ImCscRequestBuilderPostOptions options for Post
type ImCscRequestBuilderPostOptions struct {
    // 
    Body *ImCscRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// ImCscResponse union type wrapper for classes workbookFunctionResult
...
// NewImCscResponse instantiates a new imCscResponse and sets the default values.
...
// NewImCscRequestBuilderInternal instantiates a new ImCscRequestBuilder and sets the default values.
func NewImCscRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ImCscRequestBuilder) {
    m := &ImCscRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.imCsc";
...
// NewImCscRequestBuilder instantiates a new ImCscRequestBuilder and sets the default values.
func NewImCscRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ImCscRequestBuilder) {
    ...
    return NewImCscRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action imCsc
...
func (m *ImCscRequestBuilder) Post(options *ImCscRequestBuilderPostOptions)(*ImCscResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewImCscResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*ImCscResponse), nil
}
