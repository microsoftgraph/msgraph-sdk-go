...
// LogRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.log
...
// LogRequestBuilderPostOptions options for Post
...
// LogResponse union type wrapper for classes workbookFunctionResult
...
// NewLogResponse instantiates a new logResponse and sets the default values.
...
// NewLogRequestBuilderInternal instantiates a new LogRequestBuilder and sets the default values.
func NewLogRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LogRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.log";
...
// NewLogRequestBuilder instantiates a new LogRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action log
...
func (m *LogRequestBuilder) Post(options *LogRequestBuilderPostOptions)(*LogResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewLogResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
