...
// Options for Post
type Binom_Dist_RangeRequestBuilderPostOptions struct {
    // 
    Body *Binom_Dist_RangeRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func (m *Binom_Dist_RangeRequestBuilder) Post(options *Binom_Dist_RangeRequestBuilderPostOptions)(*Binom_Dist_RangeResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewBinom_Dist_RangeResponse() }, nil)
    if err != nil {
        return nil, err
    }
