...
// EffectRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.effect
...
// EffectRequestBuilderPostOptions options for Post
type EffectRequestBuilderPostOptions struct {
    // 
...
// EffectResponse union type wrapper for classes workbookFunctionResult
...
// NewEffectResponse instantiates a new effectResponse and sets the default values.
...
// NewEffectRequestBuilderInternal instantiates a new EffectRequestBuilder and sets the default values.
func NewEffectRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*EffectRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.effect";
...
// NewEffectRequestBuilder instantiates a new EffectRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action effect
...
func (m *EffectRequestBuilder) Post(options *EffectRequestBuilderPostOptions)(*EffectResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewEffectResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
