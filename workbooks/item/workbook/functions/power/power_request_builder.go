...
// PowerRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.power
...
// PowerRequestBuilderPostOptions options for Post
...
// PowerResponse union type wrapper for classes workbookFunctionResult
...
// NewPowerResponse instantiates a new powerResponse and sets the default values.
...
// NewPowerRequestBuilderInternal instantiates a new PowerRequestBuilder and sets the default values.
func NewPowerRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PowerRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.power";
...
// NewPowerRequestBuilder instantiates a new PowerRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action power
...
func (m *PowerRequestBuilder) Post(options *PowerRequestBuilderPostOptions)(*PowerResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewPowerResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
