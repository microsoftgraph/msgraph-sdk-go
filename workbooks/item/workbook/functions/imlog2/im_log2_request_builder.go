...
// ImLog2RequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.imLog2
...
// ImLog2RequestBuilderPostOptions options for Post
type ImLog2RequestBuilderPostOptions struct {
    // 
    Body *ImLog2RequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// ImLog2Response union type wrapper for classes workbookFunctionResult
...
// NewImLog2Response instantiates a new imLog2Response and sets the default values.
...
// NewImLog2RequestBuilderInternal instantiates a new ImLog2RequestBuilder and sets the default values.
func NewImLog2RequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ImLog2RequestBuilder) {
    m := &ImLog2RequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.imLog2";
...
// NewImLog2RequestBuilder instantiates a new ImLog2RequestBuilder and sets the default values.
func NewImLog2RequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ImLog2RequestBuilder) {
    ...
    return NewImLog2RequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action imLog2
...
func (m *ImLog2RequestBuilder) Post(options *ImLog2RequestBuilderPostOptions)(*ImLog2Response, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewImLog2Response() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*ImLog2Response), nil
}
