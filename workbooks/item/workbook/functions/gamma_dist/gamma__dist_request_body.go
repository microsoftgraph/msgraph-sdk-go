...
func (m *Gamma_DistRequestBody) GetAlpha()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.alpha
...
func (m *Gamma_DistRequestBody) GetBeta()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.beta
...
func (m *Gamma_DistRequestBody) GetCumulative()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.cumulative
...
func (m *Gamma_DistRequestBody) GetX()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.x
...
func (m *Gamma_DistRequestBody) SetAlpha(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json)() {
    m.alpha = value
}
// SetBeta sets the beta property value. 
func (m *Gamma_DistRequestBody) SetBeta(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json)() {
    m.beta = value
}
// SetCumulative sets the cumulative property value. 
func (m *Gamma_DistRequestBody) SetCumulative(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json)() {
    m.cumulative = value
}
// SetX sets the x property value. 
func (m *Gamma_DistRequestBody) SetX(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json)() {
    m.x = value
}
