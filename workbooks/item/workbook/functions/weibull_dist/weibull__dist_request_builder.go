...
// Weibull_DistRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.weibull_Dist
...
// Weibull_DistRequestBuilderPostOptions options for Post
type Weibull_DistRequestBuilderPostOptions struct {
    // 
    Body *Weibull_DistRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// Weibull_DistResponse union type wrapper for classes workbookFunctionResult
...
// NewWeibull_DistResponse instantiates a new weibull_DistResponse and sets the default values.
...
func (m *Weibull_DistResponse) GetWorkbookFunctionResult()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *Weibull_DistResponse) SetWorkbookFunctionResult(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewWeibull_DistRequestBuilderInternal instantiates a new Weibull_DistRequestBuilder and sets the default values.
func NewWeibull_DistRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Weibull_DistRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.weibull_Dist";
...
// NewWeibull_DistRequestBuilder instantiates a new Weibull_DistRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action weibull_Dist
func (m *Weibull_DistRequestBuilder) CreatePostRequestInformation(options *Weibull_DistRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *Weibull_DistRequestBuilder) Post(options *Weibull_DistRequestBuilderPostOptions)(*Weibull_DistResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewWeibull_DistResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
