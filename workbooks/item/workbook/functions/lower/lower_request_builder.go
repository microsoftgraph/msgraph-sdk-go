...
// LowerRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.lower
...
// LowerRequestBuilderPostOptions options for Post
...
// LowerResponse union type wrapper for classes workbookFunctionResult
...
// NewLowerResponse instantiates a new lowerResponse and sets the default values.
...
// NewLowerRequestBuilderInternal instantiates a new LowerRequestBuilder and sets the default values.
func NewLowerRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LowerRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.lower";
...
// NewLowerRequestBuilder instantiates a new LowerRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action lower
...
func (m *LowerRequestBuilder) Post(options *LowerRequestBuilderPostOptions)(*LowerResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewLowerResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
