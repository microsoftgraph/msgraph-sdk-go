...
// SlnRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.sln
...
// SlnRequestBuilderPostOptions options for Post
type SlnRequestBuilderPostOptions struct {
    // 
    Body *SlnRequestBody;
    // Request headers
    H map[string]string;
...
// SlnResponse union type wrapper for classes workbookFunctionResult
...
// NewSlnResponse instantiates a new slnResponse and sets the default values.
...
// NewSlnRequestBuilderInternal instantiates a new SlnRequestBuilder and sets the default values.
func NewSlnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SlnRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.sln";
...
// NewSlnRequestBuilder instantiates a new SlnRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action sln
...
func (m *SlnRequestBuilder) Post(options *SlnRequestBuilderPostOptions)(*SlnResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewSlnResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
