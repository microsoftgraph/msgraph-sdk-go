...
// ErfCRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.erfC
...
// ErfCRequestBuilderPostOptions options for Post
type ErfCRequestBuilderPostOptions struct {
    // 
    Body *ErfCRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// ErfCResponse union type wrapper for classes workbookFunctionResult
...
// NewErfCResponse instantiates a new erfCResponse and sets the default values.
...
// NewErfCRequestBuilderInternal instantiates a new ErfCRequestBuilder and sets the default values.
func NewErfCRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ErfCRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.erfC";
...
// NewErfCRequestBuilder instantiates a new ErfCRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action erfC
...
func (m *ErfCRequestBuilder) Post(options *ErfCRequestBuilderPostOptions)(*ErfCResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewErfCResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
