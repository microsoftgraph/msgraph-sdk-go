...
// ImCschRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.imCsch
...
// ImCschRequestBuilderPostOptions options for Post
...
// ImCschResponse union type wrapper for classes workbookFunctionResult
...
// NewImCschResponse instantiates a new imCschResponse and sets the default values.
...
// NewImCschRequestBuilderInternal instantiates a new ImCschRequestBuilder and sets the default values.
func NewImCschRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ImCschRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.imCsch";
...
// NewImCschRequestBuilder instantiates a new ImCschRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action imCsch
...
func (m *ImCschRequestBuilder) Post(options *ImCschRequestBuilderPostOptions)(*ImCschResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewImCschResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
