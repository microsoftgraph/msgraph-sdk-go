...
// ValueRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.value
...
// ValueRequestBuilderPostOptions options for Post
...
// ValueResponse union type wrapper for classes workbookFunctionResult
...
// NewValueResponse instantiates a new valueResponse and sets the default values.
...
// NewValueRequestBuilderInternal instantiates a new ValueRequestBuilder and sets the default values.
func NewValueRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ValueRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.value";
...
// NewValueRequestBuilder instantiates a new ValueRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action value
...
func (m *ValueRequestBuilder) Post(options *ValueRequestBuilderPostOptions)(*ValueResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewValueResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
