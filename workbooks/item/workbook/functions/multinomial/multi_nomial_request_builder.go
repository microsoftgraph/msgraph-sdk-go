...
// MultiNomialRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.multiNomial
...
// MultiNomialRequestBuilderPostOptions options for Post
type MultiNomialRequestBuilderPostOptions struct {
    // 
    Body *MultiNomialRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// MultiNomialResponse union type wrapper for classes workbookFunctionResult
...
// NewMultiNomialResponse instantiates a new multiNomialResponse and sets the default values.
...
// NewMultiNomialRequestBuilderInternal instantiates a new MultiNomialRequestBuilder and sets the default values.
func NewMultiNomialRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiNomialRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.multiNomial";
...
// NewMultiNomialRequestBuilder instantiates a new MultiNomialRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action multiNomial
func (m *MultiNomialRequestBuilder) CreatePostRequestInformation(options *MultiNomialRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *MultiNomialRequestBuilder) Post(options *MultiNomialRequestBuilderPostOptions)(*MultiNomialResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewMultiNomialResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
