...
// FactDoubleRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.factDouble
...
// FactDoubleRequestBuilderPostOptions options for Post
type FactDoubleRequestBuilderPostOptions struct {
    // 
    Body *FactDoubleRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// FactDoubleResponse union type wrapper for classes workbookFunctionResult
...
// NewFactDoubleResponse instantiates a new factDoubleResponse and sets the default values.
...
func (m *FactDoubleResponse) GetWorkbookFunctionResult()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *FactDoubleResponse) SetWorkbookFunctionResult(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewFactDoubleRequestBuilderInternal instantiates a new FactDoubleRequestBuilder and sets the default values.
func NewFactDoubleRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FactDoubleRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.factDouble";
...
// NewFactDoubleRequestBuilder instantiates a new FactDoubleRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action factDouble
func (m *FactDoubleRequestBuilder) CreatePostRequestInformation(options *FactDoubleRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *FactDoubleRequestBuilder) Post(options *FactDoubleRequestBuilderPostOptions)(*FactDoubleResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewFactDoubleResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
