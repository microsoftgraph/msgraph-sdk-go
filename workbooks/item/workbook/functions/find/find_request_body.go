...
func (m *FindRequestBody) GetFindText()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.findText
...
func (m *FindRequestBody) GetStartNum()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.startNum
...
func (m *FindRequestBody) GetWithinText()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.withinText
...
func (m *FindRequestBody) SetFindText(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json)() {
    if m != nil {
        m.findText = value
    }
}
// SetStartNum sets the startNum property value. 
func (m *FindRequestBody) SetStartNum(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json)() {
    if m != nil {
        m.startNum = value
    }
}
// SetWithinText sets the withinText property value. 
func (m *FindRequestBody) SetWithinText(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json)() {
    if m != nil {
        m.withinText = value
    }
}
