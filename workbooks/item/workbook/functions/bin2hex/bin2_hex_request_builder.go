...
// Bin2HexRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.bin2Hex
...
// Bin2HexRequestBuilderPostOptions options for Post
...
// Bin2HexResponse union type wrapper for classes workbookFunctionResult
...
// NewBin2HexResponse instantiates a new bin2HexResponse and sets the default values.
...
// NewBin2HexRequestBuilderInternal instantiates a new Bin2HexRequestBuilder and sets the default values.
func NewBin2HexRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Bin2HexRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.bin2Hex";
...
// NewBin2HexRequestBuilder instantiates a new Bin2HexRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action bin2Hex
...
func (m *Bin2HexRequestBuilder) Post(options *Bin2HexRequestBuilderPostOptions)(*Bin2HexResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewBin2HexResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
