...
// TruncRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.trunc
...
// TruncRequestBuilderPostOptions options for Post
type TruncRequestBuilderPostOptions struct {
    // 
    Body *TruncRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// TruncResponse union type wrapper for classes workbookFunctionResult
...
// NewTruncResponse instantiates a new truncResponse and sets the default values.
...
// NewTruncRequestBuilderInternal instantiates a new TruncRequestBuilder and sets the default values.
func NewTruncRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TruncRequestBuilder) {
    m := &TruncRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.trunc";
...
// NewTruncRequestBuilder instantiates a new TruncRequestBuilder and sets the default values.
func NewTruncRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TruncRequestBuilder) {
    ...
    return NewTruncRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action trunc
...
func (m *TruncRequestBuilder) Post(options *TruncRequestBuilderPostOptions)(*TruncResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewTruncResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*TruncResponse), nil
}
