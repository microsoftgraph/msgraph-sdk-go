...
func (m *F_Dist_RTRequestBuilder) Post(options *F_Dist_RTRequestBuilderPostOptions)(*F_Dist_RTResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewF_Dist_RTResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
