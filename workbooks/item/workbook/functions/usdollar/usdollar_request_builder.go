...
// UsdollarRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.usdollar
...
// UsdollarRequestBuilderPostOptions options for Post
...
// UsdollarResponse union type wrapper for classes workbookFunctionResult
...
// NewUsdollarResponse instantiates a new usdollarResponse and sets the default values.
...
// NewUsdollarRequestBuilderInternal instantiates a new UsdollarRequestBuilder and sets the default values.
func NewUsdollarRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UsdollarRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.usdollar";
...
// NewUsdollarRequestBuilder instantiates a new UsdollarRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action usdollar
...
func (m *UsdollarRequestBuilder) Post(options *UsdollarRequestBuilderPostOptions)(*UsdollarResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewUsdollarResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
