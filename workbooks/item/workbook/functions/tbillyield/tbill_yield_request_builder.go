...
// TbillYieldRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.tbillYield
...
// TbillYieldRequestBuilderPostOptions options for Post
type TbillYieldRequestBuilderPostOptions struct {
    // 
    Body *TbillYieldRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// TbillYieldResponse union type wrapper for classes workbookFunctionResult
...
// NewTbillYieldResponse instantiates a new tbillYieldResponse and sets the default values.
func NewTbillYieldResponse()(*TbillYieldResponse) {
    m := &TbillYieldResponse{
    }
...
// NewTbillYieldRequestBuilderInternal instantiates a new TbillYieldRequestBuilder and sets the default values.
func NewTbillYieldRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TbillYieldRequestBuilder) {
    m := &TbillYieldRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.tbillYield";
...
// NewTbillYieldRequestBuilder instantiates a new TbillYieldRequestBuilder and sets the default values.
func NewTbillYieldRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TbillYieldRequestBuilder) {
    ...
    return NewTbillYieldRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action tbillYield
...
func (m *TbillYieldRequestBuilder) Post(options *TbillYieldRequestBuilderPostOptions)(*TbillYieldResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewTbillYieldResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*TbillYieldResponse), nil
}
