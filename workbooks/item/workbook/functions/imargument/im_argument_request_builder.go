...
// ImArgumentRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.imArgument
...
// ImArgumentRequestBuilderPostOptions options for Post
...
// ImArgumentResponse union type wrapper for classes workbookFunctionResult
...
// NewImArgumentResponse instantiates a new imArgumentResponse and sets the default values.
func NewImArgumentResponse()(*ImArgumentResponse) {
    m := &ImArgumentResponse{
    }
...
// NewImArgumentRequestBuilderInternal instantiates a new ImArgumentRequestBuilder and sets the default values.
func NewImArgumentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ImArgumentRequestBuilder) {
    m := &ImArgumentRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.imArgument";
...
// NewImArgumentRequestBuilder instantiates a new ImArgumentRequestBuilder and sets the default values.
func NewImArgumentRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ImArgumentRequestBuilder) {
    ...
    return NewImArgumentRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action imArgument
...
func (m *ImArgumentRequestBuilder) Post(options *ImArgumentRequestBuilderPostOptions)(*ImArgumentResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewImArgumentResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*ImArgumentResponse), nil
}
