...
// Options for Post
type PercentRank_IncRequestBuilderPostOptions struct {
    // 
    Body *PercentRank_IncRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func (m *PercentRank_IncRequestBuilder) Post(options *PercentRank_IncRequestBuilderPostOptions)(*PercentRank_IncResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewPercentRank_IncResponse() }, nil)
    if err != nil {
        return nil, err
    }
