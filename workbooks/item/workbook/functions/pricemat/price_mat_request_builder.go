...
// PriceMatRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.priceMat
...
// PriceMatRequestBuilderPostOptions options for Post
type PriceMatRequestBuilderPostOptions struct {
    // 
    Body *PriceMatRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// PriceMatResponse union type wrapper for classes workbookFunctionResult
...
// NewPriceMatResponse instantiates a new priceMatResponse and sets the default values.
...
// NewPriceMatRequestBuilderInternal instantiates a new PriceMatRequestBuilder and sets the default values.
func NewPriceMatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PriceMatRequestBuilder) {
    m := &PriceMatRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.priceMat";
...
// NewPriceMatRequestBuilder instantiates a new PriceMatRequestBuilder and sets the default values.
func NewPriceMatRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PriceMatRequestBuilder) {
    ...
    return NewPriceMatRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action priceMat
...
func (m *PriceMatRequestBuilder) Post(options *PriceMatRequestBuilderPostOptions)(*PriceMatResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewPriceMatResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*PriceMatResponse), nil
}
