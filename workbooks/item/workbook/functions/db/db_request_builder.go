...
// DbRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.db
...
// DbRequestBuilderPostOptions options for Post
...
// DbResponse union type wrapper for classes workbookFunctionResult
...
// NewDbResponse instantiates a new dbResponse and sets the default values.
...
// NewDbRequestBuilderInternal instantiates a new DbRequestBuilder and sets the default values.
func NewDbRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DbRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.db";
...
// NewDbRequestBuilder instantiates a new DbRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action db
...
func (m *DbRequestBuilder) Post(options *DbRequestBuilderPostOptions)(*DbResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewDbResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
