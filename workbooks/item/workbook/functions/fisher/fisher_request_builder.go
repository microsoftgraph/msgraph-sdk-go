...
// FisherRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.fisher
...
// FisherRequestBuilderPostOptions options for Post
type FisherRequestBuilderPostOptions struct {
    // 
    Body *FisherRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// FisherResponse union type wrapper for classes workbookFunctionResult
...
// NewFisherResponse instantiates a new fisherResponse and sets the default values.
...
// NewFisherRequestBuilderInternal instantiates a new FisherRequestBuilder and sets the default values.
func NewFisherRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FisherRequestBuilder) {
    m := &FisherRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.fisher";
...
// NewFisherRequestBuilder instantiates a new FisherRequestBuilder and sets the default values.
func NewFisherRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FisherRequestBuilder) {
    ...
    return NewFisherRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action fisher
...
func (m *FisherRequestBuilder) Post(options *FisherRequestBuilderPostOptions)(*FisherResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewFisherResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*FisherResponse), nil
}
