...
// Options for Post
type F_DistRequestBuilderPostOptions struct {
    // 
    Body *F_DistRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func (m *F_DistRequestBuilder) Post(options *F_DistRequestBuilderPostOptions)(*F_DistResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewF_DistResponse() }, nil)
    if err != nil {
        return nil, err
    }
