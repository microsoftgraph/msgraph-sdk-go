...
// Options for Post
type T_DistRequestBuilderPostOptions struct {
    // 
    Body *T_DistRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func (m *T_DistRequestBuilder) Post(options *T_DistRequestBuilderPostOptions)(*T_DistResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewT_DistResponse() }, nil)
    if err != nil {
        return nil, err
    }
