...
// Bin2OctRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.bin2Oct
...
// Bin2OctRequestBuilderPostOptions options for Post
type Bin2OctRequestBuilderPostOptions struct {
    // 
    Body *Bin2OctRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// Bin2OctResponse union type wrapper for classes workbookFunctionResult
...
// NewBin2OctResponse instantiates a new bin2OctResponse and sets the default values.
...
// NewBin2OctRequestBuilderInternal instantiates a new Bin2OctRequestBuilder and sets the default values.
func NewBin2OctRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Bin2OctRequestBuilder) {
    m := &Bin2OctRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.bin2Oct";
...
// NewBin2OctRequestBuilder instantiates a new Bin2OctRequestBuilder and sets the default values.
func NewBin2OctRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Bin2OctRequestBuilder) {
    ...
    return NewBin2OctRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action bin2Oct
...
func (m *Bin2OctRequestBuilder) Post(options *Bin2OctRequestBuilderPostOptions)(*Bin2OctResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewBin2OctResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*Bin2OctResponse), nil
}
