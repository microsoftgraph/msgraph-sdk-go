...
// AtanRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.atan
...
// AtanRequestBuilderPostOptions options for Post
...
// AtanResponse union type wrapper for classes workbookFunctionResult
...
// NewAtanResponse instantiates a new atanResponse and sets the default values.
...
// NewAtanRequestBuilderInternal instantiates a new AtanRequestBuilder and sets the default values.
func NewAtanRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AtanRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.atan";
...
// NewAtanRequestBuilder instantiates a new AtanRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action atan
...
func (m *AtanRequestBuilder) Post(options *AtanRequestBuilderPostOptions)(*AtanResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewAtanResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
