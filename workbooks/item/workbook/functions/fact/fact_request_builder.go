...
// FactRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.fact
...
// FactRequestBuilderPostOptions options for Post
...
// FactResponse union type wrapper for classes workbookFunctionResult
...
// NewFactResponse instantiates a new factResponse and sets the default values.
...
// NewFactRequestBuilderInternal instantiates a new FactRequestBuilder and sets the default values.
func NewFactRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FactRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.fact";
...
// NewFactRequestBuilder instantiates a new FactRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action fact
...
func (m *FactRequestBuilder) Post(options *FactRequestBuilderPostOptions)(*FactResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewFactResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
