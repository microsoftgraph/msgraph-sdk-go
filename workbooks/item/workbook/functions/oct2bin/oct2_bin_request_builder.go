...
// Options for Post
type Oct2BinRequestBuilderPostOptions struct {
    // 
    Body *Oct2BinRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func (m *Oct2BinRequestBuilder) Post(options *Oct2BinRequestBuilderPostOptions)(*Oct2BinResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewOct2BinResponse() }, nil)
    if err != nil {
        return nil, err
    }
