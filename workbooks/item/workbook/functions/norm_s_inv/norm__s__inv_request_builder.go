...
// Norm_S_InvRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.norm_S_Inv
...
// Norm_S_InvRequestBuilderPostOptions options for Post
type Norm_S_InvRequestBuilderPostOptions struct {
    // 
    Body *Norm_S_InvRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// Norm_S_InvResponse union type wrapper for classes workbookFunctionResult
...
// NewNorm_S_InvResponse instantiates a new norm_S_InvResponse and sets the default values.
func NewNorm_S_InvResponse()(*Norm_S_InvResponse) {
    m := &Norm_S_InvResponse{
    }
...
// NewNorm_S_InvRequestBuilderInternal instantiates a new Norm_S_InvRequestBuilder and sets the default values.
func NewNorm_S_InvRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Norm_S_InvRequestBuilder) {
    m := &Norm_S_InvRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.norm_S_Inv";
...
// NewNorm_S_InvRequestBuilder instantiates a new Norm_S_InvRequestBuilder and sets the default values.
func NewNorm_S_InvRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Norm_S_InvRequestBuilder) {
    ...
    return NewNorm_S_InvRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action norm_S_Inv
...
func (m *Norm_S_InvRequestBuilder) Post(options *Norm_S_InvRequestBuilderPostOptions)(*Norm_S_InvResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewNorm_S_InvResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*Norm_S_InvResponse), nil
}
