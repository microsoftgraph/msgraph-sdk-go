...
// NewT_InvRequestBody instantiates a new t_InvRequestBody and sets the default values.
func NewT_InvRequestBody()(*T_InvRequestBody) {
    m := &T_InvRequestBody{
    }
...
func (m *T_InvRequestBody) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *T_InvRequestBody) GetDegFreedom()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.degFreedom
...
func (m *T_InvRequestBody) GetProbability()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
...
func (m *T_InvRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *T_InvRequestBody) IsNil()(bool) {
    return m == nil
}
// Serialize serializes information the current object
func (m *T_InvRequestBody) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
...
func (m *T_InvRequestBody) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
        m.additionalData = value
    }
}
// SetDegFreedom sets the degFreedom property value. 
func (m *T_InvRequestBody) SetDegFreedom(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json)() {
    if m != nil {
        m.degFreedom = value
    }
}
// SetProbability sets the probability property value. 
func (m *T_InvRequestBody) SetProbability(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json)() {
    if m != nil {
        m.probability = value
    }
}
