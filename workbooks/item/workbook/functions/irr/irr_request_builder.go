...
// Options for Post
type IrrRequestBuilderPostOptions struct {
    // 
    Body *IrrRequestBody;
    // Request headers
    H map[string]string;
...
func (m *IrrRequestBuilder) Post(options *IrrRequestBuilderPostOptions)(*IrrResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewIrrResponse() }, nil)
    if err != nil {
        return nil, err
    }
