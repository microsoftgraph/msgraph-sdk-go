...
// MidbRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.midb
...
// MidbRequestBuilderPostOptions options for Post
...
// MidbResponse union type wrapper for classes workbookFunctionResult
...
// NewMidbResponse instantiates a new midbResponse and sets the default values.
...
// NewMidbRequestBuilderInternal instantiates a new MidbRequestBuilder and sets the default values.
func NewMidbRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MidbRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.midb";
...
// NewMidbRequestBuilder instantiates a new MidbRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action midb
...
func (m *MidbRequestBuilder) Post(options *MidbRequestBuilderPostOptions)(*MidbResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewMidbResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
