...
// Options for Post
type IfRequestBuilderPostOptions struct {
    // 
    Body *IfRequestBody;
    // Request headers
    H map[string]string;
...
func (m *IfRequestBuilder) Post(options *IfRequestBuilderPostOptions)(*IfResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewIfResponse() }, nil)
    if err != nil {
        return nil, err
    }
