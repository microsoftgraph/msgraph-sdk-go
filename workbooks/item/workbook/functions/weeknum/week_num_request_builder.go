...
// WeekNumRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.weekNum
...
// WeekNumRequestBuilderPostOptions options for Post
...
// WeekNumResponse union type wrapper for classes workbookFunctionResult
...
// NewWeekNumResponse instantiates a new weekNumResponse and sets the default values.
...
// NewWeekNumRequestBuilderInternal instantiates a new WeekNumRequestBuilder and sets the default values.
func NewWeekNumRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*WeekNumRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.weekNum";
...
// NewWeekNumRequestBuilder instantiates a new WeekNumRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action weekNum
...
func (m *WeekNumRequestBuilder) Post(options *WeekNumRequestBuilderPostOptions)(*WeekNumResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewWeekNumResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
