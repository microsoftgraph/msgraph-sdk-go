...
// DvarPRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.dvarP
...
// DvarPRequestBuilderPostOptions options for Post
...
// DvarPResponse union type wrapper for classes workbookFunctionResult
...
// NewDvarPResponse instantiates a new dvarPResponse and sets the default values.
...
// NewDvarPRequestBuilderInternal instantiates a new DvarPRequestBuilder and sets the default values.
func NewDvarPRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DvarPRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.dvarP";
...
// NewDvarPRequestBuilder instantiates a new DvarPRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action dvarP
...
func (m *DvarPRequestBuilder) Post(options *DvarPRequestBuilderPostOptions)(*DvarPResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewDvarPResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
