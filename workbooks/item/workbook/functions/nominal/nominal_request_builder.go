...
// NominalRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.nominal
...
// NominalRequestBuilderPostOptions options for Post
...
// NominalResponse union type wrapper for classes workbookFunctionResult
...
// NewNominalResponse instantiates a new nominalResponse and sets the default values.
...
// NewNominalRequestBuilderInternal instantiates a new NominalRequestBuilder and sets the default values.
func NewNominalRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*NominalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.nominal";
...
// NewNominalRequestBuilder instantiates a new NominalRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action nominal
...
func (m *NominalRequestBuilder) Post(options *NominalRequestBuilderPostOptions)(*NominalResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewNominalResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
