...
// ImCoshRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.imCosh
...
// ImCoshRequestBuilderPostOptions options for Post
...
// ImCoshResponse union type wrapper for classes workbookFunctionResult
...
// NewImCoshResponse instantiates a new imCoshResponse and sets the default values.
...
// NewImCoshRequestBuilderInternal instantiates a new ImCoshRequestBuilder and sets the default values.
func NewImCoshRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ImCoshRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.imCosh";
...
// NewImCoshRequestBuilder instantiates a new ImCoshRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action imCosh
...
func (m *ImCoshRequestBuilder) Post(options *ImCoshRequestBuilderPostOptions)(*ImCoshResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewImCoshResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
