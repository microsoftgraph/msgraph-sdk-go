...
// IntRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.int
...
// IntRequestBuilderPostOptions options for Post
type IntRequestBuilderPostOptions struct {
    // 
    Body *IntRequestBody;
    // Request headers
    H map[string]string;
...
// IntResponse union type wrapper for classes workbookFunctionResult
...
// NewIntResponse instantiates a new intResponse and sets the default values.
...
// NewIntRequestBuilderInternal instantiates a new IntRequestBuilder and sets the default values.
func NewIntRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*IntRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.int";
...
// NewIntRequestBuilder instantiates a new IntRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action int
...
func (m *IntRequestBuilder) Post(options *IntRequestBuilderPostOptions)(*IntResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewIntResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
