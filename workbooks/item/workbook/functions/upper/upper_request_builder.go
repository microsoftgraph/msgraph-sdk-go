...
// UpperRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.upper
...
// UpperRequestBuilderPostOptions options for Post
type UpperRequestBuilderPostOptions struct {
    // 
    Body *UpperRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// UpperResponse union type wrapper for classes workbookFunctionResult
...
// NewUpperResponse instantiates a new upperResponse and sets the default values.
...
// NewUpperRequestBuilderInternal instantiates a new UpperRequestBuilder and sets the default values.
func NewUpperRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UpperRequestBuilder) {
    m := &UpperRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.upper";
...
// NewUpperRequestBuilder instantiates a new UpperRequestBuilder and sets the default values.
func NewUpperRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UpperRequestBuilder) {
    ...
    return NewUpperRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action upper
...
func (m *UpperRequestBuilder) Post(options *UpperRequestBuilderPostOptions)(*UpperResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewUpperResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*UpperResponse), nil
}
