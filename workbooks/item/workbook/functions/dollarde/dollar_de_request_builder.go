...
// DollarDeRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.dollarDe
...
// DollarDeRequestBuilderPostOptions options for Post
type DollarDeRequestBuilderPostOptions struct {
    // 
    Body *DollarDeRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// DollarDeResponse union type wrapper for classes workbookFunctionResult
...
// NewDollarDeResponse instantiates a new dollarDeResponse and sets the default values.
...
// NewDollarDeRequestBuilderInternal instantiates a new DollarDeRequestBuilder and sets the default values.
func NewDollarDeRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DollarDeRequestBuilder) {
    m := &DollarDeRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.dollarDe";
...
// NewDollarDeRequestBuilder instantiates a new DollarDeRequestBuilder and sets the default values.
func NewDollarDeRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DollarDeRequestBuilder) {
    ...
    return NewDollarDeRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action dollarDe
...
func (m *DollarDeRequestBuilder) Post(options *DollarDeRequestBuilderPostOptions)(*DollarDeResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewDollarDeResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*DollarDeResponse), nil
}
