...
// ImLnRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.imLn
...
// ImLnRequestBuilderPostOptions options for Post
type ImLnRequestBuilderPostOptions struct {
    // 
    Body *ImLnRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// ImLnResponse union type wrapper for classes workbookFunctionResult
...
// NewImLnResponse instantiates a new imLnResponse and sets the default values.
...
// NewImLnRequestBuilderInternal instantiates a new ImLnRequestBuilder and sets the default values.
func NewImLnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ImLnRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.imLn";
...
// NewImLnRequestBuilder instantiates a new ImLnRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action imLn
...
func (m *ImLnRequestBuilder) Post(options *ImLnRequestBuilderPostOptions)(*ImLnResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewImLnResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
