...
// Options for Post
type Dec2BinRequestBuilderPostOptions struct {
    // 
    Body *Dec2BinRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func (m *Dec2BinRequestBuilder) Post(options *Dec2BinRequestBuilderPostOptions)(*Dec2BinResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewDec2BinResponse() }, nil)
    if err != nil {
        return nil, err
    }
