...
// ReplaceBRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.replaceB
...
// ReplaceBRequestBuilderPostOptions options for Post
...
// ReplaceBResponse union type wrapper for classes workbookFunctionResult
...
// NewReplaceBResponse instantiates a new replaceBResponse and sets the default values.
...
// NewReplaceBRequestBuilderInternal instantiates a new ReplaceBRequestBuilder and sets the default values.
func NewReplaceBRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ReplaceBRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.replaceB";
...
// NewReplaceBRequestBuilder instantiates a new ReplaceBRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action replaceB
...
func (m *ReplaceBRequestBuilder) Post(options *ReplaceBRequestBuilderPostOptions)(*ReplaceBResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewReplaceBResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
