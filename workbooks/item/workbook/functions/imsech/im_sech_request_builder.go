...
// ImSechRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.imSech
...
// ImSechRequestBuilderPostOptions options for Post
type ImSechRequestBuilderPostOptions struct {
    // 
    Body *ImSechRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// ImSechResponse union type wrapper for classes workbookFunctionResult
...
// NewImSechResponse instantiates a new imSechResponse and sets the default values.
...
// NewImSechRequestBuilderInternal instantiates a new ImSechRequestBuilder and sets the default values.
func NewImSechRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ImSechRequestBuilder) {
    m := &ImSechRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.imSech";
...
// NewImSechRequestBuilder instantiates a new ImSechRequestBuilder and sets the default values.
func NewImSechRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ImSechRequestBuilder) {
    ...
    return NewImSechRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action imSech
...
func (m *ImSechRequestBuilder) Post(options *ImSechRequestBuilderPostOptions)(*ImSechResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewImSechResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*ImSechResponse), nil
}
