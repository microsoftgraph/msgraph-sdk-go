...
// SecondRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.second
...
// SecondRequestBuilderPostOptions options for Post
type SecondRequestBuilderPostOptions struct {
    // 
...
// SecondResponse union type wrapper for classes workbookFunctionResult
...
// NewSecondResponse instantiates a new secondResponse and sets the default values.
...
// NewSecondRequestBuilderInternal instantiates a new SecondRequestBuilder and sets the default values.
func NewSecondRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SecondRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.second";
...
// NewSecondRequestBuilder instantiates a new SecondRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action second
...
func (m *SecondRequestBuilder) Post(options *SecondRequestBuilderPostOptions)(*SecondResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewSecondResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
