...
// NewBitandRequestBody instantiates a new bitandRequestBody and sets the default values.
func NewBitandRequestBody()(*BitandRequestBody) {
    m := &BitandRequestBody{
    }
...
func (m *BitandRequestBody) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *BitandRequestBody) GetNumber1()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.number1
...
func (m *BitandRequestBody) GetNumber2()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.number2
...
func (m *BitandRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *BitandRequestBody) IsNil()(bool) {
    return m == nil
}
// Serialize serializes information the current object
func (m *BitandRequestBody) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
