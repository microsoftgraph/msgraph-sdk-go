...
// CoupNumRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.coupNum
...
// CoupNumRequestBuilderPostOptions options for Post
...
// CoupNumResponse union type wrapper for classes workbookFunctionResult
...
// NewCoupNumResponse instantiates a new coupNumResponse and sets the default values.
...
// NewCoupNumRequestBuilderInternal instantiates a new CoupNumRequestBuilder and sets the default values.
func NewCoupNumRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CoupNumRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.coupNum";
...
// NewCoupNumRequestBuilder instantiates a new CoupNumRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action coupNum
...
func (m *CoupNumRequestBuilder) Post(options *CoupNumRequestBuilderPostOptions)(*CoupNumResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewCoupNumResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
