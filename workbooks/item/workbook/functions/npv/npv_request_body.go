...
// NewNpvRequestBody instantiates a new npvRequestBody and sets the default values.
func NewNpvRequestBody()(*NpvRequestBody) {
    m := &NpvRequestBody{
    }
...
func (m *NpvRequestBody) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *NpvRequestBody) GetRate()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.rate
...
func (m *NpvRequestBody) GetValues()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json) {
    if m == nil {
        return nil
    } else {
        return m.values
...
func (m *NpvRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *NpvRequestBody) IsNil()(bool) {
    return m == nil
}
// Serialize serializes information the current object
func (m *NpvRequestBody) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
...
func (m *NpvRequestBody) SetRate(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json)() {
    if m != nil {
        m.rate = value
    }
}
// SetValues sets the values property value. 
func (m *NpvRequestBody) SetValues(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Json)() {
    if m != nil {
        m.values = value
    }
}
