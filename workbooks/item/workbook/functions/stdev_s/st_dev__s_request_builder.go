...
func (m *StDev_SRequestBuilder) Post(options *StDev_SRequestBuilderPostOptions)(*StDev_SResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewStDev_SResponse() }, nil)
    if err != nil {
        return nil, err
    }
