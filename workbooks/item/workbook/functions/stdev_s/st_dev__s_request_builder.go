...
// StDev_SRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.stDev_S
...
// StDev_SRequestBuilderPostOptions options for Post
type StDev_SRequestBuilderPostOptions struct {
    // 
    Body *StDev_SRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// StDev_SResponse union type wrapper for classes workbookFunctionResult
...
// NewStDev_SResponse instantiates a new stDev_SResponse and sets the default values.
...
// NewStDev_SRequestBuilderInternal instantiates a new StDev_SRequestBuilder and sets the default values.
func NewStDev_SRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*StDev_SRequestBuilder) {
    m := &StDev_SRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.stDev_S";
...
// NewStDev_SRequestBuilder instantiates a new StDev_SRequestBuilder and sets the default values.
func NewStDev_SRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*StDev_SRequestBuilder) {
    ...
    return NewStDev_SRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action stDev_S
...
func (m *StDev_SRequestBuilder) Post(options *StDev_SRequestBuilderPostOptions)(*StDev_SResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewStDev_SResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*StDev_SResponse), nil
}
