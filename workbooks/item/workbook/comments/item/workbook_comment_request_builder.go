...
import (
    ...
    if89a002d4a24a65a985811fa34b4e8702e32b1c64cff9670b20718f9e755d7c3 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/comments/item/replies"
...
func NewWorkbookCommentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*WorkbookCommentRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/comments/{workbookComment_id}{?select,expand}";
...
//  - q : Request query parameters
//  - responseHandler : Response handler to use in place of the default response handling provided by the core service
func (m *WorkbookCommentRequestBuilder) Get(q func (value *WorkbookCommentRequestBuilderGetQueryParameters) (err error), h func (value map[string]string) (err error), o []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption, responseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookComment, error) {
    requestInfo, err := m.CreateGetRequestInformation(q, h, o);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewWorkbookComment() }, responseHandler)
    if err != nil {
        return nil, err
    }
...
func (m *WorkbookCommentRequestBuilder) RepliesById(id string)(*if7c6b87c26560e612f175717242ca84d813291c0b9bda359fee5f53fa999dea8.WorkbookCommentReplyRequestBuilder) {
    ...
    return if7c6b87c26560e612f175717242ca84d813291c0b9bda359fee5f53fa999dea8.NewWorkbookCommentReplyRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
