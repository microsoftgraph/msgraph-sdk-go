...
// SessionInfoResourceWithKeyRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\microsoft.graph.sessionInfoResource(key='{key}')
...
// SessionInfoResourceWithKeyRequestBuilderGetOptions options for Get
type SessionInfoResourceWithKeyRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// SessionInfoResourceWithKeyResponse union type wrapper for classes workbookSessionInfo
...
// NewSessionInfoResourceWithKeyResponse instantiates a new sessionInfoResourceWithKeyResponse and sets the default values.
...
func (m *SessionInfoResourceWithKeyResponse) GetWorkbookSessionInfo()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookSessionInfo) {
    if m == nil {
        return nil
    } else {
...
func (m *SessionInfoResourceWithKeyResponse) SetWorkbookSessionInfo(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookSessionInfo)() {
    if m != nil {
        m.workbookSessionInfo = value
    }
}
// NewSessionInfoResourceWithKeyRequestBuilderInternal instantiates a new SessionInfoResourceWithKeyRequestBuilder and sets the default values.
func NewSessionInfoResourceWithKeyRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter, key *string)(*SessionInfoResourceWithKeyRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/microsoft.graph.sessionInfoResource(key='{key}')";
...
// NewSessionInfoResourceWithKeyRequestBuilder instantiates a new SessionInfoResourceWithKeyRequestBuilder and sets the default values.
...
// CreateGetRequestInformation invoke function sessionInfoResource
func (m *SessionInfoResourceWithKeyRequestBuilder) CreateGetRequestInformation(options *SessionInfoResourceWithKeyRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *SessionInfoResourceWithKeyRequestBuilder) Get(options *SessionInfoResourceWithKeyRequestBuilderGetOptions)(*SessionInfoResourceWithKeyResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewSessionInfoResourceWithKeyResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
