...
import (
    ...
    i511b0d69754ed4730da95e4a85da224368c164865b29ab5214d0e0209b58955d "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/names/item/worksheet/charts/item/axes/valueaxis/format/line/clear"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\charts\{workbookChart-id}\axes\valueAxis\format\line
...
func (m *LineRequestBuilder) Clear()(*i511b0d69754ed4730da95e4a85da224368c164865b29ab5214d0e0209b58955d.ClearRequestBuilder) {
    return i511b0d69754ed4730da95e4a85da224368c164865b29ab5214d0e0209b58955d.NewClearRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewLineRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LineRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/axes/valueAxis/format/line{?select,expand}";
