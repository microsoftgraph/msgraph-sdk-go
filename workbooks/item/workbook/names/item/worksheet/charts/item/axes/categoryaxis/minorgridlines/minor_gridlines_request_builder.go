...
import (
    ...
    i32222563abd71b08180597f57710a90d58c4dbb7ce1223ef9b64c724ee039212 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/names/item/worksheet/charts/item/axes/categoryaxis/minorgridlines/format"
)

// MinorGridlinesRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\charts\{workbookChart-id}\axes\categoryAxis\minorGridlines
...
func NewMinorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MinorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/axes/categoryAxis/minorGridlines{?select,expand}";
...
func (m *MinorGridlinesRequestBuilder) Format()(*i32222563abd71b08180597f57710a90d58c4dbb7ce1223ef9b64c724ee039212.FormatRequestBuilder) {
    return i32222563abd71b08180597f57710a90d58c4dbb7ce1223ef9b64c724ee039212.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Get returns a Gridlines object that represents the minor gridlines for the specified axis. Read-only.
func (m *MinorGridlinesRequestBuilder) Get(options *MinorGridlinesRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookChartGridlines, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewWorkbookChartGridlines() }, nil, nil)
    if err != nil {
        return nil, err
    }
