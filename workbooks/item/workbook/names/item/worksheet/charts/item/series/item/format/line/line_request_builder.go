...
import (
    ...
    if5e204db23fa2b8470f2af88e0b2d35fabd68032bf51743090532fe94c5feb11 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/names/item/worksheet/charts/item/series/item/format/line/clear"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\charts\{workbookChart-id}\series\{workbookChartSeries-id}\format\line
...
func (m *LineRequestBuilder) Clear()(*if5e204db23fa2b8470f2af88e0b2d35fabd68032bf51743090532fe94c5feb11.ClearRequestBuilder) {
    return if5e204db23fa2b8470f2af88e0b2d35fabd68032bf51743090532fe94c5feb11.NewClearRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewLineRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LineRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/series/{workbookChartSeries_id}/format/line{?select,expand}";
