...
import (
    ...
    ib2628c710674e12d8fdf8e7f0e89ddedbd575b78c378142a5f9798e7fd2cbd1e "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/names/item/worksheet/charts/item/axes/valueaxis/title/format/font"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\charts\{workbookChart-id}\axes\valueAxis\title\format
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/axes/valueAxis/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Font()(*ib2628c710674e12d8fdf8e7f0e89ddedbd575b78c378142a5f9798e7fd2cbd1e.FontRequestBuilder) {
    return ib2628c710674e12d8fdf8e7f0e89ddedbd575b78c378142a5f9798e7fd2cbd1e.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart axis title. Read-only.
// Parameters:
//  - options : Options for the request
