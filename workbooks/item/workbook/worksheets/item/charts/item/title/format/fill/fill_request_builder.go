...
import (
    ...
    i1ef47c61428df1e1612bbc21029e443409d5b668328f4875fd4ed590cc8dddca "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/title/format/fill/clear"
    icadeb7957a5213988f8ab53d14cc46ee7bc6e1c55ca2c399983cc8b36c2df990 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/title/format/fill/setsolidcolor"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\title\format\fill
...
func (m *FillRequestBuilder) Clear()(*i1ef47c61428df1e1612bbc21029e443409d5b668328f4875fd4ed590cc8dddca.ClearRequestBuilder) {
    return i1ef47c61428df1e1612bbc21029e443409d5b668328f4875fd4ed590cc8dddca.NewClearRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewFillRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FillRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/title/format/fill{?select,expand}";
...
func (m *FillRequestBuilder) SetSolidColor()(*icadeb7957a5213988f8ab53d14cc46ee7bc6e1c55ca2c399983cc8b36c2df990.SetSolidColorRequestBuilder) {
    return icadeb7957a5213988f8ab53d14cc46ee7bc6e1c55ca2c399983cc8b36c2df990.NewSetSolidColorRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
