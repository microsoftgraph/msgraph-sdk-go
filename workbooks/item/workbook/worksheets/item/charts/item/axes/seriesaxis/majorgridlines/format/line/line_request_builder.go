...
import (
    ...
    id249bb067363bef27ce9a91e362ae9400a7e12926d26e12a50374fc3805e2a76 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/axes/seriesaxis/majorgridlines/format/line/clear"
)

// LineRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\axes\seriesAxis\majorGridlines\format\line
...
func (m *LineRequestBuilder) Clear()(*id249bb067363bef27ce9a91e362ae9400a7e12926d26e12a50374fc3805e2a76.ClearRequestBuilder) {
    return id249bb067363bef27ce9a91e362ae9400a7e12926d26e12a50374fc3805e2a76.NewClearRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewLineRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LineRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/axes/seriesAxis/majorGridlines/format/line{?select,expand}";
