...
import (
    ...
    ia1a9817fc7249e56ebc8c583ec33fb6ba8995a510094214fc3457c5195727e7d "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/axes/seriesaxis/format/line/clear"
)

// LineRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\axes\seriesAxis\format\line
...
func (m *LineRequestBuilder) Clear()(*ia1a9817fc7249e56ebc8c583ec33fb6ba8995a510094214fc3457c5195727e7d.ClearRequestBuilder) {
    return ia1a9817fc7249e56ebc8c583ec33fb6ba8995a510094214fc3457c5195727e7d.NewClearRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewLineRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LineRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/axes/seriesAxis/format/line{?select,expand}";
