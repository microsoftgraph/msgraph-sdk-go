...
import (
    ...
    icc901f1d929613ff57e9fffce6f0eb61bcb812acf835618ab1f03d4b9a596c20 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/axes/categoryaxis/title/format/font"
)
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/axes/categoryAxis/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Font()(*icc901f1d929613ff57e9fffce6f0eb61bcb812acf835618ab1f03d4b9a596c20.FontRequestBuilder) {
    return icc901f1d929613ff57e9fffce6f0eb61bcb812acf835618ab1f03d4b9a596c20.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart axis title. Read-only.
// Parameters:
//  - options : Options for the request
