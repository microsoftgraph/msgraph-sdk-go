...
import (
    ...
    i94cfe0a00079436a74d892b3b8bc087e1cd6dc380fec69c9f02bae863bd62e67 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/axes/valueaxis/minorgridlines/format"
)

// MinorGridlinesRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\axes\valueAxis\minorGridlines
...
func NewMinorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MinorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/axes/valueAxis/minorGridlines{?select,expand}";
...
func (m *MinorGridlinesRequestBuilder) Format()(*i94cfe0a00079436a74d892b3b8bc087e1cd6dc380fec69c9f02bae863bd62e67.FormatRequestBuilder) {
    return i94cfe0a00079436a74d892b3b8bc087e1cd6dc380fec69c9f02bae863bd62e67.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
