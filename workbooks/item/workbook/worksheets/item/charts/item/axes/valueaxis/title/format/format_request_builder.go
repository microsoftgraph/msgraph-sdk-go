...
import (
    ...
    ia886386058a6ec7629716ccd6f1936962766fb4f8424a4228811cccfe9119a5a "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/axes/valueaxis/title/format/font"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\axes\valueAxis\title\format
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/axes/valueAxis/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Font()(*ia886386058a6ec7629716ccd6f1936962766fb4f8424a4228811cccfe9119a5a.FontRequestBuilder) {
    return ia886386058a6ec7629716ccd6f1936962766fb4f8424a4228811cccfe9119a5a.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart axis title. Read-only.
// Parameters:
//  - options : Options for the request
