...
import (
    ...
    i4e899513675e1f0994d72f31b56e4535db9718870e51cbe842d67150f59f613f "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/axes/valueaxis/format/line/clear"
)
...
func (m *LineRequestBuilder) Clear()(*i4e899513675e1f0994d72f31b56e4535db9718870e51cbe842d67150f59f613f.ClearRequestBuilder) {
    return i4e899513675e1f0994d72f31b56e4535db9718870e51cbe842d67150f59f613f.NewClearRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewLineRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LineRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/axes/valueAxis/format/line{?select,expand}";
