...
import (
    ...
    ib6fe8a9a2c2417189ee81b12e284ec114f219e5cc1e7073e79e8614b8a6044e7 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/axes/seriesaxis/title/format/font"
)

// FormatRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\axes\seriesAxis\title\format
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/axes/seriesAxis/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Font()(*ib6fe8a9a2c2417189ee81b12e284ec114f219e5cc1e7073e79e8614b8a6044e7.FontRequestBuilder) {
    return ib6fe8a9a2c2417189ee81b12e284ec114f219e5cc1e7073e79e8614b8a6044e7.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
