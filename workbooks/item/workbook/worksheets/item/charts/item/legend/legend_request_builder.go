...
import (
    ...
    i95908ac1c01191ee9bc903ef4bb8cce4e87e3df6cc27d99d5c253f72b60e3633 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/legend/format"
)

// LegendRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\legend
...
func NewLegendRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LegendRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/legend{?select,expand}";
...
func (m *LegendRequestBuilder) Format()(*i95908ac1c01191ee9bc903ef4bb8cce4e87e3df6cc27d99d5c253f72b60e3633.FormatRequestBuilder) {
    return i95908ac1c01191ee9bc903ef4bb8cce4e87e3df6cc27d99d5c253f72b60e3633.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *LegendRequestBuilder) Get(options *LegendRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookChartLegend, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewWorkbookChartLegend() }, nil, nil)
    if err != nil {
        return nil, err
    }
