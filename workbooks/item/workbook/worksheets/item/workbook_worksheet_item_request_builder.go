...
func (m *WorkbookWorksheetItemRequestBuilder) CellWithRowWithColumn(row *int32, column *int32)(*ie4b7c6c1c8b3e34e3e51127f9ebb673f0a04c788986d8229f1a710411d5f225d.CellWithRowWithColumnRequestBuilder) {
...
func (m *WorkbookWorksheetItemRequestBuilder) Charts()(*iad940f8124c7334170f4bc84a78fc081f07f84f05e2bbcdad79b8c17146992f2.ChartsRequestBuilder) {
...
func (m *WorkbookWorksheetItemRequestBuilder) ChartsById(id string)(*iaf6e80887a038f65ff678934a224c20738b5518de1ef6bd042c68d64e3eb866a.WorkbookChartItemRequestBuilder) {
    ...
    return iaf6e80887a038f65ff678934a224c20738b5518de1ef6bd042c68d64e3eb866a.NewWorkbookChartItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *WorkbookWorksheetItemRequestBuilder) Get(options *WorkbookWorksheetItemRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookWorksheet, error) {
...
func (m *WorkbookWorksheetItemRequestBuilder) Names()(*i9e565a8c9d35090b91ddaf8942fefd178ab4d8274ecd66a46cebd61471579ac8.NamesRequestBuilder) {
...
func (m *WorkbookWorksheetItemRequestBuilder) NamesById(id string)(*i8dc6bf9c3cd413c8da2a0e6e6c76573ab0a8670c078efc72a8efa32a1950ad10.WorkbookNamedItemItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i8dc6bf9c3cd413c8da2a0e6e6c76573ab0a8670c078efc72a8efa32a1950ad10.NewWorkbookNamedItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *WorkbookWorksheetItemRequestBuilder) PivotTables()(*i9c65a5e0511223ed4b7aadfa985f3cecba8763d0234d695c0eba9470b08105fd.PivotTablesRequestBuilder) {
...
func (m *WorkbookWorksheetItemRequestBuilder) PivotTablesById(id string)(*i2b7eb38de9f32e0a84e0f4d15c3dfa5d1787f849e6127d28c3c84d7fb2c68f22.WorkbookPivotTableItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i2b7eb38de9f32e0a84e0f4d15c3dfa5d1787f849e6127d28c3c84d7fb2c68f22.NewWorkbookPivotTableItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
func (m *WorkbookWorksheetItemRequestBuilder) Protection()(*i0ffc856a99ab076eacab92d71f01358a27ce7f82ca9cea1eeef71ccc0b690b04.ProtectionRequestBuilder) {
...
func (m *WorkbookWorksheetItemRequestBuilder) Range_escaped()(*ia27bd953af5b50bd89e1ac4a64ebdd5fc2bc7d28f43a08e7f1892e8d22f44739.RangeRequestBuilder) {
...
func (m *WorkbookWorksheetItemRequestBuilder) RangeWithAddress(address *string)(*ib8d36af0717b2669dc8b8889287197f9036d4251ba8a717b88522dcf0bc194d8.RangeWithAddressRequestBuilder) {
...
func (m *WorkbookWorksheetItemRequestBuilder) Tables()(*i63bfade034059e0bafdeccc55d1d84a9578056cd0b4452d244d1ea48d219bfd5.TablesRequestBuilder) {
...
func (m *WorkbookWorksheetItemRequestBuilder) TablesById(id string)(*i3ecee7d2013b82649254a2abcecff10c453e98848525efb8661b8198de377cbd.WorkbookTableItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i3ecee7d2013b82649254a2abcecff10c453e98848525efb8661b8198de377cbd.NewWorkbookTableItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *WorkbookWorksheetItemRequestBuilder) UsedRange()(*i100ec4503074fbce609d04c7af9f3038ecbe146a28dd1e9696d968fa800e43fb.UsedRangeRequestBuilder) {
...
func (m *WorkbookWorksheetItemRequestBuilder) UsedRangeWithValuesOnly(valuesOnly *bool)(*ia4b371526ab2f408171fc46a799dd775d49573d38da9d1f1459fa6b1e8cc5242.UsedRangeWithValuesOnlyRequestBuilder) {
