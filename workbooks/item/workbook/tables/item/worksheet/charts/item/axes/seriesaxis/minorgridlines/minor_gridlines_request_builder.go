...
import (
    ...
    icd7fb6fedcf91debf522ca964ed15943409f862a15d3880673e5598fae82e1b7 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/seriesaxis/minorgridlines/format"
)
...
func NewMinorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MinorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/seriesAxis/minorGridlines{?select,expand}";
...
func (m *MinorGridlinesRequestBuilder) Format()(*icd7fb6fedcf91debf522ca964ed15943409f862a15d3880673e5598fae82e1b7.FormatRequestBuilder) {
    return icd7fb6fedcf91debf522ca964ed15943409f862a15d3880673e5598fae82e1b7.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Returns a Gridlines object that represents the minor gridlines for the specified axis. Read-only.
// Parameters:
//  - options : Options for the request
