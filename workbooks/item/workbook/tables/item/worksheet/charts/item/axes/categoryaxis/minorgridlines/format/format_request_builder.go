...
import (
    ...
    i4fe31c0be738a2c1ce1c3af245e35deee75b804565c6405604927055e864006f "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/categoryaxis/minorgridlines/format/line"
)
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/categoryAxis/minorGridlines/format{?select,expand}";
...
func (m *FormatRequestBuilder) Line()(*i4fe31c0be738a2c1ce1c3af245e35deee75b804565c6405604927055e864006f.LineRequestBuilder) {
    return i4fe31c0be738a2c1ce1c3af245e35deee75b804565c6405604927055e864006f.NewLineRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart gridlines. Read-only.
// Parameters:
//  - options : Options for the request
