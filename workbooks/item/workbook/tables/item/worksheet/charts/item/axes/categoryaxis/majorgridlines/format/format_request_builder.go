...
import (
    ...
    id4e4e668b520c5be501aee338e13657df7795a3adc2b5ddde474b01a96892777 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/categoryaxis/majorgridlines/format/line"
)
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/categoryAxis/majorGridlines/format{?select,expand}";
...
func (m *FormatRequestBuilder) Line()(*id4e4e668b520c5be501aee338e13657df7795a3adc2b5ddde474b01a96892777.LineRequestBuilder) {
    return id4e4e668b520c5be501aee338e13657df7795a3adc2b5ddde474b01a96892777.NewLineRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart gridlines. Read-only.
// Parameters:
//  - options : Options for the request
