...
import (
    ...
    ifa9c86ec5fea57dd37bbc0d6c6dd27b2781e892fb0bfe0a4fd46b50805d6564e "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/seriesaxis/majorgridlines/format"
)
...
func NewMajorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MajorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/seriesAxis/majorGridlines{?select,expand}";
...
func (m *MajorGridlinesRequestBuilder) Format()(*ifa9c86ec5fea57dd37bbc0d6c6dd27b2781e892fb0bfe0a4fd46b50805d6564e.FormatRequestBuilder) {
    return ifa9c86ec5fea57dd37bbc0d6c6dd27b2781e892fb0bfe0a4fd46b50805d6564e.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Returns a gridlines object that represents the major gridlines for the specified axis. Read-only.
// Parameters:
//  - options : Options for the request
