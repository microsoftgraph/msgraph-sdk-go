...
import (
    ...
    id40ea67cfdfd1b2150eb206a2585e33c03ddf94fe35365ca2cc1a1e2e4070d78 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/categoryaxis/title/format/font"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\worksheet\charts\{workbookChart-id}\axes\categoryAxis\title\format
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/categoryAxis/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Font()(*id40ea67cfdfd1b2150eb206a2585e33c03ddf94fe35365ca2cc1a1e2e4070d78.FontRequestBuilder) {
    return id40ea67cfdfd1b2150eb206a2585e33c03ddf94fe35365ca2cc1a1e2e4070d78.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart axis title. Read-only.
// Parameters:
//  - options : Options for the request
