...
import (
    ...
    ib09c57d96d240aff13c46ce475032cf029ed2e65a23596c906c55565d5baf067 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/seriesaxis/title/format/font"
)
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/seriesAxis/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Font()(*ib09c57d96d240aff13c46ce475032cf029ed2e65a23596c906c55565d5baf067.FontRequestBuilder) {
    return ib09c57d96d240aff13c46ce475032cf029ed2e65a23596c906c55565d5baf067.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart axis title. Read-only.
// Parameters:
//  - options : Options for the request
