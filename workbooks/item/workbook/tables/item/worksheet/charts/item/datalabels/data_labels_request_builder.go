...
import (
    ...
    ida214cc23761abf3afd4a561f6203b3b71326b792faffa70462d2d5b0f0912d3 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/datalabels/format"
)
...
func NewDataLabelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DataLabelsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/dataLabels{?select,expand}";
...
func (m *DataLabelsRequestBuilder) Format()(*ida214cc23761abf3afd4a561f6203b3b71326b792faffa70462d2d5b0f0912d3.FormatRequestBuilder) {
    return ida214cc23761abf3afd4a561f6203b3b71326b792faffa70462d2d5b0f0912d3.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the datalabels on the chart. Read-only.
// Parameters:
//  - h : Request headers
