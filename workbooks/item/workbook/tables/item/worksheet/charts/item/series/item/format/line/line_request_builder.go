...
import (
    ...
    ieac32279003b1fa89bb0360003b3bd559b80110d8b0854c532fd279fc03d0329 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/series/item/format/line/clear"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\worksheet\charts\{workbookChart-id}\series\{workbookChartSeries-id}\format\line
...
func (m *LineRequestBuilder) Clear()(*ieac32279003b1fa89bb0360003b3bd559b80110d8b0854c532fd279fc03d0329.ClearRequestBuilder) {
    return ieac32279003b1fa89bb0360003b3bd559b80110d8b0854c532fd279fc03d0329.NewClearRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewLineRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LineRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/series/{workbookChartSeries_id}/format/line{?select,expand}";
