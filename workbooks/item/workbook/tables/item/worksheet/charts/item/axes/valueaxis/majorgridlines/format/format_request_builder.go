...
import (
    ...
    icf3b9e9518fe784afe2154186cea1ada38097230749f88bea2f78f5c0497ab2d "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/valueaxis/majorgridlines/format/line"
)
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/valueAxis/majorGridlines/format{?select,expand}";
...
func (m *FormatRequestBuilder) Line()(*icf3b9e9518fe784afe2154186cea1ada38097230749f88bea2f78f5c0497ab2d.LineRequestBuilder) {
    return icf3b9e9518fe784afe2154186cea1ada38097230749f88bea2f78f5c0497ab2d.NewLineRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart gridlines. Read-only.
// Parameters:
//  - options : Options for the request
