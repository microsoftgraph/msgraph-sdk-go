...
import (
    ...
    ie2f622654f4d4b2a19c1fa9198e0cd79b585d3b0f1db0dc2255188563a839fe3 "github.com/microsoftgraph/msgraph-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/valueaxis/minorgridlines/format"
)

// MinorGridlinesRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\worksheet\charts\{workbookChart-id}\axes\valueAxis\minorGridlines
...
func NewMinorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MinorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/valueAxis/minorGridlines{?select,expand}";
...
func (m *MinorGridlinesRequestBuilder) Format()(*ie2f622654f4d4b2a19c1fa9198e0cd79b585d3b0f1db0dc2255188563a839fe3.FormatRequestBuilder) {
    return ie2f622654f4d4b2a19c1fa9198e0cd79b585d3b0f1db0dc2255188563a839fe3.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
