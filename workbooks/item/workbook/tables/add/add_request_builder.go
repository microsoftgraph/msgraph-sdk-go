...
// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\microsoft.graph.add
...
func (m *AddResponse) GetWorkbookTable()(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookTable) {
    if m == nil {
        return nil
    } else {
...
func (m *AddResponse) SetWorkbookTable(value *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.WorkbookTable)() {
...
func NewAddRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AddRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/workbooks/{driveItem_id}/workbook/tables/microsoft.graph.add";
