...
func NewItemSubscriptionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSubscriptionsCountRequestBuilder) {
    m := &ItemSubscriptionsCountRequestBuilder{
    }
...
func NewItemSubscriptionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSubscriptionsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemSubscriptionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *ItemSubscriptionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemSubscriptionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemSubscriptionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSubscriptionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
