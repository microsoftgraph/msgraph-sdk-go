...
func NewWorkbooksItemPermissionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemPermissionsCountRequestBuilder) {
    m := &WorkbooksItemPermissionsCountRequestBuilder{
    }
...
func NewWorkbooksItemPermissionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemPermissionsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewWorkbooksItemPermissionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *WorkbooksItemPermissionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *WorkbooksItemPermissionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *WorkbooksItemPermissionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WorkbooksItemPermissionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
