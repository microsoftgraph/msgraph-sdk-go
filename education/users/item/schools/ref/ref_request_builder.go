...
// RefRequestBuilder builds and executes requests for operations under \education\users\{educationUser-id}\schools\$ref
...
// RefRequestBuilderGetQueryParameters schools to which the user belongs. Nullable.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/education/users/{educationUser_id}/schools/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation schools to which the user belongs. Nullable.
...
// Post schools to which the user belongs. Nullable.
