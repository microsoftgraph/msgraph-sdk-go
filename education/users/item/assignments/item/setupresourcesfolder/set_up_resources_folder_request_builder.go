...
// SetUpResourcesFolderRequestBuilder builds and executes requests for operations under \education\users\{educationUser-id}\assignments\{educationAssignment-id}\microsoft.graph.setUpResourcesFolder
