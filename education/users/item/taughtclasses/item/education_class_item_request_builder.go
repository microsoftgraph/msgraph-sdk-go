...
// EducationClassItemRequestBuilder provides operations to manage the taughtClasses property of the microsoft.graph.educationUser entity.
...
// EducationClassItemRequestBuilderGetQueryParameters classes for which the user is a teacher.
