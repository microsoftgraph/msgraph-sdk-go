...
// NewUsersItemRubricsEducationRubricItemRequestBuilderInternal instantiates a new UsersItemRubricsEducationRubricItemRequestBuilder and sets the default values.
func NewUsersItemRubricsEducationRubricItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UsersItemRubricsEducationRubricItemRequestBuilder) {
    m := &UsersItemRubricsEducationRubricItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/rubrics/{educationRubric%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewUsersItemRubricsEducationRubricItemRequestBuilder instantiates a new UsersItemRubricsEducationRubricItemRequestBuilder and sets the default values.
