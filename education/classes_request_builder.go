...
func (m *ClassesRequestBuilder) MicrosoftGraphDelta()(*ClassesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewClassesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
