...
func (m *ClassesItemAssignmentsItemCategoriesRequestBuilder) MicrosoftGraphDelta()(*ClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
