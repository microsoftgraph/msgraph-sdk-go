...
func NewMeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponse()(*MeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponse) {
    m := &MeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponse{
...
func CreateMeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewMeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponse(), nil
}
// GetFieldDeserializers the deserialization information for the current model
func (m *MeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *MeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponse) GetValue()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.EducationCategoryable) {
...
func (m *MeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *MeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponse) SetValue(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.EducationCategoryable)() {
    err := m.GetBackingStore().Set("value", value)
    if err != nil {
        panic(err)
    }
}
// MeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponseable 
type MeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponseable interface {
