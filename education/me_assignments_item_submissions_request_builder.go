...
func (m *MeAssignmentsItemSubmissionsRequestBuilder) ByEducationSubmissionIdString(educationSubmissionId string)(*MeAssignmentsItemSubmissionsEducationSubmissionItemRequestBuilder) {
