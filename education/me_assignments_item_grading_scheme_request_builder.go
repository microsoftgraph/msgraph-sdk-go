...
// MeAssignmentsItemGradingSchemeRequestBuilderGetQueryParameters when set, enables users to configure custom string grades based on the percentage of total points earned on this assignment.
...
func (m *MeAssignmentsItemGradingSchemeRequestBuilder) Get(ctx context.Context, requestConfiguration *MeAssignmentsItemGradingSchemeRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.EducationGradingSchemeable, error) {
