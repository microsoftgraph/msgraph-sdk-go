...
// ByEducationSubmissionResourceIdString provides operations to manage the submittedResources property of the microsoft.graph.educationSubmission entity.
func (m *ClassesItemAssignmentsItemSubmissionsItemSubmittedResourcesRequestBuilder) ByEducationSubmissionResourceIdString(educationSubmissionResourceId string)(*ClassesItemAssignmentsItemSubmissionsItemSubmittedResourcesEducationSubmissionResourceItemRequestBuilder) {
