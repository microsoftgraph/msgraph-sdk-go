...
func (m *MeAssignmentsItemSubmissionsItemResourcesRequestBuilder) ByEducationSubmissionResourceIdString(educationSubmissionResourceId string)(*MeAssignmentsItemSubmissionsItemResourcesEducationSubmissionResourceItemRequestBuilder) {
