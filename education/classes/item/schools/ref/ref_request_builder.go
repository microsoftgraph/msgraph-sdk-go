...
// RefRequestBuilder builds and executes requests for operations under \education\classes\{educationClass-id}\schools\$ref
...
// RefRequestBuilderGetQueryParameters all schools that this class is associated with. Nullable.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/education/classes/{educationClass_id}/schools/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation all schools that this class is associated with. Nullable.
...
// Post all schools that this class is associated with. Nullable.
