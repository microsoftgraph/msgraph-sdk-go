...
// EducationSchoolItemRequestBuilder provides operations to manage the schools property of the microsoft.graph.educationClass entity.
...
// EducationSchoolItemRequestBuilderGetQueryParameters all schools that this class is associated with. Nullable.
...
func NewEducationSchoolItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*EducationSchoolItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/education/classes/{educationClass_id}/schools/{educationSchool_id}{?select,expand}";
