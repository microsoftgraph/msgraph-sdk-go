...
func (m *MeTaughtClassesEducationClassItemRequestBuilder) WithUrl(rawUrl string)(*MeTaughtClassesEducationClassItemRequestBuilder) {
    return NewMeTaughtClassesEducationClassItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
