...
func (m *MeAssignmentsRequestBuilder) MicrosoftGraphDelta()(*MeAssignmentsMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewMeAssignmentsMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
