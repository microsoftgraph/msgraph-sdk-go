...
func (m *UsersItemTaughtClassesRequestBuilder) Count()(*UsersItemTaughtClassesCountRequestBuilder) {
    return NewUsersItemTaughtClassesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get the educationClass resources owned by an educationUser.
func (m *UsersItemTaughtClassesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *UsersItemTaughtClassesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/educationuser-list-taughtclasses?view=graph-rest-1.0
