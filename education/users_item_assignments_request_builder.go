...
func (m *UsersItemAssignmentsRequestBuilder) MicrosoftGraphDelta()(*UsersItemAssignmentsMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewUsersItemAssignmentsMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
