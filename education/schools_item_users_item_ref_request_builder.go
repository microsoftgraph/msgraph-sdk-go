...
// NewSchoolsItemUsersItemRefRequestBuilderInternal instantiates a new SchoolsItemUsersItemRefRequestBuilder and sets the default values.
func NewSchoolsItemUsersItemRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SchoolsItemUsersItemRefRequestBuilder) {
    m := &SchoolsItemUsersItemRefRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/education/schools/{educationSchool%2Did}/users/{educationUser%2Did}/$ref", pathParameters),
    }
    return m
}
// NewSchoolsItemUsersItemRefRequestBuilder instantiates a new SchoolsItemUsersItemRefRequestBuilder and sets the default values.
