...
func NewSchoolsItemUsersCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SchoolsItemUsersCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSchoolsItemUsersCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *SchoolsItemUsersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SchoolsItemUsersCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *SchoolsItemUsersCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *SchoolsItemUsersCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SchoolsItemUsersCountRequestBuilder) WithUrl(rawUrl string)(*SchoolsItemUsersCountRequestBuilder) {
    return NewSchoolsItemUsersCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
