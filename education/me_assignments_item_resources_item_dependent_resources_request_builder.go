...
// MeAssignmentsItemResourcesItemDependentResourcesRequestBuilder provides operations to manage the dependentResources property of the microsoft.graph.educationAssignmentResource entity.
...
type MeAssignmentsItemResourcesItemDependentResourcesRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *MeAssignmentsItemResourcesItemDependentResourcesRequestBuilderGetQueryParameters
}
// MeAssignmentsItemResourcesItemDependentResourcesRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type MeAssignmentsItemResourcesItemDependentResourcesRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func (m *MeAssignmentsItemResourcesItemDependentResourcesRequestBuilder) ByEducationAssignmentResourceId1(educationAssignmentResourceId1 string)(*MeAssignmentsItemResourcesItemDependentResourcesEducationAssignmentResourceItemRequestBuilder) {
...
// NewMeAssignmentsItemResourcesItemDependentResourcesRequestBuilderInternal instantiates a new MeAssignmentsItemResourcesItemDependentResourcesRequestBuilder and sets the default values.
func NewMeAssignmentsItemResourcesItemDependentResourcesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MeAssignmentsItemResourcesItemDependentResourcesRequestBuilder) {
    m := &MeAssignmentsItemResourcesItemDependentResourcesRequestBuilder{
...
// NewMeAssignmentsItemResourcesItemDependentResourcesRequestBuilder instantiates a new MeAssignmentsItemResourcesItemDependentResourcesRequestBuilder and sets the default values.
func NewMeAssignmentsItemResourcesItemDependentResourcesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MeAssignmentsItemResourcesItemDependentResourcesRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewMeAssignmentsItemResourcesItemDependentResourcesRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *MeAssignmentsItemResourcesItemDependentResourcesRequestBuilder) Get(ctx context.Context, requestConfiguration *MeAssignmentsItemResourcesItemDependentResourcesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.EducationAssignmentResourceCollectionResponseable, error) {
...
func (m *MeAssignmentsItemResourcesItemDependentResourcesRequestBuilder) WithUrl(rawUrl string)(*MeAssignmentsItemResourcesItemDependentResourcesRequestBuilder) {
    return NewMeAssignmentsItemResourcesItemDependentResourcesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
