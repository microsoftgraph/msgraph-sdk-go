...
// GetMemberObjectsRequestBuilder builds and executes requests for operations under \directoryObjects\{directoryObject-id}\microsoft.graph.getMemberObjects
...
func NewGetMemberObjectsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GetMemberObjectsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/directoryObjects/{directoryObject_id}/microsoft.graph.getMemberObjects";
