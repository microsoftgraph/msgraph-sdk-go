...
func (m *EntitlementManagementResourceRoleScopesItemRoleResourceScopesItemResourceRolesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRoleScopesItemRoleResourceScopesItemResourceRolesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
