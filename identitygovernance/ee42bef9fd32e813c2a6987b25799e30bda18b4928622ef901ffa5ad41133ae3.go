...
// LifecycleWorkflowsDeletedItemsWorkflowsItemRunsItemUserProcessingResultsItemReprocessedRunsRunItemRequestBuilder provides operations to manage the reprocessedRuns property of the microsoft.graph.identityGovernance.userProcessingResult entity.
type LifecycleWorkflowsDeletedItemsWorkflowsItemRunsItemUserProcessingResultsItemReprocessedRunsRunItemRequestBuilder struct {
...
type LifecycleWorkflowsDeletedItemsWorkflowsItemRunsItemUserProcessingResultsItemReprocessedRunsRunItemRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *LifecycleWorkflowsDeletedItemsWorkflowsItemRunsItemUserProcessingResultsItemReprocessedRunsRunItemRequestBuilderGetQueryParameters
}
// NewLifecycleWorkflowsDeletedItemsWorkflowsItemRunsItemUserProcessingResultsItemReprocessedRunsRunItemRequestBuilderInternal instantiates a new LifecycleWorkflowsDeletedItemsWorkflowsItemRunsItemUserProcessingResultsItemReprocessedRunsRunItemRequestBuilder and sets the default values.
...
// NewLifecycleWorkflowsDeletedItemsWorkflowsItemRunsItemUserProcessingResultsItemReprocessedRunsRunItemRequestBuilder instantiates a new LifecycleWorkflowsDeletedItemsWorkflowsItemRunsItemUserProcessingResultsItemReprocessedRunsRunItemRequestBuilder and sets the default values.
...
func (m *LifecycleWorkflowsDeletedItemsWorkflowsItemRunsItemUserProcessingResultsItemReprocessedRunsRunItemRequestBuilder) WithUrl(rawUrl string)(*LifecycleWorkflowsDeletedItemsWorkflowsItemRunsItemUserProcessingResultsItemReprocessedRunsRunItemRequestBuilder) {
    return NewLifecycleWorkflowsDeletedItemsWorkflowsItemRunsItemUserProcessingResultsItemReprocessedRunsRunItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
