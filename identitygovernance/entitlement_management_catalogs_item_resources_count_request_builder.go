...
func (m *EntitlementManagementCatalogsItemResourcesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementCatalogsItemResourcesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
