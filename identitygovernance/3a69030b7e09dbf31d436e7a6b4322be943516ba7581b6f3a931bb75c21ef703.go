...
func (m *EntitlementManagementCatalogsItemResourceScopesItemResourceRolesItemResourceScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementCatalogsItemResourceScopesItemResourceRolesItemResourceScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
