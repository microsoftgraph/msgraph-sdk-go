...
// PrivilegedAccessGroupEligibilitySchedulesItemGroupServiceProvisioningErrorsRequestBuilderGetQueryParameters get serviceProvisioningErrors property value
...
// NewPrivilegedAccessGroupEligibilitySchedulesItemGroupServiceProvisioningErrorsRequestBuilderInternal instantiates a new ServiceProvisioningErrorsRequestBuilder and sets the default values.
...
// NewPrivilegedAccessGroupEligibilitySchedulesItemGroupServiceProvisioningErrorsRequestBuilder instantiates a new ServiceProvisioningErrorsRequestBuilder and sets the default values.
func NewPrivilegedAccessGroupEligibilitySchedulesItemGroupServiceProvisioningErrorsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedAccessGroupEligibilitySchedulesItemGroupServiceProvisioningErrorsRequestBuilder) {
    ...
    return NewPrivilegedAccessGroupEligibilitySchedulesItemGroupServiceProvisioningErrorsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *PrivilegedAccessGroupEligibilitySchedulesItemGroupServiceProvisioningErrorsRequestBuilder) Count()(*PrivilegedAccessGroupEligibilitySchedulesItemGroupServiceProvisioningErrorsCountRequestBuilder) {
...
func (m *PrivilegedAccessGroupEligibilitySchedulesItemGroupServiceProvisioningErrorsRequestBuilder) WithUrl(rawUrl string)(*PrivilegedAccessGroupEligibilitySchedulesItemGroupServiceProvisioningErrorsRequestBuilder) {
    return NewPrivilegedAccessGroupEligibilitySchedulesItemGroupServiceProvisioningErrorsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
