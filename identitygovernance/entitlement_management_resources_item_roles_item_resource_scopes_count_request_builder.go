...
func (m *EntitlementManagementResourcesItemRolesItemResourceScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourcesItemRolesItemResourceScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
