...
func (m *EntitlementmanagementAccesspackagesItemAssignmentpoliciesItemQuestionsCountRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementAccesspackagesItemAssignmentpoliciesItemQuestionsCountRequestBuilder) {
    return NewEntitlementmanagementAccesspackagesItemAssignmentpoliciesItemQuestionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
