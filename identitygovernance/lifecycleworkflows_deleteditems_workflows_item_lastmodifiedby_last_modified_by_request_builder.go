...
// LifecycleworkflowsDeleteditemsWorkflowsItemLastmodifiedbyLastModifiedByRequestBuilderGetQueryParameters the unique identifier of the Microsoft Entra identity that last modified the workflow.
