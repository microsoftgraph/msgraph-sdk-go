...
// PrivilegedAccessGroupAssignmentScheduleRequestsRequestBuilderGetQueryParameters the schedule requests for operations to create, update, delete, extend, and renew an assignment.
