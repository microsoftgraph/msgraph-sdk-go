...
// Builds and executes requests for operations under \identityGovernance\termsOfUse\agreements\{agreement-id}
...
func NewAgreementRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AgreementRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/identityGovernance/termsOfUse/agreements/{agreement_id}{?select,expand}";
