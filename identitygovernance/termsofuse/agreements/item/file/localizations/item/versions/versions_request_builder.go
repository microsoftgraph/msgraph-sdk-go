...
import (
    ...
    i739b7b2f0fb6c19b13372586ec087603d08ee170a6d78879679fa9beee2c8dcc "github.com/microsoftgraph/msgraph-sdk-go/identitygovernance/termsofuse/agreements/item/file/localizations/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement_id}/file/localizations/{agreementFileLocalization_id}/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*i739b7b2f0fb6c19b13372586ec087603d08ee170a6d78879679fa9beee2c8dcc.CountRequestBuilder) {
    return i739b7b2f0fb6c19b13372586ec087603d08ee170a6d78879679fa9beee2c8dcc.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
