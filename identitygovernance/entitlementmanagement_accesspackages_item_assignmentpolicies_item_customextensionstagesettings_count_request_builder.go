...
func NewEntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilder) {
    m := &EntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilder{
...
func NewEntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilder) {
    ...
    return NewEntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *EntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilder) {
    return NewEntitlementmanagementAccesspackagesItemAssignmentpoliciesItemCustomextensionstagesettingsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
