...
// returns a *EntitlementManagementResourceRequestsItemCatalogResourcesItemExternalOriginResourceConnectorRequestBuilder when successful
func (m *EntitlementManagementResourceRequestsItemCatalogResourcesAccessPackageResourceItemRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementResourceRequestsItemCatalogResourcesItemExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementResourceRequestsItemCatalogResourcesItemExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *EntitlementManagementResourceRequestsItemCatalogResourcesItemRefreshRequestBuilder when successful
func (m *EntitlementManagementResourceRequestsItemCatalogResourcesAccessPackageResourceItemRequestBuilder) Refresh()(*EntitlementManagementResourceRequestsItemCatalogResourcesItemRefreshRequestBuilder) {
    return NewEntitlementManagementResourceRequestsItemCatalogResourcesItemRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *EntitlementManagementResourceRequestsItemCatalogResourcesAccessPackageResourceItemRequestBuilder) UploadSessions()(*EntitlementManagementResourceRequestsItemCatalogResourcesItemUploadSessionsRequestBuilder) {
    return NewEntitlementManagementResourceRequestsItemCatalogResourcesItemUploadSessionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
