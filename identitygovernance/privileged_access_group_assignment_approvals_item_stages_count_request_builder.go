...
func (m *PrivilegedAccessGroupAssignmentApprovalsItemStagesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivilegedAccessGroupAssignmentApprovalsItemStagesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
