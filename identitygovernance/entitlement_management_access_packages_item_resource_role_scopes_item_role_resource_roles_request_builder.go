...
func (m *EntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceRolesRequestBuilder) ByAccessPackageResourceRoleIdString(accessPackageResourceRoleId string)(*EntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceRolesAccessPackageResourceRoleItemRequestBuilder) {
...
// NewEntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceRolesRequestBuilderInternal instantiates a new RolesRequestBuilder and sets the default values.
...
// NewEntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceRolesRequestBuilder instantiates a new RolesRequestBuilder and sets the default values.
