...
func NewEntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilder) {
    m := &EntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilder{
...
func NewEntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilder) {
    ...
    return NewEntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *EntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilder) {
    return NewEntitlementmanagementResourcerequestsItemCatalogResourcesItemScopesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
