...
func (m *EntitlementManagementResourceRoleScopesItemScopeResourceScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRoleScopesItemScopeResourceScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
