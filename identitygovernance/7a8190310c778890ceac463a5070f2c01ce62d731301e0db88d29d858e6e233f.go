...
func (m *EntitlementManagementResourceRequestsItemCatalogCustomWorkflowExtensionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRequestsItemCatalogCustomWorkflowExtensionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
