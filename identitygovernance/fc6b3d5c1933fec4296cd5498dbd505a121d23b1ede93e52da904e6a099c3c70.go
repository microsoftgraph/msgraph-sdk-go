...
func (m *EntitlementManagementResourceRequestsItemCatalogResourcesItemRolesItemResourceScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRequestsItemCatalogResourcesItemRolesItemResourceScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
