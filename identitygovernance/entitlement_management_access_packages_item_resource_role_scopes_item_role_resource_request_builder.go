...
func (m *EntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *EntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceRequestBuilder) UploadSessions()(*EntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceUploadSessionsRequestBuilder) {
    return NewEntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceUploadSessionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
