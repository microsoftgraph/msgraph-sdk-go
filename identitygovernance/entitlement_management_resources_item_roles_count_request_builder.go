...
func (m *EntitlementManagementResourcesItemRolesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourcesItemRolesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
