...
func (m *EntitlementManagementResourceRequestsItemCatalogResourceScopesItemResourceScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRequestsItemCatalogResourceScopesItemResourceScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
