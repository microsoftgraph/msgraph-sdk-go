...
func (m *EntitlementManagementConnectedOrganizationsItemExternalSponsorsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementConnectedOrganizationsItemExternalSponsorsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
