...
func (m *EntitlementManagementResourceRequestsItemCatalogResourcesItemRolesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRequestsItemCatalogResourcesItemRolesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
