...
// LifecycleworkflowsWorkflowsItemTaskreportsItemTaskprocessingresultsTaskProcessingResultsRequestBuilderGetQueryParameters get the task processing result resources from the taskReport.
