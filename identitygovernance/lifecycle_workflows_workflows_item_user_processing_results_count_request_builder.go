...
func (m *LifecycleWorkflowsWorkflowsItemUserProcessingResultsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *LifecycleWorkflowsWorkflowsItemUserProcessingResultsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
