...
func (m *EntitlementManagementCatalogsItemResourcesItemRolesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementCatalogsItemResourcesItemRolesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
