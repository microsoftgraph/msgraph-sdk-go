...
func (m *PrivilegedAccessGroupEligibilityScheduleInstancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivilegedAccessGroupEligibilityScheduleInstancesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
