...
func (m *TermsOfUseAgreementAcceptancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TermsOfUseAgreementAcceptancesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
