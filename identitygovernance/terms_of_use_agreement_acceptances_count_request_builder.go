...
func NewTermsOfUseAgreementAcceptancesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TermsOfUseAgreementAcceptancesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/termsOfUse/agreementAcceptances/$count";
...
func (m *TermsOfUseAgreementAcceptancesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *TermsOfUseAgreementAcceptancesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
