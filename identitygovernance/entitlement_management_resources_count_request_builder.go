...
func (m *EntitlementManagementResourcesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourcesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
