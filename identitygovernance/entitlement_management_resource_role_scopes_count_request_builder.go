...
func (m *EntitlementManagementResourceRoleScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRoleScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
