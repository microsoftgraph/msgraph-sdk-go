...
func NewEntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder) {
    m := &EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder{
...
func NewEntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder) {
    ...
    return NewEntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilderInternal(urlParams, requestAdapter)
}
// Post invoke action refresh
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder) Post(ctx context.Context, requestConfiguration *EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilderPostRequestConfiguration)(error) {
...
func (m *EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder) WithUrl(rawUrl string)(*EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder) {
    return NewEntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
