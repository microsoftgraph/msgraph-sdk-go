...
// AccessPackageRequestBuilder provides operations to manage the accessPackage property of the microsoft.graph.accessPackageAssignmentPolicy entity.
...
// AccessPackageRequestBuilderGetQueryParameters access package containing this policy. Read-only.
...
// CreateGetRequestInformationWithRequestConfiguration access package containing this policy. Read-only.
...
func (m *AccessPackageRequestBuilder) Get()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AccessPackageable, error) {
    return m.GetWithRequestConfigurationAndResponseHandler(nil, nil);
}
// GetWithRequestConfigurationAndResponseHandler access package containing this policy. Read-only.
