...
// DirectoryObjectItemRequestBuilder provides operations to manage the internalSponsors property of the microsoft.graph.connectedOrganization entity.
...
func NewDirectoryObjectItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryObjectItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/connectedOrganizations/{connectedOrganization%2Did}/internalSponsors/{directoryObject%2Did}{?%24select,%24expand}";
...
// CreateDeleteRequestInformation delete navigation property internalSponsors for identityGovernance
...
// CreateDeleteRequestInformationWithRequestConfiguration delete navigation property internalSponsors for identityGovernance
...
// CreatePatchRequestInformation update the navigation property internalSponsors in identityGovernance
...
// CreatePatchRequestInformationWithRequestConfiguration update the navigation property internalSponsors in identityGovernance
...
// Delete delete navigation property internalSponsors for identityGovernance
func (m *DirectoryObjectItemRequestBuilder) Delete()(error) {
    return m.DeleteWithRequestConfigurationAndResponseHandler(nil, nil);
}
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property internalSponsors for identityGovernance
...
// Patch update the navigation property internalSponsors in identityGovernance
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property internalSponsors in identityGovernance
