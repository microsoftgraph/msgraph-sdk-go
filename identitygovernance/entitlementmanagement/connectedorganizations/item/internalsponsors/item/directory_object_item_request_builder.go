...
// DeleteWithResponseHandler delete navigation property internalSponsors for identityGovernance
...
// PatchWithResponseHandler update the navigation property internalSponsors in identityGovernance
