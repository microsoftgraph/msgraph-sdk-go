...
// DeleteWithResponseHandler delete navigation property externalSponsors for identityGovernance
...
// PatchWithResponseHandler update the navigation property externalSponsors in identityGovernance
