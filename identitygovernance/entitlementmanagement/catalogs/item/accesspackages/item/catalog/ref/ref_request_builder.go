...
// RefRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\catalogs\{accessPackageCatalog-id}\accessPackages\{accessPackage-id}\catalog\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog_id}/accessPackages/{accessPackage_id}/catalog/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property catalog for identityGovernance
...
// CreateGetRequestInformation get ref of catalog from identityGovernance
...
// CreatePutRequestInformation update the ref of navigation property catalog in identityGovernance
...
// Delete delete ref of navigation property catalog for identityGovernance
...
// Get get ref of catalog from identityGovernance
...
// Put update the ref of navigation property catalog in identityGovernance
