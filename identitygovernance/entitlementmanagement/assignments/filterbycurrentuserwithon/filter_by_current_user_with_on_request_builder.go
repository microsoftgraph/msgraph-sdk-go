...
// FilterByCurrentUserWithOnRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\assignments\microsoft.graph.filterByCurrentUser(on={on})
