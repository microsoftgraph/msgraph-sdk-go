...
func (m *AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdResponse) SetAdditionalData(value map[string]interface{})() {
