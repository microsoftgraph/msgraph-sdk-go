...
func NewTargetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TargetRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/assignments/{accessPackageAssignment_id}/target{?select,expand}";
...
func (m *TargetRequestBuilder) Get(options *TargetRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.AccessPackageSubject, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewAccessPackageSubject() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.AccessPackageSubject), nil
}
func (m *TargetRequestBuilder) Ref()(*i90cc19fdad9e7885738058df0ae9a07e9a7db0de4f1ccbc1780070490e9cedc9.RefRequestBuilder) {
    return i90cc19fdad9e7885738058df0ae9a07e9a7db0de4f1ccbc1780070490e9cedc9.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
