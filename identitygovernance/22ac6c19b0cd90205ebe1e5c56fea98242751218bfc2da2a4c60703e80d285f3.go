...
func (m *EntitlementManagementResourceRoleScopesItemScopeResourceRolesItemResourceScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRoleScopesItemScopeResourceRolesItemResourceScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
