...
// LifecycleWorkflowsWorkflowsItemVersionsItemAdministrationScopeTargetsDirectoryObjectItemRequestBuilder provides operations to manage the administrationScopeTargets property of the microsoft.graph.identityGovernance.workflowBase entity.
...
// LifecycleWorkflowsWorkflowsItemVersionsItemAdministrationScopeTargetsDirectoryObjectItemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type LifecycleWorkflowsWorkflowsItemVersionsItemAdministrationScopeTargetsDirectoryObjectItemRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *LifecycleWorkflowsWorkflowsItemVersionsItemAdministrationScopeTargetsDirectoryObjectItemRequestBuilderGetQueryParameters
}
// NewLifecycleWorkflowsWorkflowsItemVersionsItemAdministrationScopeTargetsDirectoryObjectItemRequestBuilderInternal instantiates a new LifecycleWorkflowsWorkflowsItemVersionsItemAdministrationScopeTargetsDirectoryObjectItemRequestBuilder and sets the default values.
...
// NewLifecycleWorkflowsWorkflowsItemVersionsItemAdministrationScopeTargetsDirectoryObjectItemRequestBuilder instantiates a new LifecycleWorkflowsWorkflowsItemVersionsItemAdministrationScopeTargetsDirectoryObjectItemRequestBuilder and sets the default values.
...
func (m *LifecycleWorkflowsWorkflowsItemVersionsItemAdministrationScopeTargetsDirectoryObjectItemRequestBuilder) WithUrl(rawUrl string)(*LifecycleWorkflowsWorkflowsItemVersionsItemAdministrationScopeTargetsDirectoryObjectItemRequestBuilder) {
    return NewLifecycleWorkflowsWorkflowsItemVersionsItemAdministrationScopeTargetsDirectoryObjectItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
