...
func (m *EntitlementManagementResourceRequestsItemCatalogResourceRolesItemResourceRolesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRequestsItemCatalogResourceRolesItemResourceRolesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
