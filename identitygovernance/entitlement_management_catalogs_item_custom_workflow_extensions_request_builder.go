...
// EntitlementManagementCatalogsItemCustomWorkflowExtensionsRequestBuilderGetQueryParameters get customWorkflowExtensions from identityGovernance
...
func (m *EntitlementManagementCatalogsItemCustomWorkflowExtensionsRequestBuilder) ByCustomCalloutExtensionIdString(customCalloutExtensionId string)(*EntitlementManagementCatalogsItemCustomWorkflowExtensionsCustomCalloutExtensionItemRequestBuilder) {
...
// NewEntitlementManagementCatalogsItemCustomWorkflowExtensionsRequestBuilderInternal instantiates a new CustomWorkflowExtensionsRequestBuilder and sets the default values.
func NewEntitlementManagementCatalogsItemCustomWorkflowExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementCatalogsItemCustomWorkflowExtensionsRequestBuilder) {
    m := &EntitlementManagementCatalogsItemCustomWorkflowExtensionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/customWorkflowExtensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewEntitlementManagementCatalogsItemCustomWorkflowExtensionsRequestBuilder instantiates a new CustomWorkflowExtensionsRequestBuilder and sets the default values.
