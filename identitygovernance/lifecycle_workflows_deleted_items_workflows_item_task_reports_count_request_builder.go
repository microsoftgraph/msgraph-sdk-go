...
func (m *LifecycleWorkflowsDeletedItemsWorkflowsItemTaskReportsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *LifecycleWorkflowsDeletedItemsWorkflowsItemTaskReportsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
