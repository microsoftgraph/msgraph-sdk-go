...
// returns a *EntitlementManagementResourceRequestsItemCatalogResourceRolesItemResourceExternalOriginResourceConnectorRequestBuilder when successful
func (m *EntitlementManagementResourceRequestsItemCatalogResourceRolesItemResourceRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementResourceRequestsItemCatalogResourceRolesItemResourceExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementResourceRequestsItemCatalogResourceRolesItemResourceExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *EntitlementManagementResourceRequestsItemCatalogResourceRolesItemResourceRequestBuilder) Refresh()(*EntitlementManagementResourceRequestsItemCatalogResourceRolesItemResourceRefreshRequestBuilder) {
    return NewEntitlementManagementResourceRequestsItemCatalogResourceRolesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
