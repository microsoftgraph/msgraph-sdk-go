...
func NewEntitlementManagementAssignmentRequestsAccessPackageAssignmentRequestItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, accessPackageAssignmentRequestId *string)(*EntitlementManagementAssignmentRequestsAccessPackageAssignmentRequestItemRequestBuilder) {
...
func NewEntitlementManagementAssignmentRequestsAccessPackageAssignmentRequestItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementAssignmentRequestsAccessPackageAssignmentRequestItemRequestBuilder) {
    ...
    return NewEntitlementManagementAssignmentRequestsAccessPackageAssignmentRequestItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *EntitlementManagementAssignmentRequestsAccessPackageAssignmentRequestItemRequestBuilder) MicrosoftGraphCancel()(*EntitlementManagementAssignmentRequestsItemMicrosoftGraphCancelCancelRequestBuilder) {
    return NewEntitlementManagementAssignmentRequestsItemMicrosoftGraphCancelCancelRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphReprocess provides operations to call the reprocess method.
func (m *EntitlementManagementAssignmentRequestsAccessPackageAssignmentRequestItemRequestBuilder) MicrosoftGraphReprocess()(*EntitlementManagementAssignmentRequestsItemMicrosoftGraphReprocessReprocessRequestBuilder) {
    return NewEntitlementManagementAssignmentRequestsItemMicrosoftGraphReprocessReprocessRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
