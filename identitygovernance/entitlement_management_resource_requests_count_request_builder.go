...
func (m *EntitlementManagementResourceRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
