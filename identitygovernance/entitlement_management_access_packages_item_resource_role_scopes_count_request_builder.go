...
func (m *EntitlementManagementAccessPackagesItemResourceRoleScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementAccessPackagesItemResourceRoleScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
