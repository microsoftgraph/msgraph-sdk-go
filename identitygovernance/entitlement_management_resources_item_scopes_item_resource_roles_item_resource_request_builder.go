...
func (m *EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementResourcesItemScopesItemResourceRolesItemResourceExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRequestBuilder) UploadSessions()(*EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceUploadSessionsRequestBuilder) {
    return NewEntitlementManagementResourcesItemScopesItemResourceRolesItemResourceUploadSessionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
