...
func NewPrivilegedaccessGroupEligibilityschedulesItemGroupServiceprovisioningerrorsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedaccessGroupEligibilityschedulesItemGroupServiceprovisioningerrorsCountRequestBuilder) {
    ...
    return NewPrivilegedaccessGroupEligibilityschedulesItemGroupServiceprovisioningerrorsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *PrivilegedaccessGroupEligibilityschedulesItemGroupServiceprovisioningerrorsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivilegedaccessGroupEligibilityschedulesItemGroupServiceprovisioningerrorsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *PrivilegedaccessGroupEligibilityschedulesItemGroupServiceprovisioningerrorsCountRequestBuilder) WithUrl(rawUrl string)(*PrivilegedaccessGroupEligibilityschedulesItemGroupServiceprovisioningerrorsCountRequestBuilder) {
    return NewPrivilegedaccessGroupEligibilityschedulesItemGroupServiceprovisioningerrorsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
