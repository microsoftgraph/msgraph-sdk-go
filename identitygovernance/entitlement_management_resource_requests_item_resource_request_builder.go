...
// returns a *EntitlementManagementResourceRequestsItemResourceExternalOriginResourceConnectorRequestBuilder when successful
func (m *EntitlementManagementResourceRequestsItemResourceRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementResourceRequestsItemResourceExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementResourceRequestsItemResourceExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *EntitlementManagementResourceRequestsItemResourceRefreshRequestBuilder when successful
func (m *EntitlementManagementResourceRequestsItemResourceRequestBuilder) Refresh()(*EntitlementManagementResourceRequestsItemResourceRefreshRequestBuilder) {
    return NewEntitlementManagementResourceRequestsItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *EntitlementManagementResourceRequestsItemResourceUploadSessionsRequestBuilder when successful
func (m *EntitlementManagementResourceRequestsItemResourceRequestBuilder) UploadSessions()(*EntitlementManagementResourceRequestsItemResourceUploadSessionsRequestBuilder) {
    return NewEntitlementManagementResourceRequestsItemResourceUploadSessionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
