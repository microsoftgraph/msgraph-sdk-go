...
func NewEntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilder) {
    m := &EntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}/scope/resource/environment{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
func NewEntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilder) {
    ...
    return NewEntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *EntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AccessPackageResourceEnvironmentable, error) {
...
func (m *EntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *EntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilder when successful
func (m *EntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilder) {
    return NewEntitlementmanagementResourcerolescopesItemScopeResourceEnvironmentRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
