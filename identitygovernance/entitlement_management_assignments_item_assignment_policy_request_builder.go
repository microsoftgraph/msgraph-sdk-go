...
func (m *EntitlementManagementAssignmentsItemAssignmentPolicyRequestBuilder) WithUrl(rawUrl string)(*EntitlementManagementAssignmentsItemAssignmentPolicyRequestBuilder) {
    return NewEntitlementManagementAssignmentsItemAssignmentPolicyRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
