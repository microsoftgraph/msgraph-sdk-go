...
func (m *EntitlementManagementResourceRoleScopesItemRoleResourceRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementResourceRoleScopesItemRoleResourceExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementResourceRoleScopesItemRoleResourceExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *EntitlementManagementResourceRoleScopesItemRoleResourceRefreshRequestBuilder when successful
func (m *EntitlementManagementResourceRoleScopesItemRoleResourceRequestBuilder) Refresh()(*EntitlementManagementResourceRoleScopesItemRoleResourceRefreshRequestBuilder) {
    return NewEntitlementManagementResourceRoleScopesItemRoleResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *EntitlementManagementResourceRoleScopesItemRoleResourceRequestBuilder) UploadSessions()(*EntitlementManagementResourceRoleScopesItemRoleResourceUploadSessionsRequestBuilder) {
    return NewEntitlementManagementResourceRoleScopesItemRoleResourceUploadSessionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
