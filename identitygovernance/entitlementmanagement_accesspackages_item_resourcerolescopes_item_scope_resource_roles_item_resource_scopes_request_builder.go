...
// returns a *EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesAccessPackageResourceScopeItemRequestBuilder when successful
func (m *EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder) ByAccessPackageResourceScopeId(accessPackageResourceScopeId string)(*EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesAccessPackageResourceScopeItemRequestBuilder) {
    ...
    return NewEntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesAccessPackageResourceScopeItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
...
func NewEntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder) {
    m := &EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder{
...
func NewEntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder) {
    ...
    return NewEntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder) Count()(*EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesCountRequestBuilder) {
    return NewEntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// Get read-only. Nullable. Supports $expand.
// returns a AccessPackageResourceScopeCollectionResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AccessPackageResourceScopeCollectionResponseable, error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AccessPackageResourceScopeable, requestConfiguration *EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AccessPackageResourceScopeable, error) {
...
func (m *EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder) {
    return NewEntitlementmanagementAccesspackagesItemResourcerolescopesItemScopeResourceRolesItemResourceScopesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
