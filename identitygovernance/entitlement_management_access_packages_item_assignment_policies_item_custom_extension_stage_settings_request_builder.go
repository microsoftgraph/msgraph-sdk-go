...
// EntitlementManagementAccessPackagesItemAssignmentPoliciesItemCustomExtensionStageSettingsRequestBuilderGetQueryParameters get customExtensionStageSettings from identityGovernance
