...
func (m *AppConsentAppConsentRequestsItemUserConsentRequestsItemApprovalStagesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AppConsentAppConsentRequestsItemUserConsentRequestsItemApprovalStagesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
