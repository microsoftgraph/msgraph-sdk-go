...
func (m *LifecycleworkflowsCustomtaskextensionsCustomTaskExtensionItemRequestBuilder) CreatedBy()(*LifecycleworkflowsCustomtaskextensionsItemCreatedbyCreatedByRequestBuilder) {
    return NewLifecycleworkflowsCustomtaskextensionsItemCreatedbyCreatedByRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *LifecycleworkflowsCustomtaskextensionsCustomTaskExtensionItemRequestBuilder) LastModifiedBy()(*LifecycleworkflowsCustomtaskextensionsItemLastmodifiedbyLastModifiedByRequestBuilder) {
    return NewLifecycleworkflowsCustomtaskextensionsItemLastmodifiedbyLastModifiedByRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
