...
func (m *EntitlementManagementAccessPackagesItemResourceRoleScopesItemScopeResourceRolesRequestBuilder) ByAccessPackageResourceRoleIdString(accessPackageResourceRoleId string)(*EntitlementManagementAccessPackagesItemResourceRoleScopesItemScopeResourceRolesAccessPackageResourceRoleItemRequestBuilder) {
...
// NewEntitlementManagementAccessPackagesItemResourceRoleScopesItemScopeResourceRolesRequestBuilderInternal instantiates a new RolesRequestBuilder and sets the default values.
...
// NewEntitlementManagementAccessPackagesItemResourceRoleScopesItemScopeResourceRolesRequestBuilder instantiates a new RolesRequestBuilder and sets the default values.
