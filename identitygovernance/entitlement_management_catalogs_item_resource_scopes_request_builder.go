...
func (m *EntitlementManagementCatalogsItemResourceScopesRequestBuilder) ByAccessPackageResourceScopeIdString(accessPackageResourceScopeId string)(*EntitlementManagementCatalogsItemResourceScopesAccessPackageResourceScopeItemRequestBuilder) {
...
// NewEntitlementManagementCatalogsItemResourceScopesRequestBuilderInternal instantiates a new ResourceScopesRequestBuilder and sets the default values.
...
// NewEntitlementManagementCatalogsItemResourceScopesRequestBuilder instantiates a new ResourceScopesRequestBuilder and sets the default values.
