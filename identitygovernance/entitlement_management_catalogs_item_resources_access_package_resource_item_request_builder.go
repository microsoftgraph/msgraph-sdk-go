...
func (m *EntitlementManagementCatalogsItemResourcesAccessPackageResourceItemRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementCatalogsItemResourcesItemExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementCatalogsItemResourcesItemExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *EntitlementManagementCatalogsItemResourcesAccessPackageResourceItemRequestBuilder) Refresh()(*EntitlementManagementCatalogsItemResourcesItemRefreshRequestBuilder) {
    return NewEntitlementManagementCatalogsItemResourcesItemRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *EntitlementManagementCatalogsItemResourcesAccessPackageResourceItemRequestBuilder) UploadSessions()(*EntitlementManagementCatalogsItemResourcesItemUploadSessionsRequestBuilder) {
    return NewEntitlementManagementCatalogsItemResourcesItemUploadSessionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
