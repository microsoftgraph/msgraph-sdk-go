...
// returns a *EntitlementManagementResourcesItemRolesItemResourceExternalOriginResourceConnectorRequestBuilder when successful
func (m *EntitlementManagementResourcesItemRolesItemResourceRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementResourcesItemRolesItemResourceExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementResourcesItemRolesItemResourceExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *EntitlementManagementResourcesItemRolesItemResourceRefreshRequestBuilder when successful
func (m *EntitlementManagementResourcesItemRolesItemResourceRequestBuilder) Refresh()(*EntitlementManagementResourcesItemRolesItemResourceRefreshRequestBuilder) {
    return NewEntitlementManagementResourcesItemRolesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *EntitlementManagementResourcesItemRolesItemResourceRequestBuilder) UploadSessions()(*EntitlementManagementResourcesItemRolesItemResourceUploadSessionsRequestBuilder) {
    return NewEntitlementManagementResourcesItemRolesItemResourceUploadSessionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
