...
func (m *EntitlementManagementResourceRoleScopesItemRoleResourceScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRoleScopesItemRoleResourceScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
