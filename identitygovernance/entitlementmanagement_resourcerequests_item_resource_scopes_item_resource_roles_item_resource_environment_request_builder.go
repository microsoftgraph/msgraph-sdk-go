...
func NewEntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilder) {
    m := &EntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilder{
...
func NewEntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilder) {
    ...
    return NewEntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *EntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AccessPackageResourceEnvironmentable, error) {
...
func (m *EntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *EntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilder when successful
func (m *EntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilder) {
    return NewEntitlementmanagementResourcerequestsItemResourceScopesItemResourceRolesItemResourceEnvironmentRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
