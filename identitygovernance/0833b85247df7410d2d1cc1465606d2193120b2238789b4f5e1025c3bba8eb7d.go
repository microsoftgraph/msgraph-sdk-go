...
func (m *EntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceRolesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceRolesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
