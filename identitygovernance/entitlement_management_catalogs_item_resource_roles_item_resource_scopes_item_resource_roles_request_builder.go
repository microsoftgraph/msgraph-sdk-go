...
func (m *EntitlementManagementCatalogsItemResourceRolesItemResourceScopesItemResourceRolesRequestBuilder) ByAccessPackageResourceRoleId1String(accessPackageResourceRoleId1 string)(*EntitlementManagementCatalogsItemResourceRolesItemResourceScopesItemResourceRolesAccessPackageResourceRoleItemRequestBuilder) {
...
// NewEntitlementManagementCatalogsItemResourceRolesItemResourceScopesItemResourceRolesRequestBuilderInternal instantiates a new RolesRequestBuilder and sets the default values.
...
// NewEntitlementManagementCatalogsItemResourceRolesItemResourceScopesItemResourceRolesRequestBuilder instantiates a new RolesRequestBuilder and sets the default values.
