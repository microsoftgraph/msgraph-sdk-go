...
func (m *EntitlementManagementResourceEnvironmentsItemResourcesItemScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceEnvironmentsItemResourcesItemScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
