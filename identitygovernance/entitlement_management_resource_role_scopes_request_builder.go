...
// ByAccessPackageResourceRoleScopeIdString provides operations to manage the resourceRoleScopes property of the microsoft.graph.entitlementManagement entity.
func (m *EntitlementManagementResourceRoleScopesRequestBuilder) ByAccessPackageResourceRoleScopeIdString(accessPackageResourceRoleScopeId string)(*EntitlementManagementResourceRoleScopesAccessPackageResourceRoleScopeItemRequestBuilder) {
...
// NewEntitlementManagementResourceRoleScopesRequestBuilderInternal instantiates a new ResourceRoleScopesRequestBuilder and sets the default values.
func NewEntitlementManagementResourceRoleScopesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementResourceRoleScopesRequestBuilder) {
    m := &EntitlementManagementResourceRoleScopesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewEntitlementManagementResourceRoleScopesRequestBuilder instantiates a new ResourceRoleScopesRequestBuilder and sets the default values.
