...
func (m *EntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementAccessPackagesItemResourceRoleScopesItemRoleResourceScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
