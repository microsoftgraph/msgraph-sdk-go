...
func (m *EntitlementmanagementResourcerolescopesItemRoleResourceScopesRequestBuilder) ByAccessPackageResourceScopeId(accessPackageResourceScopeId string)(*EntitlementmanagementResourcerolescopesItemRoleResourceScopesAccessPackageResourceScopeItemRequestBuilder) {
...
func (m *EntitlementmanagementResourcerolescopesItemRoleResourceScopesRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementResourcerolescopesItemRoleResourceScopesRequestBuilder) {
    return NewEntitlementmanagementResourcerolescopesItemRoleResourceScopesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
