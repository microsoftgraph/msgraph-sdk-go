...
func NewLifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilder) {
    m := &LifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/executionScope/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewLifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilder) {
    ...
    return NewLifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *LifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilder) Get(ctx context.Context, requestConfiguration *LifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *LifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *LifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *LifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilder) WithUrl(rawUrl string)(*LifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilder) {
    return NewLifecycleworkflowsWorkflowsItemExecutionscopeCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
