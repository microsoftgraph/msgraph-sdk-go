...
// TermsOfUseAgreementsItemFilesItemVersionsRequestBuilderGetQueryParameters read-only. Customized versions of the terms of use agreement in the Azure AD tenant.
...
// NewTermsOfUseAgreementsItemFilesItemVersionsRequestBuilder instantiates a new VersionsRequestBuilder and sets the default values.
...
func (m *TermsOfUseAgreementsItemFilesItemVersionsRequestBuilder) Count()(*TermsOfUseAgreementsItemFilesItemVersionsCountRequestBuilder) {
    return NewTermsOfUseAgreementsItemFilesItemVersionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation read-only. Customized versions of the terms of use agreement in the Azure AD tenant.
func (m *TermsOfUseAgreementsItemFilesItemVersionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *TermsOfUseAgreementsItemFilesItemVersionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
