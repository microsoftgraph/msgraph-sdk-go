...
func NewEntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilder) {
    m := &EntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilder{
...
func NewEntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilder) {
    ...
    return NewEntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilderInternal(urlParams, requestAdapter)
}
// Post invoke action refresh
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilder) Post(ctx context.Context, requestConfiguration *EntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilderPostRequestConfiguration)(error) {
...
func (m *EntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *EntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilder) WithUrl(rawUrl string)(*EntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilder) {
    return NewEntitlementManagementCatalogsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
