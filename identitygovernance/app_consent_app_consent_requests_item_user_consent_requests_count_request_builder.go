...
func (m *AppConsentAppConsentRequestsItemUserConsentRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AppConsentAppConsentRequestsItemUserConsentRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
