...
// returns a *EntitlementManagementResourcesItemRolesItemResourceScopesItemResourceExternalOriginResourceConnectorRequestBuilder when successful
func (m *EntitlementManagementResourcesItemRolesItemResourceScopesItemResourceRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementResourcesItemRolesItemResourceScopesItemResourceExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementResourcesItemRolesItemResourceScopesItemResourceExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *EntitlementManagementResourcesItemRolesItemResourceScopesItemResourceUploadSessionsRequestBuilder when successful
func (m *EntitlementManagementResourcesItemRolesItemResourceScopesItemResourceRequestBuilder) UploadSessions()(*EntitlementManagementResourcesItemRolesItemResourceScopesItemResourceUploadSessionsRequestBuilder) {
    return NewEntitlementManagementResourcesItemRolesItemResourceScopesItemResourceUploadSessionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
