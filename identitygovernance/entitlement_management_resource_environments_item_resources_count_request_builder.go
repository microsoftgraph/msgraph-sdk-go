...
func (m *EntitlementManagementResourceEnvironmentsItemResourcesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceEnvironmentsItemResourcesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
