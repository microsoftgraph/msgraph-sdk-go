...
// EntitlementManagementAssignmentPoliciesItemCustomExtensionStageSettingsRequestBuilderGetQueryParameters get customExtensionStageSettings from identityGovernance
