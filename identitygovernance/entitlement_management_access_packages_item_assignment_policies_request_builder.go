...
// ByAccessPackageAssignmentPolicyIdString provides operations to manage the assignmentPolicies property of the microsoft.graph.accessPackage entity.
func (m *EntitlementManagementAccessPackagesItemAssignmentPoliciesRequestBuilder) ByAccessPackageAssignmentPolicyIdString(accessPackageAssignmentPolicyId string)(*EntitlementManagementAccessPackagesItemAssignmentPoliciesAccessPackageAssignmentPolicyItemRequestBuilder) {
