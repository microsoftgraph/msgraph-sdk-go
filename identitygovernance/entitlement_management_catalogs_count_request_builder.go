...
func (m *EntitlementManagementCatalogsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementCatalogsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
