...
// EntitlementManagementCatalogsItemAccessPackagesItemAssignmentPoliciesItemQuestionsRequestBuilderGetQueryParameters questions that are posed to the  requestor.
...
func (m *EntitlementManagementCatalogsItemAccessPackagesItemAssignmentPoliciesItemQuestionsRequestBuilder) ByAccessPackageQuestionId(accessPackageQuestionId string)(*EntitlementManagementCatalogsItemAccessPackagesItemAssignmentPoliciesItemQuestionsAccessPackageQuestionItemRequestBuilder) {
...
func (m *EntitlementManagementCatalogsItemAccessPackagesItemAssignmentPoliciesItemQuestionsRequestBuilder) Count()(*EntitlementManagementCatalogsItemAccessPackagesItemAssignmentPoliciesItemQuestionsCountRequestBuilder) {
    return NewEntitlementManagementCatalogsItemAccessPackagesItemAssignmentPoliciesItemQuestionsCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
