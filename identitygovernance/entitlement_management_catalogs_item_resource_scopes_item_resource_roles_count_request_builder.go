...
func (m *EntitlementManagementCatalogsItemResourceScopesItemResourceRolesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementCatalogsItemResourceScopesItemResourceRolesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
