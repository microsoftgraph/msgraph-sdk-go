...
func (m *EntitlementManagementResourceRequestsItemCatalogResourcesItemScopesItemResourceRolesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRequestsItemCatalogResourcesItemScopesItemResourceRolesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
