...
// returns a *EntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceExternalOriginResourceConnectorRequestBuilder when successful
func (m *EntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *EntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilder when successful
func (m *EntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceRequestBuilder) Refresh()(*EntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilder) {
    return NewEntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *EntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceUploadSessionsRequestBuilder when successful
func (m *EntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceRequestBuilder) UploadSessions()(*EntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceUploadSessionsRequestBuilder) {
    return NewEntitlementManagementResourceEnvironmentsItemResourcesItemRolesItemResourceScopesItemResourceUploadSessionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
