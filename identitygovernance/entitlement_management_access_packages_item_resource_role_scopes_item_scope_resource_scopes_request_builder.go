...
func (m *EntitlementManagementAccessPackagesItemResourceRoleScopesItemScopeResourceScopesRequestBuilder) ByAccessPackageResourceScopeIdString(accessPackageResourceScopeId string)(*EntitlementManagementAccessPackagesItemResourceRoleScopesItemScopeResourceScopesAccessPackageResourceScopeItemRequestBuilder) {
...
// NewEntitlementManagementAccessPackagesItemResourceRoleScopesItemScopeResourceScopesRequestBuilderInternal instantiates a new ScopesRequestBuilder and sets the default values.
...
// NewEntitlementManagementAccessPackagesItemResourceRoleScopesItemScopeResourceScopesRequestBuilder instantiates a new ScopesRequestBuilder and sets the default values.
