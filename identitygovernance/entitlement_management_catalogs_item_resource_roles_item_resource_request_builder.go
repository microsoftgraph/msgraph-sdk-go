...
// returns a *EntitlementManagementCatalogsItemResourceRolesItemResourceExternalOriginResourceConnectorRequestBuilder when successful
func (m *EntitlementManagementCatalogsItemResourceRolesItemResourceRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementCatalogsItemResourceRolesItemResourceExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementCatalogsItemResourceRolesItemResourceExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *EntitlementManagementCatalogsItemResourceRolesItemResourceRefreshRequestBuilder when successful
func (m *EntitlementManagementCatalogsItemResourceRolesItemResourceRequestBuilder) Refresh()(*EntitlementManagementCatalogsItemResourceRolesItemResourceRefreshRequestBuilder) {
    return NewEntitlementManagementCatalogsItemResourceRolesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *EntitlementManagementCatalogsItemResourceRolesItemResourceRequestBuilder) UploadSessions()(*EntitlementManagementCatalogsItemResourceRolesItemResourceUploadSessionsRequestBuilder) {
    return NewEntitlementManagementCatalogsItemResourceRolesItemResourceUploadSessionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
