...
func (m *EntitlementManagementCatalogsItemResourcesItemRolesItemResourceRequestBuilder) ExternalOriginResourceConnector()(*EntitlementManagementCatalogsItemResourcesItemRolesItemResourceExternalOriginResourceConnectorRequestBuilder) {
    return NewEntitlementManagementCatalogsItemResourcesItemRolesItemResourceExternalOriginResourceConnectorRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *EntitlementManagementCatalogsItemResourcesItemRolesItemResourceRefreshRequestBuilder when successful
func (m *EntitlementManagementCatalogsItemResourcesItemRolesItemResourceRequestBuilder) Refresh()(*EntitlementManagementCatalogsItemResourcesItemRolesItemResourceRefreshRequestBuilder) {
    return NewEntitlementManagementCatalogsItemResourcesItemRolesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *EntitlementManagementCatalogsItemResourcesItemRolesItemResourceUploadSessionsRequestBuilder when successful
func (m *EntitlementManagementCatalogsItemResourcesItemRolesItemResourceRequestBuilder) UploadSessions()(*EntitlementManagementCatalogsItemResourcesItemRolesItemResourceUploadSessionsRequestBuilder) {
    return NewEntitlementManagementCatalogsItemResourcesItemRolesItemResourceUploadSessionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
