...
func NewLifecycleworkflowsWorkflowsItemLastmodifiedbyServiceprovisioningerrorsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LifecycleworkflowsWorkflowsItemLastmodifiedbyServiceprovisioningerrorsCountRequestBuilder) {
    m := &LifecycleworkflowsWorkflowsItemLastmodifiedbyServiceprovisioningerrorsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/lastModifiedBy/serviceProvisioningErrors/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewLifecycleworkflowsWorkflowsItemLastmodifiedbyServiceprovisioningerrorsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LifecycleworkflowsWorkflowsItemLastmodifiedbyServiceprovisioningerrorsCountRequestBuilder) {
    ...
    return NewLifecycleworkflowsWorkflowsItemLastmodifiedbyServiceprovisioningerrorsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *LifecycleworkflowsWorkflowsItemLastmodifiedbyServiceprovisioningerrorsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *LifecycleworkflowsWorkflowsItemLastmodifiedbyServiceprovisioningerrorsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *LifecycleworkflowsWorkflowsItemLastmodifiedbyServiceprovisioningerrorsCountRequestBuilder) WithUrl(rawUrl string)(*LifecycleworkflowsWorkflowsItemLastmodifiedbyServiceprovisioningerrorsCountRequestBuilder) {
    return NewLifecycleworkflowsWorkflowsItemLastmodifiedbyServiceprovisioningerrorsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
