...
type HistoryDefinitionsRequestBuilderGetOptions struct {
    ...
    Q *HistoryDefinitionsRequestBuilderGetQueryParameters;
...
func NewHistoryDefinitionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HistoryDefinitionsRequestBuilder) {
    m := &HistoryDefinitionsRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/identityGovernance/accessReviews/historyDefinitions{?top,skip,search,filter,count,orderby,select,expand}";
...
func NewHistoryDefinitionsRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HistoryDefinitionsRequestBuilder) {
...
func (m *HistoryDefinitionsRequestBuilder) Get(options *HistoryDefinitionsRequestBuilderGetOptions)(*HistoryDefinitionsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewHistoryDefinitionsResponse() }, nil)
    if err != nil {
        return nil, err
    }
