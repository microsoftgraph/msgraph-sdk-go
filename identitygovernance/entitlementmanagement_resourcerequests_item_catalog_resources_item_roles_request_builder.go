...
func (m *EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder) ByAccessPackageResourceRoleId(accessPackageResourceRoleId string)(*EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesAccessPackageResourceRoleItemRequestBuilder) {
    ...
    return NewEntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesAccessPackageResourceRoleItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
...
func NewEntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder) {
    m := &EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder{
...
func NewEntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder) {
    ...
    return NewEntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder) Count()(*EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesCountRequestBuilder) {
    return NewEntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// Get read-only. Nullable. Supports $expand.
// returns a AccessPackageResourceRoleCollectionResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AccessPackageResourceRoleCollectionResponseable, error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AccessPackageResourceRoleable, requestConfiguration *EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AccessPackageResourceRoleable, error) {
...
func (m *EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder) {
    return NewEntitlementmanagementResourcerequestsItemCatalogResourcesItemRolesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
