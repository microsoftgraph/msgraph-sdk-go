...
func (m *EntitlementManagementCatalogsItemResourceRolesItemResourceRolesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementCatalogsItemResourceRolesItemResourceRolesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
