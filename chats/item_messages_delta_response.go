...
// ItemMessagesDeltaResponse provides operations to call the delta method.
...
func (m *ItemMessagesDeltaResponse) GetValue()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ChatMessageable) {
    return m.value
}
...
func (m *ItemMessagesDeltaResponse) SetValue(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ChatMessageable)() {
    m.value = value
}
