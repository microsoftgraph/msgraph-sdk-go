...
func (m *ItemPinnedMessagesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemPinnedMessagesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
