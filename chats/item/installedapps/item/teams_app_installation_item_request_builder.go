...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property installedApps for chats
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property installedApps in chats
