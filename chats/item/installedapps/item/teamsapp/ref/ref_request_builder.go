...
// RefRequestBuilder builds and executes requests for operations under \chats\{chat-id}\installedApps\{teamsAppInstallation-id}\teamsApp\$ref
...
// CreateDeleteRequestInformation the app that is installed.
...
// CreatePutRequestInformation the app that is installed.
