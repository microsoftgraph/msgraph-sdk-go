...
// TeamsTabItemRequestBuilder builds and executes requests for operations under \chats\{chat-id}\tabs\{teamsTab-id}
...
// CreateDeleteRequestInformation a collection of all the tabs in the chat. Nullable.
...
// CreatePatchRequestInformation a collection of all the tabs in the chat. Nullable.
...
// Delete a collection of all the tabs in the chat. Nullable.
...
// Patch a collection of all the tabs in the chat. Nullable.
