...
import (
    ...
    ic9bd594b497a6f6ca7899d1364170e183d77b299e45e6aeae1bcba3c1d81f930 "github.com/microsoftgraph/msgraph-sdk-go/chats/item/messages/item/replies/item/hostedcontents/count"
)
...
func NewHostedContentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HostedContentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/chats/{chat_id}/messages/{chatMessage_id}/replies/{chatMessage_id1}/hostedContents{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *HostedContentsRequestBuilder) Count()(*ic9bd594b497a6f6ca7899d1364170e183d77b299e45e6aeae1bcba3c1d81f930.CountRequestBuilder) {
    return ic9bd594b497a6f6ca7899d1364170e183d77b299e45e6aeae1bcba3c1d81f930.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
