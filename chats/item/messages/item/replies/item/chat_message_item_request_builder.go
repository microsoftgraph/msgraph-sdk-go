...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property replies for chats
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property replies in chats
