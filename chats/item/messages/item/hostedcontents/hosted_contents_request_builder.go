...
import (
    ...
    id5247658c88924368ba6b6a053061635e88b4e128740b8cf75ce409d41246a10 "github.com/microsoftgraph/msgraph-sdk-go/chats/item/messages/item/hostedcontents/count"
)
...
func NewHostedContentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HostedContentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/chats/{chat_id}/messages/{chatMessage_id}/hostedContents{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *HostedContentsRequestBuilder) Count()(*id5247658c88924368ba6b6a053061635e88b4e128740b8cf75ce409d41246a10.CountRequestBuilder) {
    return id5247658c88924368ba6b6a053061635e88b4e128740b8cf75ce409d41246a10.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
