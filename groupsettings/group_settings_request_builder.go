...
// GetWithRequestConfigurationAndResponseHandler get entities from groupSettings
...
// PostWithRequestConfigurationAndResponseHandler add new entity to groupSettings
