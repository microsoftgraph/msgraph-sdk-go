...
func NewItemDirectReportsOrgContactRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDirectReportsOrgContactRequestBuilder) {
    m := &ItemDirectReportsOrgContactRequestBuilder{
    }
...
func NewItemDirectReportsOrgContactRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDirectReportsOrgContactRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemDirectReportsOrgContactRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ItemDirectReportsOrgContactRequestBuilder) Count()(*ItemDirectReportsOrgContactCountRequestBuilder) {
    return NewItemDirectReportsOrgContactCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemDirectReportsOrgContactRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemDirectReportsOrgContactRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemDirectReportsOrgContactRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDirectReportsOrgContactRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.OrgContactCollectionResponseable, error) {
