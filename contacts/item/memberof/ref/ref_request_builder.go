...
// refRequestBuilder builds and executes requests for operations under \contacts\{orgContact-id}\memberOf\$ref
...
// refRequestBuilderGetQueryParameters groups that this contact is a member of. Read-only. Nullable. Supports $expand.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/contacts/{orgContact_id}/memberOf/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation groups that this contact is a member of. Read-only. Nullable. Supports $expand.
...
// Post groups that this contact is a member of. Read-only. Nullable. Supports $expand.
