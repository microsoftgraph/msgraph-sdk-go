...
// RefRequestBuilder builds and executes requests for operations under \contacts\{orgContact-id}\manager\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/contacts/{orgContact_id}/manager/$ref";
...
// CreateDeleteRequestInformation the user or contact that is this contact's manager. Read-only. Supports $expand.
...
// CreatePutRequestInformation the user or contact that is this contact's manager. Read-only. Supports $expand.
...
// Delete the user or contact that is this contact's manager. Read-only. Supports $expand.
...
// Put the user or contact that is this contact's manager. Read-only. Supports $expand.
