...
func (m *EntitlementManagementRoleAssignmentSchedulesRequestBuilder) ByUnifiedRoleAssignmentScheduleIdString(unifiedRoleAssignmentScheduleId string)(*EntitlementManagementRoleAssignmentSchedulesUnifiedRoleAssignmentScheduleItemRequestBuilder) {
