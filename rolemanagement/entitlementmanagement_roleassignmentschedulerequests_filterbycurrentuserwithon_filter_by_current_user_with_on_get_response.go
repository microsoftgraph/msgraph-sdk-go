...
func NewEntitlementmanagementRoleassignmentschedulerequestsFilterbycurrentuserwithonFilterByCurrentUserWithOnGetResponse()(*EntitlementmanagementRoleassignmentschedulerequestsFilterbycurrentuserwithonFilterByCurrentUserWithOnGetResponse) {
    m := &EntitlementmanagementRoleassignmentschedulerequestsFilterbycurrentuserwithonFilterByCurrentUserWithOnGetResponse{
        BaseCollectionPaginationCountResponse: *iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.NewBaseCollectionPaginationCountResponse(),
    }
    return m
}
// CreateEntitlementmanagementRoleassignmentschedulerequestsFilterbycurrentuserwithonFilterByCurrentUserWithOnGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateEntitlementmanagementRoleassignmentschedulerequestsFilterbycurrentuserwithonFilterByCurrentUserWithOnGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewEntitlementmanagementRoleassignmentschedulerequestsFilterbycurrentuserwithonFilterByCurrentUserWithOnGetResponse(), nil
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *EntitlementmanagementRoleassignmentschedulerequestsFilterbycurrentuserwithonFilterByCurrentUserWithOnGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *EntitlementmanagementRoleassignmentschedulerequestsFilterbycurrentuserwithonFilterByCurrentUserWithOnGetResponse) GetValue()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UnifiedRoleAssignmentScheduleRequestable) {
...
func (m *EntitlementmanagementRoleassignmentschedulerequestsFilterbycurrentuserwithonFilterByCurrentUserWithOnGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *EntitlementmanagementRoleassignmentschedulerequestsFilterbycurrentuserwithonFilterByCurrentUserWithOnGetResponse) SetValue(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UnifiedRoleAssignmentScheduleRequestable)() {
    err := m.GetBackingStore().Set("value", value)
    if err != nil {
        panic(err)
    }
}
type EntitlementmanagementRoleassignmentschedulerequestsFilterbycurrentuserwithonFilterByCurrentUserWithOnGetResponseable interface {
