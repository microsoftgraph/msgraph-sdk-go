...
func (m *EntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementRoleEligibilitySchedulesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
