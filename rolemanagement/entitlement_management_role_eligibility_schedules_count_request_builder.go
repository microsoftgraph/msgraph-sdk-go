...
func NewEntitlementManagementRoleEligibilitySchedulesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) {
    m := &EntitlementManagementRoleEligibilitySchedulesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/roleEligibilitySchedules/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
...
func NewEntitlementManagementRoleEligibilitySchedulesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) {
    ...
    return NewEntitlementManagementRoleEligibilitySchedulesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *EntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementRoleEligibilitySchedulesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *EntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementManagementRoleEligibilitySchedulesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) WithUrl(rawUrl string)(*EntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) {
    return NewEntitlementManagementRoleEligibilitySchedulesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
