...
func NewRoleManagementDirectoryRoleEligibilityScheduleRequestsItemCancelRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementDirectoryRoleEligibilityScheduleRequestsItemCancelRequestBuilder) {
    m := &RoleManagementDirectoryRoleEligibilityScheduleRequestsItemCancelRequestBuilder{
    }
...
func NewRoleManagementDirectoryRoleEligibilityScheduleRequestsItemCancelRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementDirectoryRoleEligibilityScheduleRequestsItemCancelRequestBuilder) {
    ...
    return NewRoleManagementDirectoryRoleEligibilityScheduleRequestsItemCancelRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *RoleManagementDirectoryRoleEligibilityScheduleRequestsItemCancelRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *RoleManagementDirectoryRoleEligibilityScheduleRequestsItemCancelRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RoleManagementDirectoryRoleEligibilityScheduleRequestsItemCancelRequestBuilder) Post(ctx context.Context, requestConfiguration *RoleManagementDirectoryRoleEligibilityScheduleRequestsItemCancelRequestBuilderPostRequestConfiguration)(error) {
