...
func (m *EntitlementManagementRoleEligibilityScheduleInstancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementRoleEligibilityScheduleInstancesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
