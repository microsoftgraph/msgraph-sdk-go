...
// CreateGetRequestInformationWithRequestConfiguration the roleDefinition the assignment is for.  Supports $expand. roleDefinition.Id will be auto expanded.
...
func (m *RoleDefinitionRequestBuilder) Get()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UnifiedRoleDefinitionable, error) {
    return m.GetWithRequestConfigurationAndResponseHandler(nil, nil);
}
// GetWithRequestConfigurationAndResponseHandler the roleDefinition the assignment is for.  Supports $expand. roleDefinition.Id will be auto expanded.
