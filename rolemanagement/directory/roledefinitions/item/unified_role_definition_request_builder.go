...
import (
    ...
    i713364bc58182315d78e707b6ab95f7accc225f8745c703797a0109bdee3c372 "github.com/microsoftgraph/msgraph-sdk-go/rolemanagement/directory/roledefinitions/item/inheritspermissionsfrom"
    i5260f641e8a00ffa3f24794950dce3f61dd8e898bce562d50df416785f9e7e21 "github.com/microsoftgraph/msgraph-sdk-go/rolemanagement/directory/roledefinitions/item/inheritspermissionsfrom/item"
)
...
func NewUnifiedRoleDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UnifiedRoleDefinitionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/roleManagement/directory/roleDefinitions/{unifiedRoleDefinition_id}{?select,expand}";
...
func (m *UnifiedRoleDefinitionRequestBuilder) InheritsPermissionsFrom()(*i713364bc58182315d78e707b6ab95f7accc225f8745c703797a0109bdee3c372.InheritsPermissionsFromRequestBuilder) {
    return i713364bc58182315d78e707b6ab95f7accc225f8745c703797a0109bdee3c372.NewInheritsPermissionsFromRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Gets an item from the github.com/microsoftgraph/msgraph-sdk-go.roleManagement.directory.roleDefinitions.item.inheritsPermissionsFrom.item collection
// Parameters:
//  - id : Unique identifier of the item
func (m *UnifiedRoleDefinitionRequestBuilder) InheritsPermissionsFromById(id string)(*i5260f641e8a00ffa3f24794950dce3f61dd8e898bce562d50df416785f9e7e21.UnifiedRoleDefinitionRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i5260f641e8a00ffa3f24794950dce3f61dd8e898bce562d50df416785f9e7e21.NewUnifiedRoleDefinitionRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
// Resource representing the roles allowed by RBAC providers and the permissions assigned to the roles.
// Parameters:
//  - options : Options for the request
