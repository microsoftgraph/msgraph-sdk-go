...
func NewDirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilder) {
    m := &DirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilder{
...
func NewDirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilder) {
    ...
    return NewDirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AppScopeable, error) {
...
func (m *DirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilder) WithUrl(rawUrl string)(*DirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilder) {
    return NewDirectoryRoleEligibilitySchedulesItemAppScopeRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
