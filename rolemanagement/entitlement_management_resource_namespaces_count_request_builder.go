...
func (m *EntitlementManagementResourceNamespacesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceNamespacesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
