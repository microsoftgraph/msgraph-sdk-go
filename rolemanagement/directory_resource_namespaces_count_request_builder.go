...
func (m *DirectoryResourceNamespacesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryResourceNamespacesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
