...
func (m *DirectoryRoleAssignmentScheduleRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleAssignmentScheduleRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
