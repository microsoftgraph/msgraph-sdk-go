...
func NewDirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) {
    m := &DirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder{
...
func NewDirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) {
    ...
    return NewDirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UnifiedRoleEligibilityScheduleable, error) {
...
func (m *DirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) WithUrl(rawUrl string)(*DirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) {
    return NewDirectoryRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
