...
// CreateGetRequestInformationWithRequestConfiguration read-only property with details of the app specific scope when the assignment scope is app specific. Containment entity. Supports $expand.
...
func (m *AppScopeRequestBuilder) Patch(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AppScopeable, requestConfiguration *AppScopeRequestBuilderPatchRequestConfiguration)(error) {
