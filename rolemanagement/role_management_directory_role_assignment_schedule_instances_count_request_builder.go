...
func NewRoleManagementDirectoryRoleAssignmentScheduleInstancesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementDirectoryRoleAssignmentScheduleInstancesCountRequestBuilder) {
    m := &RoleManagementDirectoryRoleAssignmentScheduleInstancesCountRequestBuilder{
    }
...
func NewRoleManagementDirectoryRoleAssignmentScheduleInstancesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementDirectoryRoleAssignmentScheduleInstancesCountRequestBuilder) {
    ...
    return NewRoleManagementDirectoryRoleAssignmentScheduleInstancesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *RoleManagementDirectoryRoleAssignmentScheduleInstancesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *RoleManagementDirectoryRoleAssignmentScheduleInstancesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RoleManagementDirectoryRoleAssignmentScheduleInstancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *RoleManagementDirectoryRoleAssignmentScheduleInstancesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
