...
func NewDirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilder) {
    m := &DirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/directory/roleEligibilitySchedules/{unifiedRoleEligibilitySchedule%2Did}/appScope{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
func NewDirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilder) {
    ...
    return NewDirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AppScopeable, error) {
...
func (m *DirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilder) WithUrl(rawUrl string)(*DirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilder) {
    return NewDirectoryRoleeligibilityschedulesItemAppscopeAppScopeRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
