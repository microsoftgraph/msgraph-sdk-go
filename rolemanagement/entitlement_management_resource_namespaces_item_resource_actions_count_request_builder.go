...
func (m *EntitlementManagementResourceNamespacesItemResourceActionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceNamespacesItemResourceActionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
