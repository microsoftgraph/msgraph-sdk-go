...
func NewEntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) {
    m := &EntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder{
...
func NewEntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) {
    ...
    return NewEntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *EntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UnifiedRoleEligibilityScheduleable, error) {
...
func (m *EntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder) {
    return NewEntitlementmanagementRoleassignmentschedulesItemActivatedusingActivatedUsingRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
