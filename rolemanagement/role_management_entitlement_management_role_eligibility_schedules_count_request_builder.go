...
func NewRoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) {
    m := &RoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleEligibilitySchedules/$count";
...
func NewRoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) {
    ...
    return NewRoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *RoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *RoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *RoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
