...
func NewDirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilder) {
    m := &DirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilder{
...
func NewDirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilder) {
    ...
    return NewDirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AppScopeable, error) {
...
func (m *DirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilder) WithUrl(rawUrl string)(*DirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilder) {
    return NewDirectoryRoleassignmentschedulesItemAppscopeAppScopeRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
