...
func (m *EntitlementManagementRoleAssignmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementRoleAssignmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
