...
func NewRoleManagementDirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementDirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilder) {
    m := &RoleManagementDirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilder{
    }
...
func NewRoleManagementDirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementDirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilder) {
    ...
    return NewRoleManagementDirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *RoleManagementDirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *RoleManagementDirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RoleManagementDirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilder) Post(ctx context.Context, requestConfiguration *RoleManagementDirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilderPostRequestConfiguration)(error) {
