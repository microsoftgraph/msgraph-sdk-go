...
func (m *EntitlementManagementRoleAssignmentsRequestBuilder) ByUnifiedRoleAssignmentIdString(unifiedRoleAssignmentId string)(*EntitlementManagementRoleAssignmentsUnifiedRoleAssignmentItemRequestBuilder) {
