...
func NewRoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilder) {
    m := &RoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilder{
    }
...
func NewRoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilder) {
    ...
    return NewRoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *RoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilder) Count()(*RoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilder) {
    return NewRoleManagementEntitlementManagementRoleEligibilitySchedulesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *RoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *RoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilder) CreatePostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UnifiedRoleEligibilityScheduleable, requestConfiguration *RoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *RoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilder) FilterByCurrentUserWithOn(on *string)(*RoleManagementEntitlementManagementRoleEligibilitySchedulesFilterByCurrentUserWithOnRequestBuilder) {
    return NewRoleManagementEntitlementManagementRoleEligibilitySchedulesFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on);
}
// Get get the unifiedRoleEligibilitySchedule resources from the roleEligibilitySchedules navigation property.
func (m *RoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilder) Get(ctx context.Context, requestConfiguration *RoleManagementEntitlementManagementRoleEligibilitySchedulesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UnifiedRoleEligibilityScheduleCollectionResponseable, error) {
