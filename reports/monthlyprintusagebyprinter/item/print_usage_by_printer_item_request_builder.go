...
// DeleteWithResponseHandler delete navigation property monthlyPrintUsageByPrinter for reports
...
// PatchWithResponseHandler update the navigation property monthlyPrintUsageByPrinter in reports
