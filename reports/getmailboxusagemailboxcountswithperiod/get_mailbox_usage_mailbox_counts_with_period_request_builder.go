...
// getMailboxUsageMailboxCountsWithPeriodRequestBuilder builds and executes requests for operations under \reports\microsoft.graph.getMailboxUsageMailboxCounts(period='{period}')
...
func (m *GetMailboxUsageMailboxCountsWithPeriodRequestBuilder) Get(options *GetMailboxUsageMailboxCountsWithPeriodRequestBuilderGetOptions)([]byte, error) {
