...
func NewGetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder) {
    m := &GetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder{
...
func NewGetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder) {
    ...
    return NewGetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *GetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder) {
    return NewGetemailappusageversionsusercountswithperiodGetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
