...
func NewGetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilder) {
    m := &GetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilder{
...
func NewGetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilder) {
    ...
    return NewGetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function getYammerGroupsActivityDetail
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilder) {
    return NewGetyammergroupsactivitydetailwithperiodGetYammerGroupsActivityDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
