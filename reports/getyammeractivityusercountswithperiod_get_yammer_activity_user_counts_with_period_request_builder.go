...
func NewGetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilder) {
    m := &GetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilder{
...
func NewGetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilder) {
    ...
    return NewGetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *GetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilder) {
    return NewGetyammeractivityusercountswithperiodGetYammerActivityUserCountsWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
