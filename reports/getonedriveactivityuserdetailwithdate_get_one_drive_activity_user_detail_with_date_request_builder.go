...
func NewGetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, date *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly)(*GetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilder) {
    m := &GetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilder{
...
func NewGetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilder) {
    ...
    return NewGetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *GetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilder) Get(ctx context.Context, requestConfiguration *GetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilder) WithUrl(rawUrl string)(*GetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilder) {
    return NewGetonedriveactivityuserdetailwithdateGetOneDriveActivityUserDetailWithDateRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
