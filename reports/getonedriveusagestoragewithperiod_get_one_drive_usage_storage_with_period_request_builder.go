...
func NewGetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilder) {
    m := &GetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilder{
...
func NewGetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilder) {
    ...
    return NewGetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *GetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilder) {
    return NewGetonedriveusagestoragewithperiodGetOneDriveUsageStorageWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
