...
func NewGetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder) {
    m := &GetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/getSkypeForBusinessActivityUserDetail(period='{period}')", pathParameters),
    }
    if period != nil {
...
func NewGetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder) {
    ...
    return NewGetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function getSkypeForBusinessActivityUserDetail
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder) {
    return NewGetskypeforbusinessactivityuserdetailwithperiodGetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
