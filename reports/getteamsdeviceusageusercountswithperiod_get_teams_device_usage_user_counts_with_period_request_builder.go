...
func NewGetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder) {
    m := &GetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder{
...
func NewGetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder) {
    ...
    return NewGetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *GetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder) {
    return NewGetteamsdeviceusageusercountswithperiodGetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
