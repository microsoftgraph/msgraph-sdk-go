...
func NewGetEmailAppUsageUserDetailWithDateRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter, date *string)(*GetEmailAppUsageUserDetailWithDateRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/reports/microsoft.graph.getEmailAppUsageUserDetail(date={date})";
...
// Parameters:
//  - options : Options for the request
func (m *GetEmailAppUsageUserDetailWithDateRequestBuilder) Get(options *GetEmailAppUsageUserDetailWithDateRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Report, error) {
