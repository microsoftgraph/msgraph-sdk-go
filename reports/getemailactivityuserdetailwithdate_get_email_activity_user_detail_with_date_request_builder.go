...
func NewGetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, date *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly)(*GetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilder) {
    m := &GetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/getEmailActivityUserDetail(date={date})", pathParameters),
    }
    if date != nil {
...
func NewGetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilder) {
    ...
    return NewGetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get get details about email activity users have performed.
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilder) Get(ctx context.Context, requestConfiguration *GetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilder) WithUrl(rawUrl string)(*GetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilder) {
    return NewGetemailactivityuserdetailwithdateGetEmailActivityUserDetailWithDateRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
