...
// GetMailboxUsageDetailWithPeriodRequestBuilder builds and executes requests for operations under \reports\microsoft.graph.getMailboxUsageDetail(period='{period}')
...
func (m *GetMailboxUsageDetailWithPeriodRequestBuilder) Get(options *GetMailboxUsageDetailWithPeriodRequestBuilderGetOptions)([]byte, error) {
