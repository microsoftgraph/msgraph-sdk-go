...
func (m *GetOneDriveActivityUserDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetOneDriveActivityUserDetailWithPeriodRequestBuilder) {
    return NewGetOneDriveActivityUserDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
