...
func NewGetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder) {
    m := &GetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder{
...
func NewGetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder) {
    ...
    return NewGetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *GetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder) {
    return NewGetemailappusageappsusercountswithperiodGetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
