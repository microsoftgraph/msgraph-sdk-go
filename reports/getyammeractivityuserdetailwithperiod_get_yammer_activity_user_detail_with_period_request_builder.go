...
func NewGetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilder) {
    m := &GetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilder{
...
func NewGetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilder) {
    ...
    return NewGetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function getYammerActivityUserDetail
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilder) {
    return NewGetyammeractivityuserdetailwithperiodGetYammerActivityUserDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
