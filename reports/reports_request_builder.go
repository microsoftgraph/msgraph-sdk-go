...
func (m *ReportsRequestBuilder) ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipToken(skip *int32, filter *string, top *int32, skipToken *string)(*i374eb5f5ea7befd0f519a8a1c2886282c8ae9910332bd6b507ad8b29eddfdf2d.ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder) {
    return i374eb5f5ea7befd0f519a8a1c2886282c8ae9910332bd6b507ad8b29eddfdf2d.NewManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilderInternal(m.pathParameters, m.requestAdapter, skip, filter, top, skipToken);
}
