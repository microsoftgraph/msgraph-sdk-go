...
// checkMemberGroupsRequestBuilder builds and executes requests for operations under \organization\{organization-id}\microsoft.graph.checkMemberGroups
...
func NewCheckMemberGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CheckMemberGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/organization/{organization_id}/microsoft.graph.checkMemberGroups";
