...
func NewLocalizationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LocalizationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/organization/{organization_id}/branding/localizations{?top,skip,search,filter,count,orderby,select,expand}";
...
// CreatePostRequestInformation create new navigation property to localizations for organization
