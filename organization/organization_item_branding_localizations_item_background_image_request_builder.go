...
func NewOrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilder) {
    m := &OrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/organization/{organization%2Did}/branding/localizations/{organizationalBrandingLocalization%2Did}/backgroundImage";
...
func NewOrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilder) {
    ...
    return NewOrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *OrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *OrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *OrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *OrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilder) Get(ctx context.Context, requestConfiguration *OrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *OrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *OrganizationItemBrandingLocalizationsItemBackgroundImageRequestBuilderPutRequestConfiguration)(error) {
