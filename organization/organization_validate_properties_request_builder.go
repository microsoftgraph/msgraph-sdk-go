...
func NewOrganizationValidatePropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationValidatePropertiesRequestBuilder) {
    m := &OrganizationValidatePropertiesRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/organization/microsoft.graph.validateProperties";
...
func NewOrganizationValidatePropertiesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationValidatePropertiesRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewOrganizationValidatePropertiesRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *OrganizationValidatePropertiesRequestBuilder) CreatePostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.OrganizationValidatePropertiesPostRequestBodyable, requestConfiguration *OrganizationValidatePropertiesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OrganizationValidatePropertiesRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.OrganizationValidatePropertiesPostRequestBodyable, requestConfiguration *OrganizationValidatePropertiesRequestBuilderPostRequestConfiguration)(error) {
