...
func NewOrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilder) {
    m := &OrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilder{
    }
...
func NewOrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilder) {
    ...
    return NewOrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *OrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *OrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *OrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *OrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilder) Get(ctx context.Context, requestConfiguration *OrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *OrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *OrganizationItemBrandingLocalizationsItemSquareLogoRequestBuilderPutRequestConfiguration)(error) {
