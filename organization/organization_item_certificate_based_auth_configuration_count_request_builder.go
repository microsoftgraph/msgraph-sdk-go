...
func NewOrganizationItemCertificateBasedAuthConfigurationCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationItemCertificateBasedAuthConfigurationCountRequestBuilder) {
    m := &OrganizationItemCertificateBasedAuthConfigurationCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/organization/{organization%2Did}/certificateBasedAuthConfiguration/$count";
...
func NewOrganizationItemCertificateBasedAuthConfigurationCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationItemCertificateBasedAuthConfigurationCountRequestBuilder) {
    ...
    return NewOrganizationItemCertificateBasedAuthConfigurationCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *OrganizationItemCertificateBasedAuthConfigurationCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *OrganizationItemCertificateBasedAuthConfigurationCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OrganizationItemCertificateBasedAuthConfigurationCountRequestBuilder) Get(ctx context.Context, requestConfiguration *OrganizationItemCertificateBasedAuthConfigurationCountRequestBuilderGetRequestConfiguration)(*int32, error) {
