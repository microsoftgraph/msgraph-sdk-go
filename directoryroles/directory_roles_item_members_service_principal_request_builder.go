...
func NewDirectoryRolesItemMembersServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersServicePrincipalRequestBuilder) {
    m := &DirectoryRolesItemMembersServicePrincipalRequestBuilder{
    }
...
func NewDirectoryRolesItemMembersServicePrincipalRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersServicePrincipalRequestBuilder) {
    ...
    return NewDirectoryRolesItemMembersServicePrincipalRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *DirectoryRolesItemMembersServicePrincipalRequestBuilder) Count()(*DirectoryRolesItemMembersServicePrincipalCountRequestBuilder) {
    return NewDirectoryRolesItemMembersServicePrincipalCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DirectoryRolesItemMembersServicePrincipalRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersServicePrincipalRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRolesItemMembersServicePrincipalRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersServicePrincipalRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ServicePrincipalCollectionResponseable, error) {
