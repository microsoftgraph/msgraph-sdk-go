...
func NewDirectoryRolesItemMembersDeviceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersDeviceRequestBuilder) {
    m := &DirectoryRolesItemMembersDeviceRequestBuilder{
    }
...
func NewDirectoryRolesItemMembersDeviceRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersDeviceRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDirectoryRolesItemMembersDeviceRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *DirectoryRolesItemMembersDeviceRequestBuilder) Count()(*DirectoryRolesItemMembersDeviceCountRequestBuilder) {
    return NewDirectoryRolesItemMembersDeviceCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DirectoryRolesItemMembersDeviceRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersDeviceRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRolesItemMembersDeviceRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersDeviceRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DeviceCollectionResponseable, error) {
