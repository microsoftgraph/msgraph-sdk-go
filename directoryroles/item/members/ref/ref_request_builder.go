...
// RefRequestBuilder provides operations to manage the collection of directoryRole entities.
...
// RefRequestBuilderGetQueryParameters users that are members of this directory role. HTTP Methods: GET, POST, DELETE. Read-only. Nullable. Supports $expand.
...
// CreateGetRequestInformationWithRequestConfiguration users that are members of this directory role. HTTP Methods: GET, POST, DELETE. Read-only. Nullable. Supports $expand.
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property ref to members for directoryRoles
...
// GetWithRequestConfigurationAndResponseHandler users that are members of this directory role. HTTP Methods: GET, POST, DELETE. Read-only. Nullable. Supports $expand.
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property ref to members for directoryRoles
