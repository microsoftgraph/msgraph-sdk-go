...
type GetMemberObjectsRequestBuilderPostOptions struct {
    // 
    Body GetMemberObjectsRequestBodyable;
    // Request headers
...
func NewGetMemberObjectsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetMemberObjectsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/directoryRoles/{directoryRole_id}/microsoft.graph.getMemberObjects";
...
func (m *GetMemberObjectsRequestBuilder) CreatePostRequestInformation(options *GetMemberObjectsRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetMemberObjectsRequestBuilder) Post(options *GetMemberObjectsRequestBuilderPostOptions)(GetMemberObjectsResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetMemberObjectsResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
