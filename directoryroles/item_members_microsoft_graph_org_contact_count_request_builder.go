...
func NewItemMembersMicrosoftGraphOrgContactCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersMicrosoftGraphOrgContactCountRequestBuilder) {
    m := &ItemMembersMicrosoftGraphOrgContactCountRequestBuilder{
    }
...
func NewItemMembersMicrosoftGraphOrgContactCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersMicrosoftGraphOrgContactCountRequestBuilder) {
    ...
    return NewItemMembersMicrosoftGraphOrgContactCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemMembersMicrosoftGraphOrgContactCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMembersMicrosoftGraphOrgContactCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemMembersMicrosoftGraphOrgContactCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemMembersMicrosoftGraphOrgContactCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
