...
// getAvailableExtensionPropertiesRequestBuilder builds and executes requests for operations under \permissionGrants\microsoft.graph.getAvailableExtensionProperties
