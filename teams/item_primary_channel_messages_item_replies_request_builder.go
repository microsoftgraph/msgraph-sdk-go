...
func (m *ItemPrimaryChannelMessagesItemRepliesRequestBuilder) MicrosoftGraphDelta()(*ItemPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
