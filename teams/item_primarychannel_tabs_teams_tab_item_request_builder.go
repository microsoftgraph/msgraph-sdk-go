...
func (m *ItemPrimarychannelTabsTeamsTabItemRequestBuilder) TeamsApp()(*ItemPrimarychannelTabsItemTeamsappTeamsAppRequestBuilder) {
    return NewItemPrimarychannelTabsItemTeamsappTeamsAppRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
