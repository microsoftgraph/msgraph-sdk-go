...
func (m *ItemScheduleSchedulingGroupsSchedulingGroupItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemScheduleSchedulingGroupsSchedulingGroupItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
...
// ToDeleteRequestInformation delete navigation property schedulingGroups for teams
...
// ToPatchRequestInformation update the navigation property schedulingGroups in teams
