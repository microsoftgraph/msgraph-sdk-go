...
func (m *ItemOperationsTeamsAsyncOperationItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemOperationsTeamsAsyncOperationItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
