...
func NewItemMembersMicrosoftGraphAddAddPostRequestBody()(*ItemMembersMicrosoftGraphAddAddPostRequestBody) {
    m := &ItemMembersMicrosoftGraphAddAddPostRequestBody{
    }
...
func CreateItemMembersMicrosoftGraphAddAddPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemMembersMicrosoftGraphAddAddPostRequestBody(), nil
}
...
func (m *ItemMembersMicrosoftGraphAddAddPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemMembersMicrosoftGraphAddAddPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemMembersMicrosoftGraphAddAddPostRequestBody) GetValues()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationMemberable) {
...
func (m *ItemMembersMicrosoftGraphAddAddPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetValues() != nil {
...
func (m *ItemMembersMicrosoftGraphAddAddPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetValues sets the values property value. The values property
func (m *ItemMembersMicrosoftGraphAddAddPostRequestBody) SetValues(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationMemberable)() {
    err := m.GetBackingStore().Set("values", value)
    if err != nil {
        panic(err)
    }
}
// ItemMembersMicrosoftGraphAddAddPostRequestBodyable 
type ItemMembersMicrosoftGraphAddAddPostRequestBodyable interface {
