...
func (m *ItemScheduleOpenShiftChangeRequestsRequestBuilder) Count()(*ItemScheduleOpenShiftChangeRequestsCountRequestBuilder) {
    return NewItemScheduleOpenShiftChangeRequestsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation retrieve a list of openShiftChangeRequest objects in a team.
func (m *ItemScheduleOpenShiftChangeRequestsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemScheduleOpenShiftChangeRequestsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
