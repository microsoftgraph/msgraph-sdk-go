...
import (
    ...
    iaed3a57923d2d4f147409299a5c8cde97be1cf984b964289ad7cf45581c68a28 "github.com/microsoftgraph/msgraph-sdk-go/teams/item/channels/item/messages/item/replies/item/hostedcontents/count"
)
...
func NewHostedContentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HostedContentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team_id}/channels/{channel_id}/messages/{chatMessage_id}/replies/{chatMessage_id1}/hostedContents{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *HostedContentsRequestBuilder) Count()(*iaed3a57923d2d4f147409299a5c8cde97be1cf984b964289ad7cf45581c68a28.CountRequestBuilder) {
    return iaed3a57923d2d4f147409299a5c8cde97be1cf984b964289ad7cf45581c68a28.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
