...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property replies for teams
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property replies in teams
