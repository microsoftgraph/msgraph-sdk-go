...
import (
    ...
    i23cf89ab469a32c802fd637f3643d1bfd4aabc50c1e0831aaa6379a6668c3a61 "github.com/microsoftgraph/msgraph-sdk-go/teams/item/channels/item/tabs/item/teamsapp/ref"
)

// Builds and executes requests for operations under \teams\{team-id}\channels\{channel-id}\tabs\{teamsTab-id}\teamsApp
...
func NewTeamsAppRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TeamsAppRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/channels/{channel_id}/tabs/{teamsTab_id}/teamsApp{?select,expand}";
...
func (m *TeamsAppRequestBuilder) Get(q func (value *TeamsAppRequestBuilderGetQueryParameters) (err error), h func (value map[string]string) (err error), o []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption, responseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.TeamsApp, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewTeamsApp() }, responseHandler)
    if err != nil {
        return nil, err
    }
    return res.(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.TeamsApp), nil
}
func (m *TeamsAppRequestBuilder) Ref()(*i23cf89ab469a32c802fd637f3643d1bfd4aabc50c1e0831aaa6379a6668c3a61.RefRequestBuilder) {
    return i23cf89ab469a32c802fd637f3643d1bfd4aabc50c1e0831aaa6379a6668c3a61.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
