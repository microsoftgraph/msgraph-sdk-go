...
// CreateDeleteRequestInformation the application that is linked to the tab.
...
// CreatePutRequestInformation the application that is linked to the tab.
...
// Delete the application that is linked to the tab.
...
// Put the application that is linked to the tab.
