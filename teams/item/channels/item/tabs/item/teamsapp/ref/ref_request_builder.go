...
// refRequestBuilder builds and executes requests for operations under \teams\{team-id}\channels\{channel-id}\tabs\{teamsTab-id}\teamsApp\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team_id}/channels/{channel_id}/tabs/{teamsTab_id}/teamsApp/$ref";
...
// CreateDeleteRequestInformation the application that is linked to the tab. This cannot be changed after tab creation.
...
// CreatePutRequestInformation the application that is linked to the tab. This cannot be changed after tab creation.
...
// Delete the application that is linked to the tab. This cannot be changed after tab creation.
...
// Put the application that is linked to the tab. This cannot be changed after tab creation.
