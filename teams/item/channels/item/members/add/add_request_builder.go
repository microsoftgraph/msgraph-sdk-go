...
// AddRequestBuilder builds and executes requests for operations under \teams\{team-id}\channels\{channel-id}\members\microsoft.graph.add
...
func NewAddRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AddRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team_id}/channels/{channel_id}/members/microsoft.graph.add";
...
func (m *AddRequestBuilder) Post(options *AddRequestBuilderPostOptions)([]Add, error) {
    ...
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewAdd() }, nil, nil)
    if err != nil {
        return nil, err
    }
