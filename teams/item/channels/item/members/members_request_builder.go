...
func (m *MembersRequestBuilder) Add()(*ib113fbaca0760022878dc58540a742e1c1b8cf8914e6d8e83c3a98937e058882.AddRequestBuilder) {
    return ib113fbaca0760022878dc58540a742e1c1b8cf8914e6d8e83c3a98937e058882.NewAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MembersRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/channels/{channel_id}/members{?top,skip,search,filter,count,orderby,select,expand}";
