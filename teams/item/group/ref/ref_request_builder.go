...
// RefRequestBuilder builds and executes requests for operations under \teams\{team-id}\group\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team_id}/group/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property group for teams
...
// CreateGetRequestInformation get ref of group from teams
...
// CreatePutRequestInformation update the ref of navigation property group in teams
...
// Delete delete ref of navigation property group for teams
...
// Get get ref of group from teams
...
// Put update the ref of navigation property group in teams
