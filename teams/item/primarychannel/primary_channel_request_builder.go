...
// DeleteWithResponseHandler delete navigation property primaryChannel for teams
...
// PatchWithResponseHandler update the navigation property primaryChannel in teams
