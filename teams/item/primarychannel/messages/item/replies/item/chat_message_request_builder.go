...
// Builds and executes requests for operations under \teams\{team-id}\primaryChannel\messages\{chatMessage-id}\replies\{chatMessage-id1}
...
func NewChatMessageRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChatMessageRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/primaryChannel/messages/{chatMessage_id}/replies/{chatMessage_id1}{?select,expand}";
