...
func NewTeamsAppRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TeamsAppRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/teams/{team_id}/installedApps/{teamsAppInstallation_id}/teamsApp{?select,expand}";
...
func (m *TeamsAppRequestBuilder) Ref()(*i68271cb131bc84004710b4616f4354038783592cf56501f3d7f554f66d6fd3ba.RefRequestBuilder) {
    return i68271cb131bc84004710b4616f4354038783592cf56501f3d7f554f66d6fd3ba.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
