...
func NewUnarchiveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UnarchiveRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team_id}/microsoft.graph.unarchive";
...
func (m *UnarchiveRequestBuilder) CreatePostRequestInformation(options *UnarchiveRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UnarchiveRequestBuilder) Post(options *UnarchiveRequestBuilderPostOptions)(error) {
