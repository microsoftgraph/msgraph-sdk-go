...
func (m *ItemScheduleTimeCardsItemClockOutPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemScheduleTimeCardsItemClockOutPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *ItemScheduleTimeCardsItemClockOutPostRequestBody) GetIsAtApprovedLocation()(*bool) {
...
func (m *ItemScheduleTimeCardsItemClockOutPostRequestBody) GetNotes()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ItemBodyable) {
...
func (m *ItemScheduleTimeCardsItemClockOutPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ItemScheduleTimeCardsItemClockOutPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetIsAtApprovedLocation sets the isAtApprovedLocation property value. The isAtApprovedLocation property
func (m *ItemScheduleTimeCardsItemClockOutPostRequestBody) SetIsAtApprovedLocation(value *bool)() {
...
func (m *ItemScheduleTimeCardsItemClockOutPostRequestBody) SetNotes(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ItemBodyable)() {
    err := m.GetBackingStore().Set("notes", value)
    if err != nil {
        panic(err)
    }
}
type ItemScheduleTimeCardsItemClockOutPostRequestBodyable interface {
