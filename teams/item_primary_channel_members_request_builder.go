...
func (m *ItemPrimaryChannelMembersRequestBuilder) MicrosoftGraphAdd()(*ItemPrimaryChannelMembersMicrosoftGraphAddAddRequestBuilder) {
    return NewItemPrimaryChannelMembersMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
