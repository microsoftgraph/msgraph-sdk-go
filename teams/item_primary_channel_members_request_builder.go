...
func (m *ItemPrimaryChannelMembersRequestBuilder) Add()(*ItemPrimaryChannelMembersAddRequestBuilder) {
    return NewItemPrimaryChannelMembersAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewItemPrimaryChannelMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPrimaryChannelMembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team%2Did}/primaryChannel/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemPrimaryChannelMembersRequestBuilder) Count()(*ItemPrimaryChannelMembersCountRequestBuilder) {
    return NewItemPrimaryChannelMembersCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemPrimaryChannelMembersRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemPrimaryChannelMembersRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
