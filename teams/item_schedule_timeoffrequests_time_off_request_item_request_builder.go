...
// NewItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilderInternal instantiates a new ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder and sets the default values.
func NewItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder) {
    m := &ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teams/{team%2Did}/schedule/timeOffRequests/{timeOffRequest%2Did}{?%24select}", pathParameters),
    }
    return m
}
// NewItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder instantiates a new ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder and sets the default values.
...
func (m *ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilderDeleteRequestConfiguration)(error) {
...
func (m *ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.TimeOffRequestable, error) {
...
// returns a TimeOffRequestable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder) Patch(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.TimeOffRequestable, requestConfiguration *ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilderPatchRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.TimeOffRequestable, error) {
...
// returns a *RequestInformation when successful
func (m *ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder) ToPatchRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.TimeOffRequestable, requestConfiguration *ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder) WithUrl(rawUrl string)(*ItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder) {
    return NewItemScheduleTimeoffrequestsTimeOffRequestItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
