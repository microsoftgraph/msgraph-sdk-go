...
func (m *ItemScheduleOpenShiftChangeRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemScheduleOpenShiftChangeRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
