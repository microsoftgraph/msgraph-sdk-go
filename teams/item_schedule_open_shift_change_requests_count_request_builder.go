...
func NewItemScheduleOpenShiftChangeRequestsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemScheduleOpenShiftChangeRequestsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team%2Did}/schedule/openShiftChangeRequests/$count";
...
func (m *ItemScheduleOpenShiftChangeRequestsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemScheduleOpenShiftChangeRequestsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
