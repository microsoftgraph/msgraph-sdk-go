...
func (m *ItemTeamPrimaryChannelMembersRequestBuilder) MicrosoftGraphAdd()(*ItemTeamPrimaryChannelMembersMicrosoftGraphAddAddRequestBuilder) {
    return NewItemTeamPrimaryChannelMembersMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
