...
func NewItemMembersMicrosoftGraphServicePrincipalCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder) {
    m := &ItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/members/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
...
func NewItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder) {
    ...
    return NewItemMembersMicrosoftGraphServicePrincipalCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMembersMicrosoftGraphServicePrincipalCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemMembersMicrosoftGraphServicePrincipalCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
