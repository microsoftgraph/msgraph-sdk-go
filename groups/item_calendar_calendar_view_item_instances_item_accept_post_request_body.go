...
// ItemCalendarCalendarViewItemInstancesItemAcceptPostRequestBody provides operations to call the accept method.
...
func (m *ItemCalendarCalendarViewItemInstancesItemAcceptPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarCalendarViewItemInstancesItemAcceptPostRequestBody) SetAdditionalData(value map[string]interface{})() {
