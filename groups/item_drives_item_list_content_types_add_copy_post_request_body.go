...
// ItemDrivesItemListContentTypesAddCopyPostRequestBody 
...
func (m *ItemDrivesItemListContentTypesAddCopyPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemDrivesItemListContentTypesAddCopyPostRequestBody) SetAdditionalData(value map[string]any)() {
