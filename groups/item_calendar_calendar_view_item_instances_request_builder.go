...
func (m *ItemCalendarCalendarViewItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarCalendarViewItemInstancesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemCalendarCalendarViewItemInstancesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
