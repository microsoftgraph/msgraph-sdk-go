...
// ItemPermissionGrantsItemGetMemberObjectsPostRequestBody provides operations to call the getMemberObjects method.
...
func (m *ItemPermissionGrantsItemGetMemberObjectsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemPermissionGrantsItemGetMemberObjectsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
