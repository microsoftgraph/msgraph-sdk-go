...
// ItemTeamMembersAddPostRequestBody provides operations to call the add method.
...
func (m *ItemTeamMembersAddPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemTeamMembersAddPostRequestBody) SetAdditionalData(value map[string]interface{})() {
