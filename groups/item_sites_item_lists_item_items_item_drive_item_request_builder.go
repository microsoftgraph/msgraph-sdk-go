...
// NewItemSitesItemListsItemItemsItemDriveItemRequestBuilderInternal instantiates a new ItemSitesItemListsItemItemsItemDriveItemRequestBuilder and sets the default values.
...
// NewItemSitesItemListsItemItemsItemDriveItemRequestBuilder instantiates a new ItemSitesItemListsItemItemsItemDriveItemRequestBuilder and sets the default values.
...
func (m *ItemSitesItemListsItemItemsItemDriveItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemListsItemItemsItemDriveItemRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveItemable, error) {
...
func (m *ItemSitesItemListsItemItemsItemDriveItemRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemListsItemItemsItemDriveItemRequestBuilder) {
    return NewItemSitesItemListsItemItemsItemDriveItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
