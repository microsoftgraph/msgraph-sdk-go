...
func (m *ItemTeamChannelsItemSharedwithteamsSharedWithChannelTeamInfoItemRequestBuilder) AllowedMembers()(*ItemTeamChannelsItemSharedwithteamsItemAllowedmembersAllowedMembersRequestBuilder) {
    return NewItemTeamChannelsItemSharedwithteamsItemAllowedmembersAllowedMembersRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
