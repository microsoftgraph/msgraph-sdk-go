...
// ByGroupSettingIdString provides operations to manage the settings property of the microsoft.graph.group entity.
func (m *ItemSettingsRequestBuilder) ByGroupSettingIdString(groupSettingId string)(*ItemSettingsGroupSettingItemRequestBuilder) {
