...
func (m *ItemCalendarViewItemMicrosoftGraphCancelCancelPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetComment gets the comment property value. The Comment property
func (m *ItemCalendarViewItemMicrosoftGraphCancelCancelPostRequestBody) GetComment()(*string) {
...
func (m *ItemCalendarViewItemMicrosoftGraphCancelCancelPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetComment sets the comment property value. The Comment property
func (m *ItemCalendarViewItemMicrosoftGraphCancelCancelPostRequestBody) SetComment(value *string)() {
    err := m.GetBackingStore().Set("comment", value)
    if err != nil {
        panic(err)
    }
}
// ItemCalendarViewItemMicrosoftGraphCancelCancelPostRequestBodyable 
type ItemCalendarViewItemMicrosoftGraphCancelCancelPostRequestBodyable interface {
