...
func (m *ItemCalendarEventsItemInstancesItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*ItemCalendarEventsItemInstancesItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilder) {
    return NewItemCalendarEventsItemInstancesItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
