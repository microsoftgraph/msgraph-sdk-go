...
// NewItemSitesItemContenttypesItemColumnpositionsColumnDefinitionItemRequestBuilderInternal instantiates a new ItemSitesItemContenttypesItemColumnpositionsColumnDefinitionItemRequestBuilder and sets the default values.
func NewItemSitesItemContenttypesItemColumnpositionsColumnDefinitionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemContenttypesItemColumnpositionsColumnDefinitionItemRequestBuilder) {
    m := &ItemSitesItemContenttypesItemColumnpositionsColumnDefinitionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columnPositions/{columnDefinition%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemSitesItemContenttypesItemColumnpositionsColumnDefinitionItemRequestBuilder instantiates a new ItemSitesItemContenttypesItemColumnpositionsColumnDefinitionItemRequestBuilder and sets the default values.
...
func (m *ItemSitesItemContenttypesItemColumnpositionsColumnDefinitionItemRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemContenttypesItemColumnpositionsColumnDefinitionItemRequestBuilder) {
    return NewItemSitesItemContenttypesItemColumnpositionsColumnDefinitionItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
