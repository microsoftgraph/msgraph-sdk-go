...
// ItemConversationsItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody provides operations to call the createUploadSession method.
...
func (m *ItemConversationsItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemConversationsItemThreadsItemPostsItemAttachmentsCreateUploadSessionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
