...
// NewItemSitesItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRequestBuilderInternal instantiates a new ItemSitesItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRequestBuilder and sets the default values.
...
// NewItemSitesItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRequestBuilder instantiates a new ItemSitesItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRequestBuilder and sets the default values.
...
// returns a *ItemSitesItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsCountRequestBuilder when successful
...
func (m *ItemSitesItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRequestBuilder) {
    return NewItemSitesItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
