...
// ItemCalendarViewItemInstancesItemAcceptPostRequestBody provides operations to call the accept method.
...
func (m *ItemCalendarViewItemInstancesItemAcceptPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarViewItemInstancesItemAcceptPostRequestBody) SetAdditionalData(value map[string]interface{})() {
