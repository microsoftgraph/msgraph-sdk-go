...
// NewItemSitesItemContenttypesItemColumnpositionsCountRequestBuilderInternal instantiates a new ItemSitesItemContenttypesItemColumnpositionsCountRequestBuilder and sets the default values.
func NewItemSitesItemContenttypesItemColumnpositionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemContenttypesItemColumnpositionsCountRequestBuilder) {
    m := &ItemSitesItemContenttypesItemColumnpositionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columnPositions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemSitesItemContenttypesItemColumnpositionsCountRequestBuilder instantiates a new ItemSitesItemContenttypesItemColumnpositionsCountRequestBuilder and sets the default values.
...
func (m *ItemSitesItemContenttypesItemColumnpositionsCountRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemContenttypesItemColumnpositionsCountRequestBuilder) {
    return NewItemSitesItemContenttypesItemColumnpositionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
