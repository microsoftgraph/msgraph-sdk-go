...
// NewItemSitesItemListsItemItemsItemDocumentSetVersionsCountRequestBuilderInternal instantiates a new ItemSitesItemListsItemItemsItemDocumentSetVersionsCountRequestBuilder and sets the default values.
...
// NewItemSitesItemListsItemItemsItemDocumentSetVersionsCountRequestBuilder instantiates a new ItemSitesItemListsItemItemsItemDocumentSetVersionsCountRequestBuilder and sets the default values.
...
func (m *ItemSitesItemListsItemItemsItemDocumentSetVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemListsItemItemsItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
