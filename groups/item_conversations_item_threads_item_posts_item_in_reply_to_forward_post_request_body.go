...
// ItemConversationsItemThreadsItemPostsItemInReplyToForwardPostRequestBody provides operations to call the forward method.
...
func (m *ItemConversationsItemThreadsItemPostsItemInReplyToForwardPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemConversationsItemThreadsItemPostsItemInReplyToForwardPostRequestBody) SetAdditionalData(value map[string]interface{})() {
