...
// GetAvailableExtensionPropertiesRequestBuilder builds and executes requests for operations under \groups\microsoft.graph.getAvailableExtensionProperties
