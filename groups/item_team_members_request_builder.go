...
func (m *ItemTeamMembersRequestBuilder) MicrosoftGraphAdd()(*ItemTeamMembersMicrosoftGraphAddAddRequestBuilder) {
    return NewItemTeamMembersMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
