...
func (m *ItemThreadsItemPostsItemAttachmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemThreadsItemPostsItemAttachmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
