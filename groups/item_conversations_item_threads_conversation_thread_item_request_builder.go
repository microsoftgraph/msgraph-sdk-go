...
// NewItemConversationsItemThreadsConversationThreadItemRequestBuilderInternal instantiates a new ItemConversationsItemThreadsConversationThreadItemRequestBuilder and sets the default values.
func NewItemConversationsItemThreadsConversationThreadItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemConversationsItemThreadsConversationThreadItemRequestBuilder) {
    m := &ItemConversationsItemThreadsConversationThreadItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemConversationsItemThreadsConversationThreadItemRequestBuilder instantiates a new ItemConversationsItemThreadsConversationThreadItemRequestBuilder and sets the default values.
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemConversationsItemThreadsConversationThreadItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemConversationsItemThreadsConversationThreadItemRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationThreadable, error) {
...
// returns a ConversationThreadable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemConversationsItemThreadsConversationThreadItemRequestBuilder) Patch(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationThreadable, requestConfiguration *ItemConversationsItemThreadsConversationThreadItemRequestBuilderPatchRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationThreadable, error) {
...
func (m *ItemConversationsItemThreadsConversationThreadItemRequestBuilder) Posts()(*ItemConversationsItemThreadsItemPostsRequestBuilder) {
    return NewItemConversationsItemThreadsItemPostsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemConversationsItemThreadsConversationThreadItemRequestBuilder) Reply()(*ItemConversationsItemThreadsItemReplyRequestBuilder) {
    return NewItemConversationsItemThreadsItemReplyRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *ItemConversationsItemThreadsConversationThreadItemRequestBuilder when successful
func (m *ItemConversationsItemThreadsConversationThreadItemRequestBuilder) WithUrl(rawUrl string)(*ItemConversationsItemThreadsConversationThreadItemRequestBuilder) {
    return NewItemConversationsItemThreadsConversationThreadItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
