...
// ItemCalendarViewItemAcceptPostRequestBody provides operations to call the accept method.
...
func (m *ItemCalendarViewItemAcceptPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarViewItemAcceptPostRequestBody) SetAdditionalData(value map[string]interface{})() {
