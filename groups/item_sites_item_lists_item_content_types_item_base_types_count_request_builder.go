...
func (m *ItemSitesItemListsItemContentTypesItemBaseTypesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemListsItemContentTypesItemBaseTypesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
