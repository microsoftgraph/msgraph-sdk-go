...
func (m *ItemEventsItemSnoozeReminderRequestBuilder) WithUrl(rawUrl string)(*ItemEventsItemSnoozeReminderRequestBuilder) {
    return NewItemEventsItemSnoozeReminderRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
