...
func (m *ItemSitesItemContentTypesRequestBuilder) MicrosoftGraphAddCopy()(*ItemSitesItemContentTypesMicrosoftGraphAddCopyAddCopyRequestBuilder) {
    return NewItemSitesItemContentTypesMicrosoftGraphAddCopyAddCopyRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphAddCopyFromContentTypeHub provides operations to call the addCopyFromContentTypeHub method.
func (m *ItemSitesItemContentTypesRequestBuilder) MicrosoftGraphAddCopyFromContentTypeHub()(*ItemSitesItemContentTypesMicrosoftGraphAddCopyFromContentTypeHubAddCopyFromContentTypeHubRequestBuilder) {
    return NewItemSitesItemContentTypesMicrosoftGraphAddCopyFromContentTypeHubAddCopyFromContentTypeHubRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphGetCompatibleHubContentTypes provides operations to call the getCompatibleHubContentTypes method.
func (m *ItemSitesItemContentTypesRequestBuilder) MicrosoftGraphGetCompatibleHubContentTypes()(*ItemSitesItemContentTypesMicrosoftGraphGetCompatibleHubContentTypesGetCompatibleHubContentTypesRequestBuilder) {
    return NewItemSitesItemContentTypesMicrosoftGraphGetCompatibleHubContentTypesGetCompatibleHubContentTypesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
