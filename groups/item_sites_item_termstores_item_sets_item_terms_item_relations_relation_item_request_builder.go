...
func (m *ItemSitesItemTermstoresItemSetsItemTermsItemRelationsRelationItemRequestBuilder) FromTerm()(*ItemSitesItemTermstoresItemSetsItemTermsItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewItemSitesItemTermstoresItemSetsItemTermsItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemSitesItemTermstoresItemSetsItemTermsItemRelationsRelationItemRequestBuilder) ToTerm()(*ItemSitesItemTermstoresItemSetsItemTermsItemRelationsItemTotermToTermRequestBuilder) {
    return NewItemSitesItemTermstoresItemSetsItemTermsItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
