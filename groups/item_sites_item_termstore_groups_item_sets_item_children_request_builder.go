...
// ItemSitesItemTermstoreGroupsItemSetsItemChildrenRequestBuilderGetQueryParameters children terms of set in term [store].
...
// NewItemSitesItemTermstoreGroupsItemSetsItemChildrenRequestBuilderInternal instantiates a new ItemSitesItemTermstoreGroupsItemSetsItemChildrenRequestBuilder and sets the default values.
func NewItemSitesItemTermstoreGroupsItemSetsItemChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemTermstoreGroupsItemSetsItemChildrenRequestBuilder) {
    m := &ItemSitesItemTermstoreGroupsItemSetsItemChildrenRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets/{set%2Did}/children{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemSitesItemTermstoreGroupsItemSetsItemChildrenRequestBuilder instantiates a new ItemSitesItemTermstoreGroupsItemSetsItemChildrenRequestBuilder and sets the default values.
