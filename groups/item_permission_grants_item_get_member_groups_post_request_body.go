...
// ItemPermissionGrantsItemGetMemberGroupsPostRequestBody provides operations to call the getMemberGroups method.
...
func (m *ItemPermissionGrantsItemGetMemberGroupsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemPermissionGrantsItemGetMemberGroupsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
