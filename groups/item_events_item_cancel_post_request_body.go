...
// ItemEventsItemCancelPostRequestBody provides operations to call the cancel method.
...
func (m *ItemEventsItemCancelPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemEventsItemCancelPostRequestBody) SetAdditionalData(value map[string]interface{})() {
