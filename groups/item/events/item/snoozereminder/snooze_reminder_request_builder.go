...
// SnoozeReminderRequestBuilder builds and executes requests for operations under \groups\{group-id}\events\{event-id}\microsoft.graph.snoozeReminder
...
func NewSnoozeReminderRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SnoozeReminderRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/events/{event_id}/microsoft.graph.snoozeReminder";
