...
import (
    ...
    i75474811f684b5cfdc5dad4d69e160671500c589b17684a5050386e7f850c150 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/events/item/calendar/calendarview/delta"
)

// CalendarViewRequestBuilder builds and executes requests for operations under \groups\{group-id}\events\{event-id}\calendar\calendarView
...
func NewCalendarViewRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CalendarViewRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/events/{event_id}/calendar/calendarView{?top,skip,filter,count,orderby,select}";
...
// Delta builds and executes requests for operations under \groups\{group-id}\events\{event-id}\calendar\calendarView\microsoft.graph.delta()
func (m *CalendarViewRequestBuilder) Delta()(*i75474811f684b5cfdc5dad4d69e160671500c589b17684a5050386e7f850c150.DeltaRequestBuilder) {
    return i75474811f684b5cfdc5dad4d69e160671500c589b17684a5050386e7f850c150.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
