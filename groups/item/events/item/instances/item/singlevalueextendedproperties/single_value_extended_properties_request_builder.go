...
import (
    ...
    ie4eef9cc871f16d7c60ea8a8356e0457a446b655d2028ff960479e9c569beb81 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/events/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/events/{event_id}/instances/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*ie4eef9cc871f16d7c60ea8a8356e0457a446b655d2028ff960479e9c569beb81.CountRequestBuilder) {
    return ie4eef9cc871f16d7c60ea8a8356e0457a446b655d2028ff960479e9c569beb81.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
