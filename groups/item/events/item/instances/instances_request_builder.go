...
import (
    ...
    ie5204b880ecf8f55b4a3c014306bf7230402dcecfef0fce19e2300775ae05840 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/events/item/instances/delta"
    if57467d3f4349fb884d14b62feea77458c21e361eb02c680be4a035238170937 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/events/item/instances/count"
)
...
func NewInstancesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InstancesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/events/{event_id}/instances{?top,skip,filter,count,orderby,select}";
...
func (m *InstancesRequestBuilder) Count()(*if57467d3f4349fb884d14b62feea77458c21e361eb02c680be4a035238170937.CountRequestBuilder) {
    return if57467d3f4349fb884d14b62feea77458c21e361eb02c680be4a035238170937.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *InstancesRequestBuilder) Delta()(*ie5204b880ecf8f55b4a3c014306bf7230402dcecfef0fce19e2300775ae05840.DeltaRequestBuilder) {
    return ie5204b880ecf8f55b4a3c014306bf7230402dcecfef0fce19e2300775ae05840.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
