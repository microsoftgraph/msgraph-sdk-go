...
func NewPlannerBucketRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PlannerBucketRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/planner/plans/{plannerPlan_id}/buckets/{plannerBucket_id}{?select,expand}";
...
func (m *PlannerBucketRequestBuilder) Tasks()(*ica1dad19a2d768f42f14ec6042e06b2f50745de1ee385e2ba712ab94d806cef8.TasksRequestBuilder) {
...
// Gets an item from the github.com/microsoftgraph/msgraph-sdk-go.groups.item.planner.plans.item.buckets.item.tasks.item collection
// Parameters:
//  - id : Unique identifier of the item
func (m *PlannerBucketRequestBuilder) TasksById(id string)(*i23b907b1ade248a7d5f95748f2d444dd2d89c4b362306b94f133fb4273bc74cd.PlannerTaskRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i23b907b1ade248a7d5f95748f2d444dd2d89c4b362306b94f133fb4273bc74cd.NewPlannerTaskRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
