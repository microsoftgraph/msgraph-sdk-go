...
// RefRequestBuilder builds and executes requests for operations under \groups\{group-id}\transitiveMembers\$ref
...
// RefRequestBuilderGetQueryParameters get ref of transitiveMembers from groups
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/transitiveMembers/$ref{?top,skip,search,filter,count,orderby}";
...
// CreateGetRequestInformation get ref of transitiveMembers from groups
...
// CreatePostRequestInformation create new navigation property ref to transitiveMembers for groups
...
// Get get ref of transitiveMembers from groups
...
// Post create new navigation property ref to transitiveMembers for groups
