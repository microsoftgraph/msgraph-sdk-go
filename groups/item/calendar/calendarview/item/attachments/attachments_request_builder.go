...
import (
    ...
    i0964ef63ce4379d842c00adb176fc4785a0b8bb2c52ecdb55cfe1609d2afce13 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/calendar/calendarview/item/attachments/count"
    i0d1bba91dbe260134f83152522a5abeeecbb24ac52432fff4aa28f24b3cf8116 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/calendar/calendarview/item/attachments/createuploadsession"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/calendar/calendarView/{event_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*i0964ef63ce4379d842c00adb176fc4785a0b8bb2c52ecdb55cfe1609d2afce13.CountRequestBuilder) {
    return i0964ef63ce4379d842c00adb176fc4785a0b8bb2c52ecdb55cfe1609d2afce13.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*i0d1bba91dbe260134f83152522a5abeeecbb24ac52432fff4aa28f24b3cf8116.CreateUploadSessionRequestBuilder) {
    return i0d1bba91dbe260134f83152522a5abeeecbb24ac52432fff4aa28f24b3cf8116.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
