...
// MultiValueLegacyExtendedPropertyItemRequestBuilder builds and executes requests for operations under \groups\{group-id}\calendar\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
