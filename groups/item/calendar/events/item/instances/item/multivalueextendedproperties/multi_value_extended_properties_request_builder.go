...
import (
    ...
    i5249a437fd26407bbaa8dbf4b864f10fb8b349fc505b31e3c55dca93be0634c7 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/calendar/events/item/instances/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/calendar/events/{event_id}/instances/{event_id1}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*i5249a437fd26407bbaa8dbf4b864f10fb8b349fc505b31e3c55dca93be0634c7.CountRequestBuilder) {
    return i5249a437fd26407bbaa8dbf4b864f10fb8b349fc505b31e3c55dca93be0634c7.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
