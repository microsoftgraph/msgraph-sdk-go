...
import (
    ...
    ifeb7437b369a3e0e4f6a1c27a498f9850dd1da741cee7a981cf59f044333eaf9 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/notebooks/item/sectiongroups/item/parentsectiongroup/ref"
)
...
func NewParentSectionGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentSectionGroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/parentSectionGroup{?select,expand}";
...
func (m *ParentSectionGroupRequestBuilder) Ref()(*ifeb7437b369a3e0e4f6a1c27a498f9850dd1da741cee7a981cf59f044333eaf9.RefRequestBuilder) {
    return ifeb7437b369a3e0e4f6a1c27a498f9850dd1da741cee7a981cf59f044333eaf9.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
