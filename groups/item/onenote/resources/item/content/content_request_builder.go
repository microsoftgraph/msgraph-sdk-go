...
// contentRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\resources\{onenoteResource-id}\content
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/resources/{onenoteResource_id}/content";
...
// CreateGetRequestInformation get media content for the navigation property resources from groups
...
// CreatePutRequestInformation update media content for the navigation property resources in groups
...
// Get get media content for the navigation property resources from groups
...
// Put update media content for the navigation property resources in groups
