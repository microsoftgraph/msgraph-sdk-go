...
// SectionGroupsById gets an item from the github.com/microsoftgraph/msgraph-sdk-go/.groups.item.onenote.sections.item.parentNotebook.sectionGroups.item.sectionGroups.item collection
...
// SectionsById gets an item from the github.com/microsoftgraph/msgraph-sdk-go/.groups.item.onenote.sections.item.parentNotebook.sectionGroups.item.sections.item collection
