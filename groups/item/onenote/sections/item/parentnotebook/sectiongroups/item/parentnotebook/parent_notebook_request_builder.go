...
import (
    ...
    ic7371a3698b1007ba108150803a55087295e4da50c8db9939daee1beb13c385c "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/sections/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/sections/{onenoteSection_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*ic7371a3698b1007ba108150803a55087295e4da50c8db9939daee1beb13c385c.CopyNotebookRequestBuilder) {
    return ic7371a3698b1007ba108150803a55087295e4da50c8db9939daee1beb13c385c.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the section group. Read-only.
// Parameters:
