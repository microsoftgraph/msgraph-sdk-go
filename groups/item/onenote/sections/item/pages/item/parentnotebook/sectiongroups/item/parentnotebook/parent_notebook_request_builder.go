...
import (
    ...
    i73f941e41aa104405e2755af956ea174a9286a1a5079d69d3e01c0b263c34e56 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/sections/item/pages/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i73f941e41aa104405e2755af956ea174a9286a1a5079d69d3e01c0b263c34e56.CopyNotebookRequestBuilder) {
    return i73f941e41aa104405e2755af956ea174a9286a1a5079d69d3e01c0b263c34e56.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the section group. Read-only.
// Parameters:
//  - h : Request headers
