...
import (
    ...
    i0a477a3daa44a33d43f56356008d8842acf2cbce7f8ae4a86804716c14f194de "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/sections/item/pages/item/parentsection/ref"
    i42f44fedc9d1f017d1d2ae9778dcd45c2c34c8ab305858c8487bdbdf34b750ec "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/sections/item/pages/item/parentsection/copytosectiongroup"
    i81eef174c0eeadda3ca081bec4196cb29d7e9fd8bf50f01749d44e2063049efc "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/sections/item/pages/item/parentsection/copytonotebook"
)

// ParentSectionRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\sections\{onenoteSection-id}\pages\{onenotePage-id}\parentSection
...
func NewParentSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentSection{?select,expand}";
...
func (m *ParentSectionRequestBuilder) CopyToNotebook()(*i81eef174c0eeadda3ca081bec4196cb29d7e9fd8bf50f01749d44e2063049efc.CopyToNotebookRequestBuilder) {
    return i81eef174c0eeadda3ca081bec4196cb29d7e9fd8bf50f01749d44e2063049efc.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *ParentSectionRequestBuilder) CopyToSectionGroup()(*i42f44fedc9d1f017d1d2ae9778dcd45c2c34c8ab305858c8487bdbdf34b750ec.CopyToSectionGroupRequestBuilder) {
    return i42f44fedc9d1f017d1d2ae9778dcd45c2c34c8ab305858c8487bdbdf34b750ec.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ParentSectionRequestBuilder) Ref()(*i0a477a3daa44a33d43f56356008d8842acf2cbce7f8ae4a86804716c14f194de.RefRequestBuilder) {
    return i0a477a3daa44a33d43f56356008d8842acf2cbce7f8ae4a86804716c14f194de.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
