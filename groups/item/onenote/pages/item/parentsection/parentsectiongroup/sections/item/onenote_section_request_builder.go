...
import (
    ...
    iddb879443de58bb4e31f7d3e67736d740282cb46be3a9dfc41ba60743a501402 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/pages/item/parentsection/parentsectiongroup/sections/item/copytosectiongroup"
    ided2893e1840cebc872360be79eabfb408fc82f67c2142143e7ff930ac6afba2 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/pages/item/parentsection/parentsectiongroup/sections/item/copytonotebook"
)
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/sections/{onenoteSection_id}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*ided2893e1840cebc872360be79eabfb408fc82f67c2142143e7ff930ac6afba2.CopyToNotebookRequestBuilder) {
    return ided2893e1840cebc872360be79eabfb408fc82f67c2142143e7ff930ac6afba2.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*iddb879443de58bb4e31f7d3e67736d740282cb46be3a9dfc41ba60743a501402.CopyToSectionGroupRequestBuilder) {
    return iddb879443de58bb4e31f7d3e67736d740282cb46be3a9dfc41ba60743a501402.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
