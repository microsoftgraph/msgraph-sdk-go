...
import (
    ...
    i7b37fdbb8c324d57e4101eaf990d32a9390a315e9f69543329cc3619b253fa59 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/pages/item/parentnotebook/sectiongroups/item/sections/item/parentnotebook/copynotebook"
)

// parentNotebookRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\pages\{onenotePage-id}\parentNotebook\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i7b37fdbb8c324d57e4101eaf990d32a9390a315e9f69543329cc3619b253fa59.CopyNotebookRequestBuilder) {
    return i7b37fdbb8c324d57e4101eaf990d32a9390a315e9f69543329cc3619b253fa59.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
