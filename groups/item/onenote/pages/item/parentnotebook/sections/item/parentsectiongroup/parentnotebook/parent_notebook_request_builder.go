...
import (
    ...
    i2c0bf967890673f9c5895d0a97d8ca9df798017997ad9b8439a532463566418c "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/pages/item/parentnotebook/sections/item/parentsectiongroup/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\pages\{onenotePage-id}\parentNotebook\sections\{onenoteSection-id}\parentSectionGroup\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/pages/{onenotePage_id}/parentNotebook/sections/{onenoteSection_id}/parentSectionGroup/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i2c0bf967890673f9c5895d0a97d8ca9df798017997ad9b8439a532463566418c.CopyNotebookRequestBuilder) {
    return i2c0bf967890673f9c5895d0a97d8ca9df798017997ad9b8439a532463566418c.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
