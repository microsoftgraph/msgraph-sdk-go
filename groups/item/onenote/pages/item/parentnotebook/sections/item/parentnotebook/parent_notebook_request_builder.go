...
import (
    ...
    i53ada7684a6942557cfcc469929d9f5550a71ae241f57ab7b1ae252ff265671a "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/pages/item/parentnotebook/sections/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/groups/{group_id}/onenote/pages/{onenotePage_id}/parentNotebook/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i53ada7684a6942557cfcc469929d9f5550a71ae241f57ab7b1ae252ff265671a.CopyNotebookRequestBuilder) {
    return i53ada7684a6942557cfcc469929d9f5550a71ae241f57ab7b1ae252ff265671a.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the section.  Read-only.
// Parameters:
//  - h : Request headers
