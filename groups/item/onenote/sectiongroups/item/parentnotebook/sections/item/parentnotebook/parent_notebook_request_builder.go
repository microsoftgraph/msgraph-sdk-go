...
import (
    ...
    ifb63968ef539117dbf4134b77c4ba32e1d74a86df38e2b43f5b1426debccb856 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/sectiongroups/item/parentnotebook/sections/item/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\sectionGroups\{sectionGroup-id}\parentNotebook\sections\{onenoteSection-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/sectionGroups/{sectionGroup_id}/parentNotebook/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*ifb63968ef539117dbf4134b77c4ba32e1d74a86df38e2b43f5b1426debccb856.CopyNotebookRequestBuilder) {
    return ifb63968ef539117dbf4134b77c4ba32e1d74a86df38e2b43f5b1426debccb856.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
