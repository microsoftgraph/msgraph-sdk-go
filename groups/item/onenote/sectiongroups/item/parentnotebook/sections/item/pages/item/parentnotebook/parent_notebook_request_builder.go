...
import (
    ...
    idf651fc3552f347a0c759e23fa8e657aa8bc32b2f7ae6e2947adfd52e95a438f "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/sectiongroups/item/parentnotebook/sections/item/pages/item/parentnotebook/copynotebook"
)

// parentNotebookRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\sectionGroups\{sectionGroup-id}\parentNotebook\sections\{onenoteSection-id}\pages\{onenotePage-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/sectionGroups/{sectionGroup_id}/parentNotebook/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*idf651fc3552f347a0c759e23fa8e657aa8bc32b2f7ae6e2947adfd52e95a438f.CopyNotebookRequestBuilder) {
    return idf651fc3552f347a0c759e23fa8e657aa8bc32b2f7ae6e2947adfd52e95a438f.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
