...
import (
    ...
    i37d2c606dc44ca96d27401ac96f76fe4c69f8d5e3770b3ec0aed6b076c7bc0e9 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/sectiongroups/item/parentsectiongroup/ref"
)

// ParentSectionGroupRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\sectionGroups\{sectionGroup-id}\parentSectionGroup
...
func NewParentSectionGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentSectionGroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/sectionGroups/{sectionGroup_id}/parentSectionGroup{?select,expand}";
...
func (m *ParentSectionGroupRequestBuilder) Ref()(*i37d2c606dc44ca96d27401ac96f76fe4c69f8d5e3770b3ec0aed6b076c7bc0e9.RefRequestBuilder) {
    return i37d2c606dc44ca96d27401ac96f76fe4c69f8d5e3770b3ec0aed6b076c7bc0e9.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
