...
import (
    ...
    i1d606820e66b0eae277a5c338fc9b84effc2d3a5766127bb20f1731a23bbb4a0 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/onenote/sectiongroups/item/sections/item/pages/item/parentnotebook/ref"
...
// ParentNotebookRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\pages\{onenotePage-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) Ref()(*i1d606820e66b0eae277a5c338fc9b84effc2d3a5766127bb20f1731a23bbb4a0.RefRequestBuilder) {
    return i1d606820e66b0eae277a5c338fc9b84effc2d3a5766127bb20f1731a23bbb4a0.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
