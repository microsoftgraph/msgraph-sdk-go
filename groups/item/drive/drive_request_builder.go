...
import (
    ...
    ib1b4c893ce0697a027adccd465a42dab0683622733f150fc905f712d73a1aebc "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drive/ref"
)

// DriveRequestBuilder builds and executes requests for operations under \groups\{group-id}\drive
...
// DriveRequestBuilderGetQueryParameters the group's default drive. Read-only.
...
func NewDriveRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drive{?select,expand}";
...
// CreateGetRequestInformation the group's default drive. Read-only.
...
func (m *DriveRequestBuilder) Ref()(*ib1b4c893ce0697a027adccd465a42dab0683622733f150fc905f712d73a1aebc.RefRequestBuilder) {
    return ib1b4c893ce0697a027adccd465a42dab0683622733f150fc905f712d73a1aebc.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
