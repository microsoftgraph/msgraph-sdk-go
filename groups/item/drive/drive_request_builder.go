...
// CreateGetRequestInformationWithRequestConfiguration the group's default drive. Read-only.
...
// GetWithRequestConfigurationAndResponseHandler the group's default drive. Read-only.
