...
// CreateDeleteRequestInformation the group's default drive. Read-only.
...
// CreatePatchRequestInformation the group's default drive. Read-only.
...
// Delete the group's default drive. Read-only.
...
// Patch the group's default drive. Read-only.
