...
func NewSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SettingsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/settings{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SettingsRequestBuilder) Get(options *SettingsRequestBuilderGetOptions)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.GroupSettingCollectionResponseable, error) {
...
func (m *SettingsRequestBuilder) Post(options *SettingsRequestBuilderPostOptions)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.GroupSettingable, error) {
