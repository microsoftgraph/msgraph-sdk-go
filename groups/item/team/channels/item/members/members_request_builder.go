...
import (
    ...
    i0d3fc293d44e7a73e1c2383f6a5f6652698c931dc34bc2042319cae3c9ed5b02 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/team/channels/item/members/add"
    ib20bee64593a9bf54ef44e89f8fba0ef56fe122ff7509999146e81271cbe7d79 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/team/channels/item/members/count"
)
...
func (m *MembersRequestBuilder) Add()(*i0d3fc293d44e7a73e1c2383f6a5f6652698c931dc34bc2042319cae3c9ed5b02.AddRequestBuilder) {
    return i0d3fc293d44e7a73e1c2383f6a5f6652698c931dc34bc2042319cae3c9ed5b02.NewAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/team/channels/{channel_id}/members{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MembersRequestBuilder) Count()(*ib20bee64593a9bf54ef44e89f8fba0ef56fe122ff7509999146e81271cbe7d79.CountRequestBuilder) {
    return ib20bee64593a9bf54ef44e89f8fba0ef56fe122ff7509999146e81271cbe7d79.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
