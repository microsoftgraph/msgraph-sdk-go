...
import (
    ...
    i8a4e5fdd0341f7725e0679beb2b2f179d31a0dddff38467cdef03e1572d46aba "github.com/microsoftgraph/msgraph-sdk-go/groups/item/team/channels/item/messages/item/hostedcontents/count"
)
...
func NewHostedContentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HostedContentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/team/channels/{channel_id}/messages/{chatMessage_id}/hostedContents{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *HostedContentsRequestBuilder) Count()(*i8a4e5fdd0341f7725e0679beb2b2f179d31a0dddff38467cdef03e1572d46aba.CountRequestBuilder) {
    return i8a4e5fdd0341f7725e0679beb2b2f179d31a0dddff38467cdef03e1572d46aba.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
