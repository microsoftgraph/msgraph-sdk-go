...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to hostedContents for groups
...
// PostWithResponseHandler create new navigation property to hostedContents for groups
