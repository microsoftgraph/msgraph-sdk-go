...
// DeleteWithResponseHandler delete navigation property primaryChannel for groups
...
// PatchWithResponseHandler update the navigation property primaryChannel in groups
