...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property replies for groups
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property replies in groups
