...
// RefRequestBuilderDeleteQueryParameters delete ref of navigation property acceptedSenders for groups
...
// CreateDeleteRequestInformationWithRequestConfiguration delete ref of navigation property acceptedSenders for groups
