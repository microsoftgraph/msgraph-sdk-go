...
import (
    ...
    i416563d04eae5a29633c49ee934268c16b298e246bc9393024b964a6587dfd1d "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/onenote/notebooks/item/sectiongroups/item/sections/count"
)
...
func NewSectionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SectionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SectionsRequestBuilder) Count()(*i416563d04eae5a29633c49ee934268c16b298e246bc9393024b964a6587dfd1d.CountRequestBuilder) {
    return i416563d04eae5a29633c49ee934268c16b298e246bc9393024b964a6587dfd1d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *SectionsRequestBuilder) Get(options *SectionsRequestBuilderGetOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.OnenoteSectionCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CreateOnenoteSectionCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.OnenoteSectionCollectionResponseable), nil
}
// Post create new navigation property to sections for groups
func (m *SectionsRequestBuilder) Post(options *SectionsRequestBuilderPostOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.OnenoteSectionable, error) {
