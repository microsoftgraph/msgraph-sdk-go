...
import (
    ...
    if6e40075a2373eaea3599bb388e3fea42123b7484d9f260694f53f4ee1aa9a63 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/onenote/notebooks/item/sectiongroups/item/sections/item/pages/count"
)
...
func NewPagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/pages{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PagesRequestBuilder) Count()(*if6e40075a2373eaea3599bb388e3fea42123b7484d9f260694f53f4ee1aa9a63.CountRequestBuilder) {
    return if6e40075a2373eaea3599bb388e3fea42123b7484d9f260694f53f4ee1aa9a63.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
