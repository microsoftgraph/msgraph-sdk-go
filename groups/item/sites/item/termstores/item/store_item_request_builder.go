...
// DeleteWithResponseHandler delete navigation property termStores for groups
...
// PatchWithResponseHandler update the navigation property termStores in groups
