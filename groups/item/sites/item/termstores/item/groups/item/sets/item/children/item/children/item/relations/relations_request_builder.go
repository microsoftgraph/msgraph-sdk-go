...
import (
    ...
    i56873d1af926b2788b09eb311ebc85fa60d70841c0d8cf959ecd715bbcd6da16 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstores/item/groups/item/sets/item/children/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/groups/{group_id1}/sets/{set_id}/children/{term_id}/children/{term_id1}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*i56873d1af926b2788b09eb311ebc85fa60d70841c0d8cf959ecd715bbcd6da16.CountRequestBuilder) {
    return i56873d1af926b2788b09eb311ebc85fa60d70841c0d8cf959ecd715bbcd6da16.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
