...
import (
    ...
    i635d56b44aed18223a18a8a19b5964925cf2dad1fd0c7dce4eae8faab4cad9d5 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstores/item/groups/item/sets/item/terms/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/groups/{group_id1}/sets/{set_id}/terms/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i635d56b44aed18223a18a8a19b5964925cf2dad1fd0c7dce4eae8faab4cad9d5.CountRequestBuilder) {
    return i635d56b44aed18223a18a8a19b5964925cf2dad1fd0c7dce4eae8faab4cad9d5.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
