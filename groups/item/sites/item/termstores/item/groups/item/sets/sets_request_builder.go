...
import (
    ...
    iab5409c276c932316c898b96cec3c86e0dd253468737f165f70c882962413bcd "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstores/item/groups/item/sets/count"
)
...
func NewSetsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/groups/{group_id1}/sets{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SetsRequestBuilder) Count()(*iab5409c276c932316c898b96cec3c86e0dd253468737f165f70c882962413bcd.CountRequestBuilder) {
    return iab5409c276c932316c898b96cec3c86e0dd253468737f165f70c882962413bcd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
