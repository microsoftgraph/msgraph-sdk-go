...
import (
    ...
    ib39c055c68018143aa6acd5025f8cad86d11a6881bc48fddf5cba4734caa239d "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstores/item/groups/item/sets/item/children/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/groups/{group_id1}/sets/{set_id}/children/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*ib39c055c68018143aa6acd5025f8cad86d11a6881bc48fddf5cba4734caa239d.CountRequestBuilder) {
    return ib39c055c68018143aa6acd5025f8cad86d11a6881bc48fddf5cba4734caa239d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
