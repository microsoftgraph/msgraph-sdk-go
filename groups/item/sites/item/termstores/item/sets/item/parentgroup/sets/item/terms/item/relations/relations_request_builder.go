...
import (
    ...
    i034bfd24c0b175096ce22185a0f300b580cf7cc0e4a6b09c1b7dfc10c890f27e "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstores/item/sets/item/parentgroup/sets/item/terms/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/terms/{term_id}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*i034bfd24c0b175096ce22185a0f300b580cf7cc0e4a6b09c1b7dfc10c890f27e.CountRequestBuilder) {
    return i034bfd24c0b175096ce22185a0f300b580cf7cc0e4a6b09c1b7dfc10c890f27e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
