...
import (
    ...
    ia0c1fe295817011ef3ac4a5f6261b01810b36f4f72a3db63e91261e974d507a2 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstores/item/sets/item/parentgroup/sets/item/terms/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/terms/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*ia0c1fe295817011ef3ac4a5f6261b01810b36f4f72a3db63e91261e974d507a2.CountRequestBuilder) {
    return ia0c1fe295817011ef3ac4a5f6261b01810b36f4f72a3db63e91261e974d507a2.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ChildrenRequestBuilder) Get(options *ChildrenRequestBuilderGetOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.TermCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CreateTermCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.TermCollectionResponseable), nil
}
// Post create new navigation property to children for groups
func (m *ChildrenRequestBuilder) Post(options *ChildrenRequestBuilderPostOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Termable, error) {
