...
import (
    ...
    ic719c17d6dd1e307f5243686facf1d88743fc36a074030d3c9ce43f9c2917ae7 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstores/item/sets/item/terms/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*ic719c17d6dd1e307f5243686facf1d88743fc36a074030d3c9ce43f9c2917ae7.CountRequestBuilder) {
    return ic719c17d6dd1e307f5243686facf1d88743fc36a074030d3c9ce43f9c2917ae7.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
