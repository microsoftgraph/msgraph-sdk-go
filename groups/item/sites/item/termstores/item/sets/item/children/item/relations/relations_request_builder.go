...
import (
    ...
    ie3af99af3033522391d8d2a3288ad10ba486b8aef8f912a90a2e1299d9248b55 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstores/item/sets/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/children/{term_id}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*ie3af99af3033522391d8d2a3288ad10ba486b8aef8f912a90a2e1299d9248b55.CountRequestBuilder) {
    return ie3af99af3033522391d8d2a3288ad10ba486b8aef8f912a90a2e1299d9248b55.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
