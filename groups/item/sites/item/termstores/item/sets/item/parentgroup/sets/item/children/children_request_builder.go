...
import (
    ...
    i7edc403bdf41452f166823d224d76ee24963ae788d322638c799fa4cd3c75f5e "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstores/item/sets/item/parentgroup/sets/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i7edc403bdf41452f166823d224d76ee24963ae788d322638c799fa4cd3c75f5e.CountRequestBuilder) {
    return i7edc403bdf41452f166823d224d76ee24963ae788d322638c799fa4cd3c75f5e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
