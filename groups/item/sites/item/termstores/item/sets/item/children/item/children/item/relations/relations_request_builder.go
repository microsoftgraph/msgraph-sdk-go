...
import (
    ...
    i2fa690102b32d0a23498499512bac1cf99817b06ca494da8137798ae69a83585 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstores/item/sets/item/children/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/children/{term_id}/children/{term_id1}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*i2fa690102b32d0a23498499512bac1cf99817b06ca494da8137798ae69a83585.CountRequestBuilder) {
    return i2fa690102b32d0a23498499512bac1cf99817b06ca494da8137798ae69a83585.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
