...
import (
    ...
    iab94be6d2cb74197ead2caddcdd253a1f23ada5133f20eba9e65cd1e5325702c "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstores/item/sets/item/parentgroup/sets/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/children/{term_id}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*iab94be6d2cb74197ead2caddcdd253a1f23ada5133f20eba9e65cd1e5325702c.CountRequestBuilder) {
    return iab94be6d2cb74197ead2caddcdd253a1f23ada5133f20eba9e65cd1e5325702c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
