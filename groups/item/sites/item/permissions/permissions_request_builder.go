...
import (
    ...
    i32adff52b63f4888e8140fe73e9c40cc7cb56f42de7e2f50afa0742ff0ec780e "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/permissions/count"
)
...
func NewPermissionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/permissions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PermissionsRequestBuilder) Count()(*i32adff52b63f4888e8140fe73e9c40cc7cb56f42de7e2f50afa0742ff0ec780e.CountRequestBuilder) {
    return i32adff52b63f4888e8140fe73e9c40cc7cb56f42de7e2f50afa0742ff0ec780e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
