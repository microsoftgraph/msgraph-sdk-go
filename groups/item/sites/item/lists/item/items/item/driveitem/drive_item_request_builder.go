...
import (
    ...
    i07ec2770e4448662a51e2b8489f6d91eb80f454663c7c60a2937fc7d682e2af8 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/lists/item/items/item/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/lists/{list_id}/items/{listItem_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i07ec2770e4448662a51e2b8489f6d91eb80f454663c7c60a2937fc7d682e2af8.ContentRequestBuilder) {
    return i07ec2770e4448662a51e2b8489f6d91eb80f454663c7c60a2937fc7d682e2af8.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
