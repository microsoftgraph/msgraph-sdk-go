...
type CopyToDefaultContentLocationRequestBuilderPostOptions struct {
    // 
    Body CopyToDefaultContentLocationRequestBodyable;
    // Request headers
...
func NewCopyToDefaultContentLocationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CopyToDefaultContentLocationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/lists/{list_id}/contentTypes/{contentType_id}/microsoft.graph.copyToDefaultContentLocation";
...
func (m *CopyToDefaultContentLocationRequestBuilder) CreatePostRequestInformation(options *CopyToDefaultContentLocationRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
