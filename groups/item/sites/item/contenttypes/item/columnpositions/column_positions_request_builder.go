...
import (
    ...
    i99c4127a9e20f300a1cc68ca25eb9e36a5ad48cabd9690d2a96915aafecc9e2f "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/contenttypes/item/columnpositions/count"
)
...
func NewColumnPositionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ColumnPositionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/contentTypes/{contentType_id}/columnPositions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ColumnPositionsRequestBuilder) Count()(*i99c4127a9e20f300a1cc68ca25eb9e36a5ad48cabd9690d2a96915aafecc9e2f.CountRequestBuilder) {
    return i99c4127a9e20f300a1cc68ca25eb9e36a5ad48cabd9690d2a96915aafecc9e2f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
