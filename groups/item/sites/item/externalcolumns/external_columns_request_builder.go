...
// CreateGetRequestInformationWithRequestConfiguration get externalColumns from groups
...
// GetWithRequestConfigurationAndResponseHandler get externalColumns from groups
