...
// siteRequestBuilder builds and executes requests for operations under \groups\{group-id}\sites\{site-id}
...
// siteRequestBuilderGetQueryParameters the list of SharePoint sites in this group. Access the default site with /sites/root.
...
// CreateDeleteRequestInformation the list of SharePoint sites in this group. Access the default site with /sites/root.
...
// CreatePatchRequestInformation the list of SharePoint sites in this group. Access the default site with /sites/root.
...
// Delete the list of SharePoint sites in this group. Access the default site with /sites/root.
...
// Patch the list of SharePoint sites in this group. Access the default site with /sites/root.
