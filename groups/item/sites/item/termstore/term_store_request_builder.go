...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property termStore for groups
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property termStore in groups
