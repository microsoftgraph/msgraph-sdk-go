...
import (
    ...
    ibef5be94fcd81b8f4d9df9e0e9ffc4a6cc8ab1aa1c60a05e22a532275e1d064e "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstore/sets/item/parentgroup/sets/item/terms/count"
)
...
func NewTermsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TermsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStore/sets/{set_id}/parentGroup/sets/{set_id1}/terms{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *TermsRequestBuilder) Count()(*ibef5be94fcd81b8f4d9df9e0e9ffc4a6cc8ab1aa1c60a05e22a532275e1d064e.CountRequestBuilder) {
    return ibef5be94fcd81b8f4d9df9e0e9ffc4a6cc8ab1aa1c60a05e22a532275e1d064e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
