...
import (
    ...
    ie3d6dfc003487fc97b5ed06c3f4fcc0747b4aa315cadd938e9dbc114c0d29f47 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstore/sets/item/parentgroup/sets/item/children/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStore/sets/{set_id}/parentGroup/sets/{set_id1}/children/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*ie3d6dfc003487fc97b5ed06c3f4fcc0747b4aa315cadd938e9dbc114c0d29f47.CountRequestBuilder) {
    return ie3d6dfc003487fc97b5ed06c3f4fcc0747b4aa315cadd938e9dbc114c0d29f47.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
