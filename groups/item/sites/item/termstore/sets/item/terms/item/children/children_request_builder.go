...
import (
    ...
    i1f4cad24de70dba8652e5f57d81d27a373e2e3283eafcd9ab41cf0a61b775f36 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstore/sets/item/terms/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStore/sets/{set_id}/terms/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i1f4cad24de70dba8652e5f57d81d27a373e2e3283eafcd9ab41cf0a61b775f36.CountRequestBuilder) {
    return i1f4cad24de70dba8652e5f57d81d27a373e2e3283eafcd9ab41cf0a61b775f36.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
