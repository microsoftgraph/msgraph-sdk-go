...
import (
    ...
    i8a0e4d04970b16a075a9ef9b1b8d91112cf4261ae384799fbe3f25227b75dd63 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstore/groups/item/sets"
    i6feee59f8ff23cc63eafa1b33c0a07de15721906170de869886208f7a5d6649c "github.com/microsoftgraph/msgraph-sdk-go/groups/item/sites/item/termstore/groups/item/sets/item"
)
...
func NewGroupItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GroupItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStore/groups/{group_id1}{?select,expand}";
...
func (m *GroupItemRequestBuilder) Sets()(*i8a0e4d04970b16a075a9ef9b1b8d91112cf4261ae384799fbe3f25227b75dd63.SetsRequestBuilder) {
    return i8a0e4d04970b16a075a9ef9b1b8d91112cf4261ae384799fbe3f25227b75dd63.NewSetsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SetsById gets an item from the github.com/microsoftgraph/msgraph-sdk-go/.groups.item.sites.item.termStore.groups.item.sets.item collection
func (m *GroupItemRequestBuilder) SetsById(id string)(*i6feee59f8ff23cc63eafa1b33c0a07de15721906170de869886208f7a5d6649c.SetItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i6feee59f8ff23cc63eafa1b33c0a07de15721906170de869886208f7a5d6649c.NewSetItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
