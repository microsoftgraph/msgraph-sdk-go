...
import (
    ...
    i509898b99c7221e81ee3306e6d4f19ab81c73891f6c77339118bc52462d49cdc "github.com/microsoftgraph/msgraph-sdk-go/groups/item/memberof/group/count"
)
...
func NewGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/memberOf/microsoft.graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *GroupRequestBuilder) Count()(*i509898b99c7221e81ee3306e6d4f19ab81c73891f6c77339118bc52462d49cdc.CountRequestBuilder) {
    return i509898b99c7221e81ee3306e6d4f19ab81c73891f6c77339118bc52462d49cdc.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
