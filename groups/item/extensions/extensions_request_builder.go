...
// ExtensionsRequestBuilder builds and executes requests for operations under \groups\{group-id}\extensions
...
// CreatePostRequestInformation the collection of open extensions defined for the group. Read-only. Nullable.
...
// Post the collection of open extensions defined for the group. Read-only. Nullable.
