...
// DriveRequestBuilder builds and executes requests for operations under \groups\{group-id}\drives\{drive-id}
...
// DriveRequestBuilderGetQueryParameters the group's drives. Read-only.
