...
import (
    ...
    i87b19a7d9579c0782f64e70ef39515526de820bd07738c94c3f6d48a9714992e "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/following/item/children/item/content"
)
...
func NewDriveItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
...
func (m *DriveItemItemRequestBuilder) Content()(*i87b19a7d9579c0782f64e70ef39515526de820bd07738c94c3f6d48a9714992e.ContentRequestBuilder) {
    return i87b19a7d9579c0782f64e70ef39515526de820bd07738c94c3f6d48a9714992e.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
