...
import (
    ...
    i0b5ad89cf84a20d782e65b3a6ef0689f0029ed581ecac815efe42ad831506742 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/following/item/permissions/count"
)
...
func NewPermissionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/permissions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PermissionsRequestBuilder) Count()(*i0b5ad89cf84a20d782e65b3a6ef0689f0029ed581ecac815efe42ad831506742.CountRequestBuilder) {
    return i0b5ad89cf84a20d782e65b3a6ef0689f0029ed581ecac815efe42ad831506742.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
