...
import (
    ...
    i745c5a7c426c25654a6184dd37891e2c4f76c4e4e27265326724d412394d5ca0 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/bundles/item/permissions/count"
)
...
func NewPermissionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/permissions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PermissionsRequestBuilder) Count()(*i745c5a7c426c25654a6184dd37891e2c4f76c4e4e27265326724d412394d5ca0.CountRequestBuilder) {
    return i745c5a7c426c25654a6184dd37891e2c4f76c4e4e27265326724d412394d5ca0.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
