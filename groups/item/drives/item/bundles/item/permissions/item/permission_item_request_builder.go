...
import (
    ...
    idffc4877a659761e33f830683d9115078d9862622a00cd0dea5d661db8a95b93 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/bundles/item/permissions/item/grant"
)
...
func NewPermissionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/permissions/{permission_id}{?select,expand}";
...
func (m *PermissionItemRequestBuilder) Grant()(*idffc4877a659761e33f830683d9115078d9862622a00cd0dea5d661db8a95b93.GrantRequestBuilder) {
    return idffc4877a659761e33f830683d9115078d9862622a00cd0dea5d661db8a95b93.NewGrantRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
