...
import (
    ...
    i44525984cbe98718a115cf82a65b498db35b53cc406f4d63866060ec8cba1de2 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/bundles/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*i44525984cbe98718a115cf82a65b498db35b53cc406f4d63866060ec8cba1de2.CountRequestBuilder) {
    return i44525984cbe98718a115cf82a65b498db35b53cc406f4d63866060ec8cba1de2.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
