...
import (
    ...
    id57edb0e345ba359ad0ce2aec9943fc4810fa88169f52f0072e10fa690df21cb "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/bundles/item/listitem/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/listItem/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*id57edb0e345ba359ad0ce2aec9943fc4810fa88169f52f0072e10fa690df21cb.CountRequestBuilder) {
    return id57edb0e345ba359ad0ce2aec9943fc4810fa88169f52f0072e10fa690df21cb.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *VersionsRequestBuilder) Get(options *VersionsRequestBuilderGetOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ListItemVersionCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CreateListItemVersionCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ListItemVersionCollectionResponseable), nil
}
// Post create new navigation property to versions for groups
func (m *VersionsRequestBuilder) Post(options *VersionsRequestBuilderPostOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ListItemVersionable, error) {
