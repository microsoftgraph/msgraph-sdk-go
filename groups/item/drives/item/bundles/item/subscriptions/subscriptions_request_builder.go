...
import (
    ...
    i5b7139f9c9b1ec54970303173e79c608ec7f27f4d5fa60bc1ae02a593c0c00d9 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/bundles/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*i5b7139f9c9b1ec54970303173e79c608ec7f27f4d5fa60bc1ae02a593c0c00d9.CountRequestBuilder) {
    return i5b7139f9c9b1ec54970303173e79c608ec7f27f4d5fa60bc1ae02a593c0c00d9.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
