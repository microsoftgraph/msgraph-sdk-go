...
import (
    ...
    ib460302971caf541793188d6b679da0012fa0ec74c5a1cd4fcb367c8169e3bcb "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/bundles/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*ib460302971caf541793188d6b679da0012fa0ec74c5a1cd4fcb367c8169e3bcb.CountRequestBuilder) {
    return ib460302971caf541793188d6b679da0012fa0ec74c5a1cd4fcb367c8169e3bcb.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
