...
import (
    ...
    i657f148939ddffbd03abce4d3965647b1ccfbeb3d58cd724f40f5df624b80581 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/special/count"
)
...
func NewSpecialRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SpecialRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/special{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SpecialRequestBuilder) Count()(*i657f148939ddffbd03abce4d3965647b1ccfbeb3d58cd724f40f5df624b80581.CountRequestBuilder) {
    return i657f148939ddffbd03abce4d3965647b1ccfbeb3d58cd724f40f5df624b80581.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to special for groups
...
func (m *SpecialRequestBuilder) Get(options *SpecialRequestBuilderGetOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.DriveItemCollectionResponseable, error) {
...
// Post create new navigation property to special for groups
func (m *SpecialRequestBuilder) Post(options *SpecialRequestBuilderPostOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.DriveItemable, error) {
