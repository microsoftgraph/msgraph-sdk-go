...
import (
    ...
    i549342d3bba0e59badf27fce24726931fd533ba0ce1ddcb202f9b5553e4fd6dd "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/special/item/permissions/count"
)
...
func NewPermissionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/special/{driveItem_id}/permissions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PermissionsRequestBuilder) Count()(*i549342d3bba0e59badf27fce24726931fd533ba0ce1ddcb202f9b5553e4fd6dd.CountRequestBuilder) {
    return i549342d3bba0e59badf27fce24726931fd533ba0ce1ddcb202f9b5553e4fd6dd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
