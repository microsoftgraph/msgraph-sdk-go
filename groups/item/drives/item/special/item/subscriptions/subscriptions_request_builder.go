...
import (
    ...
    icdf744486aae1baa72c481a04910b6d87ac37e95eea0eeb6ad7805d7fca0a478 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/special/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/special/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*icdf744486aae1baa72c481a04910b6d87ac37e95eea0eeb6ad7805d7fca0a478.CountRequestBuilder) {
    return icdf744486aae1baa72c481a04910b6d87ac37e95eea0eeb6ad7805d7fca0a478.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
