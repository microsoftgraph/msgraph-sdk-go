...
import (
    ...
    i49127246c692a18d4119f642a75f5a5cecb2345d796a1f310a82be3192ed0656 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/special/item/children/item/content"
)
...
func NewDriveItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/special/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
...
func (m *DriveItemItemRequestBuilder) Content()(*i49127246c692a18d4119f642a75f5a5cecb2345d796a1f310a82be3192ed0656.ContentRequestBuilder) {
    return i49127246c692a18d4119f642a75f5a5cecb2345d796a1f310a82be3192ed0656.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
