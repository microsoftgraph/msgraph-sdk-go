...
import (
    ...
    i8908d4c7d690930ee98f44faed7c2fb0a7816566fd79ffa9d43aa8b86c5bd49a "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/special/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/special/{driveItem_id}/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*i8908d4c7d690930ee98f44faed7c2fb0a7816566fd79ffa9d43aa8b86c5bd49a.CountRequestBuilder) {
    return i8908d4c7d690930ee98f44faed7c2fb0a7816566fd79ffa9d43aa8b86c5bd49a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
