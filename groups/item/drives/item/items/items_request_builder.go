...
import (
    ...
    i3b3e789eb1f549cd2459bba2236457c64a43ba45d0cb9b4e961eaec1c9b468ce "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/items/count"
)
...
func NewItemsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ItemsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/items{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ItemsRequestBuilder) Count()(*i3b3e789eb1f549cd2459bba2236457c64a43ba45d0cb9b4e961eaec1c9b468ce.CountRequestBuilder) {
    return i3b3e789eb1f549cd2459bba2236457c64a43ba45d0cb9b4e961eaec1c9b468ce.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
