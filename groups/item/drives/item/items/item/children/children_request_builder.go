...
import (
    ...
    i804544900b1d7c5be4f0d300d3af542481cc22d12e4eb399e354efc5be21f37d "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/items/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/items/{driveItem_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i804544900b1d7c5be4f0d300d3af542481cc22d12e4eb399e354efc5be21f37d.CountRequestBuilder) {
    return i804544900b1d7c5be4f0d300d3af542481cc22d12e4eb399e354efc5be21f37d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
