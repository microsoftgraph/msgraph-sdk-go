...
import (
    ...
    i118b9242a4268e9eba633b0b5d6891a4729ab8283471a4f975cbb791db11c129 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/drives/item/items/item/children/item/content"
)
...
func NewDriveItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/items/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
...
func (m *DriveItemItemRequestBuilder) Content()(*i118b9242a4268e9eba633b0b5d6891a4729ab8283471a4f975cbb791db11c129.ContentRequestBuilder) {
    return i118b9242a4268e9eba633b0b5d6891a4729ab8283471a4f975cbb791db11c129.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
