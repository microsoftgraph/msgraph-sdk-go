...
// singleValueExtendedPropertiesRequestBuilder builds and executes requests for operations under \groups\{group-id}\calendarView\{event-id}\calendar\singleValueExtendedProperties
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/calendarView/{event_id}/calendar/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
