...
import (
    ...
    i613293e531ea806e14ded2da15a4d15efb8b828277da41d32e359b3780c338fa "github.com/microsoftgraph/msgraph-sdk-go/groups/item/calendarview/item/calendar/calendarview/delta"
)

// CalendarViewRequestBuilder builds and executes requests for operations under \groups\{group-id}\calendarView\{event-id}\calendar\calendarView
...
func NewCalendarViewRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CalendarViewRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/calendarView/{event_id}/calendar/calendarView{?top,skip,filter,count,orderby,select}";
...
// Delta builds and executes requests for operations under \groups\{group-id}\calendarView\{event-id}\calendar\calendarView\microsoft.graph.delta()
func (m *CalendarViewRequestBuilder) Delta()(*i613293e531ea806e14ded2da15a4d15efb8b828277da41d32e359b3780c338fa.DeltaRequestBuilder) {
    return i613293e531ea806e14ded2da15a4d15efb8b828277da41d32e359b3780c338fa.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
