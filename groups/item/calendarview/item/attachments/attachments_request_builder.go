...
import (
    ...
    id9fba29d8ceae43b5ff7867c4070882a65222570976ffbbf4c798e66b5740605 "github.com/microsoftgraph/msgraph-sdk-go/groups/item/calendarview/item/attachments/createuploadsession"
    ied705abe88cd35e8eca65cecd5374161e97303597d42e8191fadd46f323f133e "github.com/microsoftgraph/msgraph-sdk-go/groups/item/calendarview/item/attachments/count"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/calendarView/{event_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*ied705abe88cd35e8eca65cecd5374161e97303597d42e8191fadd46f323f133e.CountRequestBuilder) {
    return ied705abe88cd35e8eca65cecd5374161e97303597d42e8191fadd46f323f133e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*id9fba29d8ceae43b5ff7867c4070882a65222570976ffbbf4c798e66b5740605.CreateUploadSessionRequestBuilder) {
    return id9fba29d8ceae43b5ff7867c4070882a65222570976ffbbf4c798e66b5740605.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
