...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property photos for groups
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property photos in groups
