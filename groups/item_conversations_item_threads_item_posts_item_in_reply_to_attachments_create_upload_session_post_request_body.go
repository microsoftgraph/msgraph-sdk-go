...
// ItemConversationsItemThreadsItemPostsItemInReplyToAttachmentsCreateUploadSessionPostRequestBody provides operations to call the createUploadSession method.
...
func (m *ItemConversationsItemThreadsItemPostsItemInReplyToAttachmentsCreateUploadSessionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemConversationsItemThreadsItemPostsItemInReplyToAttachmentsCreateUploadSessionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
