...
func (m *ItemTeamPrimaryChannelMessagesItemRepliesRequestBuilder) MicrosoftGraphDelta()(*ItemTeamPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemTeamPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
