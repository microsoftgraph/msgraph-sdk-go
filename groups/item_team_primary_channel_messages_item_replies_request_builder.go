...
func (m *ItemTeamPrimaryChannelMessagesItemRepliesRequestBuilder) MicrosoftGraphDelta()(*ItemTeamPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemTeamPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
