...
// NewItemTeamScheduleTimeCardsItemStartBreakPostRequestBody instantiates a new ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody and sets the default values.
...
func CreateItemTeamScheduleTimeCardsItemStartBreakPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
...
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) GetIsAtApprovedLocation()(*bool) {
...
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) GetNotes()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ItemBodyable) {
...
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetIsAtApprovedLocation sets the isAtApprovedLocation property value. The isAtApprovedLocation property
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) SetIsAtApprovedLocation(value *bool)() {
...
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) SetNotes(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ItemBodyable)() {
    err := m.GetBackingStore().Set("notes", value)
    if err != nil {
        panic(err)
    }
}
type ItemTeamScheduleTimeCardsItemStartBreakPostRequestBodyable interface {
