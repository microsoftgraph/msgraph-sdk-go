...
// ItemThreadsItemPostsItemForwardPostRequestBody provides operations to call the forward method.
...
func (m *ItemThreadsItemPostsItemForwardPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemThreadsItemPostsItemForwardPostRequestBody) SetAdditionalData(value map[string]interface{})() {
