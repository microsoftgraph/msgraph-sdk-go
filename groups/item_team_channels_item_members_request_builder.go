...
func (m *ItemTeamChannelsItemMembersRequestBuilder) MicrosoftGraphAdd()(*ItemTeamChannelsItemMembersMicrosoftGraphAddAddRequestBuilder) {
    return NewItemTeamChannelsItemMembersMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
