...
func (m *ItemTeamChannelsItemMembersRequestBuilder) MicrosoftGraphAdd()(*ItemTeamChannelsItemMembersMicrosoftGraphAddRequestBuilder) {
    return NewItemTeamChannelsItemMembersMicrosoftGraphAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
