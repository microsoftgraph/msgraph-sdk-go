...
// ItemOwnersUserCountRequestBuilderGetQueryParameters get the number of the resource
type ItemOwnersUserCountRequestBuilderGetQueryParameters struct {
...
type ItemOwnersUserCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemOwnersUserCountRequestBuilderGetQueryParameters
}
...
func NewItemOwnersUserCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersUserCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/owners/microsoft.graph.user/$count{?%24search,%24filter}";
