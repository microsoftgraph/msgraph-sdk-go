...
// ItemCalendarViewItemInstancesItemDeclinePostRequestBody provides operations to call the decline method.
...
func (m *ItemCalendarViewItemInstancesItemDeclinePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarViewItemInstancesItemDeclinePostRequestBody) SetAdditionalData(value map[string]interface{})() {
