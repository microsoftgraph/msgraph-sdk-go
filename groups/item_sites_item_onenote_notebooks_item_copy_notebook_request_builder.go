...
func NewItemSitesItemOnenoteNotebooksItemCopyNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemOnenoteNotebooksItemCopyNotebookRequestBuilder) {
    m := &ItemSitesItemOnenoteNotebooksItemCopyNotebookRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/copyNotebook", pathParameters),
    }
    return m
}
...
func (m *ItemSitesItemOnenoteNotebooksItemCopyNotebookRequestBuilder) Post(ctx context.Context, body ItemSitesItemOnenoteNotebooksItemCopyNotebookPostRequestBodyable, requestConfiguration *ItemSitesItemOnenoteNotebooksItemCopyNotebookRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.OnenoteOperationable, error) {
...
func (m *ItemSitesItemOnenoteNotebooksItemCopyNotebookRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemOnenoteNotebooksItemCopyNotebookRequestBuilder) {
    return NewItemSitesItemOnenoteNotebooksItemCopyNotebookRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
