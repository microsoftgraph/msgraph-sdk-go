...
func (m *ItemTeamChannelsItemMessagesItemRepliesRequestBuilder) MicrosoftGraphDelta()(*ItemTeamChannelsItemMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemTeamChannelsItemMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
