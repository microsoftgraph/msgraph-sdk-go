...
// NewItemCalendarViewItemExceptionOccurrencesDeltaRequestBuilderInternal instantiates a new ItemCalendarViewItemExceptionOccurrencesDeltaRequestBuilder and sets the default values.
func NewItemCalendarViewItemExceptionOccurrencesDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarViewItemExceptionOccurrencesDeltaRequestBuilder) {
    m := &ItemCalendarViewItemExceptionOccurrencesDeltaRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/delta()?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemCalendarViewItemExceptionOccurrencesDeltaRequestBuilder instantiates a new ItemCalendarViewItemExceptionOccurrencesDeltaRequestBuilder and sets the default values.
...
// returns a ItemCalendarViewItemExceptionOccurrencesDeltaResponseable when successful
...
// returns a ItemCalendarViewItemExceptionOccurrencesDeltaGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/event-delta?view=graph-rest-1.0
