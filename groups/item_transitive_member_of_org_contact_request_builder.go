...
func NewItemTransitiveMemberOfOrgContactRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTransitiveMemberOfOrgContactRequestBuilder) {
    m := &ItemTransitiveMemberOfOrgContactRequestBuilder{
    }
...
func NewItemTransitiveMemberOfOrgContactRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTransitiveMemberOfOrgContactRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemTransitiveMemberOfOrgContactRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ItemTransitiveMemberOfOrgContactRequestBuilder) Count()(*ItemTransitiveMemberOfOrgContactCountRequestBuilder) {
    return NewItemTransitiveMemberOfOrgContactCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemTransitiveMemberOfOrgContactRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTransitiveMemberOfOrgContactRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemTransitiveMemberOfOrgContactRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTransitiveMemberOfOrgContactRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.OrgContactCollectionResponseable, error) {
