...
// ItemMemberOfGraphGroupRequestBuilderGetQueryParameters get security groups, administrative units, and admin roles that the security group is a direct member of, or administrative units and admin roles that the Microsoft 365 group is a direct member of. This operation is not transitive.
