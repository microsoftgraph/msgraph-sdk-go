...
// NewItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilderInternal instantiates a new ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder and sets the default values.
func NewItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder) {
    m := &ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did1}/sets/{set%2Did}/relations/{relation%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder instantiates a new ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder and sets the default values.
...
func (m *ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder) FromTerm()(*ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewItemSitesItemTermstoresItemGroupsItemSetsItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a Relationable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder) Patch(ctx context.Context, body ia3c27b33aa3d3ed80f9de797c48fbb8ed73f13887e301daf51f08450e9a634a3.Relationable, requestConfiguration *ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilderPatchRequestConfiguration)(ia3c27b33aa3d3ed80f9de797c48fbb8ed73f13887e301daf51f08450e9a634a3.Relationable, error) {
...
// returns a *ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsItemSetRequestBuilder when successful
func (m *ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder) Set()(*ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsItemSetRequestBuilder) {
    return NewItemSitesItemTermstoresItemGroupsItemSetsItemRelationsItemSetRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder) ToTerm()(*ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsItemTotermToTermRequestBuilder) {
    return NewItemSitesItemTermstoresItemGroupsItemSetsItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder) {
    return NewItemSitesItemTermstoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
