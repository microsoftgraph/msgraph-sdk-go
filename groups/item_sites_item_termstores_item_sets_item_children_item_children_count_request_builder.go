...
// NewItemSitesItemTermstoresItemSetsItemChildrenItemChildrenCountRequestBuilderInternal instantiates a new ItemSitesItemTermstoresItemSetsItemChildrenItemChildrenCountRequestBuilder and sets the default values.
func NewItemSitesItemTermstoresItemSetsItemChildrenItemChildrenCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemTermstoresItemSetsItemChildrenItemChildrenCountRequestBuilder) {
    m := &ItemSitesItemTermstoresItemSetsItemChildrenItemChildrenCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/children/{term%2Did}/children/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemSitesItemTermstoresItemSetsItemChildrenItemChildrenCountRequestBuilder instantiates a new ItemSitesItemTermstoresItemSetsItemChildrenItemChildrenCountRequestBuilder and sets the default values.
...
func (m *ItemSitesItemTermstoresItemSetsItemChildrenItemChildrenCountRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemTermstoresItemSetsItemChildrenItemChildrenCountRequestBuilder) {
    return NewItemSitesItemTermstoresItemSetsItemChildrenItemChildrenCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
