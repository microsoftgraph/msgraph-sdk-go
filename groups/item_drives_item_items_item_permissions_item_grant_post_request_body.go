...
// ItemDrivesItemItemsItemPermissionsItemGrantPostRequestBody provides operations to call the grant method.
...
func (m *ItemDrivesItemItemsItemPermissionsItemGrantPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemDrivesItemItemsItemPermissionsItemGrantPostRequestBody) GetRecipients()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveRecipientable) {
    return m.recipients
}
...
func (m *ItemDrivesItemItemsItemPermissionsItemGrantPostRequestBody) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetRecipients sets the recipients property value. The recipients property
func (m *ItemDrivesItemItemsItemPermissionsItemGrantPostRequestBody) SetRecipients(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveRecipientable)() {
    m.recipients = value
}
