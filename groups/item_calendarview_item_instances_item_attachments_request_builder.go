...
func (m *ItemCalendarviewItemInstancesItemAttachmentsRequestBuilder) CreateUploadSession()(*ItemCalendarviewItemInstancesItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilder) {
    return NewItemCalendarviewItemInstancesItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
