...
func (m *ItemSitesItemTermstoreSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilder) FromTerm()(*ItemSitesItemTermstoreSetsItemTermsItemChildrenItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewItemSitesItemTermstoreSetsItemTermsItemChildrenItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemSitesItemTermstoreSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilder) ToTerm()(*ItemSitesItemTermstoreSetsItemTermsItemChildrenItemRelationsItemTotermToTermRequestBuilder) {
    return NewItemSitesItemTermstoreSetsItemTermsItemChildrenItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
