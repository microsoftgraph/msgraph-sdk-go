...
func (m *ItemSitesItemTermstoreGroupsItemSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder) FromTerm()(*ItemSitesItemTermstoreGroupsItemSetsItemChildrenItemChildrenItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewItemSitesItemTermstoreGroupsItemSetsItemChildrenItemChildrenItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemSitesItemTermstoreGroupsItemSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder) ToTerm()(*ItemSitesItemTermstoreGroupsItemSetsItemChildrenItemChildrenItemRelationsItemTotermToTermRequestBuilder) {
    return NewItemSitesItemTermstoreGroupsItemSetsItemChildrenItemChildrenItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
