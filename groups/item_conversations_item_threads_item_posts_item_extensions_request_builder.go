...
func (m *ItemConversationsItemThreadsItemPostsItemExtensionsRequestBuilder) ByExtensionIdString(extensionId string)(*ItemConversationsItemThreadsItemPostsItemExtensionsExtensionItemRequestBuilder) {
