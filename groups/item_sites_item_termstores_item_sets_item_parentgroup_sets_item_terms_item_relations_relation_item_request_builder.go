...
func (m *ItemSitesItemTermstoresItemSetsItemParentgroupSetsItemTermsItemRelationsRelationItemRequestBuilder) FromTerm()(*ItemSitesItemTermstoresItemSetsItemParentgroupSetsItemTermsItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewItemSitesItemTermstoresItemSetsItemParentgroupSetsItemTermsItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *ItemSitesItemTermstoresItemSetsItemParentgroupSetsItemTermsItemRelationsItemTotermToTermRequestBuilder when successful
func (m *ItemSitesItemTermstoresItemSetsItemParentgroupSetsItemTermsItemRelationsRelationItemRequestBuilder) ToTerm()(*ItemSitesItemTermstoresItemSetsItemParentgroupSetsItemTermsItemRelationsItemTotermToTermRequestBuilder) {
    return NewItemSitesItemTermstoresItemSetsItemParentgroupSetsItemTermsItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
