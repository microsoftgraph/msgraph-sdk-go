...
// ItemCalendarViewItemForwardPostRequestBody provides operations to call the forward method.
...
func (m *ItemCalendarViewItemForwardPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarViewItemForwardPostRequestBody) SetAdditionalData(value map[string]interface{})() {
