...
// NewItemSitesItemContenttypesItemBasetypesCountRequestBuilderInternal instantiates a new ItemSitesItemContenttypesItemBasetypesCountRequestBuilder and sets the default values.
func NewItemSitesItemContenttypesItemBasetypesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemContenttypesItemBasetypesCountRequestBuilder) {
    m := &ItemSitesItemContenttypesItemBasetypesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/baseTypes/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemSitesItemContenttypesItemBasetypesCountRequestBuilder instantiates a new ItemSitesItemContenttypesItemBasetypesCountRequestBuilder and sets the default values.
...
func (m *ItemSitesItemContenttypesItemBasetypesCountRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemContenttypesItemBasetypesCountRequestBuilder) {
    return NewItemSitesItemContenttypesItemBasetypesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
