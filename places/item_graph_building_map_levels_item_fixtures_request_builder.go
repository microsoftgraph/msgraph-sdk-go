...
// ByFixtureMapId provides operations to manage the fixtures property of the microsoft.graph.levelMap entity.
// returns a *ItemGraphBuildingMapLevelsItemFixturesFixtureMapItemRequestBuilder when successful
func (m *ItemGraphBuildingMapLevelsItemFixturesRequestBuilder) ByFixtureMapId(fixtureMapId string)(*ItemGraphBuildingMapLevelsItemFixturesFixtureMapItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.BaseRequestBuilder.PathParameters {
        urlTplParams[idx] = item
    }
    if fixtureMapId != "" {
        urlTplParams["fixtureMap%2Did"] = fixtureMapId
    }
    return NewItemGraphBuildingMapLevelsItemFixturesFixtureMapItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
...
func NewItemGraphBuildingMapLevelsItemFixturesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphBuildingMapLevelsItemFixturesRequestBuilder) {
    m := &ItemGraphBuildingMapLevelsItemFixturesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.building/map/levels/{levelMap%2Did}/fixtures{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
...
func NewItemGraphBuildingMapLevelsItemFixturesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphBuildingMapLevelsItemFixturesRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemGraphBuildingMapLevelsItemFixturesRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ItemGraphBuildingMapLevelsItemFixturesCountRequestBuilder when successful
...
func (m *ItemGraphBuildingMapLevelsItemFixturesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGraphBuildingMapLevelsItemFixturesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.FixtureMapCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateFixtureMapCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.FixtureMapCollectionResponseable), nil
}
// Post create new navigation property to fixtures for places
// returns a FixtureMapable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemGraphBuildingMapLevelsItemFixturesRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.FixtureMapable, requestConfiguration *ItemGraphBuildingMapLevelsItemFixturesRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.FixtureMapable, error) {
...
// ToPostRequestInformation create new navigation property to fixtures for places
// returns a *RequestInformation when successful
func (m *ItemGraphBuildingMapLevelsItemFixturesRequestBuilder) ToPostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.FixtureMapable, requestConfiguration *ItemGraphBuildingMapLevelsItemFixturesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemGraphBuildingMapLevelsItemFixturesRequestBuilder) WithUrl(rawUrl string)(*ItemGraphBuildingMapLevelsItemFixturesRequestBuilder) {
    return NewItemGraphBuildingMapLevelsItemFixturesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
