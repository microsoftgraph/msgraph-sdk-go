...
type GraphroomGraphRoomRequestBuilder struct {
...
func NewGraphroomGraphRoomRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GraphroomGraphRoomRequestBuilder) {
    m := &GraphroomGraphRoomRequestBuilder{
...
func NewGraphroomGraphRoomRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GraphroomGraphRoomRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewGraphroomGraphRoomRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *GraphroomCountRequestBuilder when successful
func (m *GraphroomGraphRoomRequestBuilder) Count()(*GraphroomCountRequestBuilder) {
...
func (m *GraphroomGraphRoomRequestBuilder) Get(ctx context.Context, requestConfiguration *GraphroomGraphRoomRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.RoomCollectionResponseable, error) {
...
func (m *GraphroomGraphRoomRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GraphroomGraphRoomRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GraphroomGraphRoomRequestBuilder) WithUrl(rawUrl string)(*GraphroomGraphRoomRequestBuilder) {
    return NewGraphroomGraphRoomRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
