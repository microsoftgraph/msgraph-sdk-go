...
func NewItemGraphBuildingMapLevelsItemUnitsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphBuildingMapLevelsItemUnitsCountRequestBuilder) {
    m := &ItemGraphBuildingMapLevelsItemUnitsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.building/map/levels/{levelMap%2Did}/units/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewItemGraphBuildingMapLevelsItemUnitsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphBuildingMapLevelsItemUnitsCountRequestBuilder) {
    ...
    return NewItemGraphBuildingMapLevelsItemUnitsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemGraphBuildingMapLevelsItemUnitsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGraphBuildingMapLevelsItemUnitsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemGraphBuildingMapLevelsItemUnitsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemGraphBuildingMapLevelsItemUnitsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemGraphBuildingMapLevelsItemUnitsCountRequestBuilder) WithUrl(rawUrl string)(*ItemGraphBuildingMapLevelsItemUnitsCountRequestBuilder) {
    return NewItemGraphBuildingMapLevelsItemUnitsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
