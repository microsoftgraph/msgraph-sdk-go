...
func NewItemGraphRoomListRoomsItemCheckInsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphRoomListRoomsItemCheckInsCountRequestBuilder) {
    m := &ItemGraphRoomListRoomsItemCheckInsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.roomList/rooms/{room%2Did}/checkIns/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewItemGraphRoomListRoomsItemCheckInsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphRoomListRoomsItemCheckInsCountRequestBuilder) {
    ...
    return NewItemGraphRoomListRoomsItemCheckInsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemGraphRoomListRoomsItemCheckInsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGraphRoomListRoomsItemCheckInsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemGraphRoomListRoomsItemCheckInsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemGraphRoomListRoomsItemCheckInsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemGraphRoomListRoomsItemCheckInsCountRequestBuilder when successful
func (m *ItemGraphRoomListRoomsItemCheckInsCountRequestBuilder) WithUrl(rawUrl string)(*ItemGraphRoomListRoomsItemCheckInsCountRequestBuilder) {
    return NewItemGraphRoomListRoomsItemCheckInsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
