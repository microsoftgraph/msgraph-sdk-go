...
func NewItemGraphBuildingMapLevelsItemFixturesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphBuildingMapLevelsItemFixturesCountRequestBuilder) {
    m := &ItemGraphBuildingMapLevelsItemFixturesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.building/map/levels/{levelMap%2Did}/fixtures/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewItemGraphBuildingMapLevelsItemFixturesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphBuildingMapLevelsItemFixturesCountRequestBuilder) {
    ...
    return NewItemGraphBuildingMapLevelsItemFixturesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemGraphBuildingMapLevelsItemFixturesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGraphBuildingMapLevelsItemFixturesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemGraphBuildingMapLevelsItemFixturesCountRequestBuilder) WithUrl(rawUrl string)(*ItemGraphBuildingMapLevelsItemFixturesCountRequestBuilder) {
    return NewItemGraphBuildingMapLevelsItemFixturesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
