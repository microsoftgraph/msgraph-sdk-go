...
func (m *GraphRoomListCountRequestBuilder) Get(ctx context.Context, requestConfiguration *GraphRoomListCountRequestBuilderGetRequestConfiguration)(*int64, error) {
