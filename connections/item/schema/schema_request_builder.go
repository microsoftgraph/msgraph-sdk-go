...
// DeleteWithResponseHandler delete navigation property schema for connections
...
// PatchWithResponseHandler update the navigation property schema in connections
