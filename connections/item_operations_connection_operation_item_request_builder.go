...
func (m *ItemOperationsConnectionOperationItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemOperationsConnectionOperationItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
