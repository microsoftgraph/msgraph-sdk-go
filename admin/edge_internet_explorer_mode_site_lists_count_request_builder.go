...
func (m *EdgeInternetExplorerModeSiteListsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EdgeInternetExplorerModeSiteListsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
