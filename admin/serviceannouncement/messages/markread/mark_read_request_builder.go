...
// MarkReadRequestBuilder builds and executes requests for operations under \admin\serviceAnnouncement\messages\microsoft.graph.markRead
...
func (m *MarkReadRequestBuilder) CreatePostRequestInformation(options *MarkReadRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *MarkReadRequestBuilder) Post(options *MarkReadRequestBuilderPostOptions)(*bool, error) {
