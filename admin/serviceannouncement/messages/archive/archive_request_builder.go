...
func (m *ArchiveRequestBuilder) PostWithResponseHandler(body ArchiveRequestBodyable, requestConfiguration *ArchiveRequestBuilderPostRequestConfiguration)(ArchiveResponseable, error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action archive
func (m *ArchiveRequestBuilder) PostWithResponseHandler(body ArchiveRequestBodyable, requestConfiguration *ArchiveRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ArchiveResponseable, error) {
