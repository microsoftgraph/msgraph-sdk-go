...
// ContentRequestBuilder builds and executes requests for operations under \admin\serviceAnnouncement\messages\{serviceUpdateMessage-id}\attachments\{serviceAnnouncementAttachment-id}\content
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage_id}/attachments/{serviceAnnouncementAttachment_id}/content";
...
// CreateGetRequestInformation get media content for the navigation property attachments from admin
...
// CreatePutRequestInformation update media content for the navigation property attachments in admin
...
// Get get media content for the navigation property attachments from admin
...
// Put update media content for the navigation property attachments in admin
