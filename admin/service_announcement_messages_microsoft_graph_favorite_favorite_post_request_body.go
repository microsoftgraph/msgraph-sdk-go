...
func NewServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody()(*ServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody) {
    m := &ServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody{
    }
...
func CreateServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *ServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody) GetMessageIds()([]string) {
...
func (m *ServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetMessageIds sets the messageIds property value. The messageIds property
func (m *ServiceAnnouncementMessagesMicrosoftGraphFavoriteFavoritePostRequestBody) SetMessageIds(value []string)() {
