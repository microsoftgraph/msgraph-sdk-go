...
func (m *ServiceAnnouncementHealthOverviewsItemIssuesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ServiceAnnouncementHealthOverviewsItemIssuesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
