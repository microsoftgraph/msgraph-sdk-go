...
func NewConfigurationManagementConfigurationMonitorsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConfigurationManagementConfigurationMonitorsCountRequestBuilder) {
    m := &ConfigurationManagementConfigurationMonitorsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/configurationManagement/configurationMonitors/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewConfigurationManagementConfigurationMonitorsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConfigurationManagementConfigurationMonitorsCountRequestBuilder) {
    ...
    return NewConfigurationManagementConfigurationMonitorsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ConfigurationManagementConfigurationMonitorsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConfigurationManagementConfigurationMonitorsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ConfigurationManagementConfigurationMonitorsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ConfigurationManagementConfigurationMonitorsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ConfigurationManagementConfigurationMonitorsCountRequestBuilder) WithUrl(rawUrl string)(*ConfigurationManagementConfigurationMonitorsCountRequestBuilder) {
    return NewConfigurationManagementConfigurationMonitorsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
