...
// TeamsUserConfigurationsItemUserMailboxSettingsRequestBuilderGetQueryParameters settings for the primary mailbox of the signed-in user. You can get or update settings for sending automatic replies to incoming messages, locale, and time zone. Requires $select to retrieve.
...
func (m *TeamsUserConfigurationsItemUserMailboxSettingsRequestBuilder) Get(ctx context.Context, requestConfiguration *TeamsUserConfigurationsItemUserMailboxSettingsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxSettingsable, error) {
