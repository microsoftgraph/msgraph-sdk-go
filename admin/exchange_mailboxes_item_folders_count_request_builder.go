...
func NewExchangeMailboxesItemFoldersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExchangeMailboxesItemFoldersCountRequestBuilder) {
    m := &ExchangeMailboxesItemFoldersCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewExchangeMailboxesItemFoldersCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExchangeMailboxesItemFoldersCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewExchangeMailboxesItemFoldersCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ExchangeMailboxesItemFoldersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ExchangeMailboxesItemFoldersCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ExchangeMailboxesItemFoldersCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ExchangeMailboxesItemFoldersCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ExchangeMailboxesItemFoldersCountRequestBuilder) WithUrl(rawUrl string)(*ExchangeMailboxesItemFoldersCountRequestBuilder) {
    return NewExchangeMailboxesItemFoldersCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
