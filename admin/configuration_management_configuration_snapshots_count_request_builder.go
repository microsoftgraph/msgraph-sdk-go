...
func NewConfigurationManagementConfigurationSnapshotsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConfigurationManagementConfigurationSnapshotsCountRequestBuilder) {
    m := &ConfigurationManagementConfigurationSnapshotsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/configurationManagement/configurationSnapshots/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewConfigurationManagementConfigurationSnapshotsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConfigurationManagementConfigurationSnapshotsCountRequestBuilder) {
    ...
    return NewConfigurationManagementConfigurationSnapshotsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ConfigurationManagementConfigurationSnapshotsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConfigurationManagementConfigurationSnapshotsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ConfigurationManagementConfigurationSnapshotsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ConfigurationManagementConfigurationSnapshotsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ConfigurationManagementConfigurationSnapshotsCountRequestBuilder) WithUrl(rawUrl string)(*ConfigurationManagementConfigurationSnapshotsCountRequestBuilder) {
    return NewConfigurationManagementConfigurationSnapshotsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
