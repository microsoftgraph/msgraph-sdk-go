...
func (m *CloudPcOnPremisesConnectionHealthCheck) GetErrorType()(*CloudPcOnPremisesConnectionHealthCheckErrorType) {
    ...
    if val != nil {
        return val.(*CloudPcOnPremisesConnectionHealthCheckErrorType)
    }
    return nil
}
...
// GetRecommendedAction gets the recommendedAction property value. The recommendedAction property
// returns a *string when successful
...
// SetRecommendedAction sets the recommendedAction property value. The recommendedAction property
