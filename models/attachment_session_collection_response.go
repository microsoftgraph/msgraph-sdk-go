...
func (m *AttachmentSessionCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *AttachmentSessionCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *AttachmentSessionCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *AttachmentSessionCollectionResponse) SetOdataNextLink(value *string)() {
