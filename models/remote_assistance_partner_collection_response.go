...
func (m *RemoteAssistancePartnerCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *RemoteAssistancePartnerCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
