...
func (m *RoomCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *RoomCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *RoomCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *RoomCollectionResponse) SetOdataNextLink(value *string)() {
