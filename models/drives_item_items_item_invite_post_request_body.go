...
func (m *DrivesItemItemsItemInvitePostRequestBody) GetRecipients()([]DriveRecipientable) {
    return m.recipients
}
...
func (m *DrivesItemItemsItemInvitePostRequestBody) SetRecipients(value []DriveRecipientable)() {
    m.recipients = value
}
