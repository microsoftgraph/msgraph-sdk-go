...
// RecommendedAction_RecommendedAction_potentialScoreImpact composed type wrapper for classes float64, ReferenceNumeric, string
type RecommendedAction_RecommendedAction_potentialScoreImpact struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewRecommendedAction_RecommendedAction_potentialScoreImpact instantiates a new RecommendedAction_RecommendedAction_potentialScoreImpact and sets the default values.
func NewRecommendedAction_RecommendedAction_potentialScoreImpact()(*RecommendedAction_RecommendedAction_potentialScoreImpact) {
    m := &RecommendedAction_RecommendedAction_potentialScoreImpact{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    return m
}
// CreateRecommendedAction_RecommendedAction_potentialScoreImpactFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateRecommendedAction_RecommendedAction_potentialScoreImpactFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    result := NewRecommendedAction_RecommendedAction_potentialScoreImpact()
    if parseNode != nil {
...
func (m *RecommendedAction_RecommendedAction_potentialScoreImpact) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetDouble gets the double property value. Composed type representation for type float64
// returns a *float64 when successful
func (m *RecommendedAction_RecommendedAction_potentialScoreImpact) GetDouble()(*float64) {
...
func (m *RecommendedAction_RecommendedAction_potentialScoreImpact) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    return make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
}
// GetIsComposedType determines if the current object is a wrapper around a composed type
// returns a bool when successful
func (m *RecommendedAction_RecommendedAction_potentialScoreImpact) GetIsComposedType()(bool) {
    return true
}
...
func (m *RecommendedAction_RecommendedAction_potentialScoreImpact) GetReferenceNumeric()(*ReferenceNumeric) {
...
func (m *RecommendedAction_RecommendedAction_potentialScoreImpact) GetString()(*string) {
...
func (m *RecommendedAction_RecommendedAction_potentialScoreImpact) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *RecommendedAction_RecommendedAction_potentialScoreImpact) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetDouble sets the double property value. Composed type representation for type float64
func (m *RecommendedAction_RecommendedAction_potentialScoreImpact) SetDouble(value *float64)() {
...
func (m *RecommendedAction_RecommendedAction_potentialScoreImpact) SetReferenceNumeric(value *ReferenceNumeric)() {
...
func (m *RecommendedAction_RecommendedAction_potentialScoreImpact) SetString(value *string)() {
    err := m.GetBackingStore().Set("string", value)
    if err != nil {
        panic(err)
    }
}
type RecommendedAction_RecommendedAction_potentialScoreImpactable interface {
...
func (m *RecommendedAction) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["potentialScoreImpact"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateRecommendedAction_RecommendedAction_potentialScoreImpactFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetPotentialScoreImpact(val.(*RecommendedAction_RecommendedAction_potentialScoreImpact))
        }
        return nil
    }
...
// returns a RecommendedAction_RecommendedAction_potentialScoreImpactable when successful
func (m *RecommendedAction) GetPotentialScoreImpact()(RecommendedAction_RecommendedAction_potentialScoreImpactable) {
    val, err := m.GetBackingStore().Get("potentialScoreImpact")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(RecommendedAction_RecommendedAction_potentialScoreImpactable)
    }
    return nil
}
...
func (m *RecommendedAction) SetPotentialScoreImpact(value RecommendedAction_RecommendedAction_potentialScoreImpactable)() {
...
type RecommendedActionable interface {
    ...
    SetPotentialScoreImpact(value RecommendedAction_RecommendedAction_potentialScoreImpactable)()
