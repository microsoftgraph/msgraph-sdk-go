...
func (m *Win32LobAppAutoUpdateSettings) GetAutoUpdateSupersededAppsState()(*Win32LobAutoUpdateSupersededAppsState) {
    val, err := m.GetBackingStore().Get("autoUpdateSupersededAppsState")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*Win32LobAutoUpdateSupersededAppsState)
    }
    return nil
}
...
func (m *Win32LobAppAutoUpdateSettings) SetAutoUpdateSupersededAppsState(value *Win32LobAutoUpdateSupersededAppsState)() {
    err := m.GetBackingStore().Set("autoUpdateSupersededAppsState", value)
    if err != nil {
        panic(err)
    }
}
