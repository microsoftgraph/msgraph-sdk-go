...
func (m *MobileThreatDefenseConnectorCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *MobileThreatDefenseConnectorCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
