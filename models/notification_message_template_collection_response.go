...
func (m *NotificationMessageTemplateCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *NotificationMessageTemplateCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
