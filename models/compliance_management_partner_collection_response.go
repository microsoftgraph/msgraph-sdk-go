...
func (m *ComplianceManagementPartnerCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *ComplianceManagementPartnerCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
