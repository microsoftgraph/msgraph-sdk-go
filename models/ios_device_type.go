...
func (m *IosDeviceType) GetIPad()(*bool) {
    val, err := m.GetBackingStore().Get("iPad")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *IosDeviceType) GetIPhoneAndIPod()(*bool) {
    val, err := m.GetBackingStore().Get("iPhoneAndIPod")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *IosDeviceType) SetIPad(value *bool)() {
    err := m.GetBackingStore().Set("iPad", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *IosDeviceType) SetIPhoneAndIPod(value *bool)() {
    err := m.GetBackingStore().Set("iPhoneAndIPod", value)
    if err != nil {
        panic(err)
    }
}
