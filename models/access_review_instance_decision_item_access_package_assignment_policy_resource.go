...
func (m *AccessReviewInstanceDecisionItemAccessPackageAssignmentPolicyResource) GetOdataType()(*string) {
...
func (m *AccessReviewInstanceDecisionItemAccessPackageAssignmentPolicyResource) SetOdataType(value *string)() {
