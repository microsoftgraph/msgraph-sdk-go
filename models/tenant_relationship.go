...
// GetDelegatedAdminCustomers gets the delegatedAdminCustomers property value. The delegatedAdminCustomers property
func (m *TenantRelationship) GetDelegatedAdminCustomers()([]DelegatedAdminCustomerable) {
    return m.delegatedAdminCustomers
}
// GetDelegatedAdminRelationships gets the delegatedAdminRelationships property value. The delegatedAdminRelationships property
...
// SetDelegatedAdminCustomers sets the delegatedAdminCustomers property value. The delegatedAdminCustomers property
func (m *TenantRelationship) SetDelegatedAdminCustomers(value []DelegatedAdminCustomerable)() {
    m.delegatedAdminCustomers = value
}
// SetDelegatedAdminRelationships sets the delegatedAdminRelationships property value. The delegatedAdminRelationships property
