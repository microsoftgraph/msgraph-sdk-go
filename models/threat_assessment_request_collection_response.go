...
func (m *ThreatAssessmentRequestCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *ThreatAssessmentRequestCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
