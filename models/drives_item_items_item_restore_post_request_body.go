...
func (m *DrivesItemItemsItemRestorePostRequestBody) GetParentReference()(ItemReferenceable) {
...
func (m *DrivesItemItemsItemRestorePostRequestBody) SetParentReference(value ItemReferenceable)() {
