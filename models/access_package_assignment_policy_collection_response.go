...
// AccessPackageAssignmentPolicyCollectionResponse provides operations to manage the assignmentPolicies property of the microsoft.graph.accessPackage entity.
