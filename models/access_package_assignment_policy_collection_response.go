...
func (m *AccessPackageAssignmentPolicyCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessPackageAssignmentPolicyCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
