...
func (m *EdiscoveryReviewSetCollectionResponse) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EdiscoveryReviewSetCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *EdiscoveryReviewSetCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
        m.additionalData = value
    }
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EdiscoveryReviewSetCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
