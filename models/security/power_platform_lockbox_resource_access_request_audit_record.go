...
func NewPowerPlatformLockboxResourceAccessRequestAuditRecord()(*PowerPlatformLockboxResourceAccessRequestAuditRecord) {
    m := &PowerPlatformLockboxResourceAccessRequestAuditRecord{
        AuditData: *NewAuditData(),
    }
    odataTypeValue := "#microsoft.graph.security.powerPlatformLockboxResourceAccessRequestAuditRecord"
    m.SetOdataType(&odataTypeValue)
    return m
}
// CreatePowerPlatformLockboxResourceAccessRequestAuditRecordFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *PowerPlatformLockboxResourceAccessRequestAuditRecord) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    res := m.AuditData.GetFieldDeserializers()
    return res
}
// Serialize serializes information the current object
func (m *PowerPlatformLockboxResourceAccessRequestAuditRecord) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
