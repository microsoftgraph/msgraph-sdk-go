...
func (m *EdiscoveryNoncustodialDataSourceCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *EdiscoveryNoncustodialDataSourceCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *EdiscoveryNoncustodialDataSourceCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EdiscoveryNoncustodialDataSourceCollectionResponse) SetOdataNextLink(value *string)() {
