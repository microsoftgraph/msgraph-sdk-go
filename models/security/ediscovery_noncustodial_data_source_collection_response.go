...
func (m *EdiscoveryNoncustodialDataSourceCollectionResponse) GetNextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *EdiscoveryNoncustodialDataSourceCollectionResponse) SetNextLink(value *string)() {
    if m != nil {
        m.nextLink = value
    }
}
