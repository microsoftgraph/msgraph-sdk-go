...
func (m *CaseOperationCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *CaseOperationCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *CaseOperationCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *CaseOperationCollectionResponse) SetOdataNextLink(value *string)() {
