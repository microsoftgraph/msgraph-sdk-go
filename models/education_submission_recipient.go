...
func NewEducationSubmissionRecipient()(*EducationSubmissionRecipient) {
    ...
    typeValue := "#microsoft.graph.educationSubmissionRecipient";
    m.SetType(&typeValue);
    return m
}
...
func (m *EducationSubmissionRecipient) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *EducationSubmissionRecipient) SetType(value *string)() {
    if m != nil {
