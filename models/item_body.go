...
func (m *ItemBody) GetContentType()(*ItemBody_contentType) {
    val, err := m.GetBackingStore().Get("contentType")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*ItemBody_contentType)
    }
    return nil
}
...
func (m *ItemBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["contentType"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseItemBody_contentType)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetContentType(val.(*ItemBody_contentType))
        }
        return nil
    }
...
func (m *ItemBody) SetContentType(value *ItemBody_contentType)() {
...
type ItemBodyable interface {
    ...
    GetContent()(*string)
    GetContentType()(*ItemBody_contentType)
    GetOdataType()(*string)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetContent(value *string)()
    SetContentType(value *ItemBody_contentType)()
