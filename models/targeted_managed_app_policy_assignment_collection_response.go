...
func (m *TargetedManagedAppPolicyAssignmentCollectionResponse) GetOdatanextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *TargetedManagedAppPolicyAssignmentCollectionResponse) SetOdatanextLink(value *string)() {
    if m != nil {
        m.nextLink = value
    }
}
