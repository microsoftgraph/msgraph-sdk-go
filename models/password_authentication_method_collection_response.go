...
// PasswordAuthenticationMethodCollectionResponse provides operations to manage the passwordMethods property of the microsoft.graph.authentication entity.
