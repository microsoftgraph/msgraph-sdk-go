...
func (m *MicrosoftAuthenticatorAuthenticationMethodCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *MicrosoftAuthenticatorAuthenticationMethodCollectionResponse) SetOdataNextLink(value *string)() {
