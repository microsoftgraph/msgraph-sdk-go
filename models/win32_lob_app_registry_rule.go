...
// GetOperationType gets the operationType property value. The registry operation type. Possible values are: notConfigured, exists, doesNotExist, string, integer, version.
...
// GetOperator gets the operator property value. The operator for registry detection. Possible values are: notConfigured, equal, notEqual, greaterThan, greaterThanOrEqual, lessThan, lessThanOrEqual.
...
// SetOperationType sets the operationType property value. The registry operation type. Possible values are: notConfigured, exists, doesNotExist, string, integer, version.
func (m *Win32LobAppRegistryRule) SetOperationType(value *Win32LobAppRegistryRuleOperationType)() {
    if m != nil {
        m.operationType = value
    }
}
// SetOperator sets the operator property value. The operator for registry detection. Possible values are: notConfigured, equal, notEqual, greaterThan, greaterThanOrEqual, lessThan, lessThanOrEqual.
