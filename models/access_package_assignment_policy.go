...
func (m *AccessPackageAssignmentPolicy) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["notificationSettings"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetNotificationSettings(val.(AccessPackageNotificationSettingsable))
        }
        return nil
    }
...
// GetNotificationSettings gets the notificationSettings property value. The notificationSettings property
// returns a AccessPackageNotificationSettingsable when successful
func (m *AccessPackageAssignmentPolicy) GetNotificationSettings()(AccessPackageNotificationSettingsable) {
...
func (m *AccessPackageAssignmentPolicy) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err = writer.WriteObjectValue("notificationSettings", m.GetNotificationSettings())
        if err != nil {
            return err
        }
    }
...
// SetNotificationSettings sets the notificationSettings property value. The notificationSettings property
func (m *AccessPackageAssignmentPolicy) SetNotificationSettings(value AccessPackageNotificationSettingsable)() {
...
type AccessPackageAssignmentPolicyable interface {
    ...
    GetNotificationSettings()(AccessPackageNotificationSettingsable)
    ...
    SetNotificationSettings(value AccessPackageNotificationSettingsable)()
