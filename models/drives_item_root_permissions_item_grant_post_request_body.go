...
func (m *DrivesItemRootPermissionsItemGrantPostRequestBody) GetRecipients()([]DriveRecipientable) {
    return m.recipients
}
...
func (m *DrivesItemRootPermissionsItemGrantPostRequestBody) SetRecipients(value []DriveRecipientable)() {
    m.recipients = value
}
