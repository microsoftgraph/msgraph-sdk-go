...
func (m *ChannelSetAsFavoriteByDefaultEventMessageDetail) GetOdataType()(*string) {
...
func (m *ChannelSetAsFavoriteByDefaultEventMessageDetail) SetOdataType(value *string)() {
