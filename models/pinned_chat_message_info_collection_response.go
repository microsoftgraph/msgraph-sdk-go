...
func (m *PinnedChatMessageInfoCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *PinnedChatMessageInfoCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *PinnedChatMessageInfoCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *PinnedChatMessageInfoCollectionResponse) SetOdataNextLink(value *string)() {
