...
func (m *AccessReviewHistoryScheduleSettings) GetRecurrence()(*PatternedRecurrence) {
    if m == nil {
        return nil
    } else {
        return m.recurrence
...
func (m *AccessReviewHistoryScheduleSettings) IsNil()(bool) {
    return m == nil
}
...
func (m *AccessReviewHistoryScheduleSettings) SetRecurrence(value *PatternedRecurrence)() {
    if m != nil {
        m.recurrence = value
    }
}
