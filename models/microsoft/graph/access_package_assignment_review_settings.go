...
// AccessPackageAssignmentReviewSettings provides operations to manage the identityGovernance singleton.
...
func (m *AccessPackageAssignmentReviewSettings) IsNil()(bool) {
    return m == nil
}
