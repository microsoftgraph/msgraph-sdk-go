...
// PrintTaskDefinitionCollectionResponse provides operations to manage the taskDefinitions property of the microsoft.graph.print entity.
...
func (m *PrintTaskDefinitionCollectionResponse) IsNil()(bool) {
    return m == nil
}
