...
// GetDefault_escaped gets the default property value. Whether this is the default Content Type
...
// SetDefault_escaped sets the default property value. Whether this is the default Content Type
