...
// InferenceClassificationOverrideCollectionResponse provides operations to manage the overrides property of the microsoft.graph.inferenceClassification entity.
...
func (m *InferenceClassificationOverrideCollectionResponse) IsNil()(bool) {
    return m == nil
}
