...
// GetSelect_escaped gets the select property value. Columns selected from the report
...
// SetSelect_escaped sets the select property value. Columns selected from the report
