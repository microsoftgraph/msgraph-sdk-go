...
// AccessPackageAssignmentApprovalSettings provides operations to manage the identityGovernance singleton.
...
func (m *AccessPackageAssignmentApprovalSettings) IsNil()(bool) {
    return m == nil
}
