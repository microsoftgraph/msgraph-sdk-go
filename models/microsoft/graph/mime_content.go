...
// GetType_escaped gets the type property value. Indicates the content mime type.
...
// SetType_escaped sets the type property value. Indicates the content mime type.
