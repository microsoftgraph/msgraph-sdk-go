...
// GetState gets the state property value. Possible values are: accepted, declined.
...
// SetState sets the state property value. Possible values are: accepted, declined.
