...
// WindowsInformationProtectionNetworkLearningSummaryCollectionResponse provides operations to manage the windowsInformationProtectionNetworkLearningSummaries property of the microsoft.graph.deviceManagement entity.
...
func (m *WindowsInformationProtectionNetworkLearningSummaryCollectionResponse) IsNil()(bool) {
    return m == nil
}
