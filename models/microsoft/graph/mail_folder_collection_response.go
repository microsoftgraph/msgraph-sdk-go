...
// MailFolderCollectionResponse provides operations to manage the mailFolders property of the microsoft.graph.user entity.
...
func (m *MailFolderCollectionResponse) IsNil()(bool) {
    return m == nil
}
