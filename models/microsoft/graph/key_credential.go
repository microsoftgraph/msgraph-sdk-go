...
// GetType_escaped gets the type property value. The type of key credential; for example, Symmetric.
...
// SetType_escaped sets the type property value. The type of key credential; for example, Symmetric.
