...
func NewBookingCustomerInformationBase()(*BookingCustomerInformationBase) {
    ...
    typeValue := "#microsoft.graph.bookingCustomerInformationBase";
    m.SetType(&typeValue);
    return m
}
...
func (m *BookingCustomerInformationBase) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *BookingCustomerInformationBase) SetType(value *string)() {
    if m != nil {
