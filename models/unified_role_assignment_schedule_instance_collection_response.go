...
// UnifiedRoleAssignmentScheduleInstanceCollectionResponse provides operations to manage the roleAssignmentScheduleInstances property of the microsoft.graph.rbacApplication entity.
