...
func (m *ServiceAnnouncementAttachmentCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *ServiceAnnouncementAttachmentCollectionResponse) SetOdataNextLink(value *string)() {
