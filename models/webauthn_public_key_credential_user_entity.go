...
// NewWebauthnPublicKeyCredentialUserEntity instantiates a new WebauthnPublicKeyCredentialUserEntity and sets the default values.
func NewWebauthnPublicKeyCredentialUserEntity()(*WebauthnPublicKeyCredentialUserEntity) {
    m := &WebauthnPublicKeyCredentialUserEntity{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateWebauthnPublicKeyCredentialUserEntityFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateWebauthnPublicKeyCredentialUserEntityFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewWebauthnPublicKeyCredentialUserEntity(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *WebauthnPublicKeyCredentialUserEntity) GetAdditionalData()(map[string]any) {
...
func (m *WebauthnPublicKeyCredentialUserEntity) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *WebauthnPublicKeyCredentialUserEntity) GetOdataType()(*string) {
...
func (m *WebauthnPublicKeyCredentialUserEntity) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *WebauthnPublicKeyCredentialUserEntity) SetAdditionalData(value map[string]any)() {
...
func (m *WebauthnPublicKeyCredentialUserEntity) SetOdataType(value *string)() {
    err := m.GetBackingStore().Set("odataType", value)
    if err != nil {
        panic(err)
    }
}
type WebauthnPublicKeyCredentialUserEntityable interface {
