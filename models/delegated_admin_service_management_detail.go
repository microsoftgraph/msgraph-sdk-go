...
// GetServiceManagementUrl gets the serviceManagementUrl property value. The serviceManagementUrl property
func (m *DelegatedAdminServiceManagementDetail) GetServiceManagementUrl()(*string) {
    return m.serviceManagementUrl
}
// GetServiceName gets the serviceName property value. The serviceName property
...
// SetServiceManagementUrl sets the serviceManagementUrl property value. The serviceManagementUrl property
func (m *DelegatedAdminServiceManagementDetail) SetServiceManagementUrl(value *string)() {
    m.serviceManagementUrl = value
}
// SetServiceName sets the serviceName property value. The serviceName property
