...
// CalendarPermission provides operations to manage the collection of application entities.
...
func (m *CalendarPermission) GetAllowedRoles()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *CalendarPermission) SetAllowedRoles(value []string)() {
    if m != nil {
