...
// GetDescription gets the description property value. Description for the schema extension.
...
// SetDescription sets the description property value. Description for the schema extension.
