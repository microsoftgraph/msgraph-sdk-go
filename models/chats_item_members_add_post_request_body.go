...
// ChatsItemMembersAddPostRequestBody provides operations to call the add method.
...
func (m *ChatsItemMembersAddPostRequestBody) GetValues()([]ConversationMemberable) {
    return m.values
}
...
func (m *ChatsItemMembersAddPostRequestBody) SetValues(value []ConversationMemberable)() {
    m.values = value
}
