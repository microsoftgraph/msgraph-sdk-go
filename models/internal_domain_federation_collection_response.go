...
func (m *InternalDomainFederationCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *InternalDomainFederationCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *InternalDomainFederationCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *InternalDomainFederationCollectionResponse) SetOdataNextLink(value *string)() {
