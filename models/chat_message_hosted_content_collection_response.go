...
func (m *ChatMessageHostedContentCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *ChatMessageHostedContentCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
