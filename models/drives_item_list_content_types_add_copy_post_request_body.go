...
// DrivesItemListContentTypesAddCopyPostRequestBody provides operations to call the addCopy method.
...
func (m *DrivesItemListContentTypesAddCopyPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *DrivesItemListContentTypesAddCopyPostRequestBody) SetAdditionalData(value map[string]interface{})() {
