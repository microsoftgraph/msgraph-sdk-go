...
func (m *ImplicitGrantSettings) GetEnableAccessTokenIssuance()(*bool) {
    val, err := m.GetBackingStore().Get("enableAccessTokenIssuance")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ImplicitGrantSettings) GetEnableIdTokenIssuance()(*bool) {
    val, err := m.GetBackingStore().Get("enableIdTokenIssuance")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ImplicitGrantSettings) SetEnableAccessTokenIssuance(value *bool)() {
    err := m.GetBackingStore().Set("enableAccessTokenIssuance", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *ImplicitGrantSettings) SetEnableIdTokenIssuance(value *bool)() {
    err := m.GetBackingStore().Set("enableIdTokenIssuance", value)
    if err != nil {
        panic(err)
    }
}
