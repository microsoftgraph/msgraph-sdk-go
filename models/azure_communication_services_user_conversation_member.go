...
func (m *AzureCommunicationServicesUserConversationMember) GetOdataType()(*string) {
...
func (m *AzureCommunicationServicesUserConversationMember) SetOdataType(value *string)() {
