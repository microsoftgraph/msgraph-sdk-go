...
func (m *AgreementAcceptanceCollectionResponse) GetAdditionalData()(map[string]any) {
...
func (m *AgreementAcceptanceCollectionResponse) SetAdditionalData(value map[string]any)() {
