...
func NewResourcePermission()(*ResourcePermission) {
    ...
    odataTypeValue := "#microsoft.graph.resourcePermission";
...
func (m *ResourcePermission) GetAdditionalData()(map[string]interface{}) {
...
func (m *ResourcePermission) SetAdditionalData(value map[string]interface{})() {
