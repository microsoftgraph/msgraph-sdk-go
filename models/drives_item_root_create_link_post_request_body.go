...
// DrivesItemRootCreateLinkPostRequestBody provides operations to call the createLink method.
...
func (m *DrivesItemRootCreateLinkPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *DrivesItemRootCreateLinkPostRequestBody) SetAdditionalData(value map[string]interface{})() {
