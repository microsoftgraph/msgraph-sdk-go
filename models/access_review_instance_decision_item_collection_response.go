...
func (m *AccessReviewInstanceDecisionItemCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *AccessReviewInstanceDecisionItemCollectionResponse) SetOdataNextLink(value *string)() {
