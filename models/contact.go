...
// GetPrimaryEmailAddress gets the primaryEmailAddress property value. The contact's primary email address.
// returns a EmailAddressable when successful
...
// GetSecondaryEmailAddress gets the secondaryEmailAddress property value. The contact's secondary email address.
// returns a EmailAddressable when successful
...
// GetTertiaryEmailAddress gets the tertiaryEmailAddress property value. The contact's tertiary email address.
// returns a EmailAddressable when successful
...
// SetPrimaryEmailAddress sets the primaryEmailAddress property value. The contact's primary email address.
...
// SetSecondaryEmailAddress sets the secondaryEmailAddress property value. The contact's secondary email address.
...
// SetTertiaryEmailAddress sets the tertiaryEmailAddress property value. The contact's tertiary email address.
