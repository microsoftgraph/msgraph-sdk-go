...
func (m *ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse) SetOdataNextLink(value *string)() {
