...
// GetAccountEnabled gets the accountEnabled property value. true if the account is enabled; otherwise, false. This property is required when a user is created. Requires $select to retrieve. Supports $filter (eq, ne, not, and in). This property is subject to sensitive action restrictions; only specific privileged administrator roles can update it.
...
// GetBusinessPhones gets the businessPhones property value. The telephone numbers for the user. NOTE: Although it's a string collection, only one number can be set for this property. Read-only for users synced from the on-premises directory. Returned by default. Supports $filter (eq, not, ge, le, startsWith). This property is subject to sensitive action restrictions; only specific privileged administrator roles can update it.
// returns a []string when successful
...
func (m *User) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["notes"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateNoteFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]Noteable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(Noteable)
				}
...
// GetIdentityParentId gets the identityParentId property value. The identityParentId property
// returns a *string when successful
...
// GetMobilePhone gets the mobilePhone property value. The primary cellular telephone number for the user. Read-only for users synced from the on-premises directory. Maximum length is 64 characters. Returned by default. Supports $filter (eq, ne, not, ge, le, in, startsWith, and eq on null values) and $search. This property is subject to sensitive action restrictions; only specific privileged administrator roles can update it.
// returns a *string when successful
...
// GetNotes gets the notes property value. The notes in the user's Notes folder. Read-only. Nullable.
// returns a []Noteable when successful
func (m *User) GetNotes() []Noteable {
...
// SetIdentityParentId sets the identityParentId property value. The identityParentId property
...
// SetNotes sets the notes property value. The notes in the user's Notes folder. Read-only. Nullable.
func (m *User) SetNotes(value []Noteable) {
