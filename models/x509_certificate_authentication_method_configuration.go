...
func (m *X509CertificateAuthenticationMethodConfiguration) GetOdataType()(*string) {
...
func (m *X509CertificateAuthenticationMethodConfiguration) SetOdataType(value *string)() {
