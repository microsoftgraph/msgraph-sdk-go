...
// GetCreatedByAppId gets the createdByAppId property value. The appId of the application that created this agent identity. Set internally by Microsoft Entra ID. Read-only. Inherited from servicePrincipal.
// returns a *string when successful
func (m *AgentIdentity) GetCreatedByAppId()(*string) {
...
// SetCreatedByAppId sets the createdByAppId property value. The appId of the application that created this agent identity. Set internally by Microsoft Entra ID. Read-only. Inherited from servicePrincipal.
func (m *AgentIdentity) SetCreatedByAppId(value *string)() {
