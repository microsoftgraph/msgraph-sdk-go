...
func (m *UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId) GetOdataType()(*string) {
...
func (m *UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId) SetOdataType(value *string)() {
