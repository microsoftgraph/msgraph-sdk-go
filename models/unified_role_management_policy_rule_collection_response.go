...
func (m *UnifiedRoleManagementPolicyRuleCollectionResponse) GetNextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *UnifiedRoleManagementPolicyRuleCollectionResponse) SetNextLink(value *string)() {
    if m != nil {
        m.nextLink = value
    }
}
