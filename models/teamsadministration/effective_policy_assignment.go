...
func NewEffectivePolicyAssignment() *EffectivePolicyAssignment {
	m := &EffectivePolicyAssignment{}
	m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance()
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateEffectivePolicyAssignmentFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateEffectivePolicyAssignmentFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewEffectivePolicyAssignment(), nil
}
...
func (m *EffectivePolicyAssignment) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["policyAssignment"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreatePolicyAssignmentFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetPolicyAssignment(val.(PolicyAssignmentable))
		}
		return nil
	}
...
// GetPolicyAssignment gets the policyAssignment property value. The policyAssignment property
// returns a PolicyAssignmentable when successful
func (m *EffectivePolicyAssignment) GetPolicyAssignment() PolicyAssignmentable {
	val, err := m.GetBackingStore().Get("policyAssignment")
	if err != nil {
		panic(err)
	}
	if val != nil {
		return val.(PolicyAssignmentable)
	}
	return nil
}

// GetPolicyType gets the policyType property value. The type of the assigned policy; for example, TeamsMeetingPolicy and TeamsCallingPolicy.
// returns a *string when successful
...
func (m *EffectivePolicyAssignment) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	...
	{
		err := writer.WriteObjectValue("policyAssignment", m.GetPolicyAssignment())
		if err != nil {
			return err
		}
	}
...
func (m *EffectivePolicyAssignment) SetPolicyAssignment(value PolicyAssignmentable) {
	err := m.GetBackingStore().Set("policyAssignment", value)
	if err != nil {
		panic(err)
	}
}
