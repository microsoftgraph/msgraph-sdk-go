...
// GetAssignedByGroup gets the assignedByGroup property value. 
func (m *LicenseAssignmentState) GetAssignedByGroup()(*string) {
    return m.assignedByGroup
}
// GetDisabledPlans gets the disabledPlans property value. 
...
// SetAssignedByGroup sets the assignedByGroup property value. 
func (m *LicenseAssignmentState) SetAssignedByGroup(value *string)() {
    m.assignedByGroup = value
}
// SetDisabledPlans sets the disabledPlans property value. 
