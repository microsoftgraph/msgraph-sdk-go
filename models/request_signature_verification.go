...
// GetAllowedWeakAlgorithms gets the allowedWeakAlgorithms property value. 
...
// GetIsSignedRequestRequired gets the isSignedRequestRequired property value. 
...
// SetAllowedWeakAlgorithms sets the allowedWeakAlgorithms property value. 
func (m *RequestSignatureVerification) SetAllowedWeakAlgorithms(value *WeakAlgorithms)() {
    m.allowedWeakAlgorithms = value
}
// SetIsSignedRequestRequired sets the isSignedRequestRequired property value. 
