...
func (m *SecureScoreControlProfileCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *SecureScoreControlProfileCollectionResponse) SetOdataNextLink(value *string)() {
