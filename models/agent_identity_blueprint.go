...
// GetCreatedByAppId gets the createdByAppId property value. The appId of the application that created this agent identity blueprint. Set internally by Microsoft Entra ID. Read-only. Inherited from application.
// returns a *string when successful
func (m *AgentIdentityBlueprint) GetCreatedByAppId()(*string) {
...
// SetCreatedByAppId sets the createdByAppId property value. The appId of the application that created this agent identity blueprint. Set internally by Microsoft Entra ID. Read-only. Inherited from application.
func (m *AgentIdentityBlueprint) SetCreatedByAppId(value *string)() {
