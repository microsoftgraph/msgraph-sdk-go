...
func (m *AdministrativeUnitsRequestBuilder) MicrosoftGraphDelta()(*AdministrativeUnitsMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewAdministrativeUnitsMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
