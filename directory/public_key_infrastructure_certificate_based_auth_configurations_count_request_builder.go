...
func (m *PublicKeyInfrastructureCertificateBasedAuthConfigurationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PublicKeyInfrastructureCertificateBasedAuthConfigurationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
