...
// AdministrativeUnitsItemMembersUserCountRequestBuilderGetQueryParameters get the number of the resource
type AdministrativeUnitsItemMembersUserCountRequestBuilderGetQueryParameters struct {
...
type AdministrativeUnitsItemMembersUserCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *AdministrativeUnitsItemMembersUserCountRequestBuilderGetQueryParameters
}
...
func (m *AdministrativeUnitsItemMembersUserCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersUserCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
