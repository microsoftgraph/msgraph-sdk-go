...
// DeletedItemsItemCheckMemberObjectsPostRequestBody provides operations to call the checkMemberObjects method.
...
func (m *DeletedItemsItemCheckMemberObjectsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *DeletedItemsItemCheckMemberObjectsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
