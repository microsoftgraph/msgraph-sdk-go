...
func NewAdministrativeUnitsItemMembersServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersServicePrincipalRequestBuilder) {
    m := &AdministrativeUnitsItemMembersServicePrincipalRequestBuilder{
    }
...
func NewAdministrativeUnitsItemMembersServicePrincipalRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersServicePrincipalRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersServicePrincipalRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *AdministrativeUnitsItemMembersServicePrincipalRequestBuilder) Count()(*AdministrativeUnitsItemMembersServicePrincipalCountRequestBuilder) {
    return NewAdministrativeUnitsItemMembersServicePrincipalCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AdministrativeUnitsItemMembersServicePrincipalRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersServicePrincipalRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AdministrativeUnitsItemMembersServicePrincipalRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersServicePrincipalRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ServicePrincipalCollectionResponseable, error) {
