...
// NewDeletedItemsGraphGroupRequestBuilderInternal instantiates a new GraphGroupRequestBuilder and sets the default values.
func NewDeletedItemsGraphGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsGraphGroupRequestBuilder) {
    m := &DeletedItemsGraphGroupRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/directory/deletedItems/graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewDeletedItemsGraphGroupRequestBuilder instantiates a new GraphGroupRequestBuilder and sets the default values.
func NewDeletedItemsGraphGroupRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsGraphGroupRequestBuilder) {
    ...
    return NewDeletedItemsGraphGroupRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DeletedItemsGraphGroupRequestBuilder) WithUrl(rawUrl string)(*DeletedItemsGraphGroupRequestBuilder) {
    return NewDeletedItemsGraphGroupRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
