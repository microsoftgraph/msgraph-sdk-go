...
func (m *DeletedItemsGraphDeviceCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedItemsGraphDeviceCountRequestBuilderGetRequestConfiguration)(*int64, error) {
