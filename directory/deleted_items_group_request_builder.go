...
func NewDeletedItemsGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsGroupRequestBuilder) {
    m := &DeletedItemsGroupRequestBuilder{
    }
...
func NewDeletedItemsGroupRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsGroupRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDeletedItemsGroupRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *DeletedItemsGroupRequestBuilder) Count()(*DeletedItemsGroupCountRequestBuilder) {
    return NewDeletedItemsGroupCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DeletedItemsGroupRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DeletedItemsGroupRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DeletedItemsGroupRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedItemsGroupRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.GroupCollectionResponseable, error) {
