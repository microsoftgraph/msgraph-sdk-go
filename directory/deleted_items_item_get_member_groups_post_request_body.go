...
// DeletedItemsItemGetMemberGroupsPostRequestBody provides operations to call the getMemberGroups method.
...
func (m *DeletedItemsItemGetMemberGroupsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *DeletedItemsItemGetMemberGroupsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
