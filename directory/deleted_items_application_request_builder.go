...
func NewDeletedItemsApplicationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsApplicationRequestBuilder) {
    m := &DeletedItemsApplicationRequestBuilder{
    }
...
func NewDeletedItemsApplicationRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsApplicationRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDeletedItemsApplicationRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *DeletedItemsApplicationRequestBuilder) Count()(*DeletedItemsApplicationCountRequestBuilder) {
    return NewDeletedItemsApplicationCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DeletedItemsApplicationRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DeletedItemsApplicationRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DeletedItemsApplicationRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedItemsApplicationRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ApplicationCollectionResponseable, error) {
