...
func NewAdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilder) {
    m := &AdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.orgContact/$count{?%24search,%24filter}";
...
func NewAdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *AdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *AdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
