...
func NewDeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody()(*DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody) {
    m := &DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody{
    }
...
func CreateDeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewDeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetFieldDeserializers the deserialization information for the current model
func (m *DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody) GetIds()([]string) {
...
func (m *DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody) GetTypes()([]string) {
...
func (m *DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetIds() != nil {
...
func (m *DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetIds sets the ids property value. The ids property
func (m *DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody) SetIds(value []string)() {
...
func (m *DeletedItemsMicrosoftGraphGetByIdsGetByIdsPostRequestBody) SetTypes(value []string)() {
