...
// NewDeletedItemsGraphUserRequestBuilderInternal instantiates a new GraphUserRequestBuilder and sets the default values.
func NewDeletedItemsGraphUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsGraphUserRequestBuilder) {
    m := &DeletedItemsGraphUserRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/directory/deletedItems/graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewDeletedItemsGraphUserRequestBuilder instantiates a new GraphUserRequestBuilder and sets the default values.
