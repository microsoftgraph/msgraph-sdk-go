...
// DeletedItemsValidatePropertiesPostRequestBody provides operations to call the validateProperties method.
...
func (m *DeletedItemsValidatePropertiesPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *DeletedItemsValidatePropertiesPostRequestBody) GetOnBehalfOfUserId()(*UUID) {
...
func (m *DeletedItemsValidatePropertiesPostRequestBody) SetAdditionalData(value map[string]interface{})() {
...
func (m *DeletedItemsValidatePropertiesPostRequestBody) SetOnBehalfOfUserId(value *UUID)() {
