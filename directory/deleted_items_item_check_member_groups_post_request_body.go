...
// DeletedItemsItemCheckMemberGroupsPostRequestBody provides operations to call the checkMemberGroups method.
...
func (m *DeletedItemsItemCheckMemberGroupsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *DeletedItemsItemCheckMemberGroupsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
