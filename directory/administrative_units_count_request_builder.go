...
func (m *AdministrativeUnitsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
