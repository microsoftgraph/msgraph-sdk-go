...
func (m *DeletedItemsGraphServicePrincipalCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedItemsGraphServicePrincipalCountRequestBuilderGetRequestConfiguration)(*int64, error) {
