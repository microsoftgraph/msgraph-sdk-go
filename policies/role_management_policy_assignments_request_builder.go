...
// ByUnifiedRoleManagementPolicyAssignmentIdString provides operations to manage the roleManagementPolicyAssignments property of the microsoft.graph.policyRoot entity.
func (m *RoleManagementPolicyAssignmentsRequestBuilder) ByUnifiedRoleManagementPolicyAssignmentIdString(unifiedRoleManagementPolicyAssignmentId string)(*RoleManagementPolicyAssignmentsUnifiedRoleManagementPolicyAssignmentItemRequestBuilder) {
