...
func NewPermissiongrantpoliciesItemIncludesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissiongrantpoliciesItemIncludesCountRequestBuilder) {
    m := &PermissiongrantpoliciesItemIncludesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/includes/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewPermissiongrantpoliciesItemIncludesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissiongrantpoliciesItemIncludesCountRequestBuilder) {
    ...
    return NewPermissiongrantpoliciesItemIncludesCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *PermissiongrantpoliciesItemIncludesCountRequestBuilder) WithUrl(rawUrl string)(*PermissiongrantpoliciesItemIncludesCountRequestBuilder) {
    return NewPermissiongrantpoliciesItemIncludesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
