...
// DeleteWithResponseHandler delete navigation property effectiveRules for policies
...
// PatchWithResponseHandler update the navigation property effectiveRules in policies
