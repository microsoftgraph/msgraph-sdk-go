...
func NewAdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder) {
    m := &AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder{
...
func NewAdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder) {
    ...
    return NewAdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilderInternal(urlParams, requestAdapter)
}
// Delete delete navigation property adminConsentRequestPolicy for policies
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder) Delete(ctx context.Context, requestConfiguration *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilderDeleteRequestConfiguration)(error) {
...
func (m *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder) Get(ctx context.Context, requestConfiguration *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AdminConsentRequestPolicyable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateAdminConsentRequestPolicyFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder) Patch(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AdminConsentRequestPolicyable, requestConfiguration *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilderPatchRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AdminConsentRequestPolicyable, error) {
...
func (m *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder) ToPatchRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AdminConsentRequestPolicyable, requestConfiguration *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder) WithUrl(rawUrl string)(*AdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder) {
    return NewAdminconsentrequestpolicyAdminConsentRequestPolicyRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
