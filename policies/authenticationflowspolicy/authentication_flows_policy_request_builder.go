...
// CreatePatchRequestInformationWithRequestConfiguration update the **selfServiceSignUp** property of an authenticationFlowsPolicy object. The properties **id**, **type**, and **description** cannot be modified.
