...
func (m *RoleManagementPoliciesItemEffectiveRulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *RoleManagementPoliciesItemEffectiveRulesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
