...
// HomeRealmDiscoveryPoliciesHomeRealmDiscoveryPolicyItemRequestBuilderGetQueryParameters the policy to control Microsoft Entra authentication behavior for federated users.
