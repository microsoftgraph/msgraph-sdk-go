...
func NewAuthorizationPolicyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AuthorizationPolicyRequestBuilder) {
    m := &AuthorizationPolicyRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/policies/authorizationPolicy{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *AuthorizationPolicyRequestBuilder) Delete(ctx context.Context, requestConfiguration *AuthorizationPolicyRequestBuilderDeleteRequestConfiguration)([]byte, error) {
