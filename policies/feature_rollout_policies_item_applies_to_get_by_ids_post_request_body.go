...
// FeatureRolloutPoliciesItemAppliesToGetByIdsPostRequestBody provides operations to call the getByIds method.
...
func (m *FeatureRolloutPoliciesItemAppliesToGetByIdsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *FeatureRolloutPoliciesItemAppliesToGetByIdsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
