...
// createRequestBuilder builds and executes requests for operations under \print\printers\microsoft.graph.create
...
func (m *CreateRequestBuilder) CreatePostRequestInformation(options *CreateRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *CreateRequestBuilder) Post(options *CreateRequestBuilderPostOptions)(error) {
