...
func (m *CreateRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body CreateRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreatePostRequestInformationWithRequestConfiguration(body, nil);
}
// CreatePostRequestInformationWithRequestConfiguration invoke action create
func (m *CreateRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body CreateRequestBodyable, requestConfiguration *CreateRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action create
func (m *CreateRequestBuilder) PostWithResponseHandler(body CreateRequestBodyable, requestConfiguration *CreateRequestBuilderPostRequestConfiguration)(error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action create
func (m *CreateRequestBuilder) PostWithResponseHandler(body CreateRequestBodyable, requestConfiguration *CreateRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
