...
func (m *RestoreFactoryDefaultsRequestBuilder) CreatePostRequestInformationWithRequestConfiguration()(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action restoreFactoryDefaults
func (m *RestoreFactoryDefaultsRequestBuilder) PostWithResponseHandler(requestConfiguration *RestoreFactoryDefaultsRequestBuilderPostRequestConfiguration)(error) {
    return m.PostWithResponseHandler(requestConfiguration, nil);
}
// PostWithResponseHandler invoke action restoreFactoryDefaults
func (m *RestoreFactoryDefaultsRequestBuilder) PostWithResponseHandler(requestConfiguration *RestoreFactoryDefaultsRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
