...
// RestoreFactoryDefaultsRequestBuilder builds and executes requests for operations under \print\printers\{printer-id}\microsoft.graph.restoreFactoryDefaults
