...
// RefRequestBuilder builds and executes requests for operations under \print\printers\{printer-id}\connectors\$ref
...
// RefRequestBuilderGetQueryParameters the connectors that are associated with the printer.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/printers/{printer_id}/connectors/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the connectors that are associated with the printer.
...
// Post the connectors that are associated with the printer.
