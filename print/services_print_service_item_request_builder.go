...
func (m *ServicesPrintServiceItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ServicesPrintServiceItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
