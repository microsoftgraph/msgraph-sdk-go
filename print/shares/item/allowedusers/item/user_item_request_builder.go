...
// UserItemRequestBuilder provides operations to manage the allowedUsers property of the microsoft.graph.printerShare entity.
...
// UserItemRequestBuilderGetQueryParameters the users who have access to print using the printer.
...
func NewUserItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/shares/{printerShare%2Did}/allowedUsers/{user%2Did}{?%24select,%24expand}";
