...
// ByPrintDocumentIdString provides operations to manage the documents property of the microsoft.graph.printJob entity.
func (m *SharesItemJobsItemDocumentsRequestBuilder) ByPrintDocumentIdString(printDocumentId string)(*SharesItemJobsItemDocumentsPrintDocumentItemRequestBuilder) {
...
// NewSharesItemJobsItemDocumentsRequestBuilderInternal instantiates a new DocumentsRequestBuilder and sets the default values.
func NewSharesItemJobsItemDocumentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemJobsItemDocumentsRequestBuilder) {
    m := &SharesItemJobsItemDocumentsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/documents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewSharesItemJobsItemDocumentsRequestBuilder instantiates a new DocumentsRequestBuilder and sets the default values.
