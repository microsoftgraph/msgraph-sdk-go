...
import (
    ...
    i4e1988e39b5a1015e78a3e9da29fbf5d72e966a197cad44340c36012156c674f "github.com/microsoftgraph/msgraph-sdk-go/print/taskdefinitions/item/tasks/item/definition/ref"
)
...
func NewDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DefinitionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/print/taskDefinitions/{printTaskDefinition_id}/tasks/{printTask_id}/definition{?select,expand}";
...
func (m *DefinitionRequestBuilder) Ref()(*i4e1988e39b5a1015e78a3e9da29fbf5d72e966a197cad44340c36012156c674f.RefRequestBuilder) {
    return i4e1988e39b5a1015e78a3e9da29fbf5d72e966a197cad44340c36012156c674f.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
