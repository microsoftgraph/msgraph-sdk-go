...
// RefRequestBuilder builds and executes requests for operations under \print\taskDefinitions\{printTaskDefinition-id}\tasks\{printTask-id}\definition\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/taskDefinitions/{printTaskDefinition_id}/tasks/{printTask_id}/definition/$ref";
...
// CreateDeleteRequestInformation the printTaskDefinition that was used to create this task. Read-only.
...
// CreatePutRequestInformation the printTaskDefinition that was used to create this task. Read-only.
...
// Delete the printTaskDefinition that was used to create this task. Read-only.
...
// Put the printTaskDefinition that was used to create this task. Read-only.
