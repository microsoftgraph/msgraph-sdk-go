...
// RefRequestBuilder builds and executes requests for operations under \print\taskDefinitions\{printTaskDefinition-id}\tasks\{printTask-id}\trigger\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/taskDefinitions/{printTaskDefinition_id}/tasks/{printTask_id}/trigger/$ref";
...
// CreateDeleteRequestInformation the printTaskTrigger that triggered this task's execution. Read-only.
...
// CreatePutRequestInformation the printTaskTrigger that triggered this task's execution. Read-only.
...
// Delete the printTaskTrigger that triggered this task's execution. Read-only.
...
// Put the printTaskTrigger that triggered this task's execution. Read-only.
