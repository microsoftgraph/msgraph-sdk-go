...
func (m *MobileAppsItemGraphWindowsMobileMSICategoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphWindowsMobileMSICategoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
