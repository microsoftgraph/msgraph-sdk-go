...
func (m *WindowsInformationProtectionPoliciesItemAssignmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsInformationProtectionPoliciesItemAssignmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
