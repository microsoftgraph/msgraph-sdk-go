...
func (m *WindowsInformationProtectionPoliciesItemProtectedAppLockerFilesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsInformationProtectionPoliciesItemProtectedAppLockerFilesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
