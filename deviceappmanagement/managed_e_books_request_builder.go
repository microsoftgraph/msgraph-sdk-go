...
// ByManagedEBookIdString provides operations to manage the managedEBooks property of the microsoft.graph.deviceAppManagement entity.
func (m *ManagedEBooksRequestBuilder) ByManagedEBookIdString(managedEBookId string)(*ManagedEBooksManagedEBookItemRequestBuilder) {
