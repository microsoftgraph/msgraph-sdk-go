...
func (m *MobileAppConfigurationsItemDeviceStatusSummaryRequestBuilder) Delete(ctx context.Context, requestConfiguration *MobileAppConfigurationsItemDeviceStatusSummaryRequestBuilderDeleteRequestConfiguration)([]byte, error) {
