...
// refRequestBuilder builds and executes requests for operations under \deviceAppManagement\mobileApps\{mobileApp-id}\categories\$ref
...
// refRequestBuilderGetQueryParameters the list of categories for this app.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp_id}/categories/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the list of categories for this app.
...
// Post the list of categories for this app.
