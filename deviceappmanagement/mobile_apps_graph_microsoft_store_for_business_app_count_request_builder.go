...
func (m *MobileAppsGraphMicrosoftStoreForBusinessAppCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsGraphMicrosoftStoreForBusinessAppCountRequestBuilderGetRequestConfiguration)(*int64, error) {
