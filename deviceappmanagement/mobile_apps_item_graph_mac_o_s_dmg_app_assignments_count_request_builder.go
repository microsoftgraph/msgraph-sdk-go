...
func (m *MobileAppsItemGraphMacOSDmgAppAssignmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphMacOSDmgAppAssignmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
