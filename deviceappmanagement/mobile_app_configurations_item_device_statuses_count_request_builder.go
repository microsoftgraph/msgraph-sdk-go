...
func (m *MobileAppConfigurationsItemDeviceStatusesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppConfigurationsItemDeviceStatusesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
