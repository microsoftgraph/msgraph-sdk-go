...
func (m *MobileAppsItemGraphMobileLobAppRequestBuilder) WithUrl(rawUrl string)(*MobileAppsItemGraphMobileLobAppRequestBuilder) {
    return NewMobileAppsItemGraphMobileLobAppRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
