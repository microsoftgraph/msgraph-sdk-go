...
// ByManagedDeviceMobileAppConfigurationDeviceStatusIdString provides operations to manage the deviceStatuses property of the microsoft.graph.managedDeviceMobileAppConfiguration entity.
func (m *MobileAppConfigurationsItemDeviceStatusesRequestBuilder) ByManagedDeviceMobileAppConfigurationDeviceStatusIdString(managedDeviceMobileAppConfigurationDeviceStatusId string)(*MobileAppConfigurationsItemDeviceStatusesManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilder) {
