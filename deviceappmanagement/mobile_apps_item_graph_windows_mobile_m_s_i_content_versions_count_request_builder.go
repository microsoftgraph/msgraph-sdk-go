...
func (m *MobileAppsItemGraphWindowsMobileMSIContentVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphWindowsMobileMSIContentVersionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
