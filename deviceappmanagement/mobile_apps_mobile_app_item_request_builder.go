...
// Patch update the properties of a managedAndroidLobApp object.
// returns a MobileAppable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
...
// ToDeleteRequestInformation deletes a win32LobApp.
...
// ToPatchRequestInformation update the properties of a managedAndroidLobApp object.
// returns a *RequestInformation when successful
