...
// MobileAppsMobileAppItemRequestBuilderGetQueryParameters read properties and relationships of the iosStoreApp object.
...
// Get read properties and relationships of the iosStoreApp object.
...
// Patch update the properties of a webApp object.
// returns a MobileAppable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
...
// ToGetRequestInformation read properties and relationships of the iosStoreApp object.
// returns a *RequestInformation when successful
...
// ToPatchRequestInformation update the properties of a webApp object.
// returns a *RequestInformation when successful
