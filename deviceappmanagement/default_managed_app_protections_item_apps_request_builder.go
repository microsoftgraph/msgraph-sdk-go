...
// ByManagedMobileAppIdString provides operations to manage the apps property of the microsoft.graph.defaultManagedAppProtection entity.
func (m *DefaultManagedAppProtectionsItemAppsRequestBuilder) ByManagedMobileAppIdString(managedMobileAppId string)(*DefaultManagedAppProtectionsItemAppsManagedMobileAppItemRequestBuilder) {
...
// NewDefaultManagedAppProtectionsItemAppsRequestBuilderInternal instantiates a new AppsRequestBuilder and sets the default values.
func NewDefaultManagedAppProtectionsItemAppsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DefaultManagedAppProtectionsItemAppsRequestBuilder) {
    m := &DefaultManagedAppProtectionsItemAppsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection%2Did}/apps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewDefaultManagedAppProtectionsItemAppsRequestBuilder instantiates a new AppsRequestBuilder and sets the default values.
