...
func (m *DefaultManagedAppProtectionsItemAppsRequestBuilder) Count()(*DefaultManagedAppProtectionsItemAppsCountRequestBuilder) {
    return NewDefaultManagedAppProtectionsItemAppsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list of apps to which the policy is deployed.
func (m *DefaultManagedAppProtectionsItemAppsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DefaultManagedAppProtectionsItemAppsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
