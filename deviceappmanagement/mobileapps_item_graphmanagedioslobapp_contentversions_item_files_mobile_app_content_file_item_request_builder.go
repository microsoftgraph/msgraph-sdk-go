...
func (m *MobileappsItemGraphmanagedioslobappContentversionsItemFilesMobileAppContentFileItemRequestBuilder) RenewUpload()(*MobileappsItemGraphmanagedioslobappContentversionsItemFilesItemRenewuploadRenewUploadRequestBuilder) {
    return NewMobileappsItemGraphmanagedioslobappContentversionsItemFilesItemRenewuploadRenewUploadRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
