...
func (m *MobileAppsItemGraphWindowsWebAppCategoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphWindowsWebAppCategoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
