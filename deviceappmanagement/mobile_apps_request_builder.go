...
// MobileAppsRequestBuilderGetQueryParameters list properties and relationships of the managedAndroidLobApp objects.
...
// Get list properties and relationships of the managedAndroidLobApp objects.
// returns a MobileAppCollectionResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/intune-apps-managedandroidlobapp-list?view=graph-rest-1.0
...
// Post create a new managedAndroidLobApp object.
...
// ToGetRequestInformation list properties and relationships of the managedAndroidLobApp objects.
...
// ToPostRequestInformation create a new managedAndroidLobApp object.
// returns a *RequestInformation when successful
