...
// Post create a new macOSLobApp object.
// returns a MobileAppable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/intune-apps-macoslobapp-create?view=graph-rest-1.0
...
// ToPostRequestInformation create a new macOSLobApp object.
// returns a *RequestInformation when successful
