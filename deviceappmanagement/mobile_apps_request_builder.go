...
// MobileAppsRequestBuilderGetQueryParameters list properties and relationships of the managedMobileLobApp objects.
...
// Get list properties and relationships of the managedMobileLobApp objects.
// returns a MobileAppCollectionResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/intune-apps-managedmobilelobapp-list?view=graph-rest-1.0
...
// Post create a new iosiPadOSWebClip object.
// returns a MobileAppable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/intune-apps-iosipadoswebclip-create?view=graph-rest-1.0
...
// ToGetRequestInformation list properties and relationships of the managedMobileLobApp objects.
...
// ToPostRequestInformation create a new iosiPadOSWebClip object.
// returns a *RequestInformation when successful
