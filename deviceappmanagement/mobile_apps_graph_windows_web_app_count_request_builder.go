...
func (m *MobileAppsGraphWindowsWebAppCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsGraphWindowsWebAppCountRequestBuilderGetRequestConfiguration)(*int64, error) {
