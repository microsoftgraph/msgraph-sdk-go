...
func (m *MobileAppsItemGraphMicrosoftStoreForBusinessAppCategoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphMicrosoftStoreForBusinessAppCategoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
