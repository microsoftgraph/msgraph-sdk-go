...
func (m *MobileappsItemGraphmacoslobappContentversionsMobileAppContentItemRequestBuilder) ContainedApps()(*MobileappsItemGraphmacoslobappContentversionsItemContainedappsContainedAppsRequestBuilder) {
    return NewMobileappsItemGraphmacoslobappContentversionsItemContainedappsContainedAppsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
