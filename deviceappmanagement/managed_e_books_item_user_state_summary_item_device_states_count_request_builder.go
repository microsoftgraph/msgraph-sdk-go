...
func (m *ManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
