...
func (m *ManagedEBooksItemInstallSummaryRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedEBooksItemInstallSummaryRequestBuilderDeleteRequestConfiguration)([]byte, error) {
