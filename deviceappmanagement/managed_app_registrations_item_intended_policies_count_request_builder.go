...
func (m *ManagedAppRegistrationsItemIntendedPoliciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedAppRegistrationsItemIntendedPoliciesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
