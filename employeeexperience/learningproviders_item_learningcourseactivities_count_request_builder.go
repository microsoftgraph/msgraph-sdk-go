...
func NewLearningprovidersItemLearningcourseactivitiesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LearningprovidersItemLearningcourseactivitiesCountRequestBuilder) {
    m := &LearningprovidersItemLearningcourseactivitiesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningCourseActivities/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewLearningprovidersItemLearningcourseactivitiesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LearningprovidersItemLearningcourseactivitiesCountRequestBuilder) {
    ...
    return NewLearningprovidersItemLearningcourseactivitiesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *LearningprovidersItemLearningcourseactivitiesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *LearningprovidersItemLearningcourseactivitiesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *LearningprovidersItemLearningcourseactivitiesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *LearningprovidersItemLearningcourseactivitiesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *LearningprovidersItemLearningcourseactivitiesCountRequestBuilder) WithUrl(rawUrl string)(*LearningprovidersItemLearningcourseactivitiesCountRequestBuilder) {
    return NewLearningprovidersItemLearningcourseactivitiesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
