...
// NewLearningProvidersItemLearningContentsWithExternalIdRequestBuilder instantiates a new LearningContentsWithExternalIdRequestBuilder and sets the default values.
