...
// RolesItemMembersEngagementRoleMemberItemRequestBuilder provides operations to manage the members property of the microsoft.graph.engagementRole entity.
type RolesItemMembersEngagementRoleMemberItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// RolesItemMembersEngagementRoleMemberItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type RolesItemMembersEngagementRoleMemberItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// RolesItemMembersEngagementRoleMemberItemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type RolesItemMembersEngagementRoleMemberItemRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func NewRolesItemMembersEngagementRoleMemberItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RolesItemMembersEngagementRoleMemberItemRequestBuilder) {
    m := &RolesItemMembersEngagementRoleMemberItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/employeeExperience/roles/{engagementRole%2Did}/members/{engagementRoleMember%2Did}", pathParameters),
    }
    return m
}
// NewRolesItemMembersEngagementRoleMemberItemRequestBuilder instantiates a new RolesItemMembersEngagementRoleMemberItemRequestBuilder and sets the default values.
func NewRolesItemMembersEngagementRoleMemberItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RolesItemMembersEngagementRoleMemberItemRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewRolesItemMembersEngagementRoleMemberItemRequestBuilderInternal(urlParams, requestAdapter)
}
// Delete delete a Viva Engage role from a user.
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/engagementrole-delete-members?view=graph-rest-1.0
func (m *RolesItemMembersEngagementRoleMemberItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *RolesItemMembersEngagementRoleMemberItemRequestBuilderDeleteRequestConfiguration)(error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *RolesItemMembersEngagementRoleMemberItemRequestBuilder) Get(ctx context.Context, requestConfiguration *RolesItemMembersEngagementRoleMemberItemRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.EngagementRoleMemberable, error) {
...
func (m *RolesItemMembersEngagementRoleMemberItemRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *RolesItemMembersEngagementRoleMemberItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.GET, "{+baseurl}/employeeExperience/roles/{engagementRole%2Did}/members/{engagementRoleMember%2Did}{?%24expand,%24select}", m.BaseRequestBuilder.PathParameters)
    if requestConfiguration != nil {
...
// returns a *RolesItemMembersItemUserRequestBuilder when successful
func (m *RolesItemMembersEngagementRoleMemberItemRequestBuilder) User()(*RolesItemMembersItemUserRequestBuilder) {
    return NewRolesItemMembersItemUserRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// WithUrl returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
// returns a *RolesItemMembersEngagementRoleMemberItemRequestBuilder when successful
func (m *RolesItemMembersEngagementRoleMemberItemRequestBuilder) WithUrl(rawUrl string)(*RolesItemMembersEngagementRoleMemberItemRequestBuilder) {
    return NewRolesItemMembersEngagementRoleMemberItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
