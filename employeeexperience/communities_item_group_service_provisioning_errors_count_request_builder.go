...
func NewCommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilder) {
    m := &CommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/employeeExperience/communities/{community%2Did}/group/serviceProvisioningErrors/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewCommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilder) {
    ...
    return NewCommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int64 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *CommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
...
func (m *CommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilder) WithUrl(rawUrl string)(*CommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilder) {
    return NewCommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
