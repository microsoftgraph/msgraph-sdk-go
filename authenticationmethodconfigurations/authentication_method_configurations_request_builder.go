...
// GetWithResponseHandler get entities from authenticationMethodConfigurations
...
// PostWithResponseHandler add new entity to authenticationMethodConfigurations
