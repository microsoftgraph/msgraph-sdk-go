...
func NewDriveListSubscriptionsItemReauthorizeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListSubscriptionsItemReauthorizeRequestBuilder) {
    m := &DriveListSubscriptionsItemReauthorizeRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/list/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize";
...
func NewDriveListSubscriptionsItemReauthorizeRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListSubscriptionsItemReauthorizeRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveListSubscriptionsItemReauthorizeRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action reauthorize
func (m *DriveListSubscriptionsItemReauthorizeRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *DriveListSubscriptionsItemReauthorizeRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveListSubscriptionsItemReauthorizeRequestBuilder) Post(ctx context.Context, requestConfiguration *DriveListSubscriptionsItemReauthorizeRequestBuilderPostRequestConfiguration)(error) {
