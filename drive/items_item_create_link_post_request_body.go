...
// ItemsItemCreateLinkPostRequestBody provides operations to call the createLink method.
...
func (m *ItemsItemCreateLinkPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemsItemCreateLinkPostRequestBody) SetAdditionalData(value map[string]interface{})() {
