...
func NewRootCreateUploadSessionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootCreateUploadSessionRequestBuilder) {
    m := &RootCreateUploadSessionRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/root/microsoft.graph.createUploadSession";
...
func NewRootCreateUploadSessionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootCreateUploadSessionRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewRootCreateUploadSessionRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *RootCreateUploadSessionRequestBuilder) CreatePostRequestInformation(ctx context.Context, body RootCreateUploadSessionPostRequestBodyable, requestConfiguration *RootCreateUploadSessionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RootCreateUploadSessionRequestBuilder) Post(ctx context.Context, body RootCreateUploadSessionPostRequestBodyable, requestConfiguration *RootCreateUploadSessionRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UploadSessionable, error) {
