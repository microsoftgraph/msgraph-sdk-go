...
func NewItemsItemUnfollowRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemUnfollowRequestBuilder) {
    m := &ItemsItemUnfollowRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/microsoft.graph.unfollow";
...
func NewItemsItemUnfollowRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemUnfollowRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemsItemUnfollowRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation unfollow a driveItem.
func (m *ItemsItemUnfollowRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *ItemsItemUnfollowRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemsItemUnfollowRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemsItemUnfollowRequestBuilderPostRequestConfiguration)(error) {
