...
func NewDriveListColumnsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListColumnsCountRequestBuilder) {
    m := &DriveListColumnsCountRequestBuilder{
    }
...
func NewDriveListColumnsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListColumnsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveListColumnsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveListColumnsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveListColumnsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveListColumnsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveListColumnsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
