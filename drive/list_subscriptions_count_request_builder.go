...
func NewListSubscriptionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ListSubscriptionsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/list/subscriptions/$count";
...
func (m *ListSubscriptionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ListSubscriptionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
