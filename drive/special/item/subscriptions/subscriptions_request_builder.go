...
import (
    ...
    i6fa0d6e18ba09b10738d4afab53dce17cda9565b17537af30ddbd52b4653bd3e "github.com/microsoftgraph/msgraph-sdk-go/drive/special/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/special/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*i6fa0d6e18ba09b10738d4afab53dce17cda9565b17537af30ddbd52b4653bd3e.CountRequestBuilder) {
    return i6fa0d6e18ba09b10738d4afab53dce17cda9565b17537af30ddbd52b4653bd3e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
