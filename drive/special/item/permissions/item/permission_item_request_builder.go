...
import (
    ...
    i534e4cbf7715379f35dd3673b1163f2b4fbd64d1f7bf812cb712f42c1d4c4554 "github.com/microsoftgraph/msgraph-sdk-go/drive/special/item/permissions/item/grant"
)
...
func NewPermissionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/special/{driveItem_id}/permissions/{permission_id}{?select,expand}";
...
func (m *PermissionItemRequestBuilder) Grant()(*i534e4cbf7715379f35dd3673b1163f2b4fbd64d1f7bf812cb712f42c1d4c4554.GrantRequestBuilder) {
    return i534e4cbf7715379f35dd3673b1163f2b4fbd64d1f7bf812cb712f42c1d4c4554.NewGrantRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
