...
import (
    ...
    i882c746a956e2d3e0b4b2777788fade616a740cb1b0c4ea08e3eb34a62363a1c "github.com/microsoftgraph/msgraph-sdk-go/drive/special/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/special/{driveItem_id}/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*i882c746a956e2d3e0b4b2777788fade616a740cb1b0c4ea08e3eb34a62363a1c.CountRequestBuilder) {
    return i882c746a956e2d3e0b4b2777788fade616a740cb1b0c4ea08e3eb34a62363a1c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
