...
import (
    ...
    i48fba5cb3dd59a376e5fafc41f447067e834e2b548b516b8f88a2307890f547f "github.com/microsoftgraph/msgraph-sdk-go/drive/special/count"
...
func NewSpecialRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SpecialRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/special{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SpecialRequestBuilder) Count()(*i48fba5cb3dd59a376e5fafc41f447067e834e2b548b516b8f88a2307890f547f.CountRequestBuilder) {
    return i48fba5cb3dd59a376e5fafc41f447067e834e2b548b516b8f88a2307890f547f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to special for drive
...
// Post create new navigation property to special for drive
