...
func NewDriveItemsItemCheckoutRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemCheckoutRequestBuilder) {
    m := &DriveItemsItemCheckoutRequestBuilder{
    }
...
func NewDriveItemsItemCheckoutRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemCheckoutRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveItemsItemCheckoutRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DriveItemsItemCheckoutRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *DriveItemsItemCheckoutRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveItemsItemCheckoutRequestBuilder) Post(ctx context.Context, requestConfiguration *DriveItemsItemCheckoutRequestBuilderPostRequestConfiguration)(error) {
