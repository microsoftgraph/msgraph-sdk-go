...
func NewDriveItemsItemListItemDocumentSetVersionsItemRestoreRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemListItemDocumentSetVersionsItemRestoreRequestBuilder) {
    m := &DriveItemsItemListItemDocumentSetVersionsItemRestoreRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/documentSetVersions/{documentSetVersion%2Did}/microsoft.graph.restore";
...
func NewDriveItemsItemListItemDocumentSetVersionsItemRestoreRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemListItemDocumentSetVersionsItemRestoreRequestBuilder) {
    ...
    return NewDriveItemsItemListItemDocumentSetVersionsItemRestoreRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation restore a document set version.
func (m *DriveItemsItemListItemDocumentSetVersionsItemRestoreRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *DriveItemsItemListItemDocumentSetVersionsItemRestoreRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveItemsItemListItemDocumentSetVersionsItemRestoreRequestBuilder) Post(ctx context.Context, requestConfiguration *DriveItemsItemListItemDocumentSetVersionsItemRestoreRequestBuilderPostRequestConfiguration)(error) {
