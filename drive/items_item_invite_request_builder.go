...
func NewItemsItemInviteRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemInviteRequestBuilder) {
    m := &ItemsItemInviteRequestBuilder{
    }
...
func NewItemsItemInviteRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemInviteRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemsItemInviteRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemsItemInviteRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ItemsItemInvitePostRequestBodyable, requestConfiguration *ItemsItemInviteRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemsItemInviteRequestBuilder) Post(ctx context.Context, body ItemsItemInvitePostRequestBodyable, requestConfiguration *ItemsItemInviteRequestBuilderPostRequestConfiguration)(ItemsItemInviteResponseable, error) {
    ...
    return res.(ItemsItemInviteResponseable), nil
}
