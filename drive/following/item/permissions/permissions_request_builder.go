...
import (
    ...
    id7c9855b28f7373801bd01f04bed6cbab3df6bf7cf12383d8d6e6f5c7048302c "github.com/microsoftgraph/msgraph-sdk-go/drive/following/item/permissions/count"
)
...
func NewPermissionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/following/{driveItem_id}/permissions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PermissionsRequestBuilder) Count()(*id7c9855b28f7373801bd01f04bed6cbab3df6bf7cf12383d8d6e6f5c7048302c.CountRequestBuilder) {
    return id7c9855b28f7373801bd01f04bed6cbab3df6bf7cf12383d8d6e6f5c7048302c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
