...
// contentRequestBuilder builds and executes requests for operations under \drive\following\{driveItem-id}\content
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/following/{driveItem_id}/content";
...
// CreateGetRequestInformation get media content for the navigation property following from drive
...
// CreatePutRequestInformation update media content for the navigation property following in drive
...
// Get get media content for the navigation property following from drive
...
// Put update media content for the navigation property following in drive
