...
import (
    ...
    i1aa39c32fc68bbf8fe1189d4da8479218b13153f03a1911e6592c4192be3604a "github.com/microsoftgraph/msgraph-sdk-go/drive/following/item/versions/item/content"
    i7afe9d06451be5f099063121fd678f0223790802a0cf54b23207062ceca0a523 "github.com/microsoftgraph/msgraph-sdk-go/drive/following/item/versions/item/restoreversion"
)
...
func NewDriveItemVersionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemVersionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/following/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
...
func (m *DriveItemVersionItemRequestBuilder) Content()(*i1aa39c32fc68bbf8fe1189d4da8479218b13153f03a1911e6592c4192be3604a.ContentRequestBuilder) {
    return i1aa39c32fc68bbf8fe1189d4da8479218b13153f03a1911e6592c4192be3604a.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DriveItemVersionItemRequestBuilder) RestoreVersion()(*i7afe9d06451be5f099063121fd678f0223790802a0cf54b23207062ceca0a523.RestoreVersionRequestBuilder) {
    return i7afe9d06451be5f099063121fd678f0223790802a0cf54b23207062ceca0a523.NewRestoreVersionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
