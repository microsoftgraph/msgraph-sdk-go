...
import (
    ...
    ib25f4dd8f9cddc34c5ce3da2ba6d60d38f2fc3f0ea64ad82875647948a8f15dd "github.com/microsoftgraph/msgraph-sdk-go/drive/following/item/listitem/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/following/{driveItem_id}/listItem/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*ib25f4dd8f9cddc34c5ce3da2ba6d60d38f2fc3f0ea64ad82875647948a8f15dd.ContentRequestBuilder) {
    return ib25f4dd8f9cddc34c5ce3da2ba6d60d38f2fc3f0ea64ad82875647948a8f15dd.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
