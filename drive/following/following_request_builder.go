...
import (
    ...
    if5b0461dee48c1f3bc27e3e61607528f130b9db12b74f369ccca9aff27f3f870 "github.com/microsoftgraph/msgraph-sdk-go/drive/following/count"
)
...
func NewFollowingRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FollowingRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/following{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *FollowingRequestBuilder) Count()(*if5b0461dee48c1f3bc27e3e61607528f130b9db12b74f369ccca9aff27f3f870.CountRequestBuilder) {
    return if5b0461dee48c1f3bc27e3e61607528f130b9db12b74f369ccca9aff27f3f870.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to following for drive
...
func (m *FollowingRequestBuilder) Get(options *FollowingRequestBuilderGetOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.DriveItemCollectionResponseable, error) {
...
// Post create new navigation property to following for drive
func (m *FollowingRequestBuilder) Post(options *FollowingRequestBuilderPostOptions)(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.DriveItemable, error) {
