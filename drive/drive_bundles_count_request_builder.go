...
func NewDriveBundlesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveBundlesCountRequestBuilder) {
    m := &DriveBundlesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/bundles/$count";
...
func NewDriveBundlesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveBundlesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveBundlesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveBundlesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveBundlesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveBundlesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveBundlesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
