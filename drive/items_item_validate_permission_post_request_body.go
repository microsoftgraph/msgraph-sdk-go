...
// ItemsItemValidatePermissionPostRequestBody provides operations to call the validatePermission method.
...
func (m *ItemsItemValidatePermissionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemsItemValidatePermissionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
