...
func NewDriveListContentTypesItemColumnPositionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListContentTypesItemColumnPositionsRequestBuilder) {
    m := &DriveListContentTypesItemColumnPositionsRequestBuilder{
    }
...
func NewDriveListContentTypesItemColumnPositionsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListContentTypesItemColumnPositionsRequestBuilder) {
    ...
    return NewDriveListContentTypesItemColumnPositionsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *DriveListContentTypesItemColumnPositionsRequestBuilder) Count()(*DriveListContentTypesItemColumnPositionsCountRequestBuilder) {
    return NewDriveListContentTypesItemColumnPositionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation column order information in a content type.
func (m *DriveListContentTypesItemColumnPositionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveListContentTypesItemColumnPositionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveListContentTypesItemColumnPositionsRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveListContentTypesItemColumnPositionsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ColumnDefinitionCollectionResponseable, error) {
