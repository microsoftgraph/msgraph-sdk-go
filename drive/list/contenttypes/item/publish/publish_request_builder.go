...
// PublishRequestBuilder builds and executes requests for operations under \drive\list\contentTypes\{contentType-id}\microsoft.graph.publish
...
func NewPublishRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PublishRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType_id}/microsoft.graph.publish";
