...
import (
    ...
    i97bfec20b192a073802167be2ee23f456cc9fab7aed7d15e693001da45abfc20 "github.com/microsoftgraph/msgraph-sdk-go/drive/list/items/item/driveitem/content"
)

// driveItemRequestBuilder builds and executes requests for operations under \drive\list\items\{listItem-id}\driveItem
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/list/items/{listItem_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i97bfec20b192a073802167be2ee23f456cc9fab7aed7d15e693001da45abfc20.ContentRequestBuilder) {
    return i97bfec20b192a073802167be2ee23f456cc9fab7aed7d15e693001da45abfc20.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
