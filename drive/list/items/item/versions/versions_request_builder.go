...
import (
    ...
    ic64c5d7eb2e353bd429f732a233303b0e3c688db07be58bbac53f7a31a318c6d "github.com/microsoftgraph/msgraph-sdk-go/drive/list/items/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/list/items/{listItem%2Did}/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *VersionsRequestBuilder) Count()(*ic64c5d7eb2e353bd429f732a233303b0e3c688db07be58bbac53f7a31a318c6d.CountRequestBuilder) {
    return ic64c5d7eb2e353bd429f732a233303b0e3c688db07be58bbac53f7a31a318c6d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
