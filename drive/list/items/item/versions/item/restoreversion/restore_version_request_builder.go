...
// RestoreVersionRequestBuilder builds and executes requests for operations under \drive\list\items\{listItem-id}\versions\{listItemVersion-id}\microsoft.graph.restoreVersion
