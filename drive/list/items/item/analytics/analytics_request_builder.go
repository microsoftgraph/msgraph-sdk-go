...
import (
    ...
    if455ea38984a3f341f7c0281f5019dc32f3c60dd92675913a3ee391678a77af8 "github.com/microsoftgraph/msgraph-sdk-go/drive/list/items/item/analytics/ref"
)

// AnalyticsRequestBuilder builds and executes requests for operations under \drive\list\items\{listItem-id}\analytics
...
func NewAnalyticsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AnalyticsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/list/items/{listItem_id}/analytics{?select,expand}";
...
func (m *AnalyticsRequestBuilder) Ref()(*if455ea38984a3f341f7c0281f5019dc32f3c60dd92675913a3ee391678a77af8.RefRequestBuilder) {
    return if455ea38984a3f341f7c0281f5019dc32f3c60dd92675913a3ee391678a77af8.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
