...
import (
    ...
    i8cf76fbae918ed3006f17394a1591d19ade45d8b00cf4bd623abddbb2f86a4a5 "github.com/microsoftgraph/msgraph-sdk-go/drive/list/columns/item/sourcecolumn/ref"
)
...
func NewSourceColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SourceColumnRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/drive/list/columns/{columnDefinition_id}/sourceColumn{?select,expand}";
...
func (m *SourceColumnRequestBuilder) Ref()(*i8cf76fbae918ed3006f17394a1591d19ade45d8b00cf4bd623abddbb2f86a4a5.RefRequestBuilder) {
    return i8cf76fbae918ed3006f17394a1591d19ade45d8b00cf4bd623abddbb2f86a4a5.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
