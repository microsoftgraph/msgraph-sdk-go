...
func NewRootCreateLinkRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootCreateLinkRequestBuilder) {
    m := &RootCreateLinkRequestBuilder{
    }
...
func NewRootCreateLinkRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootCreateLinkRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewRootCreateLinkRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *RootCreateLinkRequestBuilder) Post(ctx context.Context, body RootCreateLinkPostRequestBodyable, requestConfiguration *RootCreateLinkRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Permissionable, error) {
...
func (m *RootCreateLinkRequestBuilder) ToPostRequestInformation(ctx context.Context, body RootCreateLinkPostRequestBodyable, requestConfiguration *RootCreateLinkRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
