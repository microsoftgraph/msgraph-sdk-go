...
func NewDriveRootListItemVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootListItemVersionsRequestBuilder) {
    m := &DriveRootListItemVersionsRequestBuilder{
    }
...
func NewDriveRootListItemVersionsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootListItemVersionsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveRootListItemVersionsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *DriveRootListItemVersionsRequestBuilder) Count()(*DriveRootListItemVersionsCountRequestBuilder) {
    return NewDriveRootListItemVersionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DriveRootListItemVersionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveRootListItemVersionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveRootListItemVersionsRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveRootListItemVersionsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ListItemVersionCollectionResponseable, error) {
