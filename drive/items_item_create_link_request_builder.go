...
func NewItemsItemCreateLinkRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemCreateLinkRequestBuilder) {
    m := &ItemsItemCreateLinkRequestBuilder{
    }
...
func NewItemsItemCreateLinkRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemCreateLinkRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemsItemCreateLinkRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemsItemCreateLinkRequestBuilder) Post(ctx context.Context, body ItemsItemCreateLinkPostRequestBodyable, requestConfiguration *ItemsItemCreateLinkRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Permissionable, error) {
...
func (m *ItemsItemCreateLinkRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemsItemCreateLinkPostRequestBodyable, requestConfiguration *ItemsItemCreateLinkRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
