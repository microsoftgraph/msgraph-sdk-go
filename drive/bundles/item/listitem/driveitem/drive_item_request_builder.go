...
import (
    ...
    ib1e23440bd45d1295b7b67fc9ea07bab96c9624f1a22ff64956df0ba4d02c8b2 "github.com/microsoftgraph/msgraph-sdk-go/drive/bundles/item/listitem/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/listItem/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*ib1e23440bd45d1295b7b67fc9ea07bab96c9624f1a22ff64956df0ba4d02c8b2.ContentRequestBuilder) {
    return ib1e23440bd45d1295b7b67fc9ea07bab96c9624f1a22ff64956df0ba4d02c8b2.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
