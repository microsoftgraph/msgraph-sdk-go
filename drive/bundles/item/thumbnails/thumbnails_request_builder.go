...
import (
    ...
    i3848e5a06a3b5552db80102c05b315d526a5a4ceed9f91c5c2eb4963b1466b8f "github.com/microsoftgraph/msgraph-sdk-go/drive/bundles/item/thumbnails/count"
)
...
func NewThumbnailsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ThumbnailsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/thumbnails{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ThumbnailsRequestBuilder) Count()(*i3848e5a06a3b5552db80102c05b315d526a5a4ceed9f91c5c2eb4963b1466b8f.CountRequestBuilder) {
    return i3848e5a06a3b5552db80102c05b315d526a5a4ceed9f91c5c2eb4963b1466b8f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
