...
import (
    ...
    ia55a14ea3488e46aca5d25ed302a3eefb283f7b8791ad5137567186a62befa25 "github.com/microsoftgraph/msgraph-sdk-go/drive/bundles/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*ia55a14ea3488e46aca5d25ed302a3eefb283f7b8791ad5137567186a62befa25.CountRequestBuilder) {
    return ia55a14ea3488e46aca5d25ed302a3eefb283f7b8791ad5137567186a62befa25.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
