...
// DriveItemItemRequestBuilder builds and executes requests for operations under \drive\bundles\{driveItem-id}
...
// CreateDeleteRequestInformation collection of [bundles][bundle] (albums and multi-select-shared sets of items). Only in personal OneDrive.
...
// CreatePatchRequestInformation collection of [bundles][bundle] (albums and multi-select-shared sets of items). Only in personal OneDrive.
...
// Delete collection of [bundles][bundle] (albums and multi-select-shared sets of items). Only in personal OneDrive.
...
func (m *DriveItemItemRequestBuilder) Get(options *DriveItemItemRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.DriveItem, error) {
...
// Patch collection of [bundles][bundle] (albums and multi-select-shared sets of items). Only in personal OneDrive.
