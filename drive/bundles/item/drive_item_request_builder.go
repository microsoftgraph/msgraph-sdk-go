...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/drive/bundles/{driveItem_id}{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*id57c1f561fd7120e715af680ab9d67e3a72d92b54657bd3f3ac2432fcaec9d32.ContentRequestBuilder) {
