...
// CheckinPostRequestBody provides operations to call the checkin method.
type CheckinPostRequestBody struct {
...
// NewCheckinPostRequestBody instantiates a new checkinPostRequestBody and sets the default values.
func NewCheckinPostRequestBody()(*CheckinPostRequestBody) {
    m := &CheckinPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]interface{}));
    return m
}
// CreateCheckinPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateCheckinPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewCheckinPostRequestBody(), nil
}
...
func (m *CheckinPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
