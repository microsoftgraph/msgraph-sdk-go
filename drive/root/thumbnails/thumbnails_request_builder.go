...
import (
    ...
    i4758a8aa8eb84f459afc6774c67fe32d456a18084cd62dbe52e85a374bf29d4a "github.com/microsoftgraph/msgraph-sdk-go/drive/root/thumbnails/count"
)
...
func NewThumbnailsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThumbnailsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/root/thumbnails{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ThumbnailsRequestBuilder) Count()(*i4758a8aa8eb84f459afc6774c67fe32d456a18084cd62dbe52e85a374bf29d4a.CountRequestBuilder) {
    return i4758a8aa8eb84f459afc6774c67fe32d456a18084cd62dbe52e85a374bf29d4a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
