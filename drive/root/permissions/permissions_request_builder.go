...
import (
    ...
    id5fe0e01d256f535617ac829cf5561c5519ea706b4cc0fb213a4913920439c1a "github.com/microsoftgraph/msgraph-sdk-go/drive/root/permissions/count"
)
...
func NewPermissionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/root/permissions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PermissionsRequestBuilder) Count()(*id5fe0e01d256f535617ac829cf5561c5519ea706b4cc0fb213a4913920439c1a.CountRequestBuilder) {
    return id5fe0e01d256f535617ac829cf5561c5519ea706b4cc0fb213a4913920439c1a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
