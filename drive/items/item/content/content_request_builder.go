...
// ContentRequestBuilder builds and executes requests for operations under \drive\items\{driveItem-id}\content
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/items/{driveItem_id}/content";
...
// CreateGetRequestInformation get media content for the navigation property items from drive
...
// CreatePutRequestInformation update media content for the navigation property items in drive
...
// Get get media content for the navigation property items from drive
...
// Put update media content for the navigation property items in drive
