...
import (
    ...
    i043ef3b50e9848d1a6f54a4ce28888d515918e7120c74c658de36558fe0b73d2 "github.com/microsoftgraph/msgraph-sdk-go/drive/items/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/items/{driveItem_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i043ef3b50e9848d1a6f54a4ce28888d515918e7120c74c658de36558fe0b73d2.CountRequestBuilder) {
    return i043ef3b50e9848d1a6f54a4ce28888d515918e7120c74c658de36558fe0b73d2.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
