...
func (m *SharedWithMeRequestBuilder) Get(ctx context.Context, requestConfiguration *SharedWithMeRequestBuilderGetRequestConfiguration)(SharedWithMeResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateSharedWithMeResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *SharedWithMeRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *SharedWithMeRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
