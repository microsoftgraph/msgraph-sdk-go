...
// ListContentTypesItemColumnPositionsCountRequestBuilderGetQueryParameters get the number of the resource
type ListContentTypesItemColumnPositionsCountRequestBuilderGetQueryParameters struct {
...
type ListContentTypesItemColumnPositionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ListContentTypesItemColumnPositionsCountRequestBuilderGetQueryParameters
}
...
func NewListContentTypesItemColumnPositionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ListContentTypesItemColumnPositionsCountRequestBuilder) {
    m := &ListContentTypesItemColumnPositionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/columnPositions/$count{?%24search,%24filter}";
...
func NewListContentTypesItemColumnPositionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ListContentTypesItemColumnPositionsCountRequestBuilder) {
    ...
    return NewListContentTypesItemColumnPositionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ListContentTypesItemColumnPositionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ListContentTypesItemColumnPositionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ListContentTypesItemColumnPositionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ListContentTypesItemColumnPositionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
