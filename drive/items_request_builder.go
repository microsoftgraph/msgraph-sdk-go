...
func (m *ItemsRequestBuilder) Count()(*ItemsCountRequestBuilder) {
    return NewItemsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
