...
func NewRootListItemGetActivitiesByIntervalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootListItemGetActivitiesByIntervalRequestBuilder) {
    m := &RootListItemGetActivitiesByIntervalRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/root/listItem/microsoft.graph.getActivitiesByInterval(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
...
func NewRootListItemGetActivitiesByIntervalRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootListItemGetActivitiesByIntervalRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewRootListItemGetActivitiesByIntervalRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation invoke function getActivitiesByInterval
func (m *RootListItemGetActivitiesByIntervalRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *RootListItemGetActivitiesByIntervalRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RootListItemGetActivitiesByIntervalRequestBuilder) Get(ctx context.Context, requestConfiguration *RootListItemGetActivitiesByIntervalRequestBuilderGetRequestConfiguration)(RootListItemGetActivitiesByIntervalResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateRootListItemGetActivitiesByIntervalResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(RootListItemGetActivitiesByIntervalResponseable), nil
}
