...
func NewDriveItemsItemListItemGetActivitiesByIntervalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemListItemGetActivitiesByIntervalRequestBuilder) {
    m := &DriveItemsItemListItemGetActivitiesByIntervalRequestBuilder{
    }
...
func NewDriveItemsItemListItemGetActivitiesByIntervalRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemListItemGetActivitiesByIntervalRequestBuilder) {
    ...
    return NewDriveItemsItemListItemGetActivitiesByIntervalRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation invoke function getActivitiesByInterval
func (m *DriveItemsItemListItemGetActivitiesByIntervalRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveItemsItemListItemGetActivitiesByIntervalRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveItemsItemListItemGetActivitiesByIntervalRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveItemsItemListItemGetActivitiesByIntervalRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveItemsItemListItemGetActivitiesByIntervalResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateDriveItemsItemListItemGetActivitiesByIntervalResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveItemsItemListItemGetActivitiesByIntervalResponseable), nil
}
