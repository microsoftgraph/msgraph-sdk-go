...
func NewItemsItemCheckinRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemCheckinRequestBuilder) {
    m := &ItemsItemCheckinRequestBuilder{
    }
...
func NewItemsItemCheckinRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemCheckinRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemsItemCheckinRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemsItemCheckinRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ItemsItemCheckinPostRequestBodyable, requestConfiguration *ItemsItemCheckinRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemsItemCheckinRequestBuilder) Post(ctx context.Context, body ItemsItemCheckinPostRequestBodyable, requestConfiguration *ItemsItemCheckinRequestBuilderPostRequestConfiguration)(error) {
