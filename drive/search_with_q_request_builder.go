...
func (m *SearchWithQRequestBuilder) Get(ctx context.Context, requestConfiguration *SearchWithQRequestBuilderGetRequestConfiguration)(SearchWithQResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateSearchWithQResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *SearchWithQRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *SearchWithQRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
