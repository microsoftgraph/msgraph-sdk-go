...
func (m *BundlesRequestBuilder) Count()(*BundlesCountRequestBuilder) {
    return NewBundlesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *BundlesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *BundlesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
