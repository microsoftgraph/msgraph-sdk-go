...
func NewDriveRootCopyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootCopyRequestBuilder) {
    m := &DriveRootCopyRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/root/microsoft.graph.copy";
...
func NewDriveRootCopyRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootCopyRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveRootCopyRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DriveRootCopyRequestBuilder) CreatePostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveRootCopyPostRequestBodyable, requestConfiguration *DriveRootCopyRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
