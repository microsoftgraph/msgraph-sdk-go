...
func NewDriveItemsItemThumbnailsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemThumbnailsCountRequestBuilder) {
    m := &DriveItemsItemThumbnailsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/thumbnails/$count";
...
func NewDriveItemsItemThumbnailsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemThumbnailsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveItemsItemThumbnailsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveItemsItemThumbnailsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveItemsItemThumbnailsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveItemsItemThumbnailsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveItemsItemThumbnailsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
