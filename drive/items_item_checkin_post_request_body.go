...
// ItemsItemCheckinPostRequestBody provides operations to call the checkin method.
...
func NewItemsItemCheckinPostRequestBody()(*ItemsItemCheckinPostRequestBody) {
    m := &ItemsItemCheckinPostRequestBody{
    }
...
func CreateItemsItemCheckinPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemsItemCheckinPostRequestBody(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *ItemsItemCheckinPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemsItemCheckinPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemsItemCheckinPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemsItemCheckinPostRequestBody) SetAdditionalData(value map[string]interface{})() {
