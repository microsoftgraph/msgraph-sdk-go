...
// ItemsItemListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters get the number of the resource
type ItemsItemListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters struct {
...
type ItemsItemListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemsItemListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters
}
...
func NewItemsItemListItemDocumentSetVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemListItemDocumentSetVersionsCountRequestBuilder) {
    m := &ItemsItemListItemDocumentSetVersionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/documentSetVersions/$count{?%24search,%24filter}";
...
func NewItemsItemListItemDocumentSetVersionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemListItemDocumentSetVersionsCountRequestBuilder) {
    ...
    return NewItemsItemListItemDocumentSetVersionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemsItemListItemDocumentSetVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemsItemListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemsItemListItemDocumentSetVersionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemsItemListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
