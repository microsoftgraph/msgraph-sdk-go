...
func NewItemsItemValidatePermissionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemValidatePermissionRequestBuilder) {
    m := &ItemsItemValidatePermissionRequestBuilder{
    }
...
func NewItemsItemValidatePermissionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemValidatePermissionRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemsItemValidatePermissionRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action validatePermission
func (m *ItemsItemValidatePermissionRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ItemsItemValidatePermissionPostRequestBodyable, requestConfiguration *ItemsItemValidatePermissionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemsItemValidatePermissionRequestBuilder) Post(ctx context.Context, body ItemsItemValidatePermissionPostRequestBodyable, requestConfiguration *ItemsItemValidatePermissionRequestBuilderPostRequestConfiguration)(error) {
