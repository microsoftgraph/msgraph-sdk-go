...
// CheckMemberGroupsRequestBuilder builds and executes requests for operations under \groupSettingTemplates\{groupSettingTemplate-id}\microsoft.graph.checkMemberGroups
