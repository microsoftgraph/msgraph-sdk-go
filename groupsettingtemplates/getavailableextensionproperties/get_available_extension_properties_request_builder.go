...
func NewGetAvailableExtensionPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetAvailableExtensionPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groupSettingTemplates/microsoft.graph.getAvailableExtensionProperties";
...
func (m *GetAvailableExtensionPropertiesRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body GetAvailableExtensionPropertiesRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreatePostRequestInformationWithRequestConfiguration(body, nil);
}
// CreatePostRequestInformationWithRequestConfiguration invoke action getAvailableExtensionProperties
func (m *GetAvailableExtensionPropertiesRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body GetAvailableExtensionPropertiesRequestBodyable, requestConfiguration *GetAvailableExtensionPropertiesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action getAvailableExtensionProperties
func (m *GetAvailableExtensionPropertiesRequestBuilder) PostWithResponseHandler(body GetAvailableExtensionPropertiesRequestBodyable, requestConfiguration *GetAvailableExtensionPropertiesRequestBuilderPostRequestConfiguration)(GetAvailableExtensionPropertiesResponseable, error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action getAvailableExtensionProperties
func (m *GetAvailableExtensionPropertiesRequestBuilder) PostWithResponseHandler(body GetAvailableExtensionPropertiesRequestBodyable, requestConfiguration *GetAvailableExtensionPropertiesRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(GetAvailableExtensionPropertiesResponseable, error) {
