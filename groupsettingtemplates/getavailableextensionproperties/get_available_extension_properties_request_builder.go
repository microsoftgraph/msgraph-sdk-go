...
// GetAvailableExtensionPropertiesRequestBuilder builds and executes requests for operations under \groupSettingTemplates\microsoft.graph.getAvailableExtensionProperties
