...
func (m *TeamsAppsItemAppDefinitionsItemBotRequestBuilder) Delete(ctx context.Context, requestConfiguration *TeamsAppsItemAppDefinitionsItemBotRequestBuilderDeleteRequestConfiguration)([]byte, error) {
