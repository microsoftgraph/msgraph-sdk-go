...
func (m *ThreatAssessmentRequestsItemResultsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatAssessmentRequestsItemResultsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
