...
func NewInformationProtectionBitlockerRecoveryKeysCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InformationProtectionBitlockerRecoveryKeysCountRequestBuilder) {
    m := &InformationProtectionBitlockerRecoveryKeysCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/informationProtection/bitlocker/recoveryKeys/$count";
...
func NewInformationProtectionBitlockerRecoveryKeysCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InformationProtectionBitlockerRecoveryKeysCountRequestBuilder) {
    ...
    return NewInformationProtectionBitlockerRecoveryKeysCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *InformationProtectionBitlockerRecoveryKeysCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *InformationProtectionBitlockerRecoveryKeysCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *InformationProtectionBitlockerRecoveryKeysCountRequestBuilder) Get(ctx context.Context, requestConfiguration *InformationProtectionBitlockerRecoveryKeysCountRequestBuilderGetRequestConfiguration)(*int32, error) {
