...
// RiskyServicePrincipalsConfirmCompromisedPostRequestBody provides operations to call the confirmCompromised method.
...
func (m *RiskyServicePrincipalsConfirmCompromisedPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *RiskyServicePrincipalsConfirmCompromisedPostRequestBody) SetAdditionalData(value map[string]interface{})() {
