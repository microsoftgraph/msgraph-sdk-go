...
func NewServicePrincipalRiskDetectionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ServicePrincipalRiskDetectionsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityProtection/servicePrincipalRiskDetections/$count";
...
func (m *ServicePrincipalRiskDetectionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ServicePrincipalRiskDetectionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
