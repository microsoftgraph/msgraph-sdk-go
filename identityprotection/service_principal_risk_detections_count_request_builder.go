...
func (m *ServicePrincipalRiskDetectionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ServicePrincipalRiskDetectionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
