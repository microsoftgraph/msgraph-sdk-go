...
func NewRiskyUsersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RiskyUsersCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityProtection/riskyUsers/$count";
...
func (m *RiskyUsersCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *RiskyUsersCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
