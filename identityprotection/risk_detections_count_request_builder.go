...
func (m *RiskDetectionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *RiskDetectionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
