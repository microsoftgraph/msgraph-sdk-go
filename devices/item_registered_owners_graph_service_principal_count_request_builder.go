...
func (m *ItemRegisteredOwnersGraphServicePrincipalCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredOwnersGraphServicePrincipalCountRequestBuilderGetRequestConfiguration)(*int64, error) {
