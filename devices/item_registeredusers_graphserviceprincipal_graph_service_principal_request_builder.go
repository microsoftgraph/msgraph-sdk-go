...
func NewItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilder) {
    m := &ItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilder{
...
func NewItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilder) {
    ...
    return NewItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ItemRegisteredusersGraphserviceprincipalCountRequestBuilder when successful
func (m *ItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilder) Count()(*ItemRegisteredusersGraphserviceprincipalCountRequestBuilder) {
...
func (m *ItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ServicePrincipalCollectionResponseable, error) {
...
func (m *ItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilder) WithUrl(rawUrl string)(*ItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilder) {
    return NewItemRegisteredusersGraphserviceprincipalGraphServicePrincipalRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
