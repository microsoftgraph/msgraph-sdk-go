...
// NewRegisteredUsersResponse instantiates a new registeredUsersResponse and sets the default values.
func NewRegisteredUsersResponse()(*RegisteredUsersResponse) {
    m := &RegisteredUsersResponse{
    }
...
func (m *RegisteredUsersResponse) GetValue()([]i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.DirectoryObject) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *RegisteredUsersResponse) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *RegisteredUsersResponse) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
...
func (m *RegisteredUsersResponse) SetValue(value []i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.DirectoryObject)() {
    if m != nil {
        m.value = value
    }
}
