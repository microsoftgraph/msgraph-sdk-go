...
func NewMemberOfRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MemberOfRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/devices/{device_id}/memberOf{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MemberOfRequestBuilder) Ref()(*i6ae77cb3c838a1e2aad7693813f80a21e8980e0894550318058caa7a7c4b52be.RefRequestBuilder) {
    return i6ae77cb3c838a1e2aad7693813f80a21e8980e0894550318058caa7a7c4b52be.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
