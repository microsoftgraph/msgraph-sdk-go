...
// TransitiveMemberOfRequestBuilderGetQueryParameters groups that this device is a member of. This operation is transitive. Supports $expand.
...
func NewTransitiveMemberOfRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TransitiveMemberOfRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/devices/{device_id}/transitiveMemberOf{?top,skip,search,filter,count,orderby,select,expand}";
