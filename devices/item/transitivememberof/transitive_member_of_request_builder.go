...
func NewTransitiveMemberOfRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TransitiveMemberOfRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/devices/{device_id}/transitiveMemberOf{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *TransitiveMemberOfRequestBuilder) CreateGetRequestInformation(q func (value *TransitiveMemberOfRequestBuilderGetQueryParameters) (err error), h func (value map[string]string) (err error), o []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
    requestInfo.Method = ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.GET
    if q != nil {
        qParams := new(TransitiveMemberOfRequestBuilderGetQueryParameters)
        err := q(qParams)
        if err != nil {
            return nil, err
        }
...
func (m *TransitiveMemberOfRequestBuilder) Get(q func (value *TransitiveMemberOfRequestBuilderGetQueryParameters) (err error), h func (value map[string]string) (err error), o []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption, responseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler)(*TransitiveMemberOfResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(q, h, o);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewTransitiveMemberOfResponse() }, responseHandler)
    if err != nil {
        return nil, err
    }
    return res.(*TransitiveMemberOfResponse), nil
}
func (m *TransitiveMemberOfRequestBuilder) Ref()(*ie55f657f849a8f0de2bdf6804a68234facf84d383c9505e027c1ff7b528a0fbf.RefRequestBuilder) {
    return ie55f657f849a8f0de2bdf6804a68234facf84d383c9505e027c1ff7b528a0fbf.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
