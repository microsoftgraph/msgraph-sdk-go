...
// RefRequestBuilder builds and executes requests for operations under \devices\{device-id}\transitiveMemberOf\$ref
...
// RefRequestBuilderGetQueryParameters groups that this device is a member of. This operation is transitive. Supports $expand.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/devices/{device_id}/transitiveMemberOf/$ref{?top,skip,search,filter,count,orderby}";
...
// CreateGetRequestInformation groups that this device is a member of. This operation is transitive. Supports $expand.
...
// CreatePostRequestInformation groups that this device is a member of. This operation is transitive. Supports $expand.
...
// Get groups that this device is a member of. This operation is transitive. Supports $expand.
...
// Post groups that this device is a member of. This operation is transitive. Supports $expand.
