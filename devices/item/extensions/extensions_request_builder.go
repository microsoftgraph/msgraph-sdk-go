...
// ExtensionsRequestBuilder builds and executes requests for operations under \devices\{device-id}\extensions
...
// CreatePostRequestInformation the collection of open extensions defined for the device. Read-only. Nullable.
...
// Post the collection of open extensions defined for the device. Read-only. Nullable.
