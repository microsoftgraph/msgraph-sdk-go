...
func NewItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) {
    m := &ItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder{
...
func NewItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) {
    ...
    return NewItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ItemRegisteredusersGraphapproleassignmentCountRequestBuilder when successful
func (m *ItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) Count()(*ItemRegisteredusersGraphapproleassignmentCountRequestBuilder) {
...
func (m *ItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AppRoleAssignmentCollectionResponseable, error) {
...
func (m *ItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) WithUrl(rawUrl string)(*ItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) {
    return NewItemRegisteredusersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
