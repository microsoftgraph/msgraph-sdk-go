...
// GetAvailableExtensionPropertiesRequestBuilder builds and executes requests for operations under \devices\microsoft.graph.getAvailableExtensionProperties
