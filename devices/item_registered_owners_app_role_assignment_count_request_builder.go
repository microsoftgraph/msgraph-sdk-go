...
func NewItemRegisteredOwnersAppRoleAssignmentCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredOwnersAppRoleAssignmentCountRequestBuilder) {
    m := &ItemRegisteredOwnersAppRoleAssignmentCountRequestBuilder{
    }
...
func NewItemRegisteredOwnersAppRoleAssignmentCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredOwnersAppRoleAssignmentCountRequestBuilder) {
    ...
    return NewItemRegisteredOwnersAppRoleAssignmentCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemRegisteredOwnersAppRoleAssignmentCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredOwnersAppRoleAssignmentCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemRegisteredOwnersAppRoleAssignmentCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredOwnersAppRoleAssignmentCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
