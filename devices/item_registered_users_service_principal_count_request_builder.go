...
func NewItemRegisteredUsersServicePrincipalCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredUsersServicePrincipalCountRequestBuilder) {
    m := &ItemRegisteredUsersServicePrincipalCountRequestBuilder{
    }
...
func NewItemRegisteredUsersServicePrincipalCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredUsersServicePrincipalCountRequestBuilder) {
    ...
    return NewItemRegisteredUsersServicePrincipalCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *ItemRegisteredUsersServicePrincipalCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredUsersServicePrincipalCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRegisteredUsersServicePrincipalCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredUsersServicePrincipalCountRequestBuilderGetRequestConfiguration)(*int32, error) {
