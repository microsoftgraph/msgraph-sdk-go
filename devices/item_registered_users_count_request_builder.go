...
func (m *ItemRegisteredUsersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredUsersCountRequestBuilderGetRequestConfiguration)(*int64, error) {
