...
func NewItemRegisteredownersGraphendpointGraphEndpointRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredownersGraphendpointGraphEndpointRequestBuilder) {
    m := &ItemRegisteredownersGraphendpointGraphEndpointRequestBuilder{
...
func NewItemRegisteredownersGraphendpointGraphEndpointRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredownersGraphendpointGraphEndpointRequestBuilder) {
    ...
    return NewItemRegisteredownersGraphendpointGraphEndpointRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ItemRegisteredownersGraphendpointCountRequestBuilder when successful
func (m *ItemRegisteredownersGraphendpointGraphEndpointRequestBuilder) Count()(*ItemRegisteredownersGraphendpointCountRequestBuilder) {
...
func (m *ItemRegisteredownersGraphendpointGraphEndpointRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredownersGraphendpointGraphEndpointRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.EndpointCollectionResponseable, error) {
...
func (m *ItemRegisteredownersGraphendpointGraphEndpointRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredownersGraphendpointGraphEndpointRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRegisteredownersGraphendpointGraphEndpointRequestBuilder) WithUrl(rawUrl string)(*ItemRegisteredownersGraphendpointGraphEndpointRequestBuilder) {
    return NewItemRegisteredownersGraphendpointGraphEndpointRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
