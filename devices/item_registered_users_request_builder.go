...
func (m *ItemRegisteredUsersRequestBuilder) MicrosoftGraphAppRoleAssignment()(*ItemRegisteredUsersMicrosoftGraphAppRoleAssignmentAppRoleAssignmentRequestBuilder) {
    return NewItemRegisteredUsersMicrosoftGraphAppRoleAssignmentAppRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
