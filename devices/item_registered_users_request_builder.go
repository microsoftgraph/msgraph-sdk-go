...
func (m *ItemRegisteredUsersRequestBuilder) AppRoleAssignment()(*ItemRegisteredUsersAppRoleAssignmentRequestBuilder) {
    return NewItemRegisteredUsersAppRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemRegisteredUsersRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredUsersRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
