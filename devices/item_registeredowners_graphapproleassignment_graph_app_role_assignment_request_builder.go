...
func NewItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) {
    m := &ItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder{
...
func NewItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) {
    ...
    return NewItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ItemRegisteredownersGraphapproleassignmentCountRequestBuilder when successful
func (m *ItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) Count()(*ItemRegisteredownersGraphapproleassignmentCountRequestBuilder) {
...
func (m *ItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AppRoleAssignmentCollectionResponseable, error) {
...
func (m *ItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) WithUrl(rawUrl string)(*ItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) {
    return NewItemRegisteredownersGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
