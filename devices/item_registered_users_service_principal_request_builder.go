...
func NewItemRegisteredUsersServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredUsersServicePrincipalRequestBuilder) {
    m := &ItemRegisteredUsersServicePrincipalRequestBuilder{
    }
...
func NewItemRegisteredUsersServicePrincipalRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredUsersServicePrincipalRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemRegisteredUsersServicePrincipalRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ItemRegisteredUsersServicePrincipalRequestBuilder) Count()(*ItemRegisteredUsersServicePrincipalCountRequestBuilder) {
    return NewItemRegisteredUsersServicePrincipalCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemRegisteredUsersServicePrincipalRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredUsersServicePrincipalRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRegisteredUsersServicePrincipalRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredUsersServicePrincipalRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ServicePrincipalCollectionResponseable, error) {
