...
func (m *ItemRegisteredOwnersRequestBuilder) MicrosoftGraphAppRoleAssignment()(*ItemRegisteredOwnersMicrosoftGraphAppRoleAssignmentAppRoleAssignmentRequestBuilder) {
    return NewItemRegisteredOwnersMicrosoftGraphAppRoleAssignmentAppRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
