...
func (m *ItemRegisteredOwnersRequestBuilder) AppRoleAssignment()(*ItemRegisteredOwnersAppRoleAssignmentRequestBuilder) {
    return NewItemRegisteredOwnersAppRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
