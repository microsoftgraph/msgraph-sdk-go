...
func NewItemRegisteredownersItemGraphuserGraphUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredownersItemGraphuserGraphUserRequestBuilder) {
    m := &ItemRegisteredownersItemGraphuserGraphUserRequestBuilder{
...
func NewItemRegisteredownersItemGraphuserGraphUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredownersItemGraphuserGraphUserRequestBuilder) {
    ...
    return NewItemRegisteredownersItemGraphuserGraphUserRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the item of type microsoft.graph.directoryObject as microsoft.graph.user
// returns a Userable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemRegisteredownersItemGraphuserGraphUserRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredownersItemGraphuserGraphUserRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Userable, error) {
...
func (m *ItemRegisteredownersItemGraphuserGraphUserRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredownersItemGraphuserGraphUserRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRegisteredownersItemGraphuserGraphUserRequestBuilder) WithUrl(rawUrl string)(*ItemRegisteredownersItemGraphuserGraphUserRequestBuilder) {
    return NewItemRegisteredownersItemGraphuserGraphUserRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
