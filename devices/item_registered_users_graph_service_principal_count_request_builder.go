...
func (m *ItemRegisteredUsersGraphServicePrincipalCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredUsersGraphServicePrincipalCountRequestBuilderGetRequestConfiguration)(*int64, error) {
