...
func (m *ItemRegisteredOwnersGraphAppRoleAssignmentCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredOwnersGraphAppRoleAssignmentCountRequestBuilderGetRequestConfiguration)(*int64, error) {
