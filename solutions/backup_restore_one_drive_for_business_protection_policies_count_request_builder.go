...
func (m *BackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
