...
func (m *VirtualEventsEventsItemSessionsItemAttendanceReportsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEventsEventsItemSessionsItemAttendanceReportsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
