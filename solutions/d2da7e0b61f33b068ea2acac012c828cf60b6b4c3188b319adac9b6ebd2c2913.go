...
func (m *BackupRestoreOneDriveForBusinessProtectionPoliciesItemDriveProtectionUnitsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreOneDriveForBusinessProtectionPoliciesItemDriveProtectionUnitsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
