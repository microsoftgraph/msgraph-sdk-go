...
// NewVirtualEventsWebinarsItemSessionsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewVirtualEventsWebinarsItemSessionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsWebinarsItemSessionsCountRequestBuilder) {
    m := &VirtualEventsWebinarsItemSessionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewVirtualEventsWebinarsItemSessionsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
func NewVirtualEventsWebinarsItemSessionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsWebinarsItemSessionsCountRequestBuilder) {
    ...
    return NewVirtualEventsWebinarsItemSessionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *VirtualEventsWebinarsItemSessionsCountRequestBuilder) WithUrl(rawUrl string)(*VirtualEventsWebinarsItemSessionsCountRequestBuilder) {
    return NewVirtualEventsWebinarsItemSessionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
