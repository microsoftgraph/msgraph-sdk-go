...
func (m *VirtualEventsWebinarsItemSessionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEventsWebinarsItemSessionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
