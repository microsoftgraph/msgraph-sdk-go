...
func (m *BackupRestoreSharePointProtectionPoliciesItemSiteInclusionRulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreSharePointProtectionPoliciesItemSiteInclusionRulesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
