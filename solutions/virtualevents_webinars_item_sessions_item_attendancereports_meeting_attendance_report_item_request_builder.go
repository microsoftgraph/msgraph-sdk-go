...
func (m *VirtualeventsWebinarsItemSessionsItemAttendancereportsMeetingAttendanceReportItemRequestBuilder) AttendanceRecords()(*VirtualeventsWebinarsItemSessionsItemAttendancereportsItemAttendancerecordsAttendanceRecordsRequestBuilder) {
    return NewVirtualeventsWebinarsItemSessionsItemAttendancereportsItemAttendancerecordsAttendanceRecordsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
