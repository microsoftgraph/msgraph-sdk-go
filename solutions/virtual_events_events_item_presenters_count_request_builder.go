...
type VirtualEventsEventsItemPresentersCountRequestBuilderGetQueryParameters struct {
...
type VirtualEventsEventsItemPresentersCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *VirtualEventsEventsItemPresentersCountRequestBuilderGetQueryParameters
}
...
func NewVirtualEventsEventsItemPresentersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsEventsItemPresentersCountRequestBuilder) {
    m := &VirtualEventsEventsItemPresentersCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/presenters/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewVirtualEventsEventsItemPresentersCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsEventsItemPresentersCountRequestBuilder) {
    ...
    return NewVirtualEventsEventsItemPresentersCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int64 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *VirtualEventsEventsItemPresentersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEventsEventsItemPresentersCountRequestBuilderGetRequestConfiguration)(*int64, error) {
...
func (m *VirtualEventsEventsItemPresentersCountRequestBuilder) WithUrl(rawUrl string)(*VirtualEventsEventsItemPresentersCountRequestBuilder) {
    return NewVirtualEventsEventsItemPresentersCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
