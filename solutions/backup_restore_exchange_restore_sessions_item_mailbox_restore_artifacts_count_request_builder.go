...
func (m *BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
