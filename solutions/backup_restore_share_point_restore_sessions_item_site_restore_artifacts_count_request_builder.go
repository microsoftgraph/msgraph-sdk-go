...
func (m *BackupRestoreSharePointRestoreSessionsItemSiteRestoreArtifactsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreSharePointRestoreSessionsItemSiteRestoreArtifactsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
