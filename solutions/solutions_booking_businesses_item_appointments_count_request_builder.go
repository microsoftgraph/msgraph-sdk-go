...
func NewSolutionsBookingBusinessesItemAppointmentsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SolutionsBookingBusinessesItemAppointmentsCountRequestBuilder) {
    m := &SolutionsBookingBusinessesItemAppointmentsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/appointments/$count";
...
func NewSolutionsBookingBusinessesItemAppointmentsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SolutionsBookingBusinessesItemAppointmentsCountRequestBuilder) {
    ...
    return NewSolutionsBookingBusinessesItemAppointmentsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *SolutionsBookingBusinessesItemAppointmentsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SolutionsBookingBusinessesItemAppointmentsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SolutionsBookingBusinessesItemAppointmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SolutionsBookingBusinessesItemAppointmentsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
