...
func NewBookingBusinessesItemAppointmentsBookingAppointmentItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BookingBusinessesItemAppointmentsBookingAppointmentItemRequestBuilder) {
    ...
    return NewBookingBusinessesItemAppointmentsBookingAppointmentItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *BookingBusinessesItemAppointmentsBookingAppointmentItemRequestBuilder) MicrosoftGraphCancel()(*BookingBusinessesItemAppointmentsItemMicrosoftGraphCancelCancelRequestBuilder) {
    return NewBookingBusinessesItemAppointmentsItemMicrosoftGraphCancelCancelRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
