...
func (m *BackupRestoreProtectionPoliciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreProtectionPoliciesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
