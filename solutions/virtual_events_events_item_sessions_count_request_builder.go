...
func (m *VirtualEventsEventsItemSessionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEventsEventsItemSessionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
