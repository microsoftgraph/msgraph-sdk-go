...
// NewVirtualEventsEventsItemSessionsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewVirtualEventsEventsItemSessionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsEventsItemSessionsCountRequestBuilder) {
    m := &VirtualEventsEventsItemSessionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewVirtualEventsEventsItemSessionsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
