...
func (m *BackupRestoreSiteProtectionUnitsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreSiteProtectionUnitsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
