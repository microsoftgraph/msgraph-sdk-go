...
func NewVirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleGetResponse()(*VirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleGetResponse) {
    m := &VirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleGetResponse{
        BaseCollectionPaginationCountResponse: *iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.NewBaseCollectionPaginationCountResponse(),
    }
    return m
}
// CreateVirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateVirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewVirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleGetResponse(), nil
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *VirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *VirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleGetResponse) GetValue()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.VirtualEventWebinarable) {
...
func (m *VirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *VirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleGetResponse) SetValue(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.VirtualEventWebinarable)() {
    err := m.GetBackingStore().Set("value", value)
    if err != nil {
        panic(err)
    }
}
type VirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleGetResponseable interface {
