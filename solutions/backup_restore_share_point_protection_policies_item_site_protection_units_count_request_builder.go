...
func (m *BackupRestoreSharePointProtectionPoliciesItemSiteProtectionUnitsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreSharePointProtectionPoliciesItemSiteProtectionUnitsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
