...
// ByBookingStaffMemberBaseIdString provides operations to manage the staffMembers property of the microsoft.graph.bookingBusiness entity.
func (m *BookingBusinessesItemStaffMembersRequestBuilder) ByBookingStaffMemberBaseIdString(bookingStaffMemberBaseId string)(*BookingBusinessesItemStaffMembersBookingStaffMemberBaseItemRequestBuilder) {
