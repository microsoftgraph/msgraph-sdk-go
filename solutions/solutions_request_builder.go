...
func (m *SolutionsRequestBuilder) BookingBusinessesById(id string)(*BookingBusinessesBookingBusinessItemRequestBuilder) {
    ...
    return NewBookingBusinessesBookingBusinessItemRequestBuilderInternal(urlTplParams, m.requestAdapter, id);
}
...
func (m *SolutionsRequestBuilder) BookingCurrenciesById(id string)(*BookingCurrenciesBookingCurrencyItemRequestBuilder) {
    ...
    return NewBookingCurrenciesBookingCurrencyItemRequestBuilderInternal(urlTplParams, m.requestAdapter, id);
}
...
func (m *SolutionsRequestBuilder) Get(ctx context.Context, requestConfiguration *SolutionsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.SolutionsRootable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateSolutionsRootFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
