...
func (m *BackupRestoreDriveInclusionRulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreDriveInclusionRulesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
