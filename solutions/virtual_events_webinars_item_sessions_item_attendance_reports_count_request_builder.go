...
func (m *VirtualEventsWebinarsItemSessionsItemAttendanceReportsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEventsWebinarsItemSessionsItemAttendanceReportsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
