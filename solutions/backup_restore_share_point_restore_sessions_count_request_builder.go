...
func (m *BackupRestoreSharePointRestoreSessionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreSharePointRestoreSessionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
