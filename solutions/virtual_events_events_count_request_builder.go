...
// NewVirtualEventsEventsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewVirtualEventsEventsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsEventsCountRequestBuilder) {
    m := &VirtualEventsEventsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewVirtualEventsEventsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
func NewVirtualEventsEventsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsEventsCountRequestBuilder) {
    ...
    return NewVirtualEventsEventsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *VirtualEventsEventsCountRequestBuilder) WithUrl(rawUrl string)(*VirtualEventsEventsCountRequestBuilder) {
    return NewVirtualEventsEventsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
