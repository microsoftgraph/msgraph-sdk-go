...
func (m *VirtualEventsEventsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEventsEventsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
