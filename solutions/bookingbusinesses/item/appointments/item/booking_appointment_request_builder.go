...
import (
    ...
    ib9abd3e638455f17c83c3fde5b6e0821a41d1aa8ad2b021ea290a0429ac27435 "github.com/microsoftgraph/msgraph-sdk-go/solutions/bookingbusinesses/item/appointments/item/cancel"
)

// BookingAppointmentRequestBuilder builds and executes requests for operations under \solutions\bookingBusinesses\{bookingBusiness-id}\appointments\{bookingAppointment-id}
...
type BookingAppointmentRequestBuilderGetOptions struct {
    ...
    Q *BookingAppointmentRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
func (m *BookingAppointmentRequestBuilder) Cancel()(*ib9abd3e638455f17c83c3fde5b6e0821a41d1aa8ad2b021ea290a0429ac27435.CancelRequestBuilder) {
    return ib9abd3e638455f17c83c3fde5b6e0821a41d1aa8ad2b021ea290a0429ac27435.NewCancelRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewBookingAppointmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BookingAppointmentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness_id}/appointments/{bookingAppointment_id}{?select,expand}";
...
// CreateDeleteRequestInformation all the appointments of this business. Read-only. Nullable.
...
// CreatePatchRequestInformation all the appointments of this business. Read-only. Nullable.
...
// Delete all the appointments of this business. Read-only. Nullable.
...
func (m *BookingAppointmentRequestBuilder) Get(options *BookingAppointmentRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.BookingAppointment, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewBookingAppointment() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.BookingAppointment), nil
}
// Patch all the appointments of this business. Read-only. Nullable.
