...
// DeleteWithResponseHandler delete navigation property appointments for solutions
...
// PatchWithResponseHandler update the navigation property appointments in solutions
