...
// CreatePostRequestInformation makes the scheduling page of this business available to the general public.
...
// PostWithRequestConfigurationAndResponseHandler makes the scheduling page of this business available to the general public.
