...
// CreateGetRequestInformationWithRequestConfiguration get the collection of bookingAppointment objects for a bookingBusiness that occurs in the specified date range.
