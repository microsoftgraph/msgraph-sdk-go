...
// BookingAppointmentItemRequestBuilder builds and executes requests for operations under \solutions\bookingBusinesses\{bookingBusiness-id}\calendarView\{bookingAppointment-id}
