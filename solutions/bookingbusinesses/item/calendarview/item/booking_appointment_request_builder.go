...
// BookingAppointmentRequestBuilder builds and executes requests for operations under \solutions\bookingBusinesses\{bookingBusiness-id}\calendarView\{bookingAppointment-id}
...
func (m *BookingAppointmentRequestBuilder) Cancel()(*ic9b04313ce66a117f2f498a30eb24422db3b399a39678e0495cc533aec72f4b8.CancelRequestBuilder) {
...
func NewBookingAppointmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BookingAppointmentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness_id}/calendarView/{bookingAppointment_id}{?select,expand}";
