...
func (m *BackupRestoreOneDriveForBusinessProtectionPoliciesItemDriveInclusionRulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreOneDriveForBusinessProtectionPoliciesItemDriveInclusionRulesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
