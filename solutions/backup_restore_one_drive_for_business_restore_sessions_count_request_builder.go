...
func (m *BackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
