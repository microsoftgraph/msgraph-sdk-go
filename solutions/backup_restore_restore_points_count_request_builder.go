...
func (m *BackupRestoreRestorePointsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreRestorePointsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
