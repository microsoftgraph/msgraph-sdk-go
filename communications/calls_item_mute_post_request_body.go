...
// CallsItemMutePostRequestBody provides operations to call the mute method.
...
func NewCallsItemMutePostRequestBody()(*CallsItemMutePostRequestBody) {
    m := &CallsItemMutePostRequestBody{
    }
...
func (m *CallsItemMutePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *CallsItemMutePostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *CallsItemMutePostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *CallsItemMutePostRequestBody) SetAdditionalData(value map[string]interface{})() {
