...
// ClearPresenceRequestBuilder builds and executes requests for operations under \communications\presences\{presence-id}\microsoft.graph.clearPresence
...
// ClearPresenceRequestBuilderPostOptions options for Post
type ClearPresenceRequestBuilderPostOptions struct {
    // 
    Body *ClearPresenceRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func (m *ClearPresenceRequestBuilder) CreatePostRequestInformation(options *ClearPresenceRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *ClearPresenceRequestBuilder) Post(options *ClearPresenceRequestBuilderPostOptions)(error) {
