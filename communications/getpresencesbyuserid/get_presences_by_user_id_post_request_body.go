...
// GetPresencesByUserIdPostRequestBody provides operations to call the getPresencesByUserId method.
...
func (m *GetPresencesByUserIdPostRequestBody) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *GetPresencesByUserIdPostRequestBody) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
