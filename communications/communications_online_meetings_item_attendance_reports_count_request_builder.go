...
func NewCommunicationsOnlineMeetingsItemAttendanceReportsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsOnlineMeetingsItemAttendanceReportsCountRequestBuilder) {
    m := &CommunicationsOnlineMeetingsItemAttendanceReportsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/$count";
...
func NewCommunicationsOnlineMeetingsItemAttendanceReportsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsOnlineMeetingsItemAttendanceReportsCountRequestBuilder) {
    ...
    return NewCommunicationsOnlineMeetingsItemAttendanceReportsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *CommunicationsOnlineMeetingsItemAttendanceReportsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CommunicationsOnlineMeetingsItemAttendanceReportsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsOnlineMeetingsItemAttendanceReportsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CommunicationsOnlineMeetingsItemAttendanceReportsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
