...
// CallsItemSubscribeToTonePostRequestBody provides operations to call the subscribeToTone method.
...
func NewCallsItemSubscribeToTonePostRequestBody()(*CallsItemSubscribeToTonePostRequestBody) {
    m := &CallsItemSubscribeToTonePostRequestBody{
    }
...
func (m *CallsItemSubscribeToTonePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *CallsItemSubscribeToTonePostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *CallsItemSubscribeToTonePostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *CallsItemSubscribeToTonePostRequestBody) SetAdditionalData(value map[string]interface{})() {
