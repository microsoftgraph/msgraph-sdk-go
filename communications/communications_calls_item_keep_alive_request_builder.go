...
func NewCommunicationsCallsItemKeepAliveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemKeepAliveRequestBuilder) {
    m := &CommunicationsCallsItemKeepAliveRequestBuilder{
    }
...
func NewCommunicationsCallsItemKeepAliveRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemKeepAliveRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewCommunicationsCallsItemKeepAliveRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *CommunicationsCallsItemKeepAliveRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *CommunicationsCallsItemKeepAliveRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsCallsItemKeepAliveRequestBuilder) Post(ctx context.Context, requestConfiguration *CommunicationsCallsItemKeepAliveRequestBuilderPostRequestConfiguration)(error) {
