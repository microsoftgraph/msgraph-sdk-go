...
func NewCallsItemRejectRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CallsItemRejectRequestBuilder) {
    m := &CallsItemRejectRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/communications/calls/{call%2Did}/reject", pathParameters),
    }
    return m
}
...
func (m *CallsItemRejectRequestBuilder) WithUrl(rawUrl string)(*CallsItemRejectRequestBuilder) {
    return NewCallsItemRejectRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
