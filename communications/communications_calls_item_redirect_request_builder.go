...
func NewCommunicationsCallsItemRedirectRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemRedirectRequestBuilder) {
    m := &CommunicationsCallsItemRedirectRequestBuilder{
    }
...
func NewCommunicationsCallsItemRedirectRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemRedirectRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewCommunicationsCallsItemRedirectRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *CommunicationsCallsItemRedirectRequestBuilder) CreatePostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CommunicationsCallsItemRedirectPostRequestBodyable, requestConfiguration *CommunicationsCallsItemRedirectRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsCallsItemRedirectRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CommunicationsCallsItemRedirectPostRequestBodyable, requestConfiguration *CommunicationsCallsItemRedirectRequestBuilderPostRequestConfiguration)(error) {
