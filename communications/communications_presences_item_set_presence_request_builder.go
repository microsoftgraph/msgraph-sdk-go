...
func NewCommunicationsPresencesItemSetPresenceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsPresencesItemSetPresenceRequestBuilder) {
    m := &CommunicationsPresencesItemSetPresenceRequestBuilder{
    }
...
func NewCommunicationsPresencesItemSetPresenceRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsPresencesItemSetPresenceRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewCommunicationsPresencesItemSetPresenceRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation set the state of a user's presence session as an application.
func (m *CommunicationsPresencesItemSetPresenceRequestBuilder) CreatePostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CommunicationsPresencesItemSetPresencePostRequestBodyable, requestConfiguration *CommunicationsPresencesItemSetPresenceRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
