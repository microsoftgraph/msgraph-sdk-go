...
// PresencesItemClearPresencePostRequestBody provides operations to call the clearPresence method.
...
func (m *PresencesItemClearPresencePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *PresencesItemClearPresencePostRequestBody) SetAdditionalData(value map[string]interface{})() {
