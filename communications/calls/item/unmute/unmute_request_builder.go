...
type UnmuteResponse struct {
    ...
    unmuteParticipantOperation i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.UnmuteParticipantOperationable;
}
...
func (m *UnmuteResponse) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["unmuteParticipantOperation"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CreateUnmuteParticipantOperationFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetUnmuteParticipantOperation(val.(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.UnmuteParticipantOperationable))
        }
        return nil
    }
    return res
...
func (m *UnmuteResponse) GetUnmuteParticipantOperation()(i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.UnmuteParticipantOperationable) {
    if m == nil {
        return nil
    } else {
...
func (m *UnmuteResponse) SetUnmuteParticipantOperation(value i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.UnmuteParticipantOperationable)() {
    if m != nil {
