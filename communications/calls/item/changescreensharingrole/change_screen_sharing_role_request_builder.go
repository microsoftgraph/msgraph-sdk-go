...
// ChangeScreenSharingRoleRequestBuilder builds and executes requests for operations under \communications\calls\{call-id}\microsoft.graph.changeScreenSharingRole
