...
func NewCallrecordsItemSessionsItemSegmentsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CallrecordsItemSessionsItemSegmentsCountRequestBuilder) {
    m := &CallrecordsItemSessionsItemSegmentsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/communications/callRecords/{callRecord%2Did}/sessions/{session%2Did}/segments/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewCallrecordsItemSessionsItemSegmentsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CallrecordsItemSessionsItemSegmentsCountRequestBuilder) {
    ...
    return NewCallrecordsItemSessionsItemSegmentsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *CallrecordsItemSessionsItemSegmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CallrecordsItemSessionsItemSegmentsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *CallrecordsItemSessionsItemSegmentsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *CallrecordsItemSessionsItemSegmentsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CallrecordsItemSessionsItemSegmentsCountRequestBuilder) WithUrl(rawUrl string)(*CallrecordsItemSessionsItemSegmentsCountRequestBuilder) {
    return NewCallrecordsItemSessionsItemSegmentsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
