...
>
> **Note:** The Microsoft Graph Go SDK is currently in General Availability version starting from version 0.60.0. The SDK is considered stable, regular releases and updates to the SDK will however continue weekly..
