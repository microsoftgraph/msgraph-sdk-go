...
// RefRequestBuilder builds and executes requests for operations under \invitations\{invitation-id}\invitedUser\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/invitations/{invitation_id}/invitedUser/$ref";
...
// CreateDeleteRequestInformation the user created as part of the invitation creation. Read-Only
...
// CreatePutRequestInformation the user created as part of the invitation creation. Read-Only
...
// Delete the user created as part of the invitation creation. Read-Only
...
// Put the user created as part of the invitation creation. Read-Only
