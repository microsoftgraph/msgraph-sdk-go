...
func (m *ThreatIntelligenceVulnerabilitiesItemComponentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceVulnerabilitiesItemComponentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
