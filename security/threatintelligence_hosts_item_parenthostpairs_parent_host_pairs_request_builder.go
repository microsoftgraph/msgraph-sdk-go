...
func (m *ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder) ByHostPairId(hostPairId string)(*ThreatintelligenceHostsItemParenthostpairsHostPairItemRequestBuilder) {
...
func NewThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder) {
    m := &ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder{
...
func NewThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder) {
    ...
    return NewThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ThreatintelligenceHostsItemParenthostpairsCountRequestBuilder when successful
func (m *ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder) Count()(*ThreatintelligenceHostsItemParenthostpairsCountRequestBuilder) {
...
func (m *ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilderGetRequestConfiguration)(idd6d442c3cc83a389b8f0b8dd7ac355916e813c2882ff3aaa23331424ba827ae.HostPairCollectionResponseable, error) {
...
func (m *ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder) WithUrl(rawUrl string)(*ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder) {
    return NewThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
