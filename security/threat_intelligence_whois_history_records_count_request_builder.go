...
func (m *ThreatIntelligenceWhoisHistoryRecordsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceWhoisHistoryRecordsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
