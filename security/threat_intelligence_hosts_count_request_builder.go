...
func (m *ThreatIntelligenceHostsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
