...
// ThreatIntelligenceHostsItemParentHostPairsRequestBuilderGetQueryParameters the hostPairs that are associated with a host, where that host is the childHost and has an incoming pairing with a parentHost.
