...
func (m *SecureScoresSecureScoreItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *SecureScoresSecureScoreItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
