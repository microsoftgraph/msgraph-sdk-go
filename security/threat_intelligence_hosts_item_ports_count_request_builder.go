...
func (m *ThreatIntelligenceHostsItemPortsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemPortsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
