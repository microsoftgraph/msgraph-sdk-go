...
// CasesEdiscoveryCasesItemNoncustodialDataSourcesApplyHoldPostRequestBody 
...
func (m *CasesEdiscoveryCasesItemNoncustodialDataSourcesApplyHoldPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CasesEdiscoveryCasesItemNoncustodialDataSourcesApplyHoldPostRequestBody) SetAdditionalData(value map[string]any)() {
