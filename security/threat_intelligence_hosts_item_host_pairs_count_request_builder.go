...
func NewThreatIntelligenceHostsItemHostPairsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatIntelligenceHostsItemHostPairsCountRequestBuilder) {
    m := &ThreatIntelligenceHostsItemHostPairsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/hostPairs/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
...
func NewThreatIntelligenceHostsItemHostPairsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatIntelligenceHostsItemHostPairsCountRequestBuilder) {
    ...
    return NewThreatIntelligenceHostsItemHostPairsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ThreatIntelligenceHostsItemHostPairsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemHostPairsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ThreatIntelligenceHostsItemHostPairsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemHostPairsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ThreatIntelligenceHostsItemHostPairsCountRequestBuilder) WithUrl(rawUrl string)(*ThreatIntelligenceHostsItemHostPairsCountRequestBuilder) {
    return NewThreatIntelligenceHostsItemHostPairsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
