...
func (m *ThreatIntelligenceHostsItemHostPairsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemHostPairsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
