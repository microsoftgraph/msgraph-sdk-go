...
func (m *IdentitiesHealthIssuesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *IdentitiesHealthIssuesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
