...
func (m *ThreatIntelligenceHostPairsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostPairsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
