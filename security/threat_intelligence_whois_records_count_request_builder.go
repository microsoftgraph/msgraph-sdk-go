...
func (m *ThreatIntelligenceWhoisRecordsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceWhoisRecordsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
