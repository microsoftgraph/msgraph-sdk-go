...
// LabelsCategoriesCategoryTemplateItemRequestBuilderGetQueryParameters get categories from security
...
// Get get categories from security
...
// ToGetRequestInformation get categories from security
// returns a *RequestInformation when successful
