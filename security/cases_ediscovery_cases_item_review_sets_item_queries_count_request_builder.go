...
func (m *CasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
