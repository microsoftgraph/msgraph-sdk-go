...
func NewThreatintelligenceHostsItemPortsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceHostsItemPortsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewThreatintelligenceHostsItemPortsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ThreatintelligenceHostsItemPortsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatintelligenceHostsItemPortsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ThreatintelligenceHostsItemPortsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatintelligenceHostsItemPortsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ThreatintelligenceHostsItemPortsCountRequestBuilder) WithUrl(rawUrl string)(*ThreatintelligenceHostsItemPortsCountRequestBuilder) {
    return NewThreatintelligenceHostsItemPortsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
