...
func (m *CasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupRequestBuilder) ServiceProvisioningErrors()(*CasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) {
    return NewCasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
