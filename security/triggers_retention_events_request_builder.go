...
// TriggersRetentionEventsRequestBuilderGetQueryParameters get retentionEvents from security
...
// ToPostRequestInformation create new navigation property to retentionEvents for security
