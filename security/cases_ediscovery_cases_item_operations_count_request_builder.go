...
func (m *CasesEdiscoveryCasesItemOperationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemOperationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
