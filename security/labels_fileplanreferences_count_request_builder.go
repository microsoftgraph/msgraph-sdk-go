...
func NewLabelsFileplanreferencesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LabelsFileplanreferencesCountRequestBuilder) {
    m := &LabelsFileplanreferencesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/labels/filePlanReferences/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewLabelsFileplanreferencesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LabelsFileplanreferencesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewLabelsFileplanreferencesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *LabelsFileplanreferencesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *LabelsFileplanreferencesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *LabelsFileplanreferencesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *LabelsFileplanreferencesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *LabelsFileplanreferencesCountRequestBuilder) WithUrl(rawUrl string)(*LabelsFileplanreferencesCountRequestBuilder) {
    return NewLabelsFileplanreferencesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
