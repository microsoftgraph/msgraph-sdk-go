...
func (m *AuditLogQueriesItemRecordsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AuditLogQueriesItemRecordsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
