...
func NewCasesEdiscoveryCasesItemCustodiansItemActivateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemCustodiansItemActivateRequestBuilder) {
    m := &CasesEdiscoveryCasesItemCustodiansItemActivateRequestBuilder{
    }
...
func NewCasesEdiscoveryCasesItemCustodiansItemActivateRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemCustodiansItemActivateRequestBuilder) {
    ...
    return NewCasesEdiscoveryCasesItemCustodiansItemActivateRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *CasesEdiscoveryCasesItemCustodiansItemActivateRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemCustodiansItemActivateRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CasesEdiscoveryCasesItemCustodiansItemActivateRequestBuilder) Post(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemCustodiansItemActivateRequestBuilderPostRequestConfiguration)(error) {
