...
func (m *ThreatIntelligenceHostSslCertificatesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostSslCertificatesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
