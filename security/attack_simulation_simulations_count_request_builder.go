...
func (m *AttackSimulationSimulationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttackSimulationSimulationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
