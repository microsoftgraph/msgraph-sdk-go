...
func (m *TriggerTypesRetentionEventTypesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TriggerTypesRetentionEventTypesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
