...
func (m *SecureScoreControlProfilesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SecureScoreControlProfilesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
