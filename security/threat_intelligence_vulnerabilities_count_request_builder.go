...
func (m *ThreatIntelligenceVulnerabilitiesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceVulnerabilitiesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
