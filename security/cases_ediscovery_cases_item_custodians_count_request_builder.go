...
func NewCasesEdiscoveryCasesItemCustodiansCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemCustodiansCountRequestBuilder) {
    m := &CasesEdiscoveryCasesItemCustodiansCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
...
func NewCasesEdiscoveryCasesItemCustodiansCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemCustodiansCountRequestBuilder) {
    ...
    return NewCasesEdiscoveryCasesItemCustodiansCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *CasesEdiscoveryCasesItemCustodiansCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemCustodiansCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *CasesEdiscoveryCasesItemCustodiansCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemCustodiansCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CasesEdiscoveryCasesItemCustodiansCountRequestBuilder) WithUrl(rawUrl string)(*CasesEdiscoveryCasesItemCustodiansCountRequestBuilder) {
    return NewCasesEdiscoveryCasesItemCustodiansCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
