...
// ThreatIntelligenceSslCertificatesRequestBuilderGetQueryParameters retrieve details about sslCertificate objects.Note: List retrieval is not yet supported.
