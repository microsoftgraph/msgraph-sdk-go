...
func (m *SubjectRightsRequestsItemNotesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SubjectRightsRequestsItemNotesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
