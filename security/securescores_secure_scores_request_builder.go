...
func (m *SecurescoresSecureScoresRequestBuilder) BySecureScoreId(secureScoreId string)(*SecurescoresSecureScoreItemRequestBuilder) {
...
func NewSecurescoresSecureScoresRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SecurescoresSecureScoresRequestBuilder) {
    m := &SecurescoresSecureScoresRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/secureScores{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
...
func NewSecurescoresSecureScoresRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SecurescoresSecureScoresRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSecurescoresSecureScoresRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *SecurescoresCountRequestBuilder when successful
func (m *SecurescoresSecureScoresRequestBuilder) Count()(*SecurescoresCountRequestBuilder) {
...
func (m *SecurescoresSecureScoresRequestBuilder) Get(ctx context.Context, requestConfiguration *SecurescoresSecureScoresRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.SecureScoreCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateSecureScoreCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *SecurescoresSecureScoresRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.SecureScoreable, requestConfiguration *SecurescoresSecureScoresRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.SecureScoreable, error) {
...
func (m *SecurescoresSecureScoresRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *SecurescoresSecureScoresRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SecurescoresSecureScoresRequestBuilder) WithUrl(rawUrl string)(*SecurescoresSecureScoresRequestBuilder) {
    return NewSecurescoresSecureScoresRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
