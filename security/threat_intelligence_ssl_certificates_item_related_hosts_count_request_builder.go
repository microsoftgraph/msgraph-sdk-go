...
func (m *ThreatIntelligenceSslCertificatesItemRelatedHostsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceSslCertificatesItemRelatedHostsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
