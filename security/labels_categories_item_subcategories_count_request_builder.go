...
func NewLabelsCategoriesItemSubcategoriesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LabelsCategoriesItemSubcategoriesCountRequestBuilder) {
    m := &LabelsCategoriesItemSubcategoriesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/labels/categories/{categoryTemplate%2Did}/subcategories/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewLabelsCategoriesItemSubcategoriesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LabelsCategoriesItemSubcategoriesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewLabelsCategoriesItemSubcategoriesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int64 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *LabelsCategoriesItemSubcategoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *LabelsCategoriesItemSubcategoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
...
func (m *LabelsCategoriesItemSubcategoriesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *LabelsCategoriesItemSubcategoriesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *LabelsCategoriesItemSubcategoriesCountRequestBuilder) WithUrl(rawUrl string)(*LabelsCategoriesItemSubcategoriesCountRequestBuilder) {
    return NewLabelsCategoriesItemSubcategoriesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
