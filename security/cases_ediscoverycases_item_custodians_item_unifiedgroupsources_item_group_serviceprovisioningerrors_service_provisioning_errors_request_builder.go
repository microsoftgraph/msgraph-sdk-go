...
func NewCasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) {
    m := &CasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder{
...
func NewCasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) {
    ...
    return NewCasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *CasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) Count()(*CasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsCountRequestBuilder) {
...
// returns a *CasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder when successful
func (m *CasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) WithUrl(rawUrl string)(*CasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) {
    return NewCasesEdiscoverycasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
