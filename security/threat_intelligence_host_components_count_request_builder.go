...
func (m *ThreatIntelligenceHostComponentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostComponentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
