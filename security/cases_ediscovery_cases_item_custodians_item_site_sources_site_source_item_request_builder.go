...
// Delete delete a siteSource object associated with an ediscoveryCustodian.
...
// ToDeleteRequestInformation delete a siteSource object associated with an ediscoveryCustodian.
