...
func NewCasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataMicrosoftGraphSecurityPurgeDataRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataMicrosoftGraphSecurityPurgeDataRequestBuilder) {
    m := &CasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataMicrosoftGraphSecurityPurgeDataRequestBuilder{
...
func NewCasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataMicrosoftGraphSecurityPurgeDataRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataMicrosoftGraphSecurityPurgeDataRequestBuilder) {
    ...
    return NewCasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataMicrosoftGraphSecurityPurgeDataRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *CasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataMicrosoftGraphSecurityPurgeDataRequestBuilder) Post(ctx context.Context, body CasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataPurgeDataPostRequestBodyable, requestConfiguration *CasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataMicrosoftGraphSecurityPurgeDataRequestBuilderPostRequestConfiguration)(error) {
...
func (m *CasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataMicrosoftGraphSecurityPurgeDataRequestBuilder) WithUrl(rawUrl string)(*CasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataMicrosoftGraphSecurityPurgeDataRequestBuilder) {
    return NewCasesEdiscoverycasesItemSearchesItemMicrosoftgraphsecuritypurgedataMicrosoftGraphSecurityPurgeDataRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
