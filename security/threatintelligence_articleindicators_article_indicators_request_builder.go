...
func (m *ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder) ByArticleIndicatorId(articleIndicatorId string)(*ThreatintelligenceArticleindicatorsArticleIndicatorItemRequestBuilder) {
...
func NewThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder) {
    m := &ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder{
...
func NewThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder) {
    ...
    return NewThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ThreatintelligenceArticleindicatorsCountRequestBuilder when successful
func (m *ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder) Count()(*ThreatintelligenceArticleindicatorsCountRequestBuilder) {
...
func (m *ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilderGetRequestConfiguration)(idd6d442c3cc83a389b8f0b8dd7ac355916e813c2882ff3aaa23331424ba827ae.ArticleIndicatorCollectionResponseable, error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder) Post(ctx context.Context, body idd6d442c3cc83a389b8f0b8dd7ac355916e813c2882ff3aaa23331424ba827ae.ArticleIndicatorable, requestConfiguration *ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilderPostRequestConfiguration)(idd6d442c3cc83a389b8f0b8dd7ac355916e813c2882ff3aaa23331424ba827ae.ArticleIndicatorable, error) {
...
func (m *ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder) ToPostRequestInformation(ctx context.Context, body idd6d442c3cc83a389b8f0b8dd7ac355916e813c2882ff3aaa23331424ba827ae.ArticleIndicatorable, requestConfiguration *ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder) WithUrl(rawUrl string)(*ThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder) {
    return NewThreatintelligenceArticleindicatorsArticleIndicatorsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
