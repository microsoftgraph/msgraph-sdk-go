...
func NewSubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilder) {
    m := &SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilder{
...
func NewSubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilder) {
    ...
    return NewSubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilder) Get(ctx context.Context, requestConfiguration *SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxSettingsable, error) {
...
// returns a MailboxSettingsable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilder) Patch(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxSettingsable, requestConfiguration *SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilderPatchRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxSettingsable, error) {
...
func (m *SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilder) ToPatchRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxSettingsable, requestConfiguration *SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilder) WithUrl(rawUrl string)(*SubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilder) {
    return NewSubjectrightsrequestsItemApproversItemMailboxsettingsMailboxSettingsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
