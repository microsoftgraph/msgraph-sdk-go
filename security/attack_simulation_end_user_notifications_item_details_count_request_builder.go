...
func (m *AttackSimulationEndUserNotificationsItemDetailsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttackSimulationEndUserNotificationsItemDetailsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
