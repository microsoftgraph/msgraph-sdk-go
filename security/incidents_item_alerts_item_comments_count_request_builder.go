...
func (m *IncidentsItemAlertsItemCommentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *IncidentsItemAlertsItemCommentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
