...
// CalendarsItemCalendarViewItemCancelPostRequestBody provides operations to call the cancel method.
...
func (m *CalendarsItemCalendarViewItemCancelPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *CalendarsItemCalendarViewItemCancelPostRequestBody) SetAdditionalData(value map[string]interface{})() {
