...
// DrivesItemItemsItemListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters get the number of the resource
type DrivesItemItemsItemListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters struct {
...
type DrivesItemItemsItemListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *DrivesItemItemsItemListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters
}
...
func NewDrivesItemItemsItemListItemDocumentSetVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemItemsItemListItemDocumentSetVersionsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions/$count{?%24search,%24filter}";
