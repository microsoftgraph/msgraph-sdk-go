...
func (m *JoinedTeamsRequestBuilder) MicrosoftGraphGetAllMessages()(*JoinedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilder) {
    return NewJoinedTeamsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
