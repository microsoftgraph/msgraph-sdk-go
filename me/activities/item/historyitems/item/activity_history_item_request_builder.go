...
func (m *ActivityHistoryItemRequestBuilder) Activity()(*icd69e766f5b9d3fc765051ec86abfb691915f928ca1e977db7a1d943ea25ee20.ActivityRequestBuilder) {
...
func NewActivityHistoryItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivityHistoryItemRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/me/activities/{userActivity_id}/historyItems/{activityHistoryItem_id}{?select,expand}";
...
// Parameters:
//  - options : Options for the request
func (m *ActivityHistoryItemRequestBuilder) Get(options *ActivityHistoryItemRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ActivityHistoryItem, error) {
