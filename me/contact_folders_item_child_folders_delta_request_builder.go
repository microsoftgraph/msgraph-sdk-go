...
func (m *ContactFoldersItemChildFoldersDeltaRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ContactFoldersItemChildFoldersDeltaRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ContactFoldersItemChildFoldersDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *ContactFoldersItemChildFoldersDeltaRequestBuilderGetRequestConfiguration)(ContactFoldersItemChildFoldersDeltaResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateContactFoldersItemChildFoldersDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
