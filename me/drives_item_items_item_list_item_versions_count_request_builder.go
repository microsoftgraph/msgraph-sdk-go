...
// DrivesItemItemsItemListItemVersionsCountRequestBuilderGetQueryParameters get the number of the resource
type DrivesItemItemsItemListItemVersionsCountRequestBuilderGetQueryParameters struct {
...
type DrivesItemItemsItemListItemVersionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *DrivesItemItemsItemListItemVersionsCountRequestBuilderGetQueryParameters
}
...
func NewDrivesItemItemsItemListItemVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemItemsItemListItemVersionsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/versions/$count{?%24search,%24filter}";
...
func (m *DrivesItemItemsItemListItemVersionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemItemsItemListItemVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
