...
import (
    ...
    icd125fbad0dd702ee9bf3cc79854841ee45d14e6911491e4d58af4247c28304f "github.com/microsoftgraph/msgraph-sdk-go/me/insights/shared/item/resource/caseexportoperation/getdownloadurl"
)

// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.ediscovery.caseExportOperation
...
func NewCaseExportOperationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CaseExportOperationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.ediscovery.caseExportOperation";
...
func (m *CaseExportOperationRequestBuilder) GetDownloadUrl()(*icd125fbad0dd702ee9bf3cc79854841ee45d14e6911491e4d58af4247c28304f.GetDownloadUrlRequestBuilder) {
    return icd125fbad0dd702ee9bf3cc79854841ee45d14e6911491e4d58af4247c28304f.NewGetDownloadUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
