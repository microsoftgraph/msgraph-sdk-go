...
import (
    ...
    ie120ae2a5f716a13f627919f35b63e3fbe2c50d54c963e4d2ffb42dda9a26fee "github.com/microsoftgraph/msgraph-sdk-go/me/insights/shared/item/resource/calendarsharingmessage/accept"
)

// CalendarSharingMessageRequestBuilder builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.calendarSharingMessage
...
func (m *CalendarSharingMessageRequestBuilder) Accept()(*ie120ae2a5f716a13f627919f35b63e3fbe2c50d54c963e4d2ffb42dda9a26fee.AcceptRequestBuilder) {
    return ie120ae2a5f716a13f627919f35b63e3fbe2c50d54c963e4d2ffb42dda9a26fee.NewAcceptRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewCalendarSharingMessageRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CalendarSharingMessageRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.calendarSharingMessage";
