...
// RowsBelowRequestBuilder builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\lastSharedMethod\microsoft.graph.workbookRange\microsoft.graph.rowsBelow()
...
// RowsBelowRequestBuilderGetOptions options for Get
type RowsBelowRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// RowsBelowResponse union type wrapper for classes workbookRange
...
// NewRowsBelowResponse instantiates a new rowsBelowResponse and sets the default values.
...
// NewRowsBelowRequestBuilderInternal instantiates a new RowsBelowRequestBuilder and sets the default values.
func NewRowsBelowRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RowsBelowRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRange/microsoft.graph.rowsBelow()";
...
// NewRowsBelowRequestBuilder instantiates a new RowsBelowRequestBuilder and sets the default values.
...
// CreateGetRequestInformation invoke function rowsBelow
func (m *RowsBelowRequestBuilder) CreateGetRequestInformation(options *RowsBelowRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *RowsBelowRequestBuilder) Get(options *RowsBelowRequestBuilderGetOptions)(*RowsBelowResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewRowsBelowResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
