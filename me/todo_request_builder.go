...
func (m *TodoRequestBuilder) Get(ctx context.Context, requestConfiguration *TodoRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Todoable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateTodoFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *TodoRequestBuilder) ListsById(id string)(*TodoListsTodoTaskListItemRequestBuilder) {
    ...
    return NewTodoListsTodoTaskListItemRequestBuilderInternal(urlTplParams, m.requestAdapter, id);
}
...
// ToDeleteRequestInformation delete navigation property todo for me
func (m *TodoRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *TodoRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *TodoRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *TodoRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
