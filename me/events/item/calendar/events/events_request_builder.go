...
import (
    ...
    i1661a0ba250828305f03c81d7cd006ff757805aae947e287d8c5c36086b80d9e "github.com/microsoftgraph/msgraph-sdk-go/me/events/item/calendar/events/delta"
)

// eventsRequestBuilder builds and executes requests for operations under \me\events\{event-id}\calendar\events
...
func NewEventsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*EventsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/events/{event_id}/calendar/events{?top,skip,filter,count,orderby,select}";
...
// Delta builds and executes requests for operations under \me\events\{event-id}\calendar\events\microsoft.graph.delta()
func (m *EventsRequestBuilder) Delta()(*i1661a0ba250828305f03c81d7cd006ff757805aae947e287d8c5c36086b80d9e.DeltaRequestBuilder) {
    return i1661a0ba250828305f03c81d7cd006ff757805aae947e287d8c5c36086b80d9e.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
