...
// CalendarCalendarViewItemCancelPostRequestBody 
...
func (m *CalendarCalendarViewItemCancelPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CalendarCalendarViewItemCancelPostRequestBody) SetAdditionalData(value map[string]any)() {
