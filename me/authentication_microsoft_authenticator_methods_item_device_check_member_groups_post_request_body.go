...
// AuthenticationMicrosoftAuthenticatorMethodsItemDeviceCheckMemberGroupsPostRequestBody 
...
func (m *AuthenticationMicrosoftAuthenticatorMethodsItemDeviceCheckMemberGroupsPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *AuthenticationMicrosoftAuthenticatorMethodsItemDeviceCheckMemberGroupsPostRequestBody) SetAdditionalData(value map[string]any)() {
