...
import (
    ...
    i1be8dce776674c6409acca5fe0d80e127f33439b478551b3c432d6285932e975 "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/list/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/list/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*i1be8dce776674c6409acca5fe0d80e127f33439b478551b3c432d6285932e975.CountRequestBuilder) {
    return i1be8dce776674c6409acca5fe0d80e127f33439b478551b3c432d6285932e975.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
