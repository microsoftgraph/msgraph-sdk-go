...
// DriveRequestBuilder builds and executes requests for operations under \me\drives\{drive-id}
...
// DriveRequestBuilderGetQueryParameters a collection of drives available for this user. Read-only.
