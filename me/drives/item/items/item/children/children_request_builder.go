...
import (
    ...
    ib5ad73cf7945748972f731591eff294b40fb25e1b959db79f05536177225771d "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/items/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/items/{driveItem_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*ib5ad73cf7945748972f731591eff294b40fb25e1b959db79f05536177225771d.CountRequestBuilder) {
    return ib5ad73cf7945748972f731591eff294b40fb25e1b959db79f05536177225771d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
