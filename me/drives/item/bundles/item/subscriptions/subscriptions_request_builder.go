...
import (
    ...
    ib416d8d285e6337e7b67c3c8aea5bbb1aa35edfe1b4f2c73fa5ed104bb5b7ee8 "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/bundles/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*ib416d8d285e6337e7b67c3c8aea5bbb1aa35edfe1b4f2c73fa5ed104bb5b7ee8.CountRequestBuilder) {
    return ib416d8d285e6337e7b67c3c8aea5bbb1aa35edfe1b4f2c73fa5ed104bb5b7ee8.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
