...
import (
    ...
    i66454e59345952bc345334f2bb1f28c13786cfa4457b56e9d3cde96088f297e7 "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/bundles/item/thumbnails/count"
)
...
func NewThumbnailsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ThumbnailsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles/{driveItem_id}/thumbnails{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ThumbnailsRequestBuilder) Count()(*i66454e59345952bc345334f2bb1f28c13786cfa4457b56e9d3cde96088f297e7.CountRequestBuilder) {
    return i66454e59345952bc345334f2bb1f28c13786cfa4457b56e9d3cde96088f297e7.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
