...
import (
    ...
    i273775557315f26bb7b3db451651770ce797cf608c4b597aa4c04a3aa5b5d53f "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/bundles/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles/{driveItem_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i273775557315f26bb7b3db451651770ce797cf608c4b597aa4c04a3aa5b5d53f.CountRequestBuilder) {
    return i273775557315f26bb7b3db451651770ce797cf608c4b597aa4c04a3aa5b5d53f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
