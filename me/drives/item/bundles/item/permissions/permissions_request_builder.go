...
import (
    ...
    i6dd688c4599a583bd64799f624ca5947d69f44777ca34631e8ef833d41446c63 "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/bundles/item/permissions/count"
)
...
func NewPermissionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles/{driveItem_id}/permissions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PermissionsRequestBuilder) Count()(*i6dd688c4599a583bd64799f624ca5947d69f44777ca34631e8ef833d41446c63.CountRequestBuilder) {
    return i6dd688c4599a583bd64799f624ca5947d69f44777ca34631e8ef833d41446c63.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
