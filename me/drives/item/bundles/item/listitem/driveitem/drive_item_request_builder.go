...
import (
    ...
    i9348f0dc78714fb1254859495675ea52ca42f0475ba3b762a0dbd30a1ae50516 "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/bundles/item/listitem/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles/{driveItem_id}/listItem/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i9348f0dc78714fb1254859495675ea52ca42f0475ba3b762a0dbd30a1ae50516.ContentRequestBuilder) {
    return i9348f0dc78714fb1254859495675ea52ca42f0475ba3b762a0dbd30a1ae50516.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
