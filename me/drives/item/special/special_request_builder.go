...
import (
    ...
    i64c317d1e31f22614926b03fe3aaf6fc7244b60e9943f3e9ad3b81791fbdc7fa "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/special/count"
)
...
func NewSpecialRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SpecialRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/special{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SpecialRequestBuilder) Count()(*i64c317d1e31f22614926b03fe3aaf6fc7244b60e9943f3e9ad3b81791fbdc7fa.CountRequestBuilder) {
    return i64c317d1e31f22614926b03fe3aaf6fc7244b60e9943f3e9ad3b81791fbdc7fa.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to special for me
...
// Post create new navigation property to special for me
