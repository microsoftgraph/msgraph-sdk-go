...
import (
    ...
    i9236e0a2ad8d939439d6b28cbebdecb2646487305041dc87ee857ed03066f882 "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/special/item/listitem/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/special/{driveItem_id}/listItem/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*i9236e0a2ad8d939439d6b28cbebdecb2646487305041dc87ee857ed03066f882.CountRequestBuilder) {
    return i9236e0a2ad8d939439d6b28cbebdecb2646487305041dc87ee857ed03066f882.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
