...
import (
    ...
    ib21d2408725a746eea8ba099acf0a7a5c32c684db9b1c0d2f6c6292a6f3c6dce "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/special/item/thumbnails/count"
)
...
func NewThumbnailsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ThumbnailsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/special/{driveItem_id}/thumbnails{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ThumbnailsRequestBuilder) Count()(*ib21d2408725a746eea8ba099acf0a7a5c32c684db9b1c0d2f6c6292a6f3c6dce.CountRequestBuilder) {
    return ib21d2408725a746eea8ba099acf0a7a5c32c684db9b1c0d2f6c6292a6f3c6dce.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
