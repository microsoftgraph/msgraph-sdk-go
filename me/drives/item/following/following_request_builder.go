...
import (
    ...
    iacf0fe785258ff5a52d1bdc668b8d9a70de9fda23bef5b1517e3ed925c6b543d "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/following/count"
)
...
func NewFollowingRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FollowingRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/following{?top,skip,search,filter,count,orderby,select,expand}";
...
// CreatePostRequestInformation create new navigation property to following for me
...
// Post create new navigation property to following for me
