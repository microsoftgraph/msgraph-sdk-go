...
import (
    ...
    i3360283816d8471d205fca93728adc05127e22b300efadb2329077da87f06bf2 "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/following/item/permissions/item/grant"
)
...
func NewPermissionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}/permissions/{permission_id}{?select,expand}";
...
func (m *PermissionItemRequestBuilder) Grant()(*i3360283816d8471d205fca93728adc05127e22b300efadb2329077da87f06bf2.GrantRequestBuilder) {
    return i3360283816d8471d205fca93728adc05127e22b300efadb2329077da87f06bf2.NewGrantRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
