...
import (
    ...
    i226fa00c6144af16beacbbb0c91f82848f477fffce566685799979a5922bbca3 "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/following/item/listitem/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}/listItem/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*i226fa00c6144af16beacbbb0c91f82848f477fffce566685799979a5922bbca3.CountRequestBuilder) {
    return i226fa00c6144af16beacbbb0c91f82848f477fffce566685799979a5922bbca3.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
