...
import (
    ...
    i501f4b056004ad2d972022e883fc602e1f66469e468241caa228eda97214bd80 "github.com/microsoftgraph/msgraph-sdk-go/me/drives/item/following/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*i501f4b056004ad2d972022e883fc602e1f66469e468241caa228eda97214bd80.CountRequestBuilder) {
    return i501f4b056004ad2d972022e883fc602e1f66469e468241caa228eda97214bd80.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
