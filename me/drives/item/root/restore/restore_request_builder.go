...
func NewRestoreRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RestoreRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/microsoft.graph.restore";
...
// CreatePostRequestInformationWithRequestConfiguration restore a driveItem that has been deleted and is currently in the recycle bin. **NOTE**: This functionality is currently only available for OneDrive Personal.
