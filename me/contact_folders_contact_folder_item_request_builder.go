...
func (m *ContactFoldersContactFolderItemRequestBuilder) ChildFoldersById(id string)(*ContactFoldersItemChildFoldersContactFolderItemRequestBuilder) {
    ...
    idPtr := &id
    return NewContactFoldersItemChildFoldersContactFolderItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ContactFoldersContactFolderItemRequestBuilder) ContactsById(id string)(*ContactFoldersItemContactsContactItemRequestBuilder) {
    ...
    idPtr := &id
    return NewContactFoldersItemContactsContactItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ContactFoldersContactFolderItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ContactFoldersContactFolderItemRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ContactFolderable, error) {
...
func (m *ContactFoldersContactFolderItemRequestBuilder) MultiValueExtendedPropertiesById(id string)(*ContactFoldersItemMultiValueExtendedPropertiesMultiValueLegacyExtendedPropertyItemRequestBuilder) {
    ...
    idPtr := &id
    return NewContactFoldersItemMultiValueExtendedPropertiesMultiValueLegacyExtendedPropertyItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ContactFoldersContactFolderItemRequestBuilder) SingleValueExtendedPropertiesById(id string)(*ContactFoldersItemSingleValueExtendedPropertiesSingleValueLegacyExtendedPropertyItemRequestBuilder) {
    ...
    idPtr := &id
    return NewContactFoldersItemSingleValueExtendedPropertiesSingleValueLegacyExtendedPropertyItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ContactFoldersContactFolderItemRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ContactFoldersContactFolderItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
// ToPatchRequestInformation update the navigation property contactFolders in me
func (m *ContactFoldersContactFolderItemRequestBuilder) ToPatchRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ContactFolderable, requestConfiguration *ContactFoldersContactFolderItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
