...
// DrivesItemListContentTypesItemColumnsCountRequestBuilderGetQueryParameters get the number of the resource
type DrivesItemListContentTypesItemColumnsCountRequestBuilderGetQueryParameters struct {
...
type DrivesItemListContentTypesItemColumnsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *DrivesItemListContentTypesItemColumnsCountRequestBuilderGetQueryParameters
}
...
func NewDrivesItemListContentTypesItemColumnsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListContentTypesItemColumnsCountRequestBuilder) {
    m := &DrivesItemListContentTypesItemColumnsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columns/$count{?%24search,%24filter}";
...
func NewDrivesItemListContentTypesItemColumnsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListContentTypesItemColumnsCountRequestBuilder) {
    ...
    return NewDrivesItemListContentTypesItemColumnsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *DrivesItemListContentTypesItemColumnsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemListContentTypesItemColumnsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *DrivesItemListContentTypesItemColumnsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemListContentTypesItemColumnsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
