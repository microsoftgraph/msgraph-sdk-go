...
func NewChatsChatItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, chatId *string)(*ChatsChatItemRequestBuilder) {
...
func NewChatsChatItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChatsChatItemRequestBuilder) {
    ...
    return NewChatsChatItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ChatsChatItemRequestBuilder) InstalledAppsById(id string)(*ChatsItemInstalledAppsTeamsAppInstallationItemRequestBuilder) {
    ...
    idPtr := &id
    return NewChatsItemInstalledAppsTeamsAppInstallationItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ChatsChatItemRequestBuilder) MembersById(id string)(*ChatsItemMembersConversationMemberItemRequestBuilder) {
    ...
    idPtr := &id
    return NewChatsItemMembersConversationMemberItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ChatsChatItemRequestBuilder) MessagesById(id string)(*ChatsItemMessagesChatMessageItemRequestBuilder) {
    ...
    idPtr := &id
    return NewChatsItemMessagesChatMessageItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
// MicrosoftGraphHideForUser provides operations to call the hideForUser method.
func (m *ChatsChatItemRequestBuilder) MicrosoftGraphHideForUser()(*ChatsItemMicrosoftGraphHideForUserHideForUserRequestBuilder) {
    return NewChatsItemMicrosoftGraphHideForUserHideForUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphMarkChatReadForUser provides operations to call the markChatReadForUser method.
func (m *ChatsChatItemRequestBuilder) MicrosoftGraphMarkChatReadForUser()(*ChatsItemMicrosoftGraphMarkChatReadForUserMarkChatReadForUserRequestBuilder) {
    return NewChatsItemMicrosoftGraphMarkChatReadForUserMarkChatReadForUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphMarkChatUnreadForUser provides operations to call the markChatUnreadForUser method.
func (m *ChatsChatItemRequestBuilder) MicrosoftGraphMarkChatUnreadForUser()(*ChatsItemMicrosoftGraphMarkChatUnreadForUserMarkChatUnreadForUserRequestBuilder) {
    return NewChatsItemMicrosoftGraphMarkChatUnreadForUserMarkChatUnreadForUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSendActivityNotification provides operations to call the sendActivityNotification method.
func (m *ChatsChatItemRequestBuilder) MicrosoftGraphSendActivityNotification()(*ChatsItemMicrosoftGraphSendActivityNotificationSendActivityNotificationRequestBuilder) {
    return NewChatsItemMicrosoftGraphSendActivityNotificationSendActivityNotificationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnhideForUser provides operations to call the unhideForUser method.
func (m *ChatsChatItemRequestBuilder) MicrosoftGraphUnhideForUser()(*ChatsItemMicrosoftGraphUnhideForUserUnhideForUserRequestBuilder) {
    return NewChatsItemMicrosoftGraphUnhideForUserUnhideForUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ChatsChatItemRequestBuilder) PinnedMessagesById(id string)(*ChatsItemPinnedMessagesPinnedChatMessageInfoItemRequestBuilder) {
    ...
    idPtr := &id
    return NewChatsItemPinnedMessagesPinnedChatMessageInfoItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ChatsChatItemRequestBuilder) TabsById(id string)(*ChatsItemTabsTeamsTabItemRequestBuilder) {
    ...
    idPtr := &id
    return NewChatsItemTabsTeamsTabItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
