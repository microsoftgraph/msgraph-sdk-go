...
import (
    ...
    if94b9fedb611df1ee1c5999612404cf3e0dfa4f4e9d6d01e85f173182e17af54 "github.com/microsoftgraph/msgraph-sdk-go/me/onenote/sections/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \me\onenote\sections\{onenoteSection-id}\parentNotebook\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/onenote/sections/{onenoteSection_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*if94b9fedb611df1ee1c5999612404cf3e0dfa4f4e9d6d01e85f173182e17af54.CopyNotebookRequestBuilder) {
    return if94b9fedb611df1ee1c5999612404cf3e0dfa4f4e9d6d01e85f173182e17af54.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
