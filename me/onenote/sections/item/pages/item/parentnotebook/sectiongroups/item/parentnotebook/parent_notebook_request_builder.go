...
import (
    ...
    i065b9a5bd70003ccc0ef459ecd82aa3609a6b5aaf99eb70153edb43d5324aa1a "github.com/microsoftgraph/msgraph-sdk-go/me/onenote/sections/item/pages/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i065b9a5bd70003ccc0ef459ecd82aa3609a6b5aaf99eb70153edb43d5324aa1a.CopyNotebookRequestBuilder) {
    return i065b9a5bd70003ccc0ef459ecd82aa3609a6b5aaf99eb70153edb43d5324aa1a.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
