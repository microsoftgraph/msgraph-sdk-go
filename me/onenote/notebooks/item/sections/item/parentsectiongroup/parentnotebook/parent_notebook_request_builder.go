...
import (
    ...
    i9be084794c98f8247c9301f7f30eb9a2535e48a2fc140f2e36ff900289cf9bdc "github.com/microsoftgraph/msgraph-sdk-go/me/onenote/notebooks/item/sections/item/parentsectiongroup/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/parentSectionGroup/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i9be084794c98f8247c9301f7f30eb9a2535e48a2fc140f2e36ff900289cf9bdc.CopyNotebookRequestBuilder) {
    return i9be084794c98f8247c9301f7f30eb9a2535e48a2fc140f2e36ff900289cf9bdc.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the section group. Read-only.
// Parameters:
