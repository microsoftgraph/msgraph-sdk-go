...
import (
    ...
    i20b9264b29e813c40f5e5dd4f7e75ee971711947a8aecc8708cdd36057c628bd "github.com/microsoftgraph/msgraph-sdk-go/me/onenote/notebooks/item/sections/item/pages/count"
)
...
func NewPagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/pages{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PagesRequestBuilder) Count()(*i20b9264b29e813c40f5e5dd4f7e75ee971711947a8aecc8708cdd36057c628bd.CountRequestBuilder) {
    return i20b9264b29e813c40f5e5dd4f7e75ee971711947a8aecc8708cdd36057c628bd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
