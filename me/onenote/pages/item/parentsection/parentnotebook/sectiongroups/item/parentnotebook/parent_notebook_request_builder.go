...
import (
    ...
    i3ca0324cc14a6a50abc2011cdd0d9b34d9cb90c30040f49a2ad1b5134ca356d0 "github.com/microsoftgraph/msgraph-sdk-go/me/onenote/pages/item/parentsection/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentSection/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i3ca0324cc14a6a50abc2011cdd0d9b34d9cb90c30040f49a2ad1b5134ca356d0.CopyNotebookRequestBuilder) {
    return i3ca0324cc14a6a50abc2011cdd0d9b34d9cb90c30040f49a2ad1b5134ca356d0.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the section group. Read-only.
// Parameters:
