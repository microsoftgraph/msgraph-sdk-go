...
import (
    ...
    idfe355262c055a8ed90da0e120abf1d342a683e0b62aa0d5cfc97d01577971d0 "github.com/microsoftgraph/msgraph-sdk-go/me/onenote/pages/item/parentnotebook/sectiongroups/item/sections/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*idfe355262c055a8ed90da0e120abf1d342a683e0b62aa0d5cfc97d01577971d0.CopyNotebookRequestBuilder) {
    return idfe355262c055a8ed90da0e120abf1d342a683e0b62aa0d5cfc97d01577971d0.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the section.  Read-only.
// Parameters:
//  - h : Request headers
