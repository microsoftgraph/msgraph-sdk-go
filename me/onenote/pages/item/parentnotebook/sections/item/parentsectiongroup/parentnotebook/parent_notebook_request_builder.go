...
import (
    ...
    i0601f92b962c4e9379a3ba6d670868298c45434c16d1f5db2fb629a19cd9e862 "github.com/microsoftgraph/msgraph-sdk-go/me/onenote/pages/item/parentnotebook/sections/item/parentsectiongroup/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePage_id}/parentNotebook/sections/{onenoteSection_id}/parentSectionGroup/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i0601f92b962c4e9379a3ba6d670868298c45434c16d1f5db2fb629a19cd9e862.CopyNotebookRequestBuilder) {
    return i0601f92b962c4e9379a3ba6d670868298c45434c16d1f5db2fb629a19cd9e862.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
