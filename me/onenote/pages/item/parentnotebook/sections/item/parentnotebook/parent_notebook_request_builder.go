...
import (
    ...
    i46609bac7a32d425b9da26bd1b9f2fb542607eecabe94e5b6ced53a9f2f9a2e1 "github.com/microsoftgraph/msgraph-sdk-go/me/onenote/pages/item/parentnotebook/sections/item/parentnotebook/copynotebook"
)

// parentNotebookRequestBuilder builds and executes requests for operations under \me\onenote\pages\{onenotePage-id}\parentNotebook\sections\{onenoteSection-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/onenote/pages/{onenotePage_id}/parentNotebook/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i46609bac7a32d425b9da26bd1b9f2fb542607eecabe94e5b6ced53a9f2f9a2e1.CopyNotebookRequestBuilder) {
    return i46609bac7a32d425b9da26bd1b9f2fb542607eecabe94e5b6ced53a9f2f9a2e1.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
