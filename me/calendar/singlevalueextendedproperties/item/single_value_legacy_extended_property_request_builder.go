...
// SingleValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \me\calendar\singleValueExtendedProperties\{singleValueLegacyExtendedProperty-id}
