...
// MultiValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \me\calendar\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
