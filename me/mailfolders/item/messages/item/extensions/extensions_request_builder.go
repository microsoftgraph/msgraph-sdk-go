...
import (
    ...
    i2a38e9d6d00db26757344eec3a7ab4c8e74a3b11a9897336b3ae7fa75af9fd70 "github.com/microsoftgraph/msgraph-sdk-go/me/mailfolders/item/messages/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/mailFolders/{mailFolder_id}/messages/{message_id}/extensions{?top,skip,filter,count,orderby,select,expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*i2a38e9d6d00db26757344eec3a7ab4c8e74a3b11a9897336b3ae7fa75af9fd70.CountRequestBuilder) {
    return i2a38e9d6d00db26757344eec3a7ab4c8e74a3b11a9897336b3ae7fa75af9fd70.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
