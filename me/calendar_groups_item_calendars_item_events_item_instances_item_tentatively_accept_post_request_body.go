...
// CalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody 
...
func (m *CalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CalendarGroupsItemCalendarsItemEventsItemInstancesItemTentativelyAcceptPostRequestBody) SetAdditionalData(value map[string]any)() {
