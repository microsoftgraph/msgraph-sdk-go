...
// AuthenticationMicrosoftAuthenticatorMethodsItemDeviceCheckMemberObjectsPostRequestBody provides operations to call the checkMemberObjects method.
...
func (m *AuthenticationMicrosoftAuthenticatorMethodsItemDeviceCheckMemberObjectsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *AuthenticationMicrosoftAuthenticatorMethodsItemDeviceCheckMemberObjectsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
