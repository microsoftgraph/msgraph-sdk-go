...
import (
    ...
    i8a923b069ff27d9933cf06efe1964ff5ce16d27746fbd575e4c6cdc9b1c578c3 "github.com/microsoftgraph/msgraph-sdk-go/me/chats/item/members/count"
    ieb7fea139410a1d546d2db2544875e39c0136cbcc56fe75088164d493b176243 "github.com/microsoftgraph/msgraph-sdk-go/me/chats/item/members/add"
)
...
func (m *MembersRequestBuilder) Add()(*ieb7fea139410a1d546d2db2544875e39c0136cbcc56fe75088164d493b176243.AddRequestBuilder) {
    return ieb7fea139410a1d546d2db2544875e39c0136cbcc56fe75088164d493b176243.NewAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/chats/{chat_id}/members{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MembersRequestBuilder) Count()(*i8a923b069ff27d9933cf06efe1964ff5ce16d27746fbd575e4c6cdc9b1c578c3.CountRequestBuilder) {
    return i8a923b069ff27d9933cf06efe1964ff5ce16d27746fbd575e4c6cdc9b1c578c3.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
