...
func (m *CalendarsItemEventsItemInstancesItemCancelPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CalendarsItemEventsItemInstancesItemCancelPostRequestBody) SetAdditionalData(value map[string]any)() {
