...
import (
    ...
    i9a188bdb75dd13a4d1a65d6e6548e4af6b4c30dfccac0c6b2902d85b989f803f "github.com/microsoftgraph/msgraph-sdk-go/me/messages/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/messages/{message_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i9a188bdb75dd13a4d1a65d6e6548e4af6b4c30dfccac0c6b2902d85b989f803f.CountRequestBuilder) {
    return i9a188bdb75dd13a4d1a65d6e6548e4af6b4c30dfccac0c6b2902d85b989f803f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
