...
func (m *MemberOfRequestBuilder) MicrosoftGraphApplication()(*MemberOfMicrosoftGraphApplicationApplicationRequestBuilder) {
    return NewMemberOfMicrosoftGraphApplicationApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphDevice casts the previous resource to device.
func (m *MemberOfRequestBuilder) MicrosoftGraphDevice()(*MemberOfMicrosoftGraphDeviceDeviceRequestBuilder) {
    return NewMemberOfMicrosoftGraphDeviceDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphGroup casts the previous resource to group.
func (m *MemberOfRequestBuilder) MicrosoftGraphGroup()(*MemberOfMicrosoftGraphGroupGroupRequestBuilder) {
    return NewMemberOfMicrosoftGraphGroupGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphOrgContact casts the previous resource to orgContact.
func (m *MemberOfRequestBuilder) MicrosoftGraphOrgContact()(*MemberOfMicrosoftGraphOrgContactOrgContactRequestBuilder) {
    return NewMemberOfMicrosoftGraphOrgContactOrgContactRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *MemberOfRequestBuilder) MicrosoftGraphServicePrincipal()(*MemberOfMicrosoftGraphServicePrincipalServicePrincipalRequestBuilder) {
    return NewMemberOfMicrosoftGraphServicePrincipalServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *MemberOfRequestBuilder) MicrosoftGraphUser()(*MemberOfMicrosoftGraphUserUserRequestBuilder) {
    return NewMemberOfMicrosoftGraphUserUserRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
