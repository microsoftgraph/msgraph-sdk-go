...
// AuthenticationWindowsHelloForBusinessMethodsItemDeviceCheckMemberGroupsPostRequestBody provides operations to call the checkMemberGroups method.
...
func (m *AuthenticationWindowsHelloForBusinessMethodsItemDeviceCheckMemberGroupsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *AuthenticationWindowsHelloForBusinessMethodsItemDeviceCheckMemberGroupsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
