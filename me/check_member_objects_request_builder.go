...
func (m *CheckMemberObjectsRequestBuilder) Post(ctx context.Context, body CheckMemberObjectsPostRequestBodyable, requestConfiguration *CheckMemberObjectsRequestBuilderPostRequestConfiguration)(CheckMemberObjectsResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateCheckMemberObjectsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *CheckMemberObjectsRequestBuilder) ToPostRequestInformation(ctx context.Context, body CheckMemberObjectsPostRequestBodyable, requestConfiguration *CheckMemberObjectsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
