...
// singleValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \me\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\singleValueExtendedProperties\{singleValueLegacyExtendedProperty-id}
