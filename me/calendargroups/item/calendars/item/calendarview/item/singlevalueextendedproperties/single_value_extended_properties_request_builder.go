...
import (
    ...
    if4e4bda179271f37e1d38fc6b9653767872c2c4a308e95b7315c92ebae1f0ebd "github.com/microsoftgraph/msgraph-sdk-go/me/calendargroups/item/calendars/item/calendarview/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/calendarView/{event_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*if4e4bda179271f37e1d38fc6b9653767872c2c4a308e95b7315c92ebae1f0ebd.CountRequestBuilder) {
    return if4e4bda179271f37e1d38fc6b9653767872c2c4a308e95b7315c92ebae1f0ebd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
