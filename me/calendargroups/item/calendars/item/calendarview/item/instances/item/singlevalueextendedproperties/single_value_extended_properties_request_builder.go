...
import (
    ...
    if308ada1af667adcfd226575ce8f6892e614d18c004c398e10d03d3006275da4 "github.com/microsoftgraph/msgraph-sdk-go/me/calendargroups/item/calendars/item/calendarview/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/calendarView/{event_id}/instances/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*if308ada1af667adcfd226575ce8f6892e614d18c004c398e10d03d3006275da4.CountRequestBuilder) {
    return if308ada1af667adcfd226575ce8f6892e614d18c004c398e10d03d3006275da4.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
