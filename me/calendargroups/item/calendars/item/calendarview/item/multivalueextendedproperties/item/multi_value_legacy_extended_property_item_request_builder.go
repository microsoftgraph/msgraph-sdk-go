...
// MultiValueLegacyExtendedPropertyItemRequestBuilder builds and executes requests for operations under \me\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\calendarView\{event-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
