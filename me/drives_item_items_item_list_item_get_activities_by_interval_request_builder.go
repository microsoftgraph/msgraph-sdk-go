...
func NewDrivesItemItemsItemListItemGetActivitiesByIntervalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemItemsItemListItemGetActivitiesByIntervalRequestBuilder) {
    m := &DrivesItemItemsItemListItemGetActivitiesByIntervalRequestBuilder{
    }
...
func NewDrivesItemItemsItemListItemGetActivitiesByIntervalRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemItemsItemListItemGetActivitiesByIntervalRequestBuilder) {
    ...
    return NewDrivesItemItemsItemListItemGetActivitiesByIntervalRequestBuilderInternal(urlParams, requestAdapter)
}
// Get invoke function getActivitiesByInterval
func (m *DrivesItemItemsItemListItemGetActivitiesByIntervalRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemItemsItemListItemGetActivitiesByIntervalRequestBuilderGetRequestConfiguration)(DrivesItemItemsItemListItemGetActivitiesByIntervalResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateDrivesItemItemsItemListItemGetActivitiesByIntervalResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(DrivesItemItemsItemListItemGetActivitiesByIntervalResponseable), nil
}
// ToGetRequestInformation invoke function getActivitiesByInterval
func (m *DrivesItemItemsItemListItemGetActivitiesByIntervalRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemItemsItemListItemGetActivitiesByIntervalRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
