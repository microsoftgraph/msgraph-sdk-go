...
// AcceptRequestBuilder builds and executes requests for operations under \me\calendars\{calendar-id}\events\{event-id}\microsoft.graph.accept
...
func NewAcceptRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AcceptRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendars/{calendar_id}/events/{event_id}/microsoft.graph.accept";
