...
// singleValueExtendedPropertiesRequestBuilder builds and executes requests for operations under \me\calendars\{calendar-id}\events\{event-id}\singleValueExtendedProperties
