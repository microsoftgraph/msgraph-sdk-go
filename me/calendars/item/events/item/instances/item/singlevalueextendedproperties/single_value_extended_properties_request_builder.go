...
import (
    ...
    i09e0472db7503f5077f1b6219f7337ce5cc4babc873a7fb19eeea9907da71f73 "github.com/microsoftgraph/msgraph-sdk-go/me/calendars/item/events/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendars/{calendar_id}/events/{event_id}/instances/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i09e0472db7503f5077f1b6219f7337ce5cc4babc873a7fb19eeea9907da71f73.CountRequestBuilder) {
    return i09e0472db7503f5077f1b6219f7337ce5cc4babc873a7fb19eeea9907da71f73.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
