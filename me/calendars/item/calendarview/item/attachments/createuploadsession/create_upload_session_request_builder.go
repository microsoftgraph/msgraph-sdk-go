...
// CreateUploadSessionRequestBuilder builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView\{event-id}\attachments\microsoft.graph.createUploadSession
