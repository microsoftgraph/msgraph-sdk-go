...
// InstancesRequestBuilder builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView\{event-id}\instances
...
// Delta builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView\{event-id}\instances\microsoft.graph.delta()
