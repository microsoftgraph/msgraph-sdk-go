...
// getScheduleRequestBuilder builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView\{event-id}\calendar\microsoft.graph.getSchedule
...
func NewGetScheduleRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GetScheduleRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendars/{calendar_id}/calendarView/{event_id}/calendar/microsoft.graph.getSchedule";
