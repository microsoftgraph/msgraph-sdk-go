...
// MultiValueLegacyExtendedPropertyItemRequestBuilder builds and executes requests for operations under \me\calendars\{calendar-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
