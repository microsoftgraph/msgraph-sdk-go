...
func (m *CheckMemberGroupsPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CheckMemberGroupsPostRequestBody) SetAdditionalData(value map[string]any)() {
