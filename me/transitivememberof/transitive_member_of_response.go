...
type TransitiveMemberOfResponse struct {
...
func NewTransitiveMemberOfResponse()(*TransitiveMemberOfResponse) {
    m := &TransitiveMemberOfResponse{
    }
    m.SetAdditionalData(make(map[string]interface{}));
    return m
}
func (m *TransitiveMemberOfResponse) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TransitiveMemberOfResponse) GetNextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *TransitiveMemberOfResponse) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *TransitiveMemberOfResponse) IsNil()(bool) {
    return m == nil
}
func (m *TransitiveMemberOfResponse) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
...
func (m *TransitiveMemberOfResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
func (m *TransitiveMemberOfResponse) SetNextLink(value *string)() {
    m.nextLink = value
}
