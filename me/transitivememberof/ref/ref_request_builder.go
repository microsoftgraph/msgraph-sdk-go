...
// refRequestBuilder builds and executes requests for operations under \me\transitiveMemberOf\$ref
...
// refRequestBuilderGetQueryParameters get ref of transitiveMemberOf from me
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/transitiveMemberOf/$ref{?top,skip,search,filter,count,orderby}";
...
// CreateGetRequestInformation get ref of transitiveMemberOf from me
...
// CreatePostRequestInformation create new navigation property ref to transitiveMemberOf for me
...
// Get get ref of transitiveMemberOf from me
...
// Post create new navigation property ref to transitiveMemberOf for me
