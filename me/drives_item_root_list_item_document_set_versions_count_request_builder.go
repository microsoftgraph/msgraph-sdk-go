...
// DrivesItemRootListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters get the number of the resource
type DrivesItemRootListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters struct {
...
type DrivesItemRootListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *DrivesItemRootListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters
}
...
func NewDrivesItemRootListItemDocumentSetVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootListItemDocumentSetVersionsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/documentSetVersions/$count{?%24search,%24filter}";
...
func (m *DrivesItemRootListItemDocumentSetVersionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemRootListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
