...
// JoinedTeamsItemChannelsItemMembersCountRequestBuilderGetQueryParameters get the number of the resource
type JoinedTeamsItemChannelsItemMembersCountRequestBuilderGetQueryParameters struct {
...
type JoinedTeamsItemChannelsItemMembersCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *JoinedTeamsItemChannelsItemMembersCountRequestBuilderGetQueryParameters
}
...
func NewJoinedTeamsItemChannelsItemMembersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*JoinedTeamsItemChannelsItemMembersCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/members/$count{?%24search,%24filter}";
