...
import (
    ...
    if1bc0e2cc387be151a90a23f9065d0c013c100afb7b3a343f9654cab1883c936 "github.com/microsoftgraph/msgraph-sdk-go/me/calendarview/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarView/{event_id}/instances/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*if1bc0e2cc387be151a90a23f9065d0c013c100afb7b3a343f9654cab1883c936.CountRequestBuilder) {
    return if1bc0e2cc387be151a90a23f9065d0c013c100afb7b3a343f9654cab1883c936.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
