...
import (
    ...
    i20c3319d626024247c6138c71888bf669ba6fa73ce158bcbacfdcb93fc0dbfc3 "github.com/microsoftgraph/msgraph-sdk-go/me/calendarview/item/calendar/calendarview/delta"
)
...
func NewCalendarViewRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CalendarViewRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/me/calendarView/{event_id}/calendar/calendarView{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *CalendarViewRequestBuilder) Delta()(*i20c3319d626024247c6138c71888bf669ba6fa73ce158bcbacfdcb93fc0dbfc3.DeltaRequestBuilder) {
    return i20c3319d626024247c6138c71888bf669ba6fa73ce158bcbacfdcb93fc0dbfc3.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
