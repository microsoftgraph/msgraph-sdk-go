...
// EventsRequestBuilder builds and executes requests for operations under \me\calendarView\{event-id}\calendar\events
...
func NewEventsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*EventsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarView/{event_id}/calendar/events{?top,skip,filter,count,orderby,select}";
...
// Delta builds and executes requests for operations under \me\calendarView\{event-id}\calendar\events\microsoft.graph.delta()
