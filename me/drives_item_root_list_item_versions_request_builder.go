...
func NewDrivesItemRootListItemVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootListItemVersionsRequestBuilder) {
    m := &DrivesItemRootListItemVersionsRequestBuilder{
    }
...
func NewDrivesItemRootListItemVersionsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootListItemVersionsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemRootListItemVersionsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *DrivesItemRootListItemVersionsRequestBuilder) Count()(*DrivesItemRootListItemVersionsCountRequestBuilder) {
    return NewDrivesItemRootListItemVersionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DrivesItemRootListItemVersionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemRootListItemVersionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemRootListItemVersionsRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemRootListItemVersionsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ListItemVersionCollectionResponseable, error) {
