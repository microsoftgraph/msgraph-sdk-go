...
// teamRequestBuilder builds and executes requests for operations under \me\joinedTeams\{team-id}
...
// teamRequestBuilderGetQueryParameters the Microsoft Teams teams that the user is a member of. Read-only. Nullable.
...
// CreateDeleteRequestInformation the Microsoft Teams teams that the user is a member of. Read-only. Nullable.
...
// CreatePatchRequestInformation the Microsoft Teams teams that the user is a member of. Read-only. Nullable.
...
// Delete the Microsoft Teams teams that the user is a member of. Read-only. Nullable.
...
// Patch the Microsoft Teams teams that the user is a member of. Read-only. Nullable.
