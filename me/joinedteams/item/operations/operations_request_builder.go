...
import (
    ...
    i84f26f75fcf89f3e3c96606429db3c73f2d85398175df143c111c4ecf1f1f317 "github.com/microsoftgraph/msgraph-sdk-go/me/joinedteams/item/operations/count"
)
...
func NewOperationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OperationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/operations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *OperationsRequestBuilder) Count()(*i84f26f75fcf89f3e3c96606429db3c73f2d85398175df143c111c4ecf1f1f317.CountRequestBuilder) {
    return i84f26f75fcf89f3e3c96606429db3c73f2d85398175df143c111c4ecf1f1f317.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
