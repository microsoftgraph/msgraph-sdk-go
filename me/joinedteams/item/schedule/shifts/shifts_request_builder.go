...
func NewShiftsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ShiftsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/schedule/shifts{?top,skip,search,filter,count,orderby,select}";
...
// CreatePostRequestInformation create new navigation property to shifts for me
...
// Post create new navigation property to shifts for me
