...
import (
    ...
    i19d08cd1ab9479cc6a54f110068603565fb30a1d2019c58f398532352be7fc71 "github.com/microsoftgraph/msgraph-sdk-go/me/joinedteams/item/channels/item/messages/item/replies"
    ib297b78bf74ca591df006389edf08db277ded27a585d2a3740aa4a52e98e87f2 "github.com/microsoftgraph/msgraph-sdk-go/me/joinedteams/item/channels/item/messages/item/hostedcontents"
    i7933a85bc211ab4c33880bb51433378717db9cefa5b0bcf27e58dbfd9e733459 "github.com/microsoftgraph/msgraph-sdk-go/me/joinedteams/item/channels/item/messages/item/replies/item"
    ice240c1c90fd6fd6588946080946c06cf5e7a0f40b0d90cf6533d4610dc7c584 "github.com/microsoftgraph/msgraph-sdk-go/me/joinedteams/item/channels/item/messages/item/hostedcontents/item"
)
...
func NewChatMessageItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChatMessageItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/channels/{channel_id}/messages/{chatMessage_id}{?select,expand}";
...
func (m *ChatMessageItemRequestBuilder) HostedContents()(*ib297b78bf74ca591df006389edf08db277ded27a585d2a3740aa4a52e98e87f2.HostedContentsRequestBuilder) {
    return ib297b78bf74ca591df006389edf08db277ded27a585d2a3740aa4a52e98e87f2.NewHostedContentsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// HostedContentsById gets an item from the github.com/microsoftgraph/msgraph-sdk-go/.me.joinedTeams.item.channels.item.messages.item.hostedContents.item collection
func (m *ChatMessageItemRequestBuilder) HostedContentsById(id string)(*ice240c1c90fd6fd6588946080946c06cf5e7a0f40b0d90cf6533d4610dc7c584.ChatMessageHostedContentItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return ice240c1c90fd6fd6588946080946c06cf5e7a0f40b0d90cf6533d4610dc7c584.NewChatMessageHostedContentItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *ChatMessageItemRequestBuilder) Replies()(*i19d08cd1ab9479cc6a54f110068603565fb30a1d2019c58f398532352be7fc71.RepliesRequestBuilder) {
    return i19d08cd1ab9479cc6a54f110068603565fb30a1d2019c58f398532352be7fc71.NewRepliesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// RepliesById gets an item from the github.com/microsoftgraph/msgraph-sdk-go/.me.joinedTeams.item.channels.item.messages.item.replies.item collection
func (m *ChatMessageItemRequestBuilder) RepliesById(id string)(*i7933a85bc211ab4c33880bb51433378717db9cefa5b0bcf27e58dbfd9e733459.ChatMessageItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i7933a85bc211ab4c33880bb51433378717db9cefa5b0bcf27e58dbfd9e733459.NewChatMessageItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
