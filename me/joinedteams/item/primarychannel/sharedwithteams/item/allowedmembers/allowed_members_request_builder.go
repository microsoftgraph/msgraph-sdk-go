...
import (
    ...
    i5b86fe6a7dad816bd30ea7e4851614218d65d8610c3ff47ebcf8b4bc2239c48b "github.com/microsoftgraph/msgraph-sdk-go/me/joinedteams/item/primarychannel/sharedwithteams/item/allowedmembers/count"
)
...
func NewAllowedMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AllowedMembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
...
func (m *AllowedMembersRequestBuilder) Count()(*i5b86fe6a7dad816bd30ea7e4851614218d65d8610c3ff47ebcf8b4bc2239c48b.CountRequestBuilder) {
    return i5b86fe6a7dad816bd30ea7e4851614218d65d8610c3ff47ebcf8b4bc2239c48b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AllowedMembersRequestBuilder) Get(ctx context.Context, requestConfiguration *AllowedMembersRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationMemberCollectionResponseable, error) {
