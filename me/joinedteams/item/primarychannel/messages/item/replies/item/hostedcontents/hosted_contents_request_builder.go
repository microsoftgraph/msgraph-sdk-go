...
import (
    ...
    id0e7723a52b5ae53a31533556cf82aa1fec285f3d299c2043c01064409f65b53 "github.com/microsoftgraph/msgraph-sdk-go/me/joinedteams/item/primarychannel/messages/item/replies/item/hostedcontents/count"
)
...
func NewHostedContentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HostedContentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/primaryChannel/messages/{chatMessage_id}/replies/{chatMessage_id1}/hostedContents{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *HostedContentsRequestBuilder) Count()(*id0e7723a52b5ae53a31533556cf82aa1fec285f3d299c2043c01064409f65b53.CountRequestBuilder) {
    return id0e7723a52b5ae53a31533556cf82aa1fec285f3d299c2043c01064409f65b53.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
