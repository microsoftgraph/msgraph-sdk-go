...
func (m *GetMailTipsRequestBuilder) Post(ctx context.Context, body GetMailTipsPostRequestBodyable, requestConfiguration *GetMailTipsRequestBuilderPostRequestConfiguration)(GetMailTipsResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateGetMailTipsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *GetMailTipsRequestBuilder) ToPostRequestInformation(ctx context.Context, body GetMailTipsPostRequestBodyable, requestConfiguration *GetMailTipsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
