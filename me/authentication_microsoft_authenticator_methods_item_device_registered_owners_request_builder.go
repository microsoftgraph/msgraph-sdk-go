...
func (m *AuthenticationMicrosoftAuthenticatorMethodsItemDeviceRegisteredOwnersRequestBuilder) AppRoleAssignment()(*AuthenticationMicrosoftAuthenticatorMethodsItemDeviceRegisteredOwnersAppRoleAssignmentRequestBuilder) {
    return NewAuthenticationMicrosoftAuthenticatorMethodsItemDeviceRegisteredOwnersAppRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
