...
func (m *ContactFoldersRequestBuilder) MicrosoftGraphDelta()(*ContactFoldersMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewContactFoldersMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ContactFoldersRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ContactFoldersRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
