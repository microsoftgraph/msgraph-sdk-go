...
func (m *SupportedTimeZonesResponse) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *SupportedTimeZonesResponse) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *SupportedTimeZonesResponse) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
