...
func NewDrivesItemListDriveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListDriveRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/drive{?%24select,%24expand}";
...
func (m *DrivesItemListDriveRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemListDriveRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Driveable, error) {
...
func (m *DrivesItemListDriveRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemListDriveRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
