...
// ListsRequestBuilder builds and executes requests for operations under \me\todo\lists
...
func NewListsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ListsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/todo/lists{?top,skip,search,filter,count,orderby,select,expand}";
...
// Delta builds and executes requests for operations under \me\todo\lists\microsoft.graph.delta()
