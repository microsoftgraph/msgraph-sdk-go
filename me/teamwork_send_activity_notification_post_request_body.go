...
func (m *TeamworkSendActivityNotificationPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *TeamworkSendActivityNotificationPostRequestBody) SetAdditionalData(value map[string]any)() {
