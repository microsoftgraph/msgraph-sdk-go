...
// RefRequestBuilder builds and executes requests for operations under \me\teamwork\installedApps\{userScopeTeamsAppInstallation-id}\chat\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/teamwork/installedApps/{userScopeTeamsAppInstallation_id}/chat/$ref";
...
// CreateDeleteRequestInformation the chat between the user and Teams app.
...
// CreatePutRequestInformation the chat between the user and Teams app.
...
// Delete the chat between the user and Teams app.
...
// Put the chat between the user and Teams app.
