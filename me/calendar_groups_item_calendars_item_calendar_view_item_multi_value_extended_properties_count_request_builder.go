...
// CalendarGroupsItemCalendarsItemCalendarViewItemMultiValueExtendedPropertiesCountRequestBuilderGetQueryParameters get the number of the resource
type CalendarGroupsItemCalendarsItemCalendarViewItemMultiValueExtendedPropertiesCountRequestBuilderGetQueryParameters struct {
...
type CalendarGroupsItemCalendarsItemCalendarViewItemMultiValueExtendedPropertiesCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *CalendarGroupsItemCalendarsItemCalendarViewItemMultiValueExtendedPropertiesCountRequestBuilderGetQueryParameters
}
...
func NewCalendarGroupsItemCalendarsItemCalendarViewItemMultiValueExtendedPropertiesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CalendarGroupsItemCalendarsItemCalendarViewItemMultiValueExtendedPropertiesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/multiValueExtendedProperties/$count{?%24search,%24filter}";
