...
func NewDrivesItemItemsItemCheckinRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemItemsItemCheckinRequestBuilder) {
    m := &DrivesItemItemsItemCheckinRequestBuilder{
    }
...
func NewDrivesItemItemsItemCheckinRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemItemsItemCheckinRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemItemsItemCheckinRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DrivesItemItemsItemCheckinRequestBuilder) Post(ctx context.Context, body DrivesItemItemsItemCheckinPostRequestBodyable, requestConfiguration *DrivesItemItemsItemCheckinRequestBuilderPostRequestConfiguration)(error) {
...
func (m *DrivesItemItemsItemCheckinRequestBuilder) ToPostRequestInformation(ctx context.Context, body DrivesItemItemsItemCheckinPostRequestBodyable, requestConfiguration *DrivesItemItemsItemCheckinRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
