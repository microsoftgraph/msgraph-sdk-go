...
// MailFoldersItemChildFoldersItemMessagesItemCreateReplyPostRequestBody provides operations to call the createReply method.
...
func (m *MailFoldersItemChildFoldersItemMessagesItemCreateReplyPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *MailFoldersItemChildFoldersItemMessagesItemCreateReplyPostRequestBody) GetMessage()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Messageable) {
    return m.message
}
...
func (m *MailFoldersItemChildFoldersItemMessagesItemCreateReplyPostRequestBody) SetAdditionalData(value map[string]interface{})() {
...
func (m *MailFoldersItemChildFoldersItemMessagesItemCreateReplyPostRequestBody) SetMessage(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Messageable)() {
    m.message = value
}
