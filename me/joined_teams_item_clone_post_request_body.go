...
// JoinedTeamsItemClonePostRequestBody 
...
func (m *JoinedTeamsItemClonePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *JoinedTeamsItemClonePostRequestBody) SetAdditionalData(value map[string]any)() {
