...
func (m *DrivesItemItemsItemSearchWithQRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemItemsItemSearchWithQRequestBuilderGetRequestConfiguration)(DrivesItemItemsItemSearchWithQResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateDrivesItemItemsItemSearchWithQResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(DrivesItemItemsItemSearchWithQResponseable), nil
}
// ToGetRequestInformation invoke function search
func (m *DrivesItemItemsItemSearchWithQRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemItemsItemSearchWithQRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
