...
// MailFoldersItemChildFoldersItemMessagesItemMovePostRequestBody 
...
func (m *MailFoldersItemChildFoldersItemMessagesItemMovePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *MailFoldersItemChildFoldersItemMessagesItemMovePostRequestBody) SetAdditionalData(value map[string]any)() {
