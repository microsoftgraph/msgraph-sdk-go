...
// AuthenticationMicrosoftAuthenticatorMethodsItemDeviceRegisteredOwnersAppRoleAssignmentCountRequestBuilderGetQueryParameters get the number of the resource
type AuthenticationMicrosoftAuthenticatorMethodsItemDeviceRegisteredOwnersAppRoleAssignmentCountRequestBuilderGetQueryParameters struct {
...
type AuthenticationMicrosoftAuthenticatorMethodsItemDeviceRegisteredOwnersAppRoleAssignmentCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *AuthenticationMicrosoftAuthenticatorMethodsItemDeviceRegisteredOwnersAppRoleAssignmentCountRequestBuilderGetQueryParameters
}
...
func NewAuthenticationMicrosoftAuthenticatorMethodsItemDeviceRegisteredOwnersAppRoleAssignmentCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AuthenticationMicrosoftAuthenticatorMethodsItemDeviceRegisteredOwnersAppRoleAssignmentCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/registeredOwners/microsoft.graph.appRoleAssignment/$count{?%24search,%24filter}";
