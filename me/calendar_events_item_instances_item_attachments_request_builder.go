...
func (m *CalendarEventsItemInstancesItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*CalendarEventsItemInstancesItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilder) {
    return NewCalendarEventsItemInstancesItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
