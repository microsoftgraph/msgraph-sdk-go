...
// DeleteWithResponseHandler delete navigation property contactFolders for me
...
// PatchWithResponseHandler update the navigation property contactFolders in me
