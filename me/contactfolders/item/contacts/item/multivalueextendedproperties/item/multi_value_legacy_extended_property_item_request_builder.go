...
// MultiValueLegacyExtendedPropertyItemRequestBuilder builds and executes requests for operations under \me\contactFolders\{contactFolder-id}\contacts\{contact-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
