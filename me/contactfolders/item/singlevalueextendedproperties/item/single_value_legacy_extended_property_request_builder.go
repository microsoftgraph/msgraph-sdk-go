...
// SingleValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \me\contactFolders\{contactFolder-id}\singleValueExtendedProperties\{singleValueLegacyExtendedProperty-id}
...
// SingleValueLegacyExtendedPropertyRequestBuilderGetQueryParameters the collection of single-value extended properties defined for the contactFolder. Read-only. Nullable.
