...
// DrivesItemItemsItemInvitePostRequestBody provides operations to call the invite method.
...
func (m *DrivesItemItemsItemInvitePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *DrivesItemItemsItemInvitePostRequestBody) GetRecipients()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveRecipientable) {
    return m.recipients
}
...
func (m *DrivesItemItemsItemInvitePostRequestBody) SetAdditionalData(value map[string]interface{})() {
...
func (m *DrivesItemItemsItemInvitePostRequestBody) SetRecipients(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveRecipientable)() {
    m.recipients = value
}
