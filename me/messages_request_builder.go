...
func (m *MessagesRequestBuilder) MicrosoftGraphDelta()(*MessagesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewMessagesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
