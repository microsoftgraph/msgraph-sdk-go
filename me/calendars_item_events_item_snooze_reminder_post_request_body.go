...
func (m *CalendarsItemEventsItemSnoozeReminderPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CalendarsItemEventsItemSnoozeReminderPostRequestBody) SetAdditionalData(value map[string]any)() {
