...
func (m *DrivesItemRootListItemGetActivitiesByIntervalRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemRootListItemGetActivitiesByIntervalRequestBuilderGetRequestConfiguration)(DrivesItemRootListItemGetActivitiesByIntervalResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateDrivesItemRootListItemGetActivitiesByIntervalResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(DrivesItemRootListItemGetActivitiesByIntervalResponseable), nil
}
