...
func (m *ContactFoldersItemChildFoldersItemContactsDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *ContactFoldersItemChildFoldersItemContactsDeltaRequestBuilderGetRequestConfiguration)(ContactFoldersItemChildFoldersItemContactsDeltaResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateContactFoldersItemChildFoldersItemContactsDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ContactFoldersItemChildFoldersItemContactsDeltaRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ContactFoldersItemChildFoldersItemContactsDeltaRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
