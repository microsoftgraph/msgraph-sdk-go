...
func NewPlannerBucketRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PlannerBucketRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/me/planner/plans/{plannerPlan_id}/buckets/{plannerBucket_id}{?select,expand}";
...
// Gets an item from the github.com/microsoftgraph/msgraph-sdk-go.me.planner.plans.item.buckets.item.tasks.item collection
// Parameters:
