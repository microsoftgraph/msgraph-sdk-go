...
// refRequestBuilder builds and executes requests for operations under \me\followedSites\$ref
...
// refRequestBuilderGetQueryParameters get ref of followedSites from me
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/followedSites/$ref{?top,skip,search,filter,count,orderby}";
...
// CreateGetRequestInformation get ref of followedSites from me
...
// CreatePostRequestInformation create new navigation property ref to followedSites for me
...
// Get get ref of followedSites from me
...
// Post create new navigation property ref to followedSites for me
