...
// CalendarViewItemDeclinePostRequestBody 
...
func (m *CalendarViewItemDeclinePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CalendarViewItemDeclinePostRequestBody) SetAdditionalData(value map[string]any)() {
