...
func (m *RevokeSignInSessionsRequestBuilder) Post(ctx context.Context, requestConfiguration *RevokeSignInSessionsRequestBuilderPostRequestConfiguration)(RevokeSignInSessionsResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateRevokeSignInSessionsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *RevokeSignInSessionsRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *RevokeSignInSessionsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
