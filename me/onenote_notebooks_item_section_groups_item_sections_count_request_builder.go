...
// OnenoteNotebooksItemSectionGroupsItemSectionsCountRequestBuilderGetQueryParameters get the number of the resource
type OnenoteNotebooksItemSectionGroupsItemSectionsCountRequestBuilderGetQueryParameters struct {
...
type OnenoteNotebooksItemSectionGroupsItemSectionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *OnenoteNotebooksItemSectionGroupsItemSectionsCountRequestBuilderGetQueryParameters
}
...
func NewOnenoteNotebooksItemSectionGroupsItemSectionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnenoteNotebooksItemSectionGroupsItemSectionsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections/$count{?%24search,%24filter}";
...
func (m *OnenoteNotebooksItemSectionGroupsItemSectionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *OnenoteNotebooksItemSectionGroupsItemSectionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
