...
func (m *JoinedTeamsItemChannelsItemMessagesItemRepliesRequestBuilder) MicrosoftGraphDelta()(*JoinedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewJoinedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
