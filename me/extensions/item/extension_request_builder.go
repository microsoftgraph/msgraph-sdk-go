...
// ExtensionRequestBuilder builds and executes requests for operations under \me\extensions\{extension-id}
...
// ExtensionRequestBuilderGetQueryParameters the collection of open extensions defined for the user. Nullable.
...
func NewExtensionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ExtensionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/extensions/{extension_id}{?select,expand}";
...
// CreateDeleteRequestInformation the collection of open extensions defined for the user. Nullable.
...
// CreatePatchRequestInformation the collection of open extensions defined for the user. Nullable.
...
// Delete the collection of open extensions defined for the user. Nullable.
...
func (m *ExtensionRequestBuilder) Get(options *ExtensionRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Extension, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewExtension() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Extension), nil
}
// Patch the collection of open extensions defined for the user. Nullable.
