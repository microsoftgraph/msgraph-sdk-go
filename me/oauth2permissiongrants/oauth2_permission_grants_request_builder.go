...
func NewOauth2PermissionGrantsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Oauth2PermissionGrantsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/me/oauth2PermissionGrants{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *Oauth2PermissionGrantsRequestBuilder) Ref()(*i758830f1f99d024f12b2370639f1411568455ff584eb1f1bcc19afb1abc25ba2.RefRequestBuilder) {
    return i758830f1f99d024f12b2370639f1411568455ff584eb1f1bcc19afb1abc25ba2.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
