...
// wipeManagedAppRegistrationsByDeviceTagRequestBuilder builds and executes requests for operations under \me\microsoft.graph.wipeManagedAppRegistrationsByDeviceTag
...
type WipeManagedAppRegistrationsByDeviceTagRequestBuilderPostOptions struct {
    // 
    Body *WipeManagedAppRegistrationsByDeviceTagRequestBody;
    // Request headers
    H map[string]string;
    // Request options
