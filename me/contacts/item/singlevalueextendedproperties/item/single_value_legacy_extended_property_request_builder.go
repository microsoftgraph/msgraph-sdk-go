...
// SingleValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \me\contacts\{contact-id}\singleValueExtendedProperties\{singleValueLegacyExtendedProperty-id}
