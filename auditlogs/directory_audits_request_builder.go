...
// ByDirectoryAuditIdString provides operations to manage the directoryAudits property of the microsoft.graph.auditLogRoot entity.
func (m *DirectoryAuditsRequestBuilder) ByDirectoryAuditIdString(directoryAuditId string)(*DirectoryAuditsDirectoryAuditItemRequestBuilder) {
