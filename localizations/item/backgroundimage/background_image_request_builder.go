...
// BackgroundImageRequestBuilder provides operations to manage the media for the organizationalBrandingLocalization entity.
...
func NewBackgroundImageRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BackgroundImageRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/localizations/{organizationalBrandingLocalization_id}/backgroundImage";
