...
// BannerLogoRequestBuilder provides operations to manage the media for the organizationalBrandingLocalization entity.
...
func NewBannerLogoRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BannerLogoRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/localizations/{organizationalBrandingLocalization_id}/bannerLogo";
