...
func NewItemFilesItemVersionsAgreementFileVersionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, agreementFileVersionId *string)(*ItemFilesItemVersionsAgreementFileVersionItemRequestBuilder) {
...
func NewItemFilesItemVersionsAgreementFileVersionItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemFilesItemVersionsAgreementFileVersionItemRequestBuilder) {
    ...
    return NewItemFilesItemVersionsAgreementFileVersionItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
