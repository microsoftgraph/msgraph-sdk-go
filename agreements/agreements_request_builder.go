...
// CreateGetRequestInformationWithRequestConfiguration get entities from agreements
...
// CreatePostRequestInformationWithRequestConfiguration add new entity to agreements
