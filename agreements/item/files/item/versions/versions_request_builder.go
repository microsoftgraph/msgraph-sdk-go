...
import (
    ...
    i4652ba3b481850eb4ace93bda1df96160cf5f6919715d099778d665b67f47294 "github.com/microsoftgraph/msgraph-sdk-go/agreements/item/files/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/agreements/{agreement_id}/files/{agreementFileLocalization_id}/versions{?top,skip,search,filter,count,orderby,select,expand}";
