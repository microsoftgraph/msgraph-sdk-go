...
// DeleteWithResponseHandler delete navigation property acceptances for agreements
...
// PatchWithResponseHandler update the navigation property acceptances in agreements
