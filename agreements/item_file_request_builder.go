...
func NewItemFileRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemFileRequestBuilder) {
    m := &ItemFileRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/agreements/{agreement%2Did}/file{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *ItemFileRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemFileRequestBuilderDeleteRequestConfiguration)([]byte, error) {
...
func (m *ItemFileRequestBuilder) LocalizationsById(id string)(*ItemFileLocalizationsAgreementFileLocalizationItemRequestBuilder) {
    ...
    return NewItemFileLocalizationsAgreementFileLocalizationItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
