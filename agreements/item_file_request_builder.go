...
func (m *ItemFileRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemFileRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemFileRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemFileRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ItemFileRequestBuilder) Localizations()(*ItemFileLocalizationsRequestBuilder) {
    return NewItemFileLocalizationsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemFileRequestBuilder) LocalizationsById(id string)(*ItemFileLocalizationsAgreementFileLocalizationItemRequestBuilder) {
    ...
    return NewItemFileLocalizationsAgreementFileLocalizationItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
