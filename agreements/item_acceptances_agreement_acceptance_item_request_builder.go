...
func (m *ItemAcceptancesAgreementAcceptanceItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemAcceptancesAgreementAcceptanceItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
