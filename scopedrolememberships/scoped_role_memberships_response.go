...
func NewScopedRoleMembershipsResponse()(*ScopedRoleMembershipsResponse) {
    m := &ScopedRoleMembershipsResponse{
    }
...
func (m *ScopedRoleMembershipsResponse) GetValue()([]i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ScopedRoleMembership) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *ScopedRoleMembershipsResponse) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *ScopedRoleMembershipsResponse) IsNil()(bool) {
    return m == nil
}
// Serialize serializes information the current object
func (m *ScopedRoleMembershipsResponse) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
...
func (m *ScopedRoleMembershipsResponse) SetValue(value []i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ScopedRoleMembership)() {
    if m != nil {
        m.value = value
    }
}
