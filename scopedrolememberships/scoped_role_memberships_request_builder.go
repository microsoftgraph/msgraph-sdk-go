...
// Parameters:
//  - options : Options for the request
func (m *ScopedRoleMembershipsRequestBuilder) CreatePostRequestInformation(options *ScopedRoleMembershipsRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ScopedRoleMembershipsRequestBuilder) Get(options *ScopedRoleMembershipsRequestBuilderGetOptions)(*ScopedRoleMembershipsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewScopedRoleMembershipsResponse() }, nil)
    if err != nil {
        return nil, err
    }
...
// Parameters:
//  - options : Options for the request
func (m *ScopedRoleMembershipsRequestBuilder) Post(options *ScopedRoleMembershipsRequestBuilderPostOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ScopedRoleMembership, error) {
