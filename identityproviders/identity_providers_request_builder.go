...
// CreateGetRequestInformationWithRequestConfiguration retrieve all identityProviders in the directory.
...
// GetWithRequestConfigurationAndResponseHandler retrieve all identityProviders in the directory.
