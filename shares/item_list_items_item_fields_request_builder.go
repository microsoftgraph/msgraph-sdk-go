...
func NewItemListItemsItemFieldsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListItemsItemFieldsRequestBuilder) {
    m := &ItemListItemsItemFieldsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/fields{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *ItemListItemsItemFieldsRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemListItemsItemFieldsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
