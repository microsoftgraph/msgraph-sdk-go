...
// GetActivitiesByIntervalRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\items\{listItem-id}\microsoft.graph.getActivitiesByInterval()
...
func NewGetActivitiesByIntervalRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GetActivitiesByIntervalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/items/{listItem_id}/microsoft.graph.getActivitiesByInterval()";
...
func (m *GetActivitiesByIntervalRequestBuilder) Get(options *GetActivitiesByIntervalRequestBuilderGetOptions)([]GetActivitiesByInterval, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGetActivitiesByInterval() }, nil, nil)
    if err != nil {
        return nil, err
    }
