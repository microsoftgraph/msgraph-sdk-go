...
// RestoreVersionRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\items\{listItem-id}\versions\{listItemVersion-id}\microsoft.graph.restoreVersion
