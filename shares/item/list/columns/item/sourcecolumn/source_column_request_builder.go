...
import (
    ...
    i6aa17f55bee72a4ebad7fd3e6edb32dccc114a4d0bc2d1bdac7258a291055d28 "github.com/microsoftgraph/msgraph-sdk-go/shares/item/list/columns/item/sourcecolumn/ref"
)
...
func NewSourceColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SourceColumnRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/list/columns/{columnDefinition_id}/sourceColumn{?select,expand}";
...
func (m *SourceColumnRequestBuilder) Ref()(*i6aa17f55bee72a4ebad7fd3e6edb32dccc114a4d0bc2d1bdac7258a291055d28.RefRequestBuilder) {
    return i6aa17f55bee72a4ebad7fd3e6edb32dccc114a4d0bc2d1bdac7258a291055d28.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
