...
// RefRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\contentTypes\{contentType-id}\columnPositions\$ref
...
// RefRequestBuilderGetQueryParameters column order information in a content type.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/contentTypes/{contentType_id}/columnPositions/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation column order information in a content type.
...
// Post column order information in a content type.
