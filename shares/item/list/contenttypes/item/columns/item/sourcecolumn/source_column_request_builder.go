...
import (
    ...
    i7e49201e7be85ced9bb8f22a9534bfcce3178bf4a7fb10a1c388d5bcb5ca9335 "github.com/microsoftgraph/msgraph-sdk-go/shares/item/list/contenttypes/item/columns/item/sourcecolumn/ref"
)
...
func NewSourceColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SourceColumnRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/list/contentTypes/{contentType_id}/columns/{columnDefinition_id}/sourceColumn{?select,expand}";
...
func (m *SourceColumnRequestBuilder) Ref()(*i7e49201e7be85ced9bb8f22a9534bfcce3178bf4a7fb10a1c388d5bcb5ca9335.RefRequestBuilder) {
    return i7e49201e7be85ced9bb8f22a9534bfcce3178bf4a7fb10a1c388d5bcb5ca9335.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
