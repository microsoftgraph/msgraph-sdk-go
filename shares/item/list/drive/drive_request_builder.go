...
import (
    ...
    i3b63894e87dfb019913422d9decf8f338fe0b7fc3b979335516303bb5bf772b6 "github.com/microsoftgraph/msgraph-sdk-go/shares/item/list/drive/ref"
)

// DriveRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\drive
...
func NewDriveRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/drive{?select,expand}";
...
func (m *DriveRequestBuilder) Ref()(*i3b63894e87dfb019913422d9decf8f338fe0b7fc3b979335516303bb5bf772b6.RefRequestBuilder) {
    return i3b63894e87dfb019913422d9decf8f338fe0b7fc3b979335516303bb5bf772b6.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
