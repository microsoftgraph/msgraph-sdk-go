...
// CreateDeleteRequestInformation used to access the underlying driveItem. Deprecated -- use driveItem instead.
...
// CreatePatchRequestInformation used to access the underlying driveItem. Deprecated -- use driveItem instead.
...
// Delete used to access the underlying driveItem. Deprecated -- use driveItem instead.
...
// Patch used to access the underlying driveItem. Deprecated -- use driveItem instead.
