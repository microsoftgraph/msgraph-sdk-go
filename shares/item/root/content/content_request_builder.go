...
// contentRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\root\content
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/root/content";
...
// CreateGetRequestInformation get media content for the navigation property root from shares
...
// CreatePutRequestInformation update media content for the navigation property root in shares
...
// Get get media content for the navigation property root from shares
...
// Put update media content for the navigation property root in shares
