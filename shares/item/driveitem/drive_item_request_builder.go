...
import (
    ...
    i47d3b89fc748d2e27955c74f78925c790cb5621ba2e51e45317f3596d6385a10 "github.com/microsoftgraph/msgraph-sdk-go/shares/item/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/shares/{sharedDriveItem_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i47d3b89fc748d2e27955c74f78925c790cb5621ba2e51e45317f3596d6385a10.ContentRequestBuilder) {
    return i47d3b89fc748d2e27955c74f78925c790cb5621ba2e51e45317f3596d6385a10.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Used to access the underlying driveItem
// Parameters:
