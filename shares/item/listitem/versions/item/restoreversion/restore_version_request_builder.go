...
// restoreVersionRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\listItem\versions\{listItemVersion-id}\microsoft.graph.restoreVersion
