...
func (m *ItemListSubscriptionsRequestBuilder) Count()(*ItemListSubscriptionsCountRequestBuilder) {
    return NewItemListSubscriptionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the set of subscriptions on the list.
func (m *ItemListSubscriptionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemListSubscriptionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
