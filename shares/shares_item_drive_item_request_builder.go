...
func NewSharesItemDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemDriveItemRequestBuilder) {
    m := &SharesItemDriveItemRequestBuilder{
    }
...
func NewSharesItemDriveItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemDriveItemRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSharesItemDriveItemRequestBuilderInternal(urlParams, requestAdapter)
}
// Content provides operations to manage the media for the sharedDriveItem entity.
func (m *SharesItemDriveItemRequestBuilder) Content()(*SharesItemDriveItemContentRequestBuilder) {
    return NewSharesItemDriveItemContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *SharesItemDriveItemRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SharesItemDriveItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SharesItemDriveItemRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemDriveItemRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveItemable, error) {
