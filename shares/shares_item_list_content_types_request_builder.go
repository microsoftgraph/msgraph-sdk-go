...
func (m *SharesItemListContentTypesRequestBuilder) AddCopy()(*SharesItemListContentTypesAddCopyRequestBuilder) {
    return NewSharesItemListContentTypesAddCopyRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// AddCopyFromContentTypeHub provides operations to call the addCopyFromContentTypeHub method.
func (m *SharesItemListContentTypesRequestBuilder) AddCopyFromContentTypeHub()(*SharesItemListContentTypesAddCopyFromContentTypeHubRequestBuilder) {
    return NewSharesItemListContentTypesAddCopyFromContentTypeHubRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewSharesItemListContentTypesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListContentTypesRequestBuilder) {
    m := &SharesItemListContentTypesRequestBuilder{
    }
...
func NewSharesItemListContentTypesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListContentTypesRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSharesItemListContentTypesRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *SharesItemListContentTypesRequestBuilder) Count()(*SharesItemListContentTypesCountRequestBuilder) {
    return NewSharesItemListContentTypesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get the collection of [contentType][contentType] resources in a [list][].
func (m *SharesItemListContentTypesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SharesItemListContentTypesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SharesItemListContentTypesRequestBuilder) CreatePostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ContentTypeable, requestConfiguration *SharesItemListContentTypesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *SharesItemListContentTypesRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemListContentTypesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ContentTypeCollectionResponseable, error) {
...
func (m *SharesItemListContentTypesRequestBuilder) GetCompatibleHubContentTypes()(*SharesItemListContentTypesGetCompatibleHubContentTypesRequestBuilder) {
    return NewSharesItemListContentTypesGetCompatibleHubContentTypesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Post create new navigation property to contentTypes for shares
func (m *SharesItemListContentTypesRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ContentTypeable, requestConfiguration *SharesItemListContentTypesRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ContentTypeable, error) {
