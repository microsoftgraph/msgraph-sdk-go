...
func NewItemListItemsItemCreatelinkCreateLinkRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListItemsItemCreatelinkCreateLinkRequestBuilder) {
    m := &ItemListItemsItemCreatelinkCreateLinkRequestBuilder{
...
func NewItemListItemsItemCreatelinkCreateLinkRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListItemsItemCreatelinkCreateLinkRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemListItemsItemCreatelinkCreateLinkRequestBuilderInternal(urlParams, requestAdapter)
}
// Post invoke action createLink
// returns a Permissionable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemListItemsItemCreatelinkCreateLinkRequestBuilder) Post(ctx context.Context, body ItemListItemsItemCreatelinkCreateLinkPostRequestBodyable, requestConfiguration *ItemListItemsItemCreatelinkCreateLinkRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Permissionable, error) {
...
func (m *ItemListItemsItemCreatelinkCreateLinkRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemListItemsItemCreatelinkCreateLinkPostRequestBodyable, requestConfiguration *ItemListItemsItemCreatelinkCreateLinkRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemListItemsItemCreatelinkCreateLinkRequestBuilder when successful
func (m *ItemListItemsItemCreatelinkCreateLinkRequestBuilder) WithUrl(rawUrl string)(*ItemListItemsItemCreatelinkCreateLinkRequestBuilder) {
    return NewItemListItemsItemCreatelinkCreateLinkRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
