...
func NewSharesItemListItemsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListItemsCountRequestBuilder) {
    m := &SharesItemListItemsCountRequestBuilder{
    }
...
func NewSharesItemListItemsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListItemsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSharesItemListItemsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *SharesItemListItemsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SharesItemListItemsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SharesItemListItemsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemListItemsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
