...
func (m *VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse) GetAdditionalData()(map[string]any) {
...
func (m *VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse) SetAdditionalData(value map[string]any)() {
