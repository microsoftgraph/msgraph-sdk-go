...
func (m *UserExperienceAnalyticsDevicePerformanceCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsDevicePerformanceCountRequestBuilderGetRequestConfiguration)(*int64, error) {
