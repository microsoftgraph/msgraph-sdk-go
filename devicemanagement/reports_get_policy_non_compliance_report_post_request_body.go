...
// ReportsGetPolicyNonComplianceReportPostRequestBody provides operations to call the getPolicyNonComplianceReport method.
...
func (m *ReportsGetPolicyNonComplianceReportPostRequestBody) GetSelect()([]string) {
...
func (m *ReportsGetPolicyNonComplianceReportPostRequestBody) SetSelect(value []string)() {
