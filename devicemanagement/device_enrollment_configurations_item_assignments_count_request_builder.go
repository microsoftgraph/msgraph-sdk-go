...
func (m *DeviceEnrollmentConfigurationsItemAssignmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceEnrollmentConfigurationsItemAssignmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
