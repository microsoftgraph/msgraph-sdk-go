...
func (m *DeviceCompliancePoliciesItemScheduledActionsForRuleCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceCompliancePoliciesItemScheduledActionsForRuleCountRequestBuilderGetRequestConfiguration)(*int64, error) {
