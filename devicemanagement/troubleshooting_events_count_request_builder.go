...
func (m *TroubleshootingEventsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TroubleshootingEventsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
