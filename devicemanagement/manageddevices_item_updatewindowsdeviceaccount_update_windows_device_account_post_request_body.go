...
func NewManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody()(*ManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody) {
    m := &ManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody) GetUpdateWindowsDeviceAccountActionParameter()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UpdateWindowsDeviceAccountActionParameterable) {
...
func (m *ManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *ManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBody) SetUpdateWindowsDeviceAccountActionParameter(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UpdateWindowsDeviceAccountActionParameterable)() {
    err := m.GetBackingStore().Set("updateWindowsDeviceAccountActionParameter", value)
    if err != nil {
        panic(err)
    }
}
type ManageddevicesItemUpdatewindowsdeviceaccountUpdateWindowsDeviceAccountPostRequestBodyable interface {
