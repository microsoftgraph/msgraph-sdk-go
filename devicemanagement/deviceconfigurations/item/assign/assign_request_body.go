...
func (m *AssignRequestBody) GetAssignments()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DeviceConfigurationAssignmentable) {
    if m == nil {
        return nil
    } else {
...
func (m *AssignRequestBody) SetAssignments(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DeviceConfigurationAssignmentable)() {
    if m != nil {
        m.assignments = value
    }
}
