...
// NewAssign instantiates a new assign and sets the default values.
...
func (m *Assign) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Assign) SetAdditionalData(value map[string]interface{})() {
