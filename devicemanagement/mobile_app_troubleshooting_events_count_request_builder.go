...
func (m *MobileAppTroubleshootingEventsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppTroubleshootingEventsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
