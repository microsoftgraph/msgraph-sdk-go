...
func NewUserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilder) {
    m := &UserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilder{
...
func NewUserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilder) {
    ...
    return NewUserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *UserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UserExperienceAnalyticsCategoryable, error) {
...
func (m *UserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilder) {
    return NewUserexperienceanalyticsbaselinesItemResourceperformancemetricsResourcePerformanceMetricsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
