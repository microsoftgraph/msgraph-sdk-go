...
func (m *UserExperienceAnalyticsDeviceStartupProcessesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsDeviceStartupProcessesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
