...
// DeviceConfigurationStateRequestBuilder builds and executes requests for operations under \deviceManagement\managedDevices\{managedDevice-id}\deviceConfigurationStates\{deviceConfigurationState-id}
