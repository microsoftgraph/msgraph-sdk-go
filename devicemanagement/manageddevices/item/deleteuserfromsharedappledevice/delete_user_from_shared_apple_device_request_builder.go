...
// DeleteUserFromSharedAppleDeviceRequestBuilder builds and executes requests for operations under \deviceManagement\managedDevices\{managedDevice-id}\microsoft.graph.deleteUserFromSharedAppleDevice
