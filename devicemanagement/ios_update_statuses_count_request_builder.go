...
func (m *IosUpdateStatusesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *IosUpdateStatusesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
