...
func (m *ReportsExportJobsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ReportsExportJobsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
