...
func (m *IosupdatestatusesIosUpdateStatusesRequestBuilder) ByIosUpdateDeviceStatusId(iosUpdateDeviceStatusId string)(*IosupdatestatusesIosUpdateDeviceStatusItemRequestBuilder) {
...
func NewIosupdatestatusesIosUpdateStatusesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IosupdatestatusesIosUpdateStatusesRequestBuilder) {
    m := &IosupdatestatusesIosUpdateStatusesRequestBuilder{
...
func NewIosupdatestatusesIosUpdateStatusesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IosupdatestatusesIosUpdateStatusesRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewIosupdatestatusesIosUpdateStatusesRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *IosupdatestatusesCountRequestBuilder when successful
func (m *IosupdatestatusesIosUpdateStatusesRequestBuilder) Count()(*IosupdatestatusesCountRequestBuilder) {
...
func (m *IosupdatestatusesIosUpdateStatusesRequestBuilder) Get(ctx context.Context, requestConfiguration *IosupdatestatusesIosUpdateStatusesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.IosUpdateDeviceStatusCollectionResponseable, error) {
...
func (m *IosupdatestatusesIosUpdateStatusesRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.IosUpdateDeviceStatusable, requestConfiguration *IosupdatestatusesIosUpdateStatusesRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.IosUpdateDeviceStatusable, error) {
...
func (m *IosupdatestatusesIosUpdateStatusesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *IosupdatestatusesIosUpdateStatusesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *IosupdatestatusesIosUpdateStatusesRequestBuilder) ToPostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.IosUpdateDeviceStatusable, requestConfiguration *IosupdatestatusesIosUpdateStatusesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *IosupdatestatusesIosUpdateStatusesRequestBuilder) WithUrl(rawUrl string)(*IosupdatestatusesIosUpdateStatusesRequestBuilder) {
    return NewIosupdatestatusesIosUpdateStatusesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
