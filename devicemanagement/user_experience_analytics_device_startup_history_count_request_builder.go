...
func (m *UserExperienceAnalyticsDeviceStartupHistoryCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsDeviceStartupHistoryCountRequestBuilderGetRequestConfiguration)(*int64, error) {
