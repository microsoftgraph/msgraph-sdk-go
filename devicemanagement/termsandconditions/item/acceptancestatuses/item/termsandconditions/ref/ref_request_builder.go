...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\termsAndConditions\{termsAndConditions-id}\acceptanceStatuses\{termsAndConditionsAcceptanceStatus-id}\termsAndConditions\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions_id}/acceptanceStatuses/{termsAndConditionsAcceptanceStatus_id}/termsAndConditions/$ref";
...
// CreateDeleteRequestInformation navigation link to the terms and conditions that are assigned.
...
// CreatePutRequestInformation navigation link to the terms and conditions that are assigned.
...
// Delete navigation link to the terms and conditions that are assigned.
...
// Put navigation link to the terms and conditions that are assigned.
