...
func (m *ReportsGetDeviceManagementIntentSettingsReportPostRequestBody) GetSelectEscaped()([]string) {
...
func (m *ReportsGetDeviceManagementIntentSettingsReportPostRequestBody) SetSelectEscaped(value []string)() {
