...
func (m *ManagedDevicesItemLogCollectionRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedDevicesItemLogCollectionRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
