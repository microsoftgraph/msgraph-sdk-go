...
func (m *ReportsGetComplianceSettingNonComplianceReportPostRequestBody) GetSelectEscaped()([]string) {
...
func (m *ReportsGetComplianceSettingNonComplianceReportPostRequestBody) SetSelectEscaped(value []string)() {
