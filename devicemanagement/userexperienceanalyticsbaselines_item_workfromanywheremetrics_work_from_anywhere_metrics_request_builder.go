...
func NewUserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilder) {
    m := &UserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilder{
...
func NewUserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilder) {
    ...
    return NewUserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *UserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UserExperienceAnalyticsCategoryable, error) {
...
func (m *UserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilder) {
    return NewUserexperienceanalyticsbaselinesItemWorkfromanywheremetricsWorkFromAnywhereMetricsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
