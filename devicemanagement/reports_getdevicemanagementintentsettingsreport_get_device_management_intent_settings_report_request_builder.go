...
func NewReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportRequestBuilder) {
    m := &ReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportRequestBuilder{
...
func NewReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportRequestBuilder) {
    ...
    return NewReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportRequestBuilder) Post(ctx context.Context, body ReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportPostRequestBodyable, requestConfiguration *ReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportRequestBuilderPostRequestConfiguration)([]byte, error) {
...
func (m *ReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportRequestBuilder) WithUrl(rawUrl string)(*ReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportRequestBuilder) {
    return NewReportsGetdevicemanagementintentsettingsreportGetDeviceManagementIntentSettingsReportRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
