...
func NewRemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilder) {
    m := &RemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilder{
...
func NewRemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilder) {
    ...
    return NewRemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *RemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilder) Post(ctx context.Context, requestConfiguration *RemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilderPostRequestConfiguration)(error) {
...
func (m *RemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *RemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilder) WithUrl(rawUrl string)(*RemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilder) {
    return NewRemoteassistancepartnersItemBeginonboardingBeginOnboardingRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
