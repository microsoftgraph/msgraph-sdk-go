...
// ReportsGetDeviceNonComplianceReportPostRequestBody provides operations to call the getDeviceNonComplianceReport method.
...
func (m *ReportsGetDeviceNonComplianceReportPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ReportsGetDeviceNonComplianceReportPostRequestBody) GetSelect()([]string) {
...
func (m *ReportsGetDeviceNonComplianceReportPostRequestBody) SetAdditionalData(value map[string]interface{})() {
...
func (m *ReportsGetDeviceNonComplianceReportPostRequestBody) SetSelect(value []string)() {
