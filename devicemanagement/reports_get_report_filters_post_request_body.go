...
// ReportsGetReportFiltersPostRequestBody provides operations to call the getReportFilters method.
...
func (m *ReportsGetReportFiltersPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ReportsGetReportFiltersPostRequestBody) GetSelect()([]string) {
...
func (m *ReportsGetReportFiltersPostRequestBody) SetAdditionalData(value map[string]interface{})() {
