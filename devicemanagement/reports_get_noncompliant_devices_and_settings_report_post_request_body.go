...
// ReportsGetNoncompliantDevicesAndSettingsReportPostRequestBody provides operations to call the getNoncompliantDevicesAndSettingsReport method.
...
func (m *ReportsGetNoncompliantDevicesAndSettingsReportPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ReportsGetNoncompliantDevicesAndSettingsReportPostRequestBody) SetAdditionalData(value map[string]interface{})() {
