...
func (m *UserExperienceAnalyticsCategoriesItemMetricValuesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsCategoriesItemMetricValuesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
