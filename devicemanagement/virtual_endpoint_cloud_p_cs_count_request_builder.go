...
func (m *VirtualEndpointCloudPCsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointCloudPCsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
