...
func (m *UserExperienceAnalyticsScoreHistoryCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsScoreHistoryCountRequestBuilderGetRequestConfiguration)(*int64, error) {
