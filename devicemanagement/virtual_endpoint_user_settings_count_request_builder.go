...
func (m *VirtualEndpointUserSettingsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointUserSettingsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
