...
// WindowsAutopilotDeviceIdentitiesItemAssignUserToDevicePostRequestBody provides operations to call the assignUserToDevice method.
...
func (m *WindowsAutopilotDeviceIdentitiesItemAssignUserToDevicePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *WindowsAutopilotDeviceIdentitiesItemAssignUserToDevicePostRequestBody) SetAdditionalData(value map[string]interface{})() {
