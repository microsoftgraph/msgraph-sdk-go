...
func NewUserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilder) {
    m := &UserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilder{
...
func NewUserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilder) {
    ...
    return NewUserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *UserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UserExperienceAnalyticsCategoryable, error) {
...
func (m *UserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilder) {
    return NewUserexperienceanalyticsbaselinesItemDevicebootperformancemetricsDeviceBootPerformanceMetricsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
