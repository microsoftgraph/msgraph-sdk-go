...
func NewNotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*NotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilder) {
    m := &NotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilder{
...
func NewNotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*NotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilder) {
    ...
    return NewNotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *NotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilder) Post(ctx context.Context, requestConfiguration *NotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilderPostRequestConfiguration)(error) {
...
func (m *NotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *NotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *NotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilder) WithUrl(rawUrl string)(*NotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilder) {
    return NewNotificationmessagetemplatesItemSendtestmessageSendTestMessageRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
