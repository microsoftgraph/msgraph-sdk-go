...
func NewManageddevicesItemWindowsdefenderscanWindowsDefenderScanRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManageddevicesItemWindowsdefenderscanWindowsDefenderScanRequestBuilder) {
    m := &ManageddevicesItemWindowsdefenderscanWindowsDefenderScanRequestBuilder{
...
func NewManageddevicesItemWindowsdefenderscanWindowsDefenderScanRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManageddevicesItemWindowsdefenderscanWindowsDefenderScanRequestBuilder) {
    ...
    return NewManageddevicesItemWindowsdefenderscanWindowsDefenderScanRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ManageddevicesItemWindowsdefenderscanWindowsDefenderScanRequestBuilder) Post(ctx context.Context, body ManageddevicesItemWindowsdefenderscanWindowsDefenderScanPostRequestBodyable, requestConfiguration *ManageddevicesItemWindowsdefenderscanWindowsDefenderScanRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ManageddevicesItemWindowsdefenderscanWindowsDefenderScanRequestBuilder) WithUrl(rawUrl string)(*ManageddevicesItemWindowsdefenderscanWindowsDefenderScanRequestBuilder) {
    return NewManageddevicesItemWindowsdefenderscanWindowsDefenderScanRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
