...
// Patch update the properties of a windows10GeneralConfiguration object.
// returns a DeviceConfigurationable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
...
// ToPatchRequestInformation update the properties of a windows10GeneralConfiguration object.
// returns a *RequestInformation when successful
