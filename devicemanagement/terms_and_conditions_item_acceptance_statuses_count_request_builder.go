...
func (m *TermsAndConditionsItemAcceptanceStatusesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TermsAndConditionsItemAcceptanceStatusesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
