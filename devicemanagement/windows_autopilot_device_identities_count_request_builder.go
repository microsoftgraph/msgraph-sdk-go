...
func (m *WindowsAutopilotDeviceIdentitiesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsAutopilotDeviceIdentitiesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
