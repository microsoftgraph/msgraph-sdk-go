...
// ReportsGetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody provides operations to call the getDeviceManagementIntentPerSettingContributingProfiles method.
