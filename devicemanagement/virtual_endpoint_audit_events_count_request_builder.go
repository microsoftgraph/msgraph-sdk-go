...
func (m *VirtualEndpointAuditEventsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointAuditEventsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
