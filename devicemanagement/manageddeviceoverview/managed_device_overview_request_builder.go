...
func (m *ManagedDeviceOverviewRequestBuilder) Get(options *ManagedDeviceOverviewRequestBuilderGetOptions)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ManagedDeviceOverviewable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateManagedDeviceOverviewFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
