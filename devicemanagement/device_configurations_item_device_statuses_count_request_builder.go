...
func (m *DeviceConfigurationsItemDeviceStatusesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceConfigurationsItemDeviceStatusesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
