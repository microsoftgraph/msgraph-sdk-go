...
func NewUserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilder) {
    m := &UserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilder{
...
func NewUserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilder) {
    ...
    return NewUserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *UserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UserExperienceAnalyticsCategoryable, error) {
...
func (m *UserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilder) {
    return NewUserexperienceanalyticsbaselinesItemBatteryhealthmetricsBatteryHealthMetricsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
