...
// DeviceConfigurationsRequestBuilderGetQueryParameters list properties and relationships of the iosCustomConfiguration objects.
...
// Get list properties and relationships of the iosCustomConfiguration objects.
// returns a DeviceConfigurationCollectionResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/intune-deviceconfig-ioscustomconfiguration-list?view=graph-rest-1.0
...
// ToGetRequestInformation list properties and relationships of the iosCustomConfiguration objects.
