...
// DeviceConfigurationsRequestBuilderGetQueryParameters list properties and relationships of the windowsUpdateForBusinessConfiguration objects.
...
// Get list properties and relationships of the windowsUpdateForBusinessConfiguration objects.
...
// Post create a new windows10SecureAssessmentConfiguration object.
// returns a DeviceConfigurationable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/intune-deviceconfig-windows10secureassessmentconfiguration-create?view=graph-rest-1.0
...
// ToGetRequestInformation list properties and relationships of the windowsUpdateForBusinessConfiguration objects.
...
// ToPostRequestInformation create a new windows10SecureAssessmentConfiguration object.
// returns a *RequestInformation when successful
