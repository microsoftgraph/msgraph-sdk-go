...
// DeviceConfigurationsRequestBuilderGetQueryParameters list properties and relationships of the macOSGeneralDeviceConfiguration objects.
...
// Get list properties and relationships of the macOSGeneralDeviceConfiguration objects.
// returns a DeviceConfigurationCollectionResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/intune-deviceconfig-macosgeneraldeviceconfiguration-list?view=graph-rest-1.0
...
// Post create a new windows10CustomConfiguration object.
// returns a DeviceConfigurationable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/intune-deviceconfig-windows10customconfiguration-create?view=graph-rest-1.0
...
// ToGetRequestInformation list properties and relationships of the macOSGeneralDeviceConfiguration objects.
...
// ToPostRequestInformation create a new windows10CustomConfiguration object.
// returns a *RequestInformation when successful
