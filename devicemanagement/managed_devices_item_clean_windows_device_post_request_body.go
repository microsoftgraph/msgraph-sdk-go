...
// ManagedDevicesItemCleanWindowsDevicePostRequestBody provides operations to call the cleanWindowsDevice method.
...
func (m *ManagedDevicesItemCleanWindowsDevicePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ManagedDevicesItemCleanWindowsDevicePostRequestBody) SetAdditionalData(value map[string]interface{})() {
