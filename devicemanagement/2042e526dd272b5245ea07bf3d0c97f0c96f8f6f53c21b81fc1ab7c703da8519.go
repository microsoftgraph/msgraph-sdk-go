...
// CreateApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestgetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestgetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestgetResponse) GetValue()(*string) {
...
func (m *ApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestgetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestgetResponse) SetValue(value *string)() {
    err := m.GetBackingStore().Set("value", value)
    if err != nil {
        panic(err)
    }
}
type ApplePushNotificationCertificateDownloadApplePushNotificationCertificateSigningRequestgetResponseable interface {
