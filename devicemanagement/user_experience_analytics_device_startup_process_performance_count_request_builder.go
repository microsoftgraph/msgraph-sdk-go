...
func (m *UserExperienceAnalyticsDeviceStartupProcessPerformanceCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsDeviceStartupProcessPerformanceCountRequestBuilderGetRequestConfiguration)(*int64, error) {
