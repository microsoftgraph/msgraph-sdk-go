...
func NewVirtualendpointProvisioningpoliciesItemAssignmentsItemAssignedusersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualendpointProvisioningpoliciesItemAssignmentsItemAssignedusersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) {
    m := &VirtualendpointProvisioningpoliciesItemAssignmentsItemAssignedusersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder{
...
func NewVirtualendpointProvisioningpoliciesItemAssignmentsItemAssignedusersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualendpointProvisioningpoliciesItemAssignmentsItemAssignedusersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) {
    ...
    return NewVirtualendpointProvisioningpoliciesItemAssignmentsItemAssignedusersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *VirtualendpointProvisioningpoliciesItemAssignmentsItemAssignedusersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) Count()(*VirtualendpointProvisioningpoliciesItemAssignmentsItemAssignedusersItemServiceprovisioningerrorsCountRequestBuilder) {
...
func (m *VirtualendpointProvisioningpoliciesItemAssignmentsItemAssignedusersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) WithUrl(rawUrl string)(*VirtualendpointProvisioningpoliciesItemAssignmentsItemAssignedusersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) {
    return NewVirtualendpointProvisioningpoliciesItemAssignmentsItemAssignedusersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
