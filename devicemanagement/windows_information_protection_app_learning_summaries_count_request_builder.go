...
func (m *WindowsInformationProtectionAppLearningSummariesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsInformationProtectionAppLearningSummariesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
