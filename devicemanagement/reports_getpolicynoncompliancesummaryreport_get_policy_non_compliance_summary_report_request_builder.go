...
func NewReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilder) {
    m := &ReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilder{
...
func NewReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilder) {
    ...
    return NewReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilder) Post(ctx context.Context, body ReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportPostRequestBodyable, requestConfiguration *ReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilderPostRequestConfiguration)([]byte, error) {
...
func (m *ReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilder) ToPostRequestInformation(ctx context.Context, body ReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportPostRequestBodyable, requestConfiguration *ReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilder) WithUrl(rawUrl string)(*ReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilder) {
    return NewReportsGetpolicynoncompliancesummaryreportGetPolicyNonComplianceSummaryReportRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
