...
// GetSettingNonComplianceReportRequestBody provides operations to call the getSettingNonComplianceReport method.
...
// NewGetSettingNonComplianceReportRequestBody instantiates a new getSettingNonComplianceReportRequestBody and sets the default values.
...
// CreateGetSettingNonComplianceReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetSettingNonComplianceReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetSettingNonComplianceReportRequestBody(), nil
}
...
func (m *GetSettingNonComplianceReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetSettingNonComplianceReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetSettingNonComplianceReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetSettingNonComplianceReportRequestBody) SetSelect(value []string)() {
    if m != nil {
