...
// GetSettingNonComplianceReportRequestBody 
...
func (m *GetSettingNonComplianceReportRequestBody) GetSelect_escaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetSettingNonComplianceReportRequestBody) SetSelect_escaped(value []string)() {
    if m != nil {
