...
func (m *GetConfigurationPolicyNonComplianceSummaryReportRequestBody) GetSelect_escaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigurationPolicyNonComplianceSummaryReportRequestBody) IsNil()(bool) {
    return m == nil
}
...
func (m *GetConfigurationPolicyNonComplianceSummaryReportRequestBody) SetSelect_escaped(value []string)() {
