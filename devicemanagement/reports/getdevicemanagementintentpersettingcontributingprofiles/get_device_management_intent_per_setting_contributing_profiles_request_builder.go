...
func (m *GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body GetDeviceManagementIntentPerSettingContributingProfilesRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action getDeviceManagementIntentPerSettingContributingProfiles
func (m *GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder) PostWithResponseHandler(body GetDeviceManagementIntentPerSettingContributingProfilesRequestBodyable, requestConfiguration *GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilderPostRequestConfiguration)(GetDeviceManagementIntentPerSettingContributingProfilesResponseable, error) {
