...
// GetDeviceManagementIntentPerSettingContributingProfilesRequestBody 
...
func (m *GetDeviceManagementIntentPerSettingContributingProfilesRequestBody) GetSelect_escaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetDeviceManagementIntentPerSettingContributingProfilesRequestBody) SetSelect_escaped(value []string)() {
    if m != nil {
