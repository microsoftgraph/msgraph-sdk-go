...
// GetPolicyNonComplianceMetadataRequestBody provides operations to call the getPolicyNonComplianceMetadata method.
...
// NewGetPolicyNonComplianceMetadataRequestBody instantiates a new getPolicyNonComplianceMetadataRequestBody and sets the default values.
...
// CreateGetPolicyNonComplianceMetadataRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetPolicyNonComplianceMetadataRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetPolicyNonComplianceMetadataRequestBody(), nil
}
...
func (m *GetPolicyNonComplianceMetadataRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetPolicyNonComplianceMetadataRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
