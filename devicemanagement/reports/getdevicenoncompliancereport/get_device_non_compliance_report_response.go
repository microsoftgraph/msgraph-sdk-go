...
func NewGetDeviceNonComplianceReportResponse()(*GetDeviceNonComplianceReportResponse) {
    m := &GetDeviceNonComplianceReportResponse{
    }
...
func CreateGetDeviceNonComplianceReportResponseFromDiscriminatorValue(parseNode i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable, error) {
    return NewGetDeviceNonComplianceReportResponse(), nil
}
...
func (m *GetDeviceNonComplianceReportResponse) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *GetDeviceNonComplianceReportResponse) GetValue()([]byte) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *GetDeviceNonComplianceReportResponse) IsNil()(bool) {
    return m == nil
}
// Serialize serializes information the current object
func (m *GetDeviceNonComplianceReportResponse) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
