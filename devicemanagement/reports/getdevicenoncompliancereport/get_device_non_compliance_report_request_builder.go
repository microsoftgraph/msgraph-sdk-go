...
// GetDeviceNonComplianceReportRequestBuilder builds and executes requests for operations under \deviceManagement\reports\microsoft.graph.getDeviceNonComplianceReport
