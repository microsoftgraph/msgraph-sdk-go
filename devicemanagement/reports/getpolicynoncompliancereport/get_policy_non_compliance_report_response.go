...
func NewGetPolicyNonComplianceReportResponse()(*GetPolicyNonComplianceReportResponse) {
    m := &GetPolicyNonComplianceReportResponse{
    }
...
func CreateGetPolicyNonComplianceReportResponseFromDiscriminatorValue(parseNode i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable, error) {
    return NewGetPolicyNonComplianceReportResponse(), nil
}
...
func (m *GetPolicyNonComplianceReportResponse) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *GetPolicyNonComplianceReportResponse) GetValue()([]byte) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *GetPolicyNonComplianceReportResponse) IsNil()(bool) {
    return m == nil
}
// Serialize serializes information the current object
func (m *GetPolicyNonComplianceReportResponse) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
