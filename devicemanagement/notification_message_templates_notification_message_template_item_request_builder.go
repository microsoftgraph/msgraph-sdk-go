...
func NewNotificationMessageTemplatesNotificationMessageTemplateItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, notificationMessageTemplateId *string)(*NotificationMessageTemplatesNotificationMessageTemplateItemRequestBuilder) {
    ...
    if notificationMessageTemplateId != nil {
...
func NewNotificationMessageTemplatesNotificationMessageTemplateItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*NotificationMessageTemplatesNotificationMessageTemplateItemRequestBuilder) {
    ...
    return NewNotificationMessageTemplatesNotificationMessageTemplateItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *NotificationMessageTemplatesNotificationMessageTemplateItemRequestBuilder) LocalizedNotificationMessagesById(id string)(*NotificationMessageTemplatesItemLocalizedNotificationMessagesLocalizedNotificationMessageItemRequestBuilder) {
    ...
    idPtr := &id
    return NewNotificationMessageTemplatesItemLocalizedNotificationMessagesLocalizedNotificationMessageItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
// MicrosoftGraphSendTestMessage provides operations to call the sendTestMessage method.
func (m *NotificationMessageTemplatesNotificationMessageTemplateItemRequestBuilder) MicrosoftGraphSendTestMessage()(*NotificationMessageTemplatesItemMicrosoftGraphSendTestMessageSendTestMessageRequestBuilder) {
    return NewNotificationMessageTemplatesItemMicrosoftGraphSendTestMessageSendTestMessageRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
