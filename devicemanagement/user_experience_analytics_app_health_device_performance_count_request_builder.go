...
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilderGetRequestConfiguration)(*int64, error) {
