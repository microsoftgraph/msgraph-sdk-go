...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\softwareUpdateStatusSummary\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/softwareUpdateStatusSummary/$ref";
...
// CreateDeleteRequestInformation the software update status summary.
...
// CreatePutRequestInformation the software update status summary.
...
// Delete the software update status summary.
...
// Put the software update status summary.
