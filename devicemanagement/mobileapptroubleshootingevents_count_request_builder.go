...
func NewMobileapptroubleshootingeventsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileapptroubleshootingeventsCountRequestBuilder) {
    m := &MobileapptroubleshootingeventsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewMobileapptroubleshootingeventsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileapptroubleshootingeventsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewMobileapptroubleshootingeventsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *MobileapptroubleshootingeventsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileapptroubleshootingeventsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *MobileapptroubleshootingeventsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *MobileapptroubleshootingeventsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *MobileapptroubleshootingeventsCountRequestBuilder) WithUrl(rawUrl string)(*MobileapptroubleshootingeventsCountRequestBuilder) {
    return NewMobileapptroubleshootingeventsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
