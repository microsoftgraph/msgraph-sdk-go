...
func (m *SyncRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body SyncRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreatePostRequestInformationWithRequestConfiguration(body, nil);
}
// CreatePostRequestInformationWithRequestConfiguration invoke action sync
func (m *SyncRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body SyncRequestBodyable, requestConfiguration *SyncRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action sync
func (m *SyncRequestBuilder) PostWithResponseHandler(body SyncRequestBodyable, requestConfiguration *SyncRequestBuilderPostRequestConfiguration)(error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action sync
func (m *SyncRequestBuilder) PostWithResponseHandler(body SyncRequestBodyable, requestConfiguration *SyncRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
