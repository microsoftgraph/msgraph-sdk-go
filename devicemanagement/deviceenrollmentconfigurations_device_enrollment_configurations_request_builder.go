...
// DeviceenrollmentconfigurationsDeviceEnrollmentConfigurationsRequestBuilderGetQueryParameters list properties and relationships of the deviceEnrollmentConfiguration objects.
