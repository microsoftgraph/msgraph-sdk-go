...
type RemovePasswordRequestBuilderPostOptions struct {
    // 
    Body RemovePasswordRequestBodyable;
    // Request headers
...
func NewRemovePasswordRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RemovePasswordRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/applications/{application_id}/microsoft.graph.removePassword";
...
func (m *RemovePasswordRequestBuilder) CreatePostRequestInformation(options *RemovePasswordRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
