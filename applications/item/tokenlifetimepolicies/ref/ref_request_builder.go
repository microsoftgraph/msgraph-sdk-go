...
// RefRequestBuilder builds and executes requests for operations under \applications\{application-id}\tokenLifetimePolicies\$ref
...
// RefRequestBuilderGetQueryParameters the tokenLifetimePolicies assigned to this application. Supports $expand.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/applications/{application_id}/tokenLifetimePolicies/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the tokenLifetimePolicies assigned to this application. Supports $expand.
...
// Post the tokenLifetimePolicies assigned to this application. Supports $expand.
