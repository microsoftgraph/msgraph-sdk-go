...
// UnsetVerifiedPublisherRequestBuilderPostOptions options for Post
...
func NewUnsetVerifiedPublisherRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UnsetVerifiedPublisherRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/applications/{application_id}/microsoft.graph.unsetVerifiedPublisher";
...
func (m *UnsetVerifiedPublisherRequestBuilder) CreatePostRequestInformation(options *UnsetVerifiedPublisherRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
