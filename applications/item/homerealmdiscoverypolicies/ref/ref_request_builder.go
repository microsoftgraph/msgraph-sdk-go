...
// RefRequestBuilder builds and executes requests for operations under \applications\{application-id}\homeRealmDiscoveryPolicies\$ref
...
// RefRequestBuilderGetQueryParameters get ref of homeRealmDiscoveryPolicies from applications
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/applications/{application_id}/homeRealmDiscoveryPolicies/$ref{?top,skip,search,filter,count,orderby}";
...
// CreateGetRequestInformation get ref of homeRealmDiscoveryPolicies from applications
...
// CreatePostRequestInformation create new navigation property ref to homeRealmDiscoveryPolicies for applications
...
// Get get ref of homeRealmDiscoveryPolicies from applications
...
// Post create new navigation property ref to homeRealmDiscoveryPolicies for applications
