...
// GetMemberGroupsRequestBuilder builds and executes requests for operations under \applications\{application-id}\microsoft.graph.getMemberGroups
...
func NewGetMemberGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GetMemberGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/applications/{application_id}/microsoft.graph.getMemberGroups";
