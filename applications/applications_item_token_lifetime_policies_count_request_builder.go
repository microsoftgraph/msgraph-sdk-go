...
func NewApplicationsItemTokenLifetimePoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenLifetimePoliciesCountRequestBuilder) {
    m := &ApplicationsItemTokenLifetimePoliciesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/applications/{application%2Did}/tokenLifetimePolicies/$count";
...
func NewApplicationsItemTokenLifetimePoliciesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenLifetimePoliciesCountRequestBuilder) {
    ...
    return NewApplicationsItemTokenLifetimePoliciesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *ApplicationsItemTokenLifetimePoliciesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemTokenLifetimePoliciesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemTokenLifetimePoliciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsItemTokenLifetimePoliciesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
