...
func NewApplicationsItemTokenIssuancePoliciesItemRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenIssuancePoliciesItemRefRequestBuilder) {
    m := &ApplicationsItemTokenIssuancePoliciesItemRefRequestBuilder{
    }
...
func NewApplicationsItemTokenIssuancePoliciesItemRefRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenIssuancePoliciesItemRefRequestBuilder) {
    ...
    return NewApplicationsItemTokenIssuancePoliciesItemRefRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateDeleteRequestInformation delete ref of navigation property tokenIssuancePolicies for applications
func (m *ApplicationsItemTokenIssuancePoliciesItemRefRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemTokenIssuancePoliciesItemRefRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemTokenIssuancePoliciesItemRefRequestBuilder) Delete(ctx context.Context, requestConfiguration *ApplicationsItemTokenIssuancePoliciesItemRefRequestBuilderDeleteRequestConfiguration)(error) {
