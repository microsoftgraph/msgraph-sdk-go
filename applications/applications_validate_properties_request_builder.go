...
func NewApplicationsValidatePropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsValidatePropertiesRequestBuilder) {
    m := &ApplicationsValidatePropertiesRequestBuilder{
    }
...
func NewApplicationsValidatePropertiesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsValidatePropertiesRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewApplicationsValidatePropertiesRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ApplicationsValidatePropertiesRequestBuilder) CreatePostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ApplicationsValidatePropertiesPostRequestBodyable, requestConfiguration *ApplicationsValidatePropertiesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsValidatePropertiesRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ApplicationsValidatePropertiesPostRequestBodyable, requestConfiguration *ApplicationsValidatePropertiesRequestBuilderPostRequestConfiguration)(error) {
