...
func NewApplicationsItemTokenLifetimePoliciesRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenLifetimePoliciesRefRequestBuilder) {
    m := &ApplicationsItemTokenLifetimePoliciesRefRequestBuilder{
    }
...
func NewApplicationsItemTokenLifetimePoliciesRefRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenLifetimePoliciesRefRequestBuilder) {
    ...
    return NewApplicationsItemTokenLifetimePoliciesRefRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation list the tokenLifetimePolicy objects that are assigned to an application.
func (m *ApplicationsItemTokenLifetimePoliciesRefRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemTokenLifetimePoliciesRefRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemTokenLifetimePoliciesRefRequestBuilder) CreatePostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ReferenceCreateable, requestConfiguration *ApplicationsItemTokenLifetimePoliciesRefRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ApplicationsItemTokenLifetimePoliciesRefRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsItemTokenLifetimePoliciesRefRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.StringCollectionResponseable, error) {
...
func (m *ApplicationsItemTokenLifetimePoliciesRefRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ReferenceCreateable, requestConfiguration *ApplicationsItemTokenLifetimePoliciesRefRequestBuilderPostRequestConfiguration)(error) {
