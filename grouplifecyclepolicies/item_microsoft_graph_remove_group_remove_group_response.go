...
func NewItemMicrosoftGraphRemoveGroupRemoveGroupResponse()(*ItemMicrosoftGraphRemoveGroupRemoveGroupResponse) {
    m := &ItemMicrosoftGraphRemoveGroupRemoveGroupResponse{
    }
...
func CreateItemMicrosoftGraphRemoveGroupRemoveGroupResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemMicrosoftGraphRemoveGroupRemoveGroupResponse(), nil
}
...
func (m *ItemMicrosoftGraphRemoveGroupRemoveGroupResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemMicrosoftGraphRemoveGroupRemoveGroupResponse) GetValue()(*bool) {
    return m.value
}
// Serialize serializes information the current object
func (m *ItemMicrosoftGraphRemoveGroupRemoveGroupResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemMicrosoftGraphRemoveGroupRemoveGroupResponse) SetValue(value *bool)() {
    m.value = value
}
