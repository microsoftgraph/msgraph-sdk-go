...
// ItemRemoveGroupResponse provides operations to call the removeGroup method.
...
func (m *ItemRemoveGroupResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemRemoveGroupResponse) SetAdditionalData(value map[string]interface{})() {
