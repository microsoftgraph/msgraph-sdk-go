...
// GetWithRequestConfigurationAndResponseHandler list all the groupLifecyclePolicies.
...
// PostWithRequestConfigurationAndResponseHandler creates a new groupLifecyclePolicy.
