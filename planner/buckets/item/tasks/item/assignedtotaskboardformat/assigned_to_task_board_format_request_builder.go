...
// AssignedToTaskBoardFormatRequestBuilder builds and executes requests for operations under \planner\buckets\{plannerBucket-id}\tasks\{plannerTask-id}\assignedToTaskBoardFormat
...
func NewAssignedToTaskBoardFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AssignedToTaskBoardFormatRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/planner/buckets/{plannerBucket_id}/tasks/{plannerTask_id}/assignedToTaskBoardFormat{?select,expand}";
