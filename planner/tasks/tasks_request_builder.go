...
// TasksRequestBuilder builds and executes requests for operations under \planner\tasks
...
// CreatePostRequestInformation read-only. Nullable. Returns a collection of the specified tasks
...
// Post read-only. Nullable. Returns a collection of the specified tasks
