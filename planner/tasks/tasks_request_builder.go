...
// CreateGetRequestInformationWithRequestConfiguration retrieve a list of **plannertask** objects.
...
// CreatePostRequestInformationWithRequestConfiguration create a new **plannerTask**.
