...
// BucketTaskBoardFormatRequestBuilder builds and executes requests for operations under \planner\plans\{plannerPlan-id}\tasks\{plannerTask-id}\bucketTaskBoardFormat
...
func (m *BucketTaskBoardFormatRequestBuilder) Get(options *BucketTaskBoardFormatRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.PlannerBucketTaskBoardTaskFormat, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewPlannerBucketTaskBoardTaskFormat() }, nil, nil)
    if err != nil {
        return nil, err
    }
