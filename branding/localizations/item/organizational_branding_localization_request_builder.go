...
// OrganizationalBrandingLocalizationRequestBuilder builds and executes requests for operations under \branding\localizations\{organizationalBrandingLocalization-id}
...
type OrganizationalBrandingLocalizationRequestBuilderGetOptions struct {
    ...
    Q *OrganizationalBrandingLocalizationRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
// OrganizationalBrandingLocalizationRequestBuilderGetQueryParameters add different branding based on a locale.
