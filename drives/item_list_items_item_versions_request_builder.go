...
func NewItemListItemsItemVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListItemsItemVersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemListItemsItemVersionsRequestBuilder) Count()(*ItemListItemsItemVersionsCountRequestBuilder) {
    return NewItemListItemsItemVersionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemListItemsItemVersionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemListItemsItemVersionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
