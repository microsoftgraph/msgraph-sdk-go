...
// ItemItemsItemWorkbookWorksheetsRequestBuilderGetQueryParameters retrieve a list of worksheet objects.
...
func NewItemItemsItemWorkbookWorksheetsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemItemsItemWorkbookWorksheetsRequestBuilder instantiates a new WorksheetsRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookWorksheetsRequestBuilder) Count()(*ItemItemsItemWorkbookWorksheetsCountRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemItemsItemWorkbookWorksheetsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookWorksheetsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.WorkbookWorksheetCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateWorkbookWorksheetCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemItemsItemWorkbookWorksheetsRequestBuilder) MicrosoftGraphAdd()(*ItemItemsItemWorkbookWorksheetsMicrosoftGraphAddAddRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// ToGetRequestInformation retrieve a list of worksheet objects.
