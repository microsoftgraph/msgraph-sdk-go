...
// SharedWithMeRequestBuilder builds and executes requests for operations under \drives\{drive-id}\microsoft.graph.sharedWithMe()
...
// SharedWithMeRequestBuilderGetOptions options for Get
type SharedWithMeRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
func (m *SharedWithMeRequestBuilder) CreateGetRequestInformation(options *SharedWithMeRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *SharedWithMeRequestBuilder) Get(options *SharedWithMeRequestBuilderGetOptions)([]SharedWithMe, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewSharedWithMe() }, nil, nil)
    if err != nil {
        return nil, err
    }
