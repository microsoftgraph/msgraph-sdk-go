...
import (
    ...
    ia6996a87969a2ca3792da9bce21825f510a9c7fee4f61ded238c14e674378d0c "github.com/microsoftgraph/msgraph-sdk-go/drives/item/following/count"
)
...
func NewFollowingRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FollowingRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/following{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *FollowingRequestBuilder) Count()(*ia6996a87969a2ca3792da9bce21825f510a9c7fee4f61ded238c14e674378d0c.CountRequestBuilder) {
    return ia6996a87969a2ca3792da9bce21825f510a9c7fee4f61ded238c14e674378d0c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to following for drives
...
// Post create new navigation property to following for drives
