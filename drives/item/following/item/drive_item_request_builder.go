...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/drives/{drive_id}/following/{driveItem_id}{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i3811e7083d98f3346aeb13b52f6b1cd47f750c3344259843eed30986fe674956.ContentRequestBuilder) {
