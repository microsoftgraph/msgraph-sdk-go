...
import (
    ...
    id7331969d511c6d5e41806e87f38d3eff1f17bb702f9b00523154f53aa40cd7e "github.com/microsoftgraph/msgraph-sdk-go/drives/item/following/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/following/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*id7331969d511c6d5e41806e87f38d3eff1f17bb702f9b00523154f53aa40cd7e.CountRequestBuilder) {
    return id7331969d511c6d5e41806e87f38d3eff1f17bb702f9b00523154f53aa40cd7e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
