...
import (
    ...
    i867b299989dfc717868e9452264e8144339141eaabb0f7816cbab8eb4a6daf30 "github.com/microsoftgraph/msgraph-sdk-go/drives/item/list/columns/item/sourcecolumn/ref"
)

// SourceColumnRequestBuilder builds and executes requests for operations under \drives\{drive-id}\list\columns\{columnDefinition-id}\sourceColumn
...
func NewSourceColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SourceColumnRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/list/columns/{columnDefinition_id}/sourceColumn{?select,expand}";
...
func (m *SourceColumnRequestBuilder) Ref()(*i867b299989dfc717868e9452264e8144339141eaabb0f7816cbab8eb4a6daf30.RefRequestBuilder) {
    return i867b299989dfc717868e9452264e8144339141eaabb0f7816cbab8eb4a6daf30.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
