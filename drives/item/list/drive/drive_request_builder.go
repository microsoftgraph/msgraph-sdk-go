...
import (
    ...
    i96bdb12c9cb8cf4332762697f2575eea51ca8ab5364de657edb43f06a6cfbe95 "github.com/microsoftgraph/msgraph-sdk-go/drives/item/list/drive/ref"
)

// DriveRequestBuilder builds and executes requests for operations under \drives\{drive-id}\list\drive
...
func NewDriveRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/list/drive{?select,expand}";
...
func (m *DriveRequestBuilder) Ref()(*i96bdb12c9cb8cf4332762697f2575eea51ca8ab5364de657edb43f06a6cfbe95.RefRequestBuilder) {
    return i96bdb12c9cb8cf4332762697f2575eea51ca8ab5364de657edb43f06a6cfbe95.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
