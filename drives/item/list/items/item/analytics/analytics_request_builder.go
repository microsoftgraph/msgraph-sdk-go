...
import (
    ...
    ibcd5a9f4f71fb0cec23f4c7e2643e0e52c30ec66e45dec9323dedb300b821973 "github.com/microsoftgraph/msgraph-sdk-go/drives/item/list/items/item/analytics/ref"
)

// AnalyticsRequestBuilder builds and executes requests for operations under \drives\{drive-id}\list\items\{listItem-id}\analytics
...
func NewAnalyticsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AnalyticsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/list/items/{listItem_id}/analytics{?select,expand}";
...
func (m *AnalyticsRequestBuilder) Get(options *AnalyticsRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ItemAnalytics, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewItemAnalytics() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.ItemAnalytics), nil
}
func (m *AnalyticsRequestBuilder) Ref()(*ibcd5a9f4f71fb0cec23f4c7e2643e0e52c30ec66e45dec9323dedb300b821973.RefRequestBuilder) {
    return ibcd5a9f4f71fb0cec23f4c7e2643e0e52c30ec66e45dec9323dedb300b821973.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
