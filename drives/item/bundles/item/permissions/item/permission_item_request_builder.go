...
import (
    ...
    ia18a86d917fce6071be5e0e7c24c71df7710021ab810c062eb8036dcc1122e40 "github.com/microsoftgraph/msgraph-sdk-go/drives/item/bundles/item/permissions/item/grant"
)
...
func NewPermissionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/permissions/{permission_id}{?select,expand}";
...
func (m *PermissionItemRequestBuilder) Grant()(*ia18a86d917fce6071be5e0e7c24c71df7710021ab810c062eb8036dcc1122e40.GrantRequestBuilder) {
    return ia18a86d917fce6071be5e0e7c24c71df7710021ab810c062eb8036dcc1122e40.NewGrantRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
