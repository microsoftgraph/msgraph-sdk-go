...
import (
    ...
    i6fc96b5c35d0251b774104ee463b8f435b24067c093fdb736ac07a8142fed207 "github.com/microsoftgraph/msgraph-sdk-go/drives/item/bundles/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*i6fc96b5c35d0251b774104ee463b8f435b24067c093fdb736ac07a8142fed207.CountRequestBuilder) {
    return i6fc96b5c35d0251b774104ee463b8f435b24067c093fdb736ac07a8142fed207.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
