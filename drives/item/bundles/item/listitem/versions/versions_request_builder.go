...
import (
    ...
    i7b316afcb5db5ac755d61b67bdf593b708de07b792ee83514128a73d8895c4dd "github.com/microsoftgraph/msgraph-sdk-go/drives/item/bundles/item/listitem/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/listItem/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*i7b316afcb5db5ac755d61b67bdf593b708de07b792ee83514128a73d8895c4dd.CountRequestBuilder) {
    return i7b316afcb5db5ac755d61b67bdf593b708de07b792ee83514128a73d8895c4dd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
