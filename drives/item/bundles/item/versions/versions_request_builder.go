...
import (
    ...
    i544e583385d9d05a41034683c3ac0d37f31c8531a16c1b8b103f55420b897888 "github.com/microsoftgraph/msgraph-sdk-go/drives/item/bundles/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*i544e583385d9d05a41034683c3ac0d37f31c8531a16c1b8b103f55420b897888.CountRequestBuilder) {
    return i544e583385d9d05a41034683c3ac0d37f31c8531a16c1b8b103f55420b897888.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
