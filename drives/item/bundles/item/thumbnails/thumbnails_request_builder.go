...
import (
    ...
    id422e5d991c485a6c73c2db19927814c1c8d8c9be368e7e2f53fc7ae4d65669c "github.com/microsoftgraph/msgraph-sdk-go/drives/item/bundles/item/thumbnails/count"
)
...
func NewThumbnailsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ThumbnailsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/thumbnails{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ThumbnailsRequestBuilder) Count()(*id422e5d991c485a6c73c2db19927814c1c8d8c9be368e7e2f53fc7ae4d65669c.CountRequestBuilder) {
    return id422e5d991c485a6c73c2db19927814c1c8d8c9be368e7e2f53fc7ae4d65669c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
