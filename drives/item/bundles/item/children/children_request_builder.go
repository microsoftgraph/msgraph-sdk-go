...
import (
    ...
    i0c8667ec1a71e018b61612d4054d2a7d44911eae60b562b8951e0a06a9c59d42 "github.com/microsoftgraph/msgraph-sdk-go/drives/item/bundles/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i0c8667ec1a71e018b61612d4054d2a7d44911eae60b562b8951e0a06a9c59d42.CountRequestBuilder) {
    return i0c8667ec1a71e018b61612d4054d2a7d44911eae60b562b8951e0a06a9c59d42.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
