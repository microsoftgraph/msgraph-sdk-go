...
import (
    ...
    i916562fdb7fe8a9f0b8368df4cd076d5f819afa02e90a0e8b9c0cf2dceaf9f40 "github.com/microsoftgraph/msgraph-sdk-go/drives/item/root/listitem/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/root/listItem/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i916562fdb7fe8a9f0b8368df4cd076d5f819afa02e90a0e8b9c0cf2dceaf9f40.ContentRequestBuilder) {
    return i916562fdb7fe8a9f0b8368df4cd076d5f819afa02e90a0e8b9c0cf2dceaf9f40.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
