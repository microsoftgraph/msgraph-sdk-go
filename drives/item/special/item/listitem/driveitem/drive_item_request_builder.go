...
import (
    ...
    id2b3506c0697d7d2743d1e1bab20bedf47ee2a63b923d05d7d476c7ab8533101 "github.com/microsoftgraph/msgraph-sdk-go/drives/item/special/item/listitem/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/special/{driveItem_id}/listItem/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*id2b3506c0697d7d2743d1e1bab20bedf47ee2a63b923d05d7d476c7ab8533101.ContentRequestBuilder) {
    return id2b3506c0697d7d2743d1e1bab20bedf47ee2a63b923d05d7d476c7ab8533101.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
