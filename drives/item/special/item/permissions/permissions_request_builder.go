...
import (
    ...
    ifee2a127b5477a0d6870c934b511ff91269f32488d82586ec7e59e9bb2165f31 "github.com/microsoftgraph/msgraph-sdk-go/drives/item/special/item/permissions/count"
)
...
func NewPermissionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/special/{driveItem_id}/permissions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PermissionsRequestBuilder) Count()(*ifee2a127b5477a0d6870c934b511ff91269f32488d82586ec7e59e9bb2165f31.CountRequestBuilder) {
    return ifee2a127b5477a0d6870c934b511ff91269f32488d82586ec7e59e9bb2165f31.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
