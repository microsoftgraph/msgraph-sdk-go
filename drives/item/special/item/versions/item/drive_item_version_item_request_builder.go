...
import (
    ...
    i893966c86bdd9a45bcdeca018d5810b4a0890645facbedaccc4dab31d86ebcbe "github.com/microsoftgraph/msgraph-sdk-go/drives/item/special/item/versions/item/restoreversion"
    ie356bf79ff75f316aa72d393af3dee6e2c1e8f1397fb8f242377e80e19d7538d "github.com/microsoftgraph/msgraph-sdk-go/drives/item/special/item/versions/item/content"
)
...
func NewDriveItemVersionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemVersionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/special/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
...
func (m *DriveItemVersionItemRequestBuilder) Content()(*ie356bf79ff75f316aa72d393af3dee6e2c1e8f1397fb8f242377e80e19d7538d.ContentRequestBuilder) {
    return ie356bf79ff75f316aa72d393af3dee6e2c1e8f1397fb8f242377e80e19d7538d.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DriveItemVersionItemRequestBuilder) RestoreVersion()(*i893966c86bdd9a45bcdeca018d5810b4a0890645facbedaccc4dab31d86ebcbe.RestoreVersionRequestBuilder) {
    return i893966c86bdd9a45bcdeca018d5810b4a0890645facbedaccc4dab31d86ebcbe.NewRestoreVersionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
