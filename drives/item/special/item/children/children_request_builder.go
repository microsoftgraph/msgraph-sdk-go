...
import (
    ...
    i9d0589e766393dcdd8de0065f0c42fef950ec747824f01237a310915825ed997 "github.com/microsoftgraph/msgraph-sdk-go/drives/item/special/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/special/{driveItem_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i9d0589e766393dcdd8de0065f0c42fef950ec747824f01237a310915825ed997.CountRequestBuilder) {
    return i9d0589e766393dcdd8de0065f0c42fef950ec747824f01237a310915825ed997.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
