...
// ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody 
type ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody instantiates a new ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody()(*ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody) {
    m := &ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody) GetDegFreedom()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable) {
...
func (m *ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody) GetProbability()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable) {
...
func (m *ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody) SetDegFreedom(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable)() {
...
func (m *ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBody) SetProbability(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable)() {
    err := m.GetBackingStore().Set("probability", value)
    if err != nil {
        panic(err)
    }
}
// ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBodyable 
type ItemItemsItemWorkbookFunctionsChiSq_InvPostRequestBodyable interface {
