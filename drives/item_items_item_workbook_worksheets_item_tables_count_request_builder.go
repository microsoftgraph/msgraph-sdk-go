...
// ItemItemsItemWorkbookWorksheetsItemTablesCountRequestBuilder provides operations to count the resources in the collection.
...
// ItemItemsItemWorkbookWorksheetsItemTablesCountRequestBuilderGetQueryParameters get the number of the resource
type ItemItemsItemWorkbookWorksheetsItemTablesCountRequestBuilderGetQueryParameters struct {
...
type ItemItemsItemWorkbookWorksheetsItemTablesCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemItemsItemWorkbookWorksheetsItemTablesCountRequestBuilderGetQueryParameters
}
// NewItemItemsItemWorkbookWorksheetsItemTablesCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookWorksheetsItemTablesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemTablesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/$count{?%24search,%24filter}";
...
// NewItemItemsItemWorkbookWorksheetsItemTablesCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookWorksheetsItemTablesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
