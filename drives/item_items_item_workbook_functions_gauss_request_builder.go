...
// NewItemItemsItemWorkbookFunctionsGaussRequestBuilderInternal instantiates a new GaussRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookFunctionsGaussRequestBuilder instantiates a new GaussRequestBuilder and sets the default values.
