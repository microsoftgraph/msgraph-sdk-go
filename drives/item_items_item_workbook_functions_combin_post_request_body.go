...
// ItemItemsItemWorkbookFunctionsCombinPostRequestBody 
type ItemItemsItemWorkbookFunctionsCombinPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookFunctionsCombinPostRequestBody instantiates a new ItemItemsItemWorkbookFunctionsCombinPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookFunctionsCombinPostRequestBody()(*ItemItemsItemWorkbookFunctionsCombinPostRequestBody) {
    m := &ItemItemsItemWorkbookFunctionsCombinPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookFunctionsCombinPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookFunctionsCombinPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemsItemWorkbookFunctionsCombinPostRequestBody) GetNumber()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable) {
...
func (m *ItemItemsItemWorkbookFunctionsCombinPostRequestBody) GetNumberChosen()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable) {
...
func (m *ItemItemsItemWorkbookFunctionsCombinPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookFunctionsCombinPostRequestBody) SetNumber(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable)() {
...
func (m *ItemItemsItemWorkbookFunctionsCombinPostRequestBody) SetNumberChosen(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable)() {
    err := m.GetBackingStore().Set("numberChosen", value)
    if err != nil {
        panic(err)
    }
}
// ItemItemsItemWorkbookFunctionsCombinPostRequestBodyable 
type ItemItemsItemWorkbookFunctionsCombinPostRequestBodyable interface {
