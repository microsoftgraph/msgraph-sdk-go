...
// NewItemItemsItemWorkbookFunctionsTanhRequestBuilderInternal instantiates a new TanhRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookFunctionsTanhRequestBuilder instantiates a new TanhRequestBuilder and sets the default values.
