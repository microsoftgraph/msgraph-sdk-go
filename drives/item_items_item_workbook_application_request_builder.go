...
func (m *ItemItemsItemWorkbookApplicationRequestBuilder) MicrosoftGraphCalculate()(*ItemItemsItemWorkbookApplicationMicrosoftGraphCalculateCalculateRequestBuilder) {
    return NewItemItemsItemWorkbookApplicationMicrosoftGraphCalculateCalculateRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
