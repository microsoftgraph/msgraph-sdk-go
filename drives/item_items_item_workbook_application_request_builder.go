...
func (m *ItemItemsItemWorkbookApplicationRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookApplicationRequestBuilderDeleteRequestConfiguration)([]byte, error) {
