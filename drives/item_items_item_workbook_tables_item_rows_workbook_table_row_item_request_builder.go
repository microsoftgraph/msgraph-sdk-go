...
func NewItemItemsItemWorkbookTablesItemRowsWorkbookTableRowItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, workbookTableRowId *string)(*ItemItemsItemWorkbookTablesItemRowsWorkbookTableRowItemRequestBuilder) {
    m := &ItemItemsItemWorkbookTablesItemRowsWorkbookTableRowItemRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows/{workbookTableRow%2Did}{?%24select,%24expand}";
...
func NewItemItemsItemWorkbookTablesItemRowsWorkbookTableRowItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookTablesItemRowsWorkbookTableRowItemRequestBuilder) {
    ...
    return NewItemItemsItemWorkbookTablesItemRowsWorkbookTableRowItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemItemsItemWorkbookTablesItemRowsWorkbookTableRowItemRequestBuilder) MicrosoftGraphRange()(*ItemItemsItemWorkbookTablesItemRowsItemMicrosoftGraphRangeRangeRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemRowsItemMicrosoftGraphRangeRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
