...
func NewItemRootCreateUploadSessionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootCreateUploadSessionRequestBuilder) {
    m := &ItemRootCreateUploadSessionRequestBuilder{
    }
...
func NewItemRootCreateUploadSessionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootCreateUploadSessionRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemRootCreateUploadSessionRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemRootCreateUploadSessionRequestBuilder) Post(ctx context.Context, body ItemRootCreateUploadSessionPostRequestBodyable, requestConfiguration *ItemRootCreateUploadSessionRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UploadSessionable, error) {
...
func (m *ItemRootCreateUploadSessionRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemRootCreateUploadSessionPostRequestBodyable, requestConfiguration *ItemRootCreateUploadSessionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
