...
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphApply()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyApplyRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyApplyRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyBottomItemsFilter provides operations to call the applyBottomItemsFilter method.
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphApplyBottomItemsFilter()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyBottomItemsFilterApplyBottomItemsFilterRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyBottomItemsFilterApplyBottomItemsFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyBottomPercentFilter provides operations to call the applyBottomPercentFilter method.
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphApplyBottomPercentFilter()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyBottomPercentFilterApplyBottomPercentFilterRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyBottomPercentFilterApplyBottomPercentFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyCellColorFilter provides operations to call the applyCellColorFilter method.
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphApplyCellColorFilter()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyCellColorFilterApplyCellColorFilterRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyCellColorFilterApplyCellColorFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyCustomFilter provides operations to call the applyCustomFilter method.
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphApplyCustomFilter()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyCustomFilterApplyCustomFilterRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyCustomFilterApplyCustomFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyDynamicFilter provides operations to call the applyDynamicFilter method.
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphApplyDynamicFilter()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyDynamicFilterApplyDynamicFilterRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyDynamicFilterApplyDynamicFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyFontColorFilter provides operations to call the applyFontColorFilter method.
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphApplyFontColorFilter()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyFontColorFilterApplyFontColorFilterRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyFontColorFilterApplyFontColorFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyIconFilter provides operations to call the applyIconFilter method.
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphApplyIconFilter()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyIconFilterApplyIconFilterRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyIconFilterApplyIconFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyTopItemsFilter provides operations to call the applyTopItemsFilter method.
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphApplyTopItemsFilter()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyTopItemsFilterApplyTopItemsFilterRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyTopItemsFilterApplyTopItemsFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyTopPercentFilter provides operations to call the applyTopPercentFilter method.
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphApplyTopPercentFilter()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyTopPercentFilterApplyTopPercentFilterRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyTopPercentFilterApplyTopPercentFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyValuesFilter provides operations to call the applyValuesFilter method.
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphApplyValuesFilter()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyValuesFilterApplyValuesFilterRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphApplyValuesFilterApplyValuesFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphClear provides operations to call the clear method.
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterRequestBuilder) MicrosoftGraphClear()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphClearClearRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItemFilterMicrosoftGraphClearClearRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
