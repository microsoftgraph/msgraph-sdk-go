...
func (m *ItemListContentTypesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListContentTypesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
