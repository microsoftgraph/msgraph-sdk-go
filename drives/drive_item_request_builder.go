...
func (m *DriveItemRequestBuilder) BundlesById(id string)(*ItemBundlesDriveItemItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemBundlesDriveItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *DriveItemRequestBuilder) FollowingById(id string)(*ItemFollowingDriveItemItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemFollowingDriveItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *DriveItemRequestBuilder) SpecialById(id string)(*ItemSpecialDriveItemItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemSpecialDriveItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
