...
// NewItemItemsItemWorkbookFunctionsCountIfRequestBuilderInternal instantiates a new CountIfRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookFunctionsCountIfRequestBuilder instantiates a new CountIfRequestBuilder and sets the default values.
