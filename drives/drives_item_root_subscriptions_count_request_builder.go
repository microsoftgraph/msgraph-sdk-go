...
func NewDrivesItemRootSubscriptionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootSubscriptionsCountRequestBuilder) {
    m := &DrivesItemRootSubscriptionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/root/subscriptions/$count";
...
func NewDrivesItemRootSubscriptionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootSubscriptionsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemRootSubscriptionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DrivesItemRootSubscriptionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemRootSubscriptionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemRootSubscriptionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemRootSubscriptionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
