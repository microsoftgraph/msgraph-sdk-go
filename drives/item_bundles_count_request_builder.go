...
// NewItemBundlesCountRequestBuilderInternal instantiates a new ItemBundlesCountRequestBuilder and sets the default values.
...
// NewItemBundlesCountRequestBuilder instantiates a new ItemBundlesCountRequestBuilder and sets the default values.
...
func (m *ItemBundlesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemBundlesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
