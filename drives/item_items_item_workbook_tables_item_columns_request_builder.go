...
func (m *ItemItemsItemWorkbookTablesItemColumnsRequestBuilder) Count()(*ItemItemsItemWorkbookTablesItemColumnsMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemItemsItemWorkbookTablesItemColumnsRequestBuilder) MicrosoftGraphAdd()(*ItemItemsItemWorkbookTablesItemColumnsMicrosoftGraphAddAddRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphCount provides operations to call the count method.
func (m *ItemItemsItemWorkbookTablesItemColumnsRequestBuilder) MicrosoftGraphCount()(*ItemItemsItemWorkbookTablesItemColumnsMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphItemAtWithIndex provides operations to call the itemAt method.
func (m *ItemItemsItemWorkbookTablesItemColumnsRequestBuilder) MicrosoftGraphItemAtWithIndex(index *int32)(*ItemItemsItemWorkbookTablesItemColumnsMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilderInternal(m.pathParameters, m.requestAdapter, index);
}
