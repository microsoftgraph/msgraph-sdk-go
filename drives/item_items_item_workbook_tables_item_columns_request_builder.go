...
// ItemItemsItemWorkbookTablesItemColumnsRequestBuilderGetQueryParameters represents a collection of all the columns in the table. Read-only.
...
// NewItemItemsItemWorkbookTablesItemColumnsRequestBuilderInternal instantiates a new ItemItemsItemWorkbookTablesItemColumnsRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookTablesItemColumnsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookTablesItemColumnsRequestBuilder) {
    m := &ItemItemsItemWorkbookTablesItemColumnsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemItemsItemWorkbookTablesItemColumnsRequestBuilder instantiates a new ItemItemsItemWorkbookTablesItemColumnsRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookTablesItemColumnsRequestBuilder) ItemAtWithIndex(index *int32)(*ItemItemsItemWorkbookTablesItemColumnsItematwithindexItemAtWithIndexRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemColumnsItematwithindexItemAtWithIndexRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, index)
}
