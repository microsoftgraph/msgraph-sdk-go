...
func NewDrivesItemSpecialItemContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemSpecialItemContentRequestBuilder) {
    m := &DrivesItemSpecialItemContentRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/special/{driveItem%2Did}/content";
...
func NewDrivesItemSpecialItemContentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemSpecialItemContentRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemSpecialItemContentRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation the content stream, if the item represents a file.
func (m *DrivesItemSpecialItemContentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemSpecialItemContentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemSpecialItemContentRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *DrivesItemSpecialItemContentRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *DrivesItemSpecialItemContentRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemSpecialItemContentRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *DrivesItemSpecialItemContentRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *DrivesItemSpecialItemContentRequestBuilderPutRequestConfiguration)(error) {
