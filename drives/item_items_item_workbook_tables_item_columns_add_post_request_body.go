...
// ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody 
type ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody instantiates a new ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody()(*ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody) {
    m := &ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookTablesItemColumnsAddPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody) GetIndex()(*int32) {
...
func (m *ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody) GetName()(*string) {
...
func (m *ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody) SetIndex(value *int32)() {
...
func (m *ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBody) SetName(value *string)() {
...
// ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBodyable 
type ItemItemsItemWorkbookTablesItemColumnsAddPostRequestBodyable interface {
