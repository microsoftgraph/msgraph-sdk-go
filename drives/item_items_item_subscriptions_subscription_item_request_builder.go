...
func (m *ItemItemsItemSubscriptionsSubscriptionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemItemsItemSubscriptionsSubscriptionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
