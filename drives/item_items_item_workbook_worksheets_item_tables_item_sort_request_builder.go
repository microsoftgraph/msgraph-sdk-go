...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder) MicrosoftGraphApply()(*ItemItemsItemWorkbookWorksheetsItemTablesItemSortMicrosoftGraphApplyApplyRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesItemSortMicrosoftGraphApplyApplyRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphClear provides operations to call the clear method.
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder) MicrosoftGraphClear()(*ItemItemsItemWorkbookWorksheetsItemTablesItemSortMicrosoftGraphClearClearRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesItemSortMicrosoftGraphClearClearRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphReapply provides operations to call the reapply method.
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder) MicrosoftGraphReapply()(*ItemItemsItemWorkbookWorksheetsItemTablesItemSortMicrosoftGraphReapplyReapplyRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesItemSortMicrosoftGraphReapplyReapplyRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
