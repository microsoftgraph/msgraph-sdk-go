...
func (m *ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) ColumnsById(id string)(*ItemItemsItemWorkbookTablesItemColumnsWorkbookTableColumnItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookTablesItemColumnsWorkbookTableColumnItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, workbookTableId *string)(*ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) {
...
func NewItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) {
    ...
    return NewItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) MicrosoftGraphClearFilters()(*ItemItemsItemWorkbookTablesItemMicrosoftGraphClearFiltersClearFiltersRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemMicrosoftGraphClearFiltersClearFiltersRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphConvertToRange provides operations to call the convertToRange method.
func (m *ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) MicrosoftGraphConvertToRange()(*ItemItemsItemWorkbookTablesItemMicrosoftGraphConvertToRangeConvertToRangeRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemMicrosoftGraphConvertToRangeConvertToRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDataBodyRange provides operations to call the dataBodyRange method.
func (m *ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) MicrosoftGraphDataBodyRange()(*ItemItemsItemWorkbookTablesItemMicrosoftGraphDataBodyRangeDataBodyRangeRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemMicrosoftGraphDataBodyRangeDataBodyRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphHeaderRowRange provides operations to call the headerRowRange method.
func (m *ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) MicrosoftGraphHeaderRowRange()(*ItemItemsItemWorkbookTablesItemMicrosoftGraphHeaderRowRangeHeaderRowRangeRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemMicrosoftGraphHeaderRowRangeHeaderRowRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRange provides operations to call the range method.
func (m *ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) MicrosoftGraphRange()(*ItemItemsItemWorkbookTablesItemMicrosoftGraphRangeRangeRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemMicrosoftGraphRangeRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphReapplyFilters provides operations to call the reapplyFilters method.
func (m *ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) MicrosoftGraphReapplyFilters()(*ItemItemsItemWorkbookTablesItemMicrosoftGraphReapplyFiltersReapplyFiltersRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemMicrosoftGraphReapplyFiltersReapplyFiltersRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphTotalRowRange provides operations to call the totalRowRange method.
func (m *ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) MicrosoftGraphTotalRowRange()(*ItemItemsItemWorkbookTablesItemMicrosoftGraphTotalRowRangeTotalRowRangeRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemMicrosoftGraphTotalRowRangeTotalRowRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) RowsById(id string)(*ItemItemsItemWorkbookTablesItemRowsWorkbookTableRowItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookTablesItemRowsWorkbookTableRowItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
