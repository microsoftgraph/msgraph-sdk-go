...
// ItemItemsItemWorkbookFunctionsErfC_PrecisePostRequestBody 
type ItemItemsItemWorkbookFunctionsErfC_PrecisePostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookFunctionsErfC_PrecisePostRequestBody instantiates a new ItemItemsItemWorkbookFunctionsErfC_PrecisePostRequestBody and sets the default values.
func NewItemItemsItemWorkbookFunctionsErfC_PrecisePostRequestBody()(*ItemItemsItemWorkbookFunctionsErfC_PrecisePostRequestBody) {
    m := &ItemItemsItemWorkbookFunctionsErfC_PrecisePostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookFunctionsErfC_PrecisePostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
// ItemItemsItemWorkbookFunctionsErfC_PrecisePostRequestBodyable 
type ItemItemsItemWorkbookFunctionsErfC_PrecisePostRequestBodyable interface {
