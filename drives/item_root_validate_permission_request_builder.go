...
func NewItemRootValidatePermissionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootValidatePermissionRequestBuilder) {
    m := &ItemRootValidatePermissionRequestBuilder{
    }
...
func NewItemRootValidatePermissionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootValidatePermissionRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemRootValidatePermissionRequestBuilderInternal(urlParams, requestAdapter)
}
// Post invoke action validatePermission
func (m *ItemRootValidatePermissionRequestBuilder) Post(ctx context.Context, body ItemRootValidatePermissionPostRequestBodyable, requestConfiguration *ItemRootValidatePermissionRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemRootValidatePermissionRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemRootValidatePermissionPostRequestBodyable, requestConfiguration *ItemRootValidatePermissionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
