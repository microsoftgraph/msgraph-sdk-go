...
func (m *ItemBundlesItemContentRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *ItemBundlesItemContentRequestBuilderPutRequestConfiguration)(error) {
