...
func NewItemItemsItemWorkbookWorksheetsItemTablesItemRowsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemTablesItemRowsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/rows{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemRowsRequestBuilder) Count()(*ItemItemsItemWorkbookWorksheetsItemTablesItemRowsMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesItemRowsMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemRowsRequestBuilder) MicrosoftGraphAdd()(*ItemItemsItemWorkbookWorksheetsItemTablesItemRowsMicrosoftGraphAddAddRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesItemRowsMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphCount provides operations to call the count method.
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemRowsRequestBuilder) MicrosoftGraphCount()(*ItemItemsItemWorkbookWorksheetsItemTablesItemRowsMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesItemRowsMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphItemAtWithIndex provides operations to call the itemAt method.
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemRowsRequestBuilder) MicrosoftGraphItemAtWithIndex(index *int32)(*ItemItemsItemWorkbookWorksheetsItemTablesItemRowsMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesItemRowsMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilderInternal(m.pathParameters, m.requestAdapter, index);
}
