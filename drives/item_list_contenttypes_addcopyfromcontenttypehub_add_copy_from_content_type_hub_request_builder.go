...
func NewItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilder) {
    m := &ItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilder{
...
func NewItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilder) {
    ...
    return NewItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilder) Post(ctx context.Context, body ItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubPostRequestBodyable, requestConfiguration *ItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ContentTypeable, error) {
...
func (m *ItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubPostRequestBodyable, requestConfiguration *ItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilder) WithUrl(rawUrl string)(*ItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilder) {
    return NewItemListContenttypesAddcopyfromcontenttypehubAddCopyFromContentTypeHubRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
