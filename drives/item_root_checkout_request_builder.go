...
func NewItemRootCheckoutRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootCheckoutRequestBuilder) {
    m := &ItemRootCheckoutRequestBuilder{
    }
...
func NewItemRootCheckoutRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootCheckoutRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemRootCheckoutRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemRootCheckoutRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *ItemRootCheckoutRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRootCheckoutRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemRootCheckoutRequestBuilderPostRequestConfiguration)(error) {
