...
// NewItemItemsItemWorkbookFunctionsTbillEqRequestBuilderInternal instantiates a new TbillEqRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookFunctionsTbillEqRequestBuilder instantiates a new TbillEqRequestBuilder and sets the default values.
