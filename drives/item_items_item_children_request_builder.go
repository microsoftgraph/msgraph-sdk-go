...
func (m *ItemItemsItemChildrenRequestBuilder) Count()(*ItemItemsItemChildrenCountRequestBuilder) {
    return NewItemItemsItemChildrenCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemItemsItemChildrenRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemItemsItemChildrenRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
