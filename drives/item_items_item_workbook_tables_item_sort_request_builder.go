...
func NewItemItemsItemWorkbookTablesItemSortRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookTablesItemSortRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/sort{?%24select,%24expand}";
...
func (m *ItemItemsItemWorkbookTablesItemSortRequestBuilder) MicrosoftGraphApply()(*ItemItemsItemWorkbookTablesItemSortMicrosoftGraphApplyApplyRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemSortMicrosoftGraphApplyApplyRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphClear provides operations to call the clear method.
func (m *ItemItemsItemWorkbookTablesItemSortRequestBuilder) MicrosoftGraphClear()(*ItemItemsItemWorkbookTablesItemSortMicrosoftGraphClearClearRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemSortMicrosoftGraphClearClearRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphReapply provides operations to call the reapply method.
func (m *ItemItemsItemWorkbookTablesItemSortRequestBuilder) MicrosoftGraphReapply()(*ItemItemsItemWorkbookTablesItemSortMicrosoftGraphReapplyReapplyRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemSortMicrosoftGraphReapplyReapplyRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
