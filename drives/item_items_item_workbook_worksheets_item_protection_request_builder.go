...
// NewItemItemsItemWorkbookWorksheetsItemProtectionRequestBuilderInternal instantiates a new ProtectionRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookWorksheetsItemProtectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemProtectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/protection{?%24select,%24expand}";
...
// NewItemItemsItemWorkbookWorksheetsItemProtectionRequestBuilder instantiates a new ProtectionRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookWorksheetsItemProtectionRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookWorksheetsItemProtectionRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.WorkbookWorksheetProtectionable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateWorkbookWorksheetProtectionFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemItemsItemWorkbookWorksheetsItemProtectionRequestBuilder) MicrosoftGraphProtect()(*ItemItemsItemWorkbookWorksheetsItemProtectionMicrosoftGraphProtectProtectRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemProtectionMicrosoftGraphProtectProtectRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnprotect provides operations to call the unprotect method.
func (m *ItemItemsItemWorkbookWorksheetsItemProtectionRequestBuilder) MicrosoftGraphUnprotect()(*ItemItemsItemWorkbookWorksheetsItemProtectionMicrosoftGraphUnprotectUnprotectRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemProtectionMicrosoftGraphUnprotectUnprotectRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
