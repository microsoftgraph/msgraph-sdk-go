...
func (m *ItemItemsItemWorkbookWorksheetsItemPivotTablesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookWorksheetsItemPivotTablesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
