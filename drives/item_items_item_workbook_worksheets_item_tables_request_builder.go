...
func NewItemItemsItemWorkbookWorksheetsItemTablesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemTablesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesRequestBuilder) Count()(*ItemItemsItemWorkbookWorksheetsItemTablesMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get retrieve a list of table objects.
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/worksheet-list-tables?view=graph-rest-1.0
func (m *ItemItemsItemWorkbookWorksheetsItemTablesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookWorksheetsItemTablesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.WorkbookTableCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateWorkbookTableCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesRequestBuilder) MicrosoftGraphAdd()(*ItemItemsItemWorkbookWorksheetsItemTablesMicrosoftGraphAddAddRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCount provides operations to call the count method.
func (m *ItemItemsItemWorkbookWorksheetsItemTablesRequestBuilder) MicrosoftGraphCount()(*ItemItemsItemWorkbookWorksheetsItemTablesMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphItemAtWithIndex provides operations to call the itemAt method.
func (m *ItemItemsItemWorkbookWorksheetsItemTablesRequestBuilder) MicrosoftGraphItemAtWithIndex(index *int32)(*ItemItemsItemWorkbookWorksheetsItemTablesMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilderInternal(m.pathParameters, m.requestAdapter, index)
}
