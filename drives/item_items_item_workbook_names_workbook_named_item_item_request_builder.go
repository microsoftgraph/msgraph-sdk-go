...
func NewItemItemsItemWorkbookNamesWorkbookNamedItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, workbookNamedItemId *string)(*ItemItemsItemWorkbookNamesWorkbookNamedItemItemRequestBuilder) {
...
func NewItemItemsItemWorkbookNamesWorkbookNamedItemItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookNamesWorkbookNamedItemItemRequestBuilder) {
    ...
    return NewItemItemsItemWorkbookNamesWorkbookNamedItemItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemItemsItemWorkbookNamesWorkbookNamedItemItemRequestBuilder) MicrosoftGraphRange()(*ItemItemsItemWorkbookNamesItemMicrosoftGraphRangeRangeRequestBuilder) {
    return NewItemItemsItemWorkbookNamesItemMicrosoftGraphRangeRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
