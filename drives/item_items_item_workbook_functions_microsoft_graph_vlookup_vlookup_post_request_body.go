...
// GetColIndexNum gets the colIndexNum property value. 
...
// GetRangeLookup gets the rangeLookup property value. 
...
// GetTableArray gets the tableArray property value. 
...
// SetColIndexNum sets the colIndexNum property value. 
