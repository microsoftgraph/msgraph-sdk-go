...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsItemDataLabelsFormatRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookWorksheetsItemChartsItemDataLabelsFormatRequestBuilderDeleteRequestConfiguration)([]byte, error) {
