...
func NewItemItemsItemWorkbookNamesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookNamesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemItemsItemWorkbookNamesRequestBuilder instantiates a new NamesRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookNamesRequestBuilder) Count()(*ItemItemsItemWorkbookNamesCountRequestBuilder) {
    return NewItemItemsItemWorkbookNamesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemItemsItemWorkbookNamesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookNamesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.WorkbookNamedItemCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateWorkbookNamedItemCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemItemsItemWorkbookNamesRequestBuilder) MicrosoftGraphAdd()(*ItemItemsItemWorkbookNamesMicrosoftGraphAddAddRequestBuilder) {
    return NewItemItemsItemWorkbookNamesMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphAddFormulaLocal provides operations to call the addFormulaLocal method.
func (m *ItemItemsItemWorkbookNamesRequestBuilder) MicrosoftGraphAddFormulaLocal()(*ItemItemsItemWorkbookNamesMicrosoftGraphAddFormulaLocalAddFormulaLocalRequestBuilder) {
    return NewItemItemsItemWorkbookNamesMicrosoftGraphAddFormulaLocalAddFormulaLocalRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
