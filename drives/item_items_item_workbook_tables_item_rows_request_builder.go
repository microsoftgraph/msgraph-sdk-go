...
func (m *ItemItemsItemWorkbookTablesItemRowsRequestBuilder) Count()(*ItemItemsItemWorkbookTablesItemRowsMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemRowsMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemItemsItemWorkbookTablesItemRowsRequestBuilder) MicrosoftGraphAdd()(*ItemItemsItemWorkbookTablesItemRowsMicrosoftGraphAddAddRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemRowsMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCount provides operations to call the count method.
func (m *ItemItemsItemWorkbookTablesItemRowsRequestBuilder) MicrosoftGraphCount()(*ItemItemsItemWorkbookTablesItemRowsMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemRowsMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphItemAtWithIndex provides operations to call the itemAt method.
func (m *ItemItemsItemWorkbookTablesItemRowsRequestBuilder) MicrosoftGraphItemAtWithIndex(index *int32)(*ItemItemsItemWorkbookTablesItemRowsMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemRowsMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilderInternal(m.pathParameters, m.requestAdapter, index)
}
