...
// ItemItemsItemWorkbookFunctionsDminPostRequestBody 
type ItemItemsItemWorkbookFunctionsDminPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookFunctionsDminPostRequestBody instantiates a new ItemItemsItemWorkbookFunctionsDminPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookFunctionsDminPostRequestBody()(*ItemItemsItemWorkbookFunctionsDminPostRequestBody) {
    m := &ItemItemsItemWorkbookFunctionsDminPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookFunctionsDminPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookFunctionsDminPostRequestBody) GetCriteria()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable) {
...
func (m *ItemItemsItemWorkbookFunctionsDminPostRequestBody) GetDatabase()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable) {
...
func (m *ItemItemsItemWorkbookFunctionsDminPostRequestBody) GetField()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable) {
...
func (m *ItemItemsItemWorkbookFunctionsDminPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemsItemWorkbookFunctionsDminPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookFunctionsDminPostRequestBody) SetCriteria(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable)() {
...
func (m *ItemItemsItemWorkbookFunctionsDminPostRequestBody) SetDatabase(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable)() {
...
func (m *ItemItemsItemWorkbookFunctionsDminPostRequestBody) SetField(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Jsonable)() {
    err := m.GetBackingStore().Set("field", value)
    if err != nil {
        panic(err)
    }
}
// ItemItemsItemWorkbookFunctionsDminPostRequestBodyable 
type ItemItemsItemWorkbookFunctionsDminPostRequestBodyable interface {
