...
func NewItemOwnedObjectsEndpointRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedObjectsEndpointRequestBuilder) {
    m := &ItemOwnedObjectsEndpointRequestBuilder{
    }
...
func NewItemOwnedObjectsEndpointRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedObjectsEndpointRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemOwnedObjectsEndpointRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ItemOwnedObjectsEndpointRequestBuilder) Count()(*ItemOwnedObjectsEndpointCountRequestBuilder) {
    return NewItemOwnedObjectsEndpointCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemOwnedObjectsEndpointRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemOwnedObjectsEndpointRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemOwnedObjectsEndpointRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedObjectsEndpointRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.EndpointCollectionResponseable, error) {
