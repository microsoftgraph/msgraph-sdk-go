...
func NewItemOwnersMicrosoftGraphServicePrincipalCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersMicrosoftGraphServicePrincipalCountRequestBuilder) {
    m := &ItemOwnersMicrosoftGraphServicePrincipalCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
...
func NewItemOwnersMicrosoftGraphServicePrincipalCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersMicrosoftGraphServicePrincipalCountRequestBuilder) {
    ...
    return NewItemOwnersMicrosoftGraphServicePrincipalCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemOwnersMicrosoftGraphServicePrincipalCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnersMicrosoftGraphServicePrincipalCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemOwnersMicrosoftGraphServicePrincipalCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemOwnersMicrosoftGraphServicePrincipalCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
