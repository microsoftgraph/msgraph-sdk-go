...
// refRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\homeRealmDiscoveryPolicies\$ref
...
// refRequestBuilderGetQueryParameters the homeRealmDiscoveryPolicies assigned to this service principal. Supports $expand.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal_id}/homeRealmDiscoveryPolicies/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the homeRealmDiscoveryPolicies assigned to this service principal. Supports $expand.
...
// Post the homeRealmDiscoveryPolicies assigned to this service principal. Supports $expand.
