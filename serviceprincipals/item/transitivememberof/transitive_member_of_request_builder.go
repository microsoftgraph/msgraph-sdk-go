...
// TransitiveMemberOfRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\transitiveMemberOf
...
func NewTransitiveMemberOfRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TransitiveMemberOfRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal_id}/transitiveMemberOf{?top,skip,search,filter,count,orderby,select,expand}";
