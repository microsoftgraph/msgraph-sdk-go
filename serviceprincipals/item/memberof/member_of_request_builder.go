...
import (
    ...
    i1ba02fdb19be50febe7ea813d2646f6e555c4ca3fa98622f6280ab89667a381d "github.com/microsoftgraph/msgraph-sdk-go/serviceprincipals/item/memberof/ref"
)
...
func NewMemberOfRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MemberOfRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/servicePrincipals/{servicePrincipal_id}/memberOf{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MemberOfRequestBuilder) Ref()(*i1ba02fdb19be50febe7ea813d2646f6e555c4ca3fa98622f6280ab89667a381d.RefRequestBuilder) {
    return i1ba02fdb19be50febe7ea813d2646f6e555c4ca3fa98622f6280ab89667a381d.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
