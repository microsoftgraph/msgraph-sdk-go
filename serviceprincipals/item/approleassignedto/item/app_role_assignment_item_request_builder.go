...
// DeleteWithResponseHandler delete navigation property appRoleAssignedTo for servicePrincipals
...
// PatchWithResponseHandler update the navigation property appRoleAssignedTo in servicePrincipals
