...
// DeleteWithResponseHandler delete navigation property appRoleAssignments for servicePrincipals
...
// PatchWithResponseHandler update the navigation property appRoleAssignments in servicePrincipals
