...
func (m *ItemOauth2PermissionGrantsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOauth2PermissionGrantsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
