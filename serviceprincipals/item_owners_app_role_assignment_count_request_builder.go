...
// ItemOwnersAppRoleAssignmentCountRequestBuilderGetQueryParameters get the number of the resource
type ItemOwnersAppRoleAssignmentCountRequestBuilderGetQueryParameters struct {
...
type ItemOwnersAppRoleAssignmentCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemOwnersAppRoleAssignmentCountRequestBuilderGetQueryParameters
}
...
func NewItemOwnersAppRoleAssignmentCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersAppRoleAssignmentCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/microsoft.graph.appRoleAssignment/$count{?%24search,%24filter}";
