...
// Post discover the latest schema definition for provisioning to an application for the directoryDefinition.
...
// ToPostRequestInformation discover the latest schema definition for provisioning to an application for the directoryDefinition.
