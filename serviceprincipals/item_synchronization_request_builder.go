...
// ItemSynchronizationRequestBuilderGetQueryParameters get synchronization from servicePrincipals
...
// ToGetRequestInformation get synchronization from servicePrincipals
