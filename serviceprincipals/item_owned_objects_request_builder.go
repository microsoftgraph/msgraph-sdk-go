...
func (m *ItemOwnedObjectsRequestBuilder) MicrosoftGraphAppRoleAssignment()(*ItemOwnedObjectsMicrosoftGraphAppRoleAssignmentAppRoleAssignmentRequestBuilder) {
    return NewItemOwnedObjectsMicrosoftGraphAppRoleAssignmentAppRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
