...
func (m *ItemOwnedobjectsDirectoryObjectItemRequestBuilder) GraphAppRoleAssignment()(*ItemOwnedobjectsItemGraphapproleassignmentGraphAppRoleAssignmentRequestBuilder) {
    return NewItemOwnedobjectsItemGraphapproleassignmentGraphAppRoleAssignmentRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemOwnedobjectsDirectoryObjectItemRequestBuilder) GraphEndpoint()(*ItemOwnedobjectsItemGraphendpointGraphEndpointRequestBuilder) {
    return NewItemOwnedobjectsItemGraphendpointGraphEndpointRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
