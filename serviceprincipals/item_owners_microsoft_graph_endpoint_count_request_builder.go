...
func NewItemOwnersMicrosoftGraphEndpointCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersMicrosoftGraphEndpointCountRequestBuilder) {
    m := &ItemOwnersMicrosoftGraphEndpointCountRequestBuilder{
    }
...
func NewItemOwnersMicrosoftGraphEndpointCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersMicrosoftGraphEndpointCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemOwnersMicrosoftGraphEndpointCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemOwnersMicrosoftGraphEndpointCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnersMicrosoftGraphEndpointCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemOwnersMicrosoftGraphEndpointCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemOwnersMicrosoftGraphEndpointCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
