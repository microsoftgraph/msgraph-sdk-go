...
// ItemSynchronizationTemplatesSynchronizationTemplateItemRequestBuilderGetQueryParameters get templates from servicePrincipals
...
// ToGetRequestInformation get templates from servicePrincipals
