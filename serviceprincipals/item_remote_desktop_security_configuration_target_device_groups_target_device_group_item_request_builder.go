...
// ItemRemoteDesktopSecurityConfigurationTargetDeviceGroupsTargetDeviceGroupItemRequestBuilderGetQueryParameters get targetDeviceGroups from servicePrincipals
