...
func NewItemTransitiveMemberOfDirectoryObjectItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, directoryObjectId *string)(*ItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) {
...
func NewItemTransitiveMemberOfDirectoryObjectItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) {
    ...
    return NewItemTransitiveMemberOfDirectoryObjectItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphApplication()(*ItemTransitiveMemberOfItemMicrosoftGraphApplicationApplicationRequestBuilder) {
    return NewItemTransitiveMemberOfItemMicrosoftGraphApplicationApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphDevice casts the previous resource to device.
func (m *ItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphDevice()(*ItemTransitiveMemberOfItemMicrosoftGraphDeviceDeviceRequestBuilder) {
    return NewItemTransitiveMemberOfItemMicrosoftGraphDeviceDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphGroup casts the previous resource to group.
func (m *ItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphGroup()(*ItemTransitiveMemberOfItemMicrosoftGraphGroupGroupRequestBuilder) {
    return NewItemTransitiveMemberOfItemMicrosoftGraphGroupGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphOrgContact casts the previous resource to orgContact.
func (m *ItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphOrgContact()(*ItemTransitiveMemberOfItemMicrosoftGraphOrgContactOrgContactRequestBuilder) {
    return NewItemTransitiveMemberOfItemMicrosoftGraphOrgContactOrgContactRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *ItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphServicePrincipal()(*ItemTransitiveMemberOfItemMicrosoftGraphServicePrincipalServicePrincipalRequestBuilder) {
    return NewItemTransitiveMemberOfItemMicrosoftGraphServicePrincipalServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *ItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphUser()(*ItemTransitiveMemberOfItemMicrosoftGraphUserUserRequestBuilder) {
    return NewItemTransitiveMemberOfItemMicrosoftGraphUserUserRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
