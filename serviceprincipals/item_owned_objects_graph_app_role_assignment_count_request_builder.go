...
func (m *ItemOwnedObjectsGraphAppRoleAssignmentCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedObjectsGraphAppRoleAssignmentCountRequestBuilderGetRequestConfiguration)(*int64, error) {
