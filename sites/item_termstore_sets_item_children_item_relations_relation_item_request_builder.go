...
func (m *ItemTermstoreSetsItemChildrenItemRelationsRelationItemRequestBuilder) FromTerm()(*ItemTermstoreSetsItemChildrenItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewItemTermstoreSetsItemChildrenItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemTermstoreSetsItemChildrenItemRelationsRelationItemRequestBuilder) ToTerm()(*ItemTermstoreSetsItemChildrenItemRelationsItemTotermToTermRequestBuilder) {
    return NewItemTermstoreSetsItemChildrenItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
