...
func (m *ItemTermStoresStoreItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTermStoresStoreItemRequestBuilderGetRequestConfiguration)(ia3c27b33aa3d3ed80f9de797c48fbb8ed73f13887e301daf51f08450e9a634a3.Storeable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ia3c27b33aa3d3ed80f9de797c48fbb8ed73f13887e301daf51f08450e9a634a3.CreateStoreFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemTermStoresStoreItemRequestBuilder) GroupsById(id string)(*ItemTermStoresItemGroupsGroupItemRequestBuilder) {
    ...
    return NewItemTermStoresItemGroupsGroupItemRequestBuilderInternal(urlTplParams, m.requestAdapter, id);
}
...
func (m *ItemTermStoresStoreItemRequestBuilder) SetsById(id string)(*ItemTermStoresItemSetsSetItemRequestBuilder) {
    ...
    return NewItemTermStoresItemSetsSetItemRequestBuilderInternal(urlTplParams, m.requestAdapter, id);
}
