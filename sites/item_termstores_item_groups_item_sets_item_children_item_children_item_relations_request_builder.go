...
// NewItemTermstoresItemGroupsItemSetsItemChildrenItemChildrenItemRelationsRequestBuilderInternal instantiates a new ItemTermstoresItemGroupsItemSetsItemChildrenItemChildrenItemRelationsRequestBuilder and sets the default values.
...
// NewItemTermstoresItemGroupsItemSetsItemChildrenItemChildrenItemRelationsRequestBuilder instantiates a new ItemTermstoresItemGroupsItemSetsItemChildrenItemChildrenItemRelationsRequestBuilder and sets the default values.
...
func (m *ItemTermstoresItemGroupsItemSetsItemChildrenItemChildrenItemRelationsRequestBuilder) WithUrl(rawUrl string)(*ItemTermstoresItemGroupsItemSetsItemChildrenItemChildrenItemRelationsRequestBuilder) {
    return NewItemTermstoresItemGroupsItemSetsItemChildrenItemChildrenItemRelationsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
