...
func (m *ItemTermstoreSetsItemParentgroupSetsItemTermsItemRelationsRelationItemRequestBuilder) FromTerm()(*ItemTermstoreSetsItemParentgroupSetsItemTermsItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewItemTermstoreSetsItemParentgroupSetsItemTermsItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemTermstoreSetsItemParentgroupSetsItemTermsItemRelationsRelationItemRequestBuilder) ToTerm()(*ItemTermstoreSetsItemParentgroupSetsItemTermsItemRelationsItemTotermToTermRequestBuilder) {
    return NewItemTermstoreSetsItemParentgroupSetsItemTermsItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
