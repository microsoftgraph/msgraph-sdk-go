...
func (m *ItemTermStoresItemGroupsItemSetsSetItemRequestBuilder) ChildrenById(id string)(*ItemTermStoresItemGroupsItemSetsItemChildrenTermItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemTermStoresItemGroupsItemSetsItemChildrenTermItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewItemTermStoresItemGroupsItemSetsSetItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, setId *string)(*ItemTermStoresItemGroupsItemSetsSetItemRequestBuilder) {
...
func NewItemTermStoresItemGroupsItemSetsSetItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTermStoresItemGroupsItemSetsSetItemRequestBuilder) {
    ...
    return NewItemTermStoresItemGroupsItemSetsSetItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemTermStoresItemGroupsItemSetsSetItemRequestBuilder) RelationsById(id string)(*ItemTermStoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemTermStoresItemGroupsItemSetsItemRelationsRelationItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemTermStoresItemGroupsItemSetsSetItemRequestBuilder) TermsById(id string)(*ItemTermStoresItemGroupsItemSetsItemTermsTermItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemTermStoresItemGroupsItemSetsItemTermsTermItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
