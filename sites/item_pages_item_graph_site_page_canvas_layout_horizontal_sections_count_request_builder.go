...
func (m *ItemPagesItemGraphSitePageCanvasLayoutHorizontalSectionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemPagesItemGraphSitePageCanvasLayoutHorizontalSectionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
