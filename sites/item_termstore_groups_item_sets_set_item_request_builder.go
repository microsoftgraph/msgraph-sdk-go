...
func (m *ItemTermstoreGroupsItemSetsSetItemRequestBuilder) ParentGroup()(*ItemTermstoreGroupsItemSetsItemParentgroupParentGroupRequestBuilder) {
    return NewItemTermstoreGroupsItemSetsItemParentgroupParentGroupRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
