...
func (m *ItemTermstoreGroupsItemSetsItemChildrenItemRelationsRelationItemRequestBuilder) FromTerm()(*ItemTermstoreGroupsItemSetsItemChildrenItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewItemTermstoreGroupsItemSetsItemChildrenItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemTermstoreGroupsItemSetsItemChildrenItemRelationsRelationItemRequestBuilder) ToTerm()(*ItemTermstoreGroupsItemSetsItemChildrenItemRelationsItemTotermToTermRequestBuilder) {
    return NewItemTermstoreGroupsItemSetsItemChildrenItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
