...
// NewItemTermstoreSetsItemParentgroupSetsItemTermsItemSetRequestBuilderInternal instantiates a new ItemTermstoreSetsItemParentgroupSetsItemTermsItemSetRequestBuilder and sets the default values.
func NewItemTermstoreSetsItemParentgroupSetsItemTermsItemSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTermstoreSetsItemParentgroupSetsItemTermsItemSetRequestBuilder) {
    m := &ItemTermstoreSetsItemParentgroupSetsItemTermsItemSetRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/{term%2Did}/set{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemTermstoreSetsItemParentgroupSetsItemTermsItemSetRequestBuilder instantiates a new ItemTermstoreSetsItemParentgroupSetsItemTermsItemSetRequestBuilder and sets the default values.
...
func (m *ItemTermstoreSetsItemParentgroupSetsItemTermsItemSetRequestBuilder) WithUrl(rawUrl string)(*ItemTermstoreSetsItemParentgroupSetsItemTermsItemSetRequestBuilder) {
    return NewItemTermstoreSetsItemParentgroupSetsItemTermsItemSetRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
