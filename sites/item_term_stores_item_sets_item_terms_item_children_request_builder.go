...
// NewItemTermStoresItemSetsItemTermsItemChildrenRequestBuilderInternal instantiates a new ChildrenRequestBuilder and sets the default values.
...
// NewItemTermStoresItemSetsItemTermsItemChildrenRequestBuilder instantiates a new ChildrenRequestBuilder and sets the default values.
...
func (m *ItemTermStoresItemSetsItemTermsItemChildrenRequestBuilder) Count()(*ItemTermStoresItemSetsItemTermsItemChildrenCountRequestBuilder) {
    return NewItemTermStoresItemSetsItemTermsItemChildrenCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation children of current term.
func (m *ItemTermStoresItemSetsItemTermsItemChildrenRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTermStoresItemSetsItemTermsItemChildrenRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
