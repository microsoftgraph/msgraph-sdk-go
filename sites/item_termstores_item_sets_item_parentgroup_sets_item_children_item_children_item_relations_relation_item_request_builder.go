...
func (m *ItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder) FromTerm()(*ItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder) ToTerm()(*ItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsItemTotermToTermRequestBuilder) {
    return NewItemTermstoresItemSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
