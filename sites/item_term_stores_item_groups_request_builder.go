...
// NewItemTermStoresItemGroupsRequestBuilder instantiates a new GroupsRequestBuilder and sets the default values.
...
func (m *ItemTermStoresItemGroupsRequestBuilder) Count()(*ItemTermStoresItemGroupsCountRequestBuilder) {
    return NewItemTermStoresItemGroupsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of group objects in a term store.
func (m *ItemTermStoresItemGroupsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTermStoresItemGroupsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
