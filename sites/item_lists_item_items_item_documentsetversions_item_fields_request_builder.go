...
// NewItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilderInternal instantiates a new ItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder and sets the default values.
func NewItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder) {
    m := &ItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}/fields{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder instantiates a new ItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder and sets the default values.
...
func (m *ItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder) WithUrl(rawUrl string)(*ItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder) {
    return NewItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
