...
// ItemTermStoreSetsSetItemRequestBuilderGetQueryParameters collection of all sets available in the term store. This relationship can only be used to load a specific term set.
...
func (m *ItemTermStoreSetsSetItemRequestBuilder) ChildrenById(id string)(*ItemTermStoreSetsItemChildrenTermItemRequestBuilder) {
    ...
    return NewItemTermStoreSetsItemChildrenTermItemRequestBuilderInternal(urlTplParams, m.requestAdapter, id);
}
...
func (m *ItemTermStoreSetsSetItemRequestBuilder) RelationsById(id string)(*ItemTermStoreSetsItemRelationsRelationItemRequestBuilder) {
    ...
    return NewItemTermStoreSetsItemRelationsRelationItemRequestBuilderInternal(urlTplParams, m.requestAdapter, id);
}
...
func (m *ItemTermStoreSetsSetItemRequestBuilder) TermsById(id string)(*ItemTermStoreSetsItemTermsTermItemRequestBuilder) {
    ...
    return NewItemTermStoreSetsItemTermsTermItemRequestBuilderInternal(urlTplParams, m.requestAdapter, id);
}
