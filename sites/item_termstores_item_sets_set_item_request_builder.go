...
// returns a *ItemTermstoresItemSetsItemParentgroupParentGroupRequestBuilder when successful
func (m *ItemTermstoresItemSetsSetItemRequestBuilder) ParentGroup()(*ItemTermstoresItemSetsItemParentgroupParentGroupRequestBuilder) {
    return NewItemTermstoresItemSetsItemParentgroupParentGroupRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
