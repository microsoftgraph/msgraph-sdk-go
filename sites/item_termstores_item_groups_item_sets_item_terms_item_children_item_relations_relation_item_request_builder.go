...
func (m *ItemTermstoresItemGroupsItemSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilder) FromTerm()(*ItemTermstoresItemGroupsItemSetsItemTermsItemChildrenItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewItemTermstoresItemGroupsItemSetsItemTermsItemChildrenItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemTermstoresItemGroupsItemSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilder) ToTerm()(*ItemTermstoresItemGroupsItemSetsItemTermsItemChildrenItemRelationsItemTotermToTermRequestBuilder) {
    return NewItemTermstoresItemGroupsItemSetsItemTermsItemChildrenItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
