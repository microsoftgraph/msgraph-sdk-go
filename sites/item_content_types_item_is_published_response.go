...
func (m *ItemContentTypesItemIsPublishedResponse) GetAdditionalData()(map[string]any) {
...
func (m *ItemContentTypesItemIsPublishedResponse) SetAdditionalData(value map[string]any)() {
