...
func (m *ItemListsItemContentTypesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListsItemContentTypesRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ContentTypeCollectionResponseable, error) {
...
func (m *ItemListsItemContentTypesRequestBuilder) MicrosoftGraphAddCopy()(*ItemListsItemContentTypesMicrosoftGraphAddCopyAddCopyRequestBuilder) {
    return NewItemListsItemContentTypesMicrosoftGraphAddCopyAddCopyRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphAddCopyFromContentTypeHub provides operations to call the addCopyFromContentTypeHub method.
func (m *ItemListsItemContentTypesRequestBuilder) MicrosoftGraphAddCopyFromContentTypeHub()(*ItemListsItemContentTypesMicrosoftGraphAddCopyFromContentTypeHubAddCopyFromContentTypeHubRequestBuilder) {
    return NewItemListsItemContentTypesMicrosoftGraphAddCopyFromContentTypeHubAddCopyFromContentTypeHubRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MicrosoftGraphGetCompatibleHubContentTypes provides operations to call the getCompatibleHubContentTypes method.
func (m *ItemListsItemContentTypesRequestBuilder) MicrosoftGraphGetCompatibleHubContentTypes()(*ItemListsItemContentTypesMicrosoftGraphGetCompatibleHubContentTypesGetCompatibleHubContentTypesRequestBuilder) {
    return NewItemListsItemContentTypesMicrosoftGraphGetCompatibleHubContentTypesGetCompatibleHubContentTypesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Post create new navigation property to contentTypes for sites
func (m *ItemListsItemContentTypesRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ContentTypeable, requestConfiguration *ItemListsItemContentTypesRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ContentTypeable, error) {
...
func (m *ItemListsItemContentTypesRequestBuilder) ToPostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ContentTypeable, requestConfiguration *ItemListsItemContentTypesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
