...
// ItemTermStoresItemGroupsItemSetsItemTermsRequestBuilderGetQueryParameters read the properties and relationships of a term object.
...
func (m *ItemTermStoresItemGroupsItemSetsItemTermsRequestBuilder) ByTermIdString(termId string)(*ItemTermStoresItemGroupsItemSetsItemTermsTermItemRequestBuilder) {
...
func NewItemTermStoresItemGroupsItemSetsItemTermsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTermStoresItemGroupsItemSetsItemTermsRequestBuilder) {
    m := &ItemTermStoresItemGroupsItemSetsItemTermsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did}/sets/{set%2Did}/terms{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
