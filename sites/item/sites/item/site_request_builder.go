...
// siteRequestBuilder builds and executes requests for operations under \sites\{site-id}\sites\{site-id1}
...
// siteRequestBuilderGetQueryParameters the collection of the sub-sites under this site.
...
func NewSiteRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SiteRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/sites/{site_id1}{?select,expand}";
...
// CreateDeleteRequestInformation the collection of the sub-sites under this site.
...
// CreatePatchRequestInformation the collection of the sub-sites under this site.
...
// Delete the collection of the sub-sites under this site.
...
// Patch the collection of the sub-sites under this site.
