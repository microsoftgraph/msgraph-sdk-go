...
// RefRequestBuilder builds and executes requests for operations under \sites\{site-id}\sites\$ref
...
// RefRequestBuilderGetQueryParameters the collection of the sub-sites under this site.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/sites/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the collection of the sub-sites under this site.
...
// Post the collection of the sub-sites under this site.
