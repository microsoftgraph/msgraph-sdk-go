...
import (
    ...
    ia9eeb56e866f301ee1b13e3173849bc26ff0e8834d7a4c37a79bdf7ec5b047c6 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/groups/item/sets/item/terms/item/relations/item/set/ref"
)

// SetRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStore\groups\{group-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*ia9eeb56e866f301ee1b13e3173849bc26ff0e8834d7a4c37a79bdf7ec5b047c6.RefRequestBuilder) {
    return ia9eeb56e866f301ee1b13e3173849bc26ff0e8834d7a4c37a79bdf7ec5b047c6.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
