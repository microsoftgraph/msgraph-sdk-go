...
import (
    ...
    ifd83c6b58493b8669e2a6233f1569f35d30e61981911e6ee73307b10a5bc4978 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/groups/item/sets/item/terms/item/set/ref"
)

// setRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStore\groups\{group-id}\sets\{set-id}\terms\{term-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*ifd83c6b58493b8669e2a6233f1569f35d30e61981911e6ee73307b10a5bc4978.RefRequestBuilder) {
    return ifd83c6b58493b8669e2a6233f1569f35d30e61981911e6ee73307b10a5bc4978.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
