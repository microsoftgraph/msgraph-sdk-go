...
import (
    ...
    if3879b8cc2e2281951f17e4ce1db77ec4699f11647f8e623dc0c898c9da5979d "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/groups/item/sets/item/terms/item/relations/item/fromterm/ref"
)

// FromTermRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStore\groups\{group-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}\fromTerm
...
func NewFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FromTermRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/fromTerm{?select,expand}";
...
func (m *FromTermRequestBuilder) Ref()(*if3879b8cc2e2281951f17e4ce1db77ec4699f11647f8e623dc0c898c9da5979d.RefRequestBuilder) {
    return if3879b8cc2e2281951f17e4ce1db77ec4699f11647f8e623dc0c898c9da5979d.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
