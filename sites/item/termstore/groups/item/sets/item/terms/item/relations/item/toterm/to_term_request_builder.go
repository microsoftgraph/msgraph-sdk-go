...
import (
    ...
    i96960795a59139f82c216b7c7c9911c80e99817d50be8820e29fe724e1ec799b "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/groups/item/sets/item/terms/item/relations/item/toterm/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStore\groups\{group-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}\toTerm
...
func NewToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ToTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/toTerm{?select,expand}";
...
func (m *ToTermRequestBuilder) Ref()(*i96960795a59139f82c216b7c7c9911c80e99817d50be8820e29fe724e1ec799b.RefRequestBuilder) {
    return i96960795a59139f82c216b7c7c9911c80e99817d50be8820e29fe724e1ec799b.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
