...
import (
    ...
    i5b643ebd2ff5fa97d922bc25de0c6b80dfab7013840c20efda83698c1ef8d004 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/groups/item/sets/item/relations/item/set/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStore\groups\{group-id}\sets\{set-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*i5b643ebd2ff5fa97d922bc25de0c6b80dfab7013840c20efda83698c1ef8d004.RefRequestBuilder) {
    return i5b643ebd2ff5fa97d922bc25de0c6b80dfab7013840c20efda83698c1ef8d004.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
