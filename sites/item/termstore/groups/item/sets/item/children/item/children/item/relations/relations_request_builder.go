...
import (
    ...
    ifb3bd0d198348ee34b92c45dbe3213045f902ca6bcafd9e065640e2ee1c68947 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/groups/item/sets/item/children/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/children/{term_id}/children/{term_id1}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*ifb3bd0d198348ee34b92c45dbe3213045f902ca6bcafd9e065640e2ee1c68947.CountRequestBuilder) {
    return ifb3bd0d198348ee34b92c45dbe3213045f902ca6bcafd9e065640e2ee1c68947.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
