...
import (
    ...
    i62d60d5d2904d8dd1465ca577c29816d3293e4b5e5fcf4151b8f462b51497ce0 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/groups/item/sets/item/children/item/relations/item/toterm/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStore\groups\{group-id}\sets\{set-id}\children\{term-id}\relations\{relation-id}\toTerm
...
func NewToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ToTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/children/{term_id}/relations/{relation_id}/toTerm{?select,expand}";
...
func (m *ToTermRequestBuilder) Ref()(*i62d60d5d2904d8dd1465ca577c29816d3293e4b5e5fcf4151b8f462b51497ce0.RefRequestBuilder) {
    return i62d60d5d2904d8dd1465ca577c29816d3293e4b5e5fcf4151b8f462b51497ce0.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
