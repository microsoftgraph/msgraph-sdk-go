...
import (
    ...
    id9dfc93f844db2ac05b697b65ae648a1b896ba8e2084d75df1d5bff5dfb7a988 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/sets/count"
)
...
func NewSetsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SetsRequestBuilder) Count()(*id9dfc93f844db2ac05b697b65ae648a1b896ba8e2084d75df1d5bff5dfb7a988.CountRequestBuilder) {
    return id9dfc93f844db2ac05b697b65ae648a1b896ba8e2084d75df1d5bff5dfb7a988.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
