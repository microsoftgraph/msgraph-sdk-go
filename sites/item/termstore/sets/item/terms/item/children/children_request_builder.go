...
import (
    ...
    ic3f24970a8efa16dd4ff8df676d1b204220aa406158b78e7aef0319416e37b39 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/sets/item/terms/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/terms/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*ic3f24970a8efa16dd4ff8df676d1b204220aa406158b78e7aef0319416e37b39.CountRequestBuilder) {
    return ic3f24970a8efa16dd4ff8df676d1b204220aa406158b78e7aef0319416e37b39.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
