...
import (
    ...
    i461824cdee254e20809cee7746f1f6a249f7f231f333114f222ba7df3f2bea8d "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/sets/item/terms/item/relations/item/set/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStore\sets\{set-id}\terms\{term-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/sets/{set_id}/terms/{term_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*i461824cdee254e20809cee7746f1f6a249f7f231f333114f222ba7df3f2bea8d.RefRequestBuilder) {
    return i461824cdee254e20809cee7746f1f6a249f7f231f333114f222ba7df3f2bea8d.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
