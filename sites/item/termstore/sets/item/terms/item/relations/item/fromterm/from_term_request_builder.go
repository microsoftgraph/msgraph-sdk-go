...
func NewFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FromTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/sets/{set_id}/terms/{term_id}/relations/{relation_id}/fromTerm{?select,expand}";
...
func (m *FromTermRequestBuilder) Ref()(*i545b9d875a38d8d819c4e8a61c2d2b4d67909732e296b1c3257a374a29cd6b57.RefRequestBuilder) {
    return i545b9d875a38d8d819c4e8a61c2d2b4d67909732e296b1c3257a374a29cd6b57.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
