...
func NewToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ToTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/sets/{set_id}/children/{term_id}/relations/{relation_id}/toTerm{?select,expand}";
...
func (m *ToTermRequestBuilder) Ref()(*id4dc26bdab0e071eec0eaa71d2b6d48c1b8197fa97a284dfeab7c9337c63d2de.RefRequestBuilder) {
    return id4dc26bdab0e071eec0eaa71d2b6d48c1b8197fa97a284dfeab7c9337c63d2de.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
