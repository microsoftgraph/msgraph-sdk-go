...
import (
    ...
    ia179f640f4157ba2708886948a85bb6accebb3959bd9f9649f0b3153bf02600b "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/sets/item/children/item/set/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStore\sets\{set-id}\children\{term-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/sets/{set_id}/children/{term_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*ia179f640f4157ba2708886948a85bb6accebb3959bd9f9649f0b3153bf02600b.RefRequestBuilder) {
    return ia179f640f4157ba2708886948a85bb6accebb3959bd9f9649f0b3153bf02600b.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
