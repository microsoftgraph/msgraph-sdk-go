...
import (
    ...
    ifd75f0d6f2632c55239abcd51ad14c30d9791e3cb1d5b7eea143cffde98bae54 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/sets/item/parentgroup/sets/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/parentGroup/sets/{set_id1}/children/{term_id}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*ifd75f0d6f2632c55239abcd51ad14c30d9791e3cb1d5b7eea143cffde98bae54.CountRequestBuilder) {
    return ifd75f0d6f2632c55239abcd51ad14c30d9791e3cb1d5b7eea143cffde98bae54.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
