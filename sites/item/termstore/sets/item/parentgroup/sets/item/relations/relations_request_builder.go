...
import (
    ...
    i61c97f3beb5a1c136618b869a34f15cd33eadbd0127f2540453c5e01bb3af4c5 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/sets/item/parentgroup/sets/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/parentGroup/sets/{set_id1}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*i61c97f3beb5a1c136618b869a34f15cd33eadbd0127f2540453c5e01bb3af4c5.CountRequestBuilder) {
    return i61c97f3beb5a1c136618b869a34f15cd33eadbd0127f2540453c5e01bb3af4c5.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
