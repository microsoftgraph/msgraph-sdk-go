...
import (
    ...
    i531cbc10e765bfe56b32d58d84d3129ec067d699aeb2995fd0f065c0cb099d37 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/sets/item/parentgroup/sets/item/terms/count"
)
...
func NewTermsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TermsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/parentGroup/sets/{set_id1}/terms{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *TermsRequestBuilder) Count()(*i531cbc10e765bfe56b32d58d84d3129ec067d699aeb2995fd0f065c0cb099d37.CountRequestBuilder) {
    return i531cbc10e765bfe56b32d58d84d3129ec067d699aeb2995fd0f065c0cb099d37.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
