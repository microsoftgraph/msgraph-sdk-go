...
// Builds and executes requests for operations under \sites\{site-id}\termStore\sets\{set-id}\relations\{relation-id}
...
func NewRelationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/sets/{set_id}/relations/{relation_id}{?select,expand}";
...
func (m *RelationRequestBuilder) FromTerm()(*ifc647a7c725dc0e258a99b9c11e19941833fe8423add71bbef926f35a5cc31d3.FromTermRequestBuilder) {
...
func (m *RelationRequestBuilder) Set()(*id711b09b87f991a04b185b531ea679d97856268acbc316c4ce918c0d25e6a8cb.SetRequestBuilder) {
...
func (m *RelationRequestBuilder) ToTerm()(*i879874a3e2d513d7981b52180462cc831916f4cdda43182ba96edd913902e1cc.ToTermRequestBuilder) {
