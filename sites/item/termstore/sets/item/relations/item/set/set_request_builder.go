...
import (
    ...
    ib1e2aadebf9768297d81b1bc90f1200ad485868b6c8f7f38e327b5335ea3fb2a "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstore/sets/item/relations/item/set/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStore\sets\{set-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStore/sets/{set_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*ib1e2aadebf9768297d81b1bc90f1200ad485868b6c8f7f38e327b5335ea3fb2a.RefRequestBuilder) {
    return ib1e2aadebf9768297d81b1bc90f1200ad485868b6c8f7f38e327b5335ea3fb2a.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
