...
import (
    ...
    i5d09e0a2fe2c44368e104efd05fbe23499f5d0cf4d4f6da2d6f9a26ab33f265a "github.com/microsoftgraph/msgraph-sdk-go/sites/item/items/count"
)
...
func (m *ItemsRequestBuilder) Count()(*i5d09e0a2fe2c44368e104efd05fbe23499f5d0cf4d4f6da2d6f9a26ab33f265a.CountRequestBuilder) {
    return i5d09e0a2fe2c44368e104efd05fbe23499f5d0cf4d4f6da2d6f9a26ab33f265a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemsRequestBuilder) GetWithResponseHandler(requestConfiguration *ItemsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.BaseItemCollectionResponseable, error) {
    return m.GetWithResponseHandler(requestConfiguration, nil);
}
// GetWithResponseHandler used to address any item contained in this site. This collection cannot be enumerated.
func (m *ItemsRequestBuilder) GetWithResponseHandler(requestConfiguration *ItemsRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.BaseItemCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateBaseItemCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping)
    if err != nil {
        return nil, err
    }
