...
import (
    ...
    ib68e228f79bbb1bb37031725d047264a0842968ad93580746a15aff905cf9039 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sectiongroups/item/parentsectiongroup/ref"
)

// ParentSectionGroupRequestBuilder builds and executes requests for operations under \sites\{site-id}\onenote\sectionGroups\{sectionGroup-id}\parentSectionGroup
...
func NewParentSectionGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentSectionGroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/sectionGroups/{sectionGroup_id}/parentSectionGroup{?select,expand}";
...
func (m *ParentSectionGroupRequestBuilder) Ref()(*ib68e228f79bbb1bb37031725d047264a0842968ad93580746a15aff905cf9039.RefRequestBuilder) {
    return ib68e228f79bbb1bb37031725d047264a0842968ad93580746a15aff905cf9039.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
