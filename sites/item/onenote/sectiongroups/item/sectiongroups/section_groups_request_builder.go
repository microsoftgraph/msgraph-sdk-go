...
import (
    ...
    ie88cf2e51c374b266de252a7ee47d72295ba3ed2c12502506f139a855fe95717 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sectiongroups/item/sectiongroups/ref"
)

// SectionGroupsRequestBuilder builds and executes requests for operations under \sites\{site-id}\onenote\sectionGroups\{sectionGroup-id}\sectionGroups
...
func NewSectionGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SectionGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/sectionGroups/{sectionGroup_id}/sectionGroups{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SectionGroupsRequestBuilder) Ref()(*ie88cf2e51c374b266de252a7ee47d72295ba3ed2c12502506f139a855fe95717.RefRequestBuilder) {
    return ie88cf2e51c374b266de252a7ee47d72295ba3ed2c12502506f139a855fe95717.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
