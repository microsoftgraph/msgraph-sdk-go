...
import (
    ...
    i2e5660d6e9df690b0e72b1ff2fbdb9a3deb8a85aafa4f2a052b5f757fd438efb "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sectiongroups/item/sections/item/parentsectiongroup/ref"
)

// ParentSectionGroupRequestBuilder builds and executes requests for operations under \sites\{site-id}\onenote\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\parentSectionGroup
...
func NewParentSectionGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentSectionGroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/parentSectionGroup{?select,expand}";
...
func (m *ParentSectionGroupRequestBuilder) Ref()(*i2e5660d6e9df690b0e72b1ff2fbdb9a3deb8a85aafa4f2a052b5f757fd438efb.RefRequestBuilder) {
    return i2e5660d6e9df690b0e72b1ff2fbdb9a3deb8a85aafa4f2a052b5f757fd438efb.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
