...
import (
    ...
    i6c06c5d08ae64b04c4037fafe9d01039cabb1d22f5a2c5bcfb4ee6add440d52b "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sectiongroups/item/sections/item/parentnotebook/sections/item/copytonotebook"
    if023a8fa91b11ef8e72694458036601189cb437ba85353874ec1315d02ec3b1d "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sectiongroups/item/sections/item/parentnotebook/sections/item/copytosectiongroup"
)

// OnenoteSectionRequestBuilder builds and executes requests for operations under \sites\{site-id}\onenote\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\parentNotebook\sections\{onenoteSection-id1}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/parentNotebook/sections/{onenoteSection_id1}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*i6c06c5d08ae64b04c4037fafe9d01039cabb1d22f5a2c5bcfb4ee6add440d52b.CopyToNotebookRequestBuilder) {
    return i6c06c5d08ae64b04c4037fafe9d01039cabb1d22f5a2c5bcfb4ee6add440d52b.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*if023a8fa91b11ef8e72694458036601189cb437ba85353874ec1315d02ec3b1d.CopyToSectionGroupRequestBuilder) {
    return if023a8fa91b11ef8e72694458036601189cb437ba85353874ec1315d02ec3b1d.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
