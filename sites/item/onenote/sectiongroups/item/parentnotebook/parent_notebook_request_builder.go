...
import (
    ...
    i26871fd50c170542fa6648e892de1b86d46d2acb302ce8a84e892775a29d31a0 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sectiongroups/item/parentnotebook/copynotebook"
    i517b13ab5bcf9a29672b3c1ffe49c3026613c7d12c3c4248ff0a536db318f51c "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sectiongroups/item/parentnotebook/sectiongroups"
    ibe84130344188eaad7493a63c0899ebd1edee9a06d3a828ec50789172e273acc "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sectiongroups/item/parentnotebook/sections"
    if03936f25d17e7ff303e220bc5e26ae15b2a9bc8866d944ccac8125c17ea3d01 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sectiongroups/item/parentnotebook/sectiongroups/item"
    if87a867d852b7b79457ed301abc6e3a35696afa9ecc51f6de3091657f30ededc "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sectiongroups/item/parentnotebook/sections/item"
)

// parentNotebookRequestBuilder builds and executes requests for operations under \sites\{site-id}\onenote\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i26871fd50c170542fa6648e892de1b86d46d2acb302ce8a84e892775a29d31a0.CopyNotebookRequestBuilder) {
    return i26871fd50c170542fa6648e892de1b86d46d2acb302ce8a84e892775a29d31a0.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ParentNotebookRequestBuilder) SectionGroups()(*i517b13ab5bcf9a29672b3c1ffe49c3026613c7d12c3c4248ff0a536db318f51c.SectionGroupsRequestBuilder) {
    return i517b13ab5bcf9a29672b3c1ffe49c3026613c7d12c3c4248ff0a536db318f51c.NewSectionGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionGroupsById gets an item from the github.com/microsoftgraph/msgraph-sdk-go/.sites.item.onenote.sectionGroups.item.parentNotebook.sectionGroups.item collection
func (m *ParentNotebookRequestBuilder) SectionGroupsById(id string)(*if03936f25d17e7ff303e220bc5e26ae15b2a9bc8866d944ccac8125c17ea3d01.SectionGroupRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return if03936f25d17e7ff303e220bc5e26ae15b2a9bc8866d944ccac8125c17ea3d01.NewSectionGroupRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
func (m *ParentNotebookRequestBuilder) Sections()(*ibe84130344188eaad7493a63c0899ebd1edee9a06d3a828ec50789172e273acc.SectionsRequestBuilder) {
    return ibe84130344188eaad7493a63c0899ebd1edee9a06d3a828ec50789172e273acc.NewSectionsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionsById gets an item from the github.com/microsoftgraph/msgraph-sdk-go/.sites.item.onenote.sectionGroups.item.parentNotebook.sections.item collection
func (m *ParentNotebookRequestBuilder) SectionsById(id string)(*if87a867d852b7b79457ed301abc6e3a35696afa9ecc51f6de3091657f30ededc.OnenoteSectionRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return if87a867d852b7b79457ed301abc6e3a35696afa9ecc51f6de3091657f30ededc.NewOnenoteSectionRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
