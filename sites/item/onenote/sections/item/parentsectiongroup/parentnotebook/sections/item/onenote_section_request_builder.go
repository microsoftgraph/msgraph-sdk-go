...
import (
    ...
    i0cb74a0fb073737aefbed6ccdf6cd37c310bd39050f78c510c39d154d71e3e8d "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sections/item/parentsectiongroup/parentnotebook/sections/item/copytosectiongroup"
    ifebdd1b82a21479922063b990efc1272adaf9d024fea0cc3feb905241eed9347 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sections/item/parentsectiongroup/parentnotebook/sections/item/copytonotebook"
)

// OnenoteSectionRequestBuilder builds and executes requests for operations under \sites\{site-id}\onenote\sections\{onenoteSection-id}\parentSectionGroup\parentNotebook\sections\{onenoteSection-id1}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/sections/{onenoteSection_id}/parentSectionGroup/parentNotebook/sections/{onenoteSection_id1}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*ifebdd1b82a21479922063b990efc1272adaf9d024fea0cc3feb905241eed9347.CopyToNotebookRequestBuilder) {
    return ifebdd1b82a21479922063b990efc1272adaf9d024fea0cc3feb905241eed9347.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*i0cb74a0fb073737aefbed6ccdf6cd37c310bd39050f78c510c39d154d71e3e8d.CopyToSectionGroupRequestBuilder) {
    return i0cb74a0fb073737aefbed6ccdf6cd37c310bd39050f78c510c39d154d71e3e8d.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
