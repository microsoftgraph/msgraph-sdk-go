...
import (
    ...
    i2f66fc8b4273f709be824d93bcd94293ef81e0458ed499cf10e2f1a87c47a035 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sections/item/parentsectiongroup/sections/item/copytonotebook"
    i8754d61834d4fe88df7dbe9b32b060a43303f77af323c81e84a94f821fd6b74a "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sections/item/parentsectiongroup/sections/item/copytosectiongroup"
)
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/sections/{onenoteSection_id}/parentSectionGroup/sections/{onenoteSection_id1}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*i2f66fc8b4273f709be824d93bcd94293ef81e0458ed499cf10e2f1a87c47a035.CopyToNotebookRequestBuilder) {
    return i2f66fc8b4273f709be824d93bcd94293ef81e0458ed499cf10e2f1a87c47a035.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*i8754d61834d4fe88df7dbe9b32b060a43303f77af323c81e84a94f821fd6b74a.CopyToSectionGroupRequestBuilder) {
    return i8754d61834d4fe88df7dbe9b32b060a43303f77af323c81e84a94f821fd6b74a.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The sections in the section group. Read-only. Nullable.
// Parameters:
