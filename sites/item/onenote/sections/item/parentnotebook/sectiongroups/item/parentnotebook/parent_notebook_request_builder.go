...
import (
    ...
    i2fe0871c6020d206563a33b4e53c17b227d5a610c6e8377d504d940268186310 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/sections/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/sections/{onenoteSection_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i2fe0871c6020d206563a33b4e53c17b227d5a610c6e8377d504d940268186310.CopyNotebookRequestBuilder) {
    return i2fe0871c6020d206563a33b4e53c17b227d5a610c6e8377d504d940268186310.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
