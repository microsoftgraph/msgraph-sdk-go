...
import (
    ...
    i2cd4832bd4f2805d8ee3469527f2a13a651f65f803e4e920f705fb907527e60e "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/pages/item/parentnotebook/sectiongroups/item/sections/item/parentnotebook/copynotebook"
)

// parentNotebookRequestBuilder builds and executes requests for operations under \sites\{site-id}\onenote\pages\{onenotePage-id}\parentNotebook\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i2cd4832bd4f2805d8ee3469527f2a13a651f65f803e4e920f705fb907527e60e.CopyNotebookRequestBuilder) {
    return i2cd4832bd4f2805d8ee3469527f2a13a651f65f803e4e920f705fb907527e60e.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
