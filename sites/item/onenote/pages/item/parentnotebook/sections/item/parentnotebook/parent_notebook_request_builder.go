...
import (
    ...
    i7b6fce6b04e13b1d55a87ac64bb3b0b785823f98878ae835b537d5bc8df7db06 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/pages/item/parentnotebook/sections/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/pages/{onenotePage_id}/parentNotebook/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i7b6fce6b04e13b1d55a87ac64bb3b0b785823f98878ae835b537d5bc8df7db06.CopyNotebookRequestBuilder) {
    return i7b6fce6b04e13b1d55a87ac64bb3b0b785823f98878ae835b537d5bc8df7db06.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the section.  Read-only.
// Parameters:
//  - h : Request headers
