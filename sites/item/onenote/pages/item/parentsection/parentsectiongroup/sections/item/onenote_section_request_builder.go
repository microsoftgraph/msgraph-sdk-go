...
import (
    ...
    iaec725688c27ef4e98e2bf1eeac33d780d4d15d95bc39fdf98c516b48d7339ac "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/pages/item/parentsection/parentsectiongroup/sections/item/copytosectiongroup"
    ic2a51d2e34dfbb8999e50c1535bd48ac309ff0cc01375a83066408ca5a0771e0 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/pages/item/parentsection/parentsectiongroup/sections/item/copytonotebook"
)
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/sections/{onenoteSection_id}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*ic2a51d2e34dfbb8999e50c1535bd48ac309ff0cc01375a83066408ca5a0771e0.CopyToNotebookRequestBuilder) {
    return ic2a51d2e34dfbb8999e50c1535bd48ac309ff0cc01375a83066408ca5a0771e0.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*iaec725688c27ef4e98e2bf1eeac33d780d4d15d95bc39fdf98c516b48d7339ac.CopyToSectionGroupRequestBuilder) {
    return iaec725688c27ef4e98e2bf1eeac33d780d4d15d95bc39fdf98c516b48d7339ac.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The sections in the section group. Read-only. Nullable.
// Parameters:
//  - h : Request headers
