...
import (
    ...
    i4020c8062f6125e7d98bc7bf79588673f813c5014ebf6c0fd54ddc467b5f96a8 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/onenote/notebooks/item/sections/item/parentsectiongroup/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/parentSectionGroup/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i4020c8062f6125e7d98bc7bf79588673f813c5014ebf6c0fd54ddc467b5f96a8.CopyNotebookRequestBuilder) {
    return i4020c8062f6125e7d98bc7bf79588673f813c5014ebf6c0fd54ddc467b5f96a8.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the section group. Read-only.
// Parameters:
