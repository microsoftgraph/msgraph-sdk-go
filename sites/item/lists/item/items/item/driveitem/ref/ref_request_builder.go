...
// RefRequestBuilder builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\items\{listItem-id}\driveItem\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/items/{listItem_id}/driveItem/$ref";
...
// CreatePutRequestInformation for document libraries, the driveItem relationship exposes the listItem as a [driveItem][]
...
// Put for document libraries, the driveItem relationship exposes the listItem as a [driveItem][]
