...
import (
    ...
    i73c6218c11aa29424d7ac3f0f6de2772296cf03800149ace1398ab87fb2903f3 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/lists/item/items/item/driveitem/content"
)

// DriveItemRequestBuilder builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\items\{listItem-id}\driveItem
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/items/{listItem_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i73c6218c11aa29424d7ac3f0f6de2772296cf03800149ace1398ab87fb2903f3.ContentRequestBuilder) {
    return i73c6218c11aa29424d7ac3f0f6de2772296cf03800149ace1398ab87fb2903f3.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
