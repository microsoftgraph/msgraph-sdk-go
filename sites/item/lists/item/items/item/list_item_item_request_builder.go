...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property items for sites
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property items in sites
