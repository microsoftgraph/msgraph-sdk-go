...
// DeleteWithResponseHandler delete navigation property subscriptions for sites
...
// PatchWithResponseHandler update the navigation property subscriptions in sites
