...
// AssociateWithHubSitesRequestBuilder builds and executes requests for operations under \sites\{site-id}\contentTypes\{contentType-id}\base\microsoft.graph.associateWithHubSites
...
func NewAssociateWithHubSitesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AssociateWithHubSitesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/contentTypes/{contentType_id}/base/microsoft.graph.associateWithHubSites";
