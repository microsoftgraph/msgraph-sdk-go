...
import (
    ...
    ibda32b79292f6281ae15b1ce0cb0f5eeb090307f2bc8166e58c00f81b73cccb2 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/contenttypes/item/columns/item/sourcecolumn/ref"
)

// SourceColumnRequestBuilder builds and executes requests for operations under \sites\{site-id}\contentTypes\{contentType-id}\columns\{columnDefinition-id}\sourceColumn
...
func NewSourceColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SourceColumnRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/contentTypes/{contentType_id}/columns/{columnDefinition_id}/sourceColumn{?select,expand}";
...
func (m *SourceColumnRequestBuilder) Ref()(*ibda32b79292f6281ae15b1ce0cb0f5eeb090307f2bc8166e58c00f81b73cccb2.RefRequestBuilder) {
    return ibda32b79292f6281ae15b1ce0cb0f5eeb090307f2bc8166e58c00f81b73cccb2.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
