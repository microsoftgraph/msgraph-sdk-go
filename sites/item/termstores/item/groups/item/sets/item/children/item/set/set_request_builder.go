...
import (
    ...
    i36ea647ac8faecd1ecb07f22ee5caab7c85ab8a5e106d33eeb3b314543caa9c9 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/groups/item/sets/item/children/item/set/ref"
)

// setRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\groups\{group-id}\sets\{set-id}\children\{term-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/children/{term_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*i36ea647ac8faecd1ecb07f22ee5caab7c85ab8a5e106d33eeb3b314543caa9c9.RefRequestBuilder) {
    return i36ea647ac8faecd1ecb07f22ee5caab7c85ab8a5e106d33eeb3b314543caa9c9.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
