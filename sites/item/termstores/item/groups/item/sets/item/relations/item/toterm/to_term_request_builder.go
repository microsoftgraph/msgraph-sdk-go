...
func NewToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ToTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/relations/{relation_id}/toTerm{?select,expand}";
...
func (m *ToTermRequestBuilder) Ref()(*i415748cc8f8e69ceadb08d9f3b3e6aa5b2df030488cf04002d186028391305fb.RefRequestBuilder) {
    return i415748cc8f8e69ceadb08d9f3b3e6aa5b2df030488cf04002d186028391305fb.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
