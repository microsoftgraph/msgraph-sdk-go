...
import (
    ...
    ie7902825d875a045663c72369e0d2d4c3f9e028ba8db4555b0a7252b8d5d36e0 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/groups/item/sets/item/terms/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/terms/{term_id}/children/{term_id1}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*ie7902825d875a045663c72369e0d2d4c3f9e028ba8db4555b0a7252b8d5d36e0.CountRequestBuilder) {
    return ie7902825d875a045663c72369e0d2d4c3f9e028ba8db4555b0a7252b8d5d36e0.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
