...
import (
    ...
    icd79c3eb7367e7b129d692dd7752a9e1386987e68a3a6ab3dfc4bf4ec0c2e9ab "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/groups/item/sets/item/terms/item/set/ref"
)

// SetRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\groups\{group-id}\sets\{set-id}\terms\{term-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/terms/{term_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*icd79c3eb7367e7b129d692dd7752a9e1386987e68a3a6ab3dfc4bf4ec0c2e9ab.RefRequestBuilder) {
    return icd79c3eb7367e7b129d692dd7752a9e1386987e68a3a6ab3dfc4bf4ec0c2e9ab.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
