...
import (
    ...
    i67edc2a61d2a2501ed026b183f958ca54f2585c0c8f94266cdb4af137db412a8 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/groups/item/sets/item/terms/item/relations/item/toterm/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\groups\{group-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}\toTerm
...
func NewToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ToTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/toTerm{?select,expand}";
...
func (m *ToTermRequestBuilder) Ref()(*i67edc2a61d2a2501ed026b183f958ca54f2585c0c8f94266cdb4af137db412a8.RefRequestBuilder) {
    return i67edc2a61d2a2501ed026b183f958ca54f2585c0c8f94266cdb4af137db412a8.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
