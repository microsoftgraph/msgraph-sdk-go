...
import (
    ...
    idf750136cc6cb3ac4a835931ce970e53495d62bda01d948b7db090b5f5b551ef "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/groups/item/sets/item/children/item/relations/item/set/ref"
)

// SetRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\groups\{group-id}\sets\{set-id}\children\{term-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/children/{term_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*idf750136cc6cb3ac4a835931ce970e53495d62bda01d948b7db090b5f5b551ef.RefRequestBuilder) {
    return idf750136cc6cb3ac4a835931ce970e53495d62bda01d948b7db090b5f5b551ef.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
