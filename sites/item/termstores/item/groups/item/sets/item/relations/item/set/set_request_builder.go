...
import (
    ...
    i6b7fcdc4e90923acff2c7acfcfb279f843b6ceedc16ab6876dbd9ccd67ccf0d4 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/groups/item/sets/item/relations/item/set/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\groups\{group-id}\sets\{set-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*i6b7fcdc4e90923acff2c7acfcfb279f843b6ceedc16ab6876dbd9ccd67ccf0d4.RefRequestBuilder) {
    return i6b7fcdc4e90923acff2c7acfcfb279f843b6ceedc16ab6876dbd9ccd67ccf0d4.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
