...
import (
    ...
    ic12358e781cff7bbfd7271719951566404ac39071d28d28b96d7fed9deb730db "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/groups/item/sets/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*ic12358e781cff7bbfd7271719951566404ac39071d28d28b96d7fed9deb730db.CountRequestBuilder) {
    return ic12358e781cff7bbfd7271719951566404ac39071d28d28b96d7fed9deb730db.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
