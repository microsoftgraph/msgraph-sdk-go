...
import (
    ...
    ide829bd6cd70d7fada81aa62bf6320e030449525807f8037dbf60251fd03a8c1 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/groups/item/sets"
...
// GroupItemRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\groups\{group-id}
...
func NewGroupItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GroupItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/groups/{group_id}{?select,expand}";
...
func (m *GroupItemRequestBuilder) Sets()(*ide829bd6cd70d7fada81aa62bf6320e030449525807f8037dbf60251fd03a8c1.SetsRequestBuilder) {
...
func (m *GroupItemRequestBuilder) SetsById(id string)(*i5fdd48054605d51ed33ea2d41b75d39ed3218582993ba4e6df34e3814d837ebd.SetItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i5fdd48054605d51ed33ea2d41b75d39ed3218582993ba4e6df34e3814d837ebd.NewSetItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
