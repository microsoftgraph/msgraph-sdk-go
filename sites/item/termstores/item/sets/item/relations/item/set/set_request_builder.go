...
import (
    ...
    ic54af5ec78d955abb443d63493dcd70fb8adb418b3696e3c57469a3ecfefa817 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/relations/item/set/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/sets/{set_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*ic54af5ec78d955abb443d63493dcd70fb8adb418b3696e3c57469a3ecfefa817.RefRequestBuilder) {
    return ic54af5ec78d955abb443d63493dcd70fb8adb418b3696e3c57469a3ecfefa817.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
