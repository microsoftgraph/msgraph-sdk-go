...
import (
    ...
    if0b329784dfd7e59b5c80d98d2d7d93c769b6d107a4cd09876e133f612598646 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/relations/item/fromterm/ref"
)

// FromTermRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\relations\{relation-id}\fromTerm
...
func NewFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FromTermRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/relations/{relation_id}/fromTerm{?select,expand}";
...
func (m *FromTermRequestBuilder) Ref()(*if0b329784dfd7e59b5c80d98d2d7d93c769b6d107a4cd09876e133f612598646.RefRequestBuilder) {
    return if0b329784dfd7e59b5c80d98d2d7d93c769b6d107a4cd09876e133f612598646.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
