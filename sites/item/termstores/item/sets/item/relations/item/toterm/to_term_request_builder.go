...
import (
    ...
    if47cd5d1819c83061d652af351068189432cfa0217e8793df1b59c517f29704e "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/relations/item/toterm/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\relations\{relation-id}\toTerm
...
func NewToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ToTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/sets/{set_id}/relations/{relation_id}/toTerm{?select,expand}";
...
func (m *ToTermRequestBuilder) Ref()(*if47cd5d1819c83061d652af351068189432cfa0217e8793df1b59c517f29704e.RefRequestBuilder) {
    return if47cd5d1819c83061d652af351068189432cfa0217e8793df1b59c517f29704e.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
