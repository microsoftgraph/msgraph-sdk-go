...
import (
    ...
    iaaa3aaae56ac1de154a616cb23ffa535888cdc6054fa74128dbd4d3e2fd74c3c "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*iaaa3aaae56ac1de154a616cb23ffa535888cdc6054fa74128dbd4d3e2fd74c3c.CountRequestBuilder) {
    return iaaa3aaae56ac1de154a616cb23ffa535888cdc6054fa74128dbd4d3e2fd74c3c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
