...
import (
    ...
    if9b7e8058bd587cdadbc1491477516266392aa6e91bc5651c0da42cc819fedc6 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/terms/item/set/ref"
)

// setRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\terms\{term-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms/{term_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*if9b7e8058bd587cdadbc1491477516266392aa6e91bc5651c0da42cc819fedc6.RefRequestBuilder) {
    return if9b7e8058bd587cdadbc1491477516266392aa6e91bc5651c0da42cc819fedc6.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
