...
import (
    ...
    i246183d5df7dde0a7a46c8f9f60baa64a7872fd352b912a049ed5b6259588876 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/terms/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms/{term_id}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*i246183d5df7dde0a7a46c8f9f60baa64a7872fd352b912a049ed5b6259588876.CountRequestBuilder) {
    return i246183d5df7dde0a7a46c8f9f60baa64a7872fd352b912a049ed5b6259588876.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
