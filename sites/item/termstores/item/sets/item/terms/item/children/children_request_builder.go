...
import (
    ...
    i570a3bb09cd38c8b12a6ac29f7f11ee46536ac09d22a4755bdb34093f61e7c8d "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/terms/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i570a3bb09cd38c8b12a6ac29f7f11ee46536ac09d22a4755bdb34093f61e7c8d.CountRequestBuilder) {
    return i570a3bb09cd38c8b12a6ac29f7f11ee46536ac09d22a4755bdb34093f61e7c8d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
