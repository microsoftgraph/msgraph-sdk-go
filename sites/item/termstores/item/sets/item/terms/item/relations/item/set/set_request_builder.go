...
import (
    ...
    iec804219f842cc61e244040890dd15508df159b9cd3dcc40a9607ebb9e4c5db1 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/terms/item/relations/item/set/ref"
)

// setRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*iec804219f842cc61e244040890dd15508df159b9cd3dcc40a9607ebb9e4c5db1.RefRequestBuilder) {
    return iec804219f842cc61e244040890dd15508df159b9cd3dcc40a9607ebb9e4c5db1.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
