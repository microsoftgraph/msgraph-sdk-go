...
import (
    ...
    ice3393f33e6a5ec1db9a8bedca34dddc1cc2c74af69eeda9b19f78e6b2e0b46a "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/terms/item/relations/item/toterm/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}\toTerm
...
func NewToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ToTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/toTerm{?select,expand}";
...
func (m *ToTermRequestBuilder) Ref()(*ice3393f33e6a5ec1db9a8bedca34dddc1cc2c74af69eeda9b19f78e6b2e0b46a.RefRequestBuilder) {
    return ice3393f33e6a5ec1db9a8bedca34dddc1cc2c74af69eeda9b19f78e6b2e0b46a.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
