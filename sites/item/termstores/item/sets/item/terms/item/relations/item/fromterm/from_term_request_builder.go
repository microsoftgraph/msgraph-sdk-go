...
import (
    ...
    i5c366c3c67e7ae9a4e047399dc35cb70f282cedfd61bcf4dadc01e72ebda7733 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/terms/item/relations/item/fromterm/ref"
)

// FromTermRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}\fromTerm
...
func NewFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FromTermRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/fromTerm{?select,expand}";
...
func (m *FromTermRequestBuilder) Ref()(*i5c366c3c67e7ae9a4e047399dc35cb70f282cedfd61bcf4dadc01e72ebda7733.RefRequestBuilder) {
    return i5c366c3c67e7ae9a4e047399dc35cb70f282cedfd61bcf4dadc01e72ebda7733.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
