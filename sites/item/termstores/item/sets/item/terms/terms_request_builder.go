...
import (
    ...
    i56bd38774540c01aa407ce06960ce7db78168353957856a0ac8e91352a9fb194 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/terms/count"
)
...
func NewTermsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TermsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *TermsRequestBuilder) Count()(*i56bd38774540c01aa407ce06960ce7db78168353957856a0ac8e91352a9fb194.CountRequestBuilder) {
    return i56bd38774540c01aa407ce06960ce7db78168353957856a0ac8e91352a9fb194.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
