...
import (
    ...
    i185cac2ad45e1822c3231203987136cb6413c35f396ee213af4b05cbae5cd4fa "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/children/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/children/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i185cac2ad45e1822c3231203987136cb6413c35f396ee213af4b05cbae5cd4fa.CountRequestBuilder) {
    return i185cac2ad45e1822c3231203987136cb6413c35f396ee213af4b05cbae5cd4fa.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
