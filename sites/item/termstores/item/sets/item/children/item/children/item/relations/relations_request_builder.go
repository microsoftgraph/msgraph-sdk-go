...
import (
    ...
    i0ccb5433ddf0e5a73027790954c1479dc30a90ac15c52f821dfc46914fd8360b "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/children/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/children/{term_id}/children/{term_id1}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*i0ccb5433ddf0e5a73027790954c1479dc30a90ac15c52f821dfc46914fd8360b.CountRequestBuilder) {
    return i0ccb5433ddf0e5a73027790954c1479dc30a90ac15c52f821dfc46914fd8360b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
