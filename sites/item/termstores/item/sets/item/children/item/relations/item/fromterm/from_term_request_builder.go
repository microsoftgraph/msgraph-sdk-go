...
import (
    ...
    ic5be849857922a157810b0ab9b9d064326c08d32055bb3616cbc3186ad836b47 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/children/item/relations/item/fromterm/ref"
)

// FromTermRequestBuilder builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\children\{term-id}\relations\{relation-id}\fromTerm
...
func NewFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FromTermRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/children/{term_id}/relations/{relation_id}/fromTerm{?select,expand}";
...
func (m *FromTermRequestBuilder) Ref()(*ic5be849857922a157810b0ab9b9d064326c08d32055bb3616cbc3186ad836b47.RefRequestBuilder) {
    return ic5be849857922a157810b0ab9b9d064326c08d32055bb3616cbc3186ad836b47.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
