...
import (
    ...
    i68014917bf894277fe586c7953defc5eda882e87e3706e036eb6bc8dc4611302 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/children/item/set/ref"
)

// Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\children\{term-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/v1.0/sites/{site_id}/termStores/{store_id}/sets/{set_id}/children/{term_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*i68014917bf894277fe586c7953defc5eda882e87e3706e036eb6bc8dc4611302.RefRequestBuilder) {
    return i68014917bf894277fe586c7953defc5eda882e87e3706e036eb6bc8dc4611302.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
