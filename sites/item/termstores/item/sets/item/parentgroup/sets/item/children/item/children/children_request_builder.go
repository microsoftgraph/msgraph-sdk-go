...
import (
    ...
    i7b0c8812af1e8cf4ba588d95550fc160a1a489f88eba8c662d8aa150d5840514 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/parentgroup/sets/item/children/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/children/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i7b0c8812af1e8cf4ba588d95550fc160a1a489f88eba8c662d8aa150d5840514.CountRequestBuilder) {
    return i7b0c8812af1e8cf4ba588d95550fc160a1a489f88eba8c662d8aa150d5840514.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
