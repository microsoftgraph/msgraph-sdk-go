...
import (
    ...
    i2737ff64dbdbb7ae69427814e8510ab256bc760340989df33da38ee7133a2ab1 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/parentgroup/sets/item/terms/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/terms/{term_id}/children/{term_id1}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*i2737ff64dbdbb7ae69427814e8510ab256bc760340989df33da38ee7133a2ab1.CountRequestBuilder) {
    return i2737ff64dbdbb7ae69427814e8510ab256bc760340989df33da38ee7133a2ab1.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
