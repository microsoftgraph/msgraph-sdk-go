...
import (
    ...
    i1f2758c2fc310375da0bd7cc9d21654be41a3b9410348e5e4ea0079610c38eba "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/parentgroup/sets/item/terms/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/terms/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i1f2758c2fc310375da0bd7cc9d21654be41a3b9410348e5e4ea0079610c38eba.CountRequestBuilder) {
    return i1f2758c2fc310375da0bd7cc9d21654be41a3b9410348e5e4ea0079610c38eba.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
