...
import (
    ...
    ic5dfb5e58b88edd45a9b29f1db48ccad229fd29a536faf93aa3bce36abececb8 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/parentgroup/sets/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/children/{term_id}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*ic5dfb5e58b88edd45a9b29f1db48ccad229fd29a536faf93aa3bce36abececb8.CountRequestBuilder) {
    return ic5dfb5e58b88edd45a9b29f1db48ccad229fd29a536faf93aa3bce36abececb8.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
