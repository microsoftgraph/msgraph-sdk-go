...
import (
    ...
    i4d41fb49b7743409105bba9c86015118de0949e678344fb3cea660ab7342ede8 "github.com/microsoftgraph/msgraph-sdk-go/sites/item/termstores/item/sets/item/parentgroup/sets/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i4d41fb49b7743409105bba9c86015118de0949e678344fb3cea660ab7342ede8.CountRequestBuilder) {
    return i4d41fb49b7743409105bba9c86015118de0949e678344fb3cea660ab7342ede8.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
