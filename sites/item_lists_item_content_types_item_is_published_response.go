...
func (m *ItemListsItemContentTypesItemIsPublishedResponse) GetAdditionalData()(map[string]any) {
...
func (m *ItemListsItemContentTypesItemIsPublishedResponse) SetAdditionalData(value map[string]any)() {
