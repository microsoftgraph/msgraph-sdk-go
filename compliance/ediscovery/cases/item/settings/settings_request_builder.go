...
import (
    ...
    i8fdc4af8d9a1aec6e19330355ce368c76a084135db1a671bde411809e0892837 "github.com/microsoftgraph/msgraph-sdk-go/compliance/ediscovery/cases/item/settings/resettodefault"
)
...
type SettingsRequestBuilderPatchOptions struct {
    // 
    Body *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CaseSettings;
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
...
func NewSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SettingsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/settings{?select,expand}";
...
// Parameters:
//  - options : Options for the request
func (m *SettingsRequestBuilder) Get(options *SettingsRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CaseSettings, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewCaseSettings() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CaseSettings), nil
}
// Update the navigation property settings in compliance
// Parameters:
//  - options : Options for the request
...
func (m *SettingsRequestBuilder) ResetToDefault()(*i8fdc4af8d9a1aec6e19330355ce368c76a084135db1a671bde411809e0892837.ResetToDefaultRequestBuilder) {
    return i8fdc4af8d9a1aec6e19330355ce368c76a084135db1a671bde411809e0892837.NewResetToDefaultRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
