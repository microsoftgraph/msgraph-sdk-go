...
import (
    ...
    if3bd9a560c751001d210577c48bdac447e7b20d9c954262ec26184903438f40c "github.com/microsoftgraph/msgraph-sdk-go/compliance/ediscovery/cases/item/sourcecollections/item/lastestimatestatisticsoperation/ref"
)
...
// Parameters:
//  - options : Options for the request
func (m *LastEstimateStatisticsOperationRequestBuilder) Get(options *LastEstimateStatisticsOperationRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.EstimateStatisticsOperation, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewEstimateStatisticsOperation() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.EstimateStatisticsOperation), nil
}
func (m *LastEstimateStatisticsOperationRequestBuilder) Ref()(*if3bd9a560c751001d210577c48bdac447e7b20d9c954262ec26184903438f40c.RefRequestBuilder) {
    return if3bd9a560c751001d210577c48bdac447e7b20d9c954262ec26184903438f40c.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
