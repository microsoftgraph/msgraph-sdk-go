...
// Builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\legalHolds\{legalHold-id}\userSources
...
// Parameters:
//  - options : Options for the request
func (m *UserSourcesRequestBuilder) Get(options *UserSourcesRequestBuilderGetOptions)(*UserSourcesResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewUserSourcesResponse() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*UserSourcesResponse), nil
}
// Data source entity for a the legal hold. This is the container for a mailbox and OneDrive for Business site.
// Parameters:
//  - options : Options for the request
func (m *UserSourcesRequestBuilder) Post(options *UserSourcesRequestBuilderPostOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.UserSource, error) {
