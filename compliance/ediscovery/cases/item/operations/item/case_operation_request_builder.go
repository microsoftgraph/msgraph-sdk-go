...
import (
    ...
    id14eddb6bccb430279b88054f6d4b55f32b051c8ed9b91ef3638e6621491e45f "github.com/microsoftgraph/msgraph-sdk-go/compliance/ediscovery/cases/item/operations/item/caseexportoperation"
)
...
type CaseOperationRequestBuilderGetOptions struct {
    ...
    Q *CaseOperationRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
type CaseOperationRequestBuilderPatchOptions struct {
    // 
    Body *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CaseOperation;
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
...
func (m *CaseOperationRequestBuilder) CaseExportOperation()(*id14eddb6bccb430279b88054f6d4b55f32b051c8ed9b91ef3638e6621491e45f.CaseExportOperationRequestBuilder) {
    return id14eddb6bccb430279b88054f6d4b55f32b051c8ed9b91ef3638e6621491e45f.NewCaseExportOperationRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewCaseOperationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CaseOperationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/operations/{caseOperation_id}{?select,expand}";
...
// Parameters:
//  - options : Options for the request
func (m *CaseOperationRequestBuilder) Get(options *CaseOperationRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CaseOperation, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewCaseOperation() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.CaseOperation), nil
}
// Returns a list of case operation objects for this case. Nullable.
// Parameters:
//  - options : Options for the request
