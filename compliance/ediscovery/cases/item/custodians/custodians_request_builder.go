...
// Builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\custodians
...
func (m *CustodiansRequestBuilder) Get(options *CustodiansRequestBuilderGetOptions)(*CustodiansResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewCustodiansResponse() }, nil)
    if err != nil {
        return nil, err
    }
...
// Parameters:
//  - options : Options for the request
func (m *CustodiansRequestBuilder) Post(options *CustodiansRequestBuilderPostOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Custodian, error) {
