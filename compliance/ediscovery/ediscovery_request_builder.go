...
import (
    ...
    i5045e9cc31a8a791245cd7585fb9472087839f69ebc27c09cd89c7e09151a678 "github.com/microsoftgraph/msgraph-sdk-go/compliance/ediscovery/cases"
    iee22373475020cf75fd613ed0a68578b1293cac4a3a9504fed531a49c50e9ec4 "github.com/microsoftgraph/msgraph-sdk-go/compliance/ediscovery/cases/item"
)
...
type EdiscoveryRequestBuilderGetOptions struct {
    ...
    Q *EdiscoveryRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
type EdiscoveryRequestBuilderPatchOptions struct {
    // 
    Body *i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Ediscoveryroot;
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
...
func (m *EdiscoveryRequestBuilder) Cases()(*i5045e9cc31a8a791245cd7585fb9472087839f69ebc27c09cd89c7e09151a678.CasesRequestBuilder) {
    return i5045e9cc31a8a791245cd7585fb9472087839f69ebc27c09cd89c7e09151a678.NewCasesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Gets an item from the github.com/microsoftgraph/msgraph-sdk-go/.compliance.ediscovery.cases.item collection
// Parameters:
//  - id : Unique identifier of the item
func (m *EdiscoveryRequestBuilder) CasesById(id string)(*iee22373475020cf75fd613ed0a68578b1293cac4a3a9504fed531a49c50e9ec4.CaseRequestBuilder) {
    ...
    return iee22373475020cf75fd613ed0a68578b1293cac4a3a9504fed531a49c50e9ec4.NewCaseRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
// Parameters:
//  - options : Options for the request
func (m *EdiscoveryRequestBuilder) Get(options *EdiscoveryRequestBuilderGetOptions)(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Ediscoveryroot, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.NewEdiscoveryroot() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*i4a838ef194e4c99e9f2c63ba10dab9cb120a89367c1d4ab0daa63bb424e20d87.Ediscoveryroot), nil
}
// Update the navigation property ediscovery in compliance
// Parameters:
//  - options : Options for the request
