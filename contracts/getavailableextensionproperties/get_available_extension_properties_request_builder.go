...
// GetAvailableExtensionPropertiesRequestBuilder builds and executes requests for operations under \contracts\microsoft.graph.getAvailableExtensionProperties
