...
// ContractsRequestBuilderGetQueryParameters retrieve a list of [contract](../resources/contract.md) objects associated to a partner tenant.
...
// CreateGetRequestInformation retrieve a list of [contract](../resources/contract.md) objects associated to a partner tenant.
...
// CreateGetRequestInformationWithRequestConfiguration retrieve a list of [contract](../resources/contract.md) objects associated to a partner tenant.
...
// Get retrieve a list of [contract](../resources/contract.md) objects associated to a partner tenant.
...
// GetWithRequestConfigurationAndResponseHandler retrieve a list of [contract](../resources/contract.md) objects associated to a partner tenant.
